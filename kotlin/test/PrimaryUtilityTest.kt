...
class PrimaryUtilityTest {
  ...
  companion object {
    ...
    private var CLIENT: BluefinTecsMerchantServicesSDK? = null
    ...
    fun run(): OmniResolver.Run {
      var r = RUN
      if (null == r) {
        val client = BluefinTecsMerchantServicesSDK.testSDK()
        CLIENT = client
    ...
    fun client(): BluefinTecsMerchantServicesSDK {
      run()
      return CLIENT!!
    }
  ...
  fun featureHookBasic() {
    val hookClient = BluefinTecsMerchantServicesSDK.testSDK()
  ...
  fun featureInitBasic() {
    val initClient = BluefinTecsMerchantServicesSDK.testSDK()
