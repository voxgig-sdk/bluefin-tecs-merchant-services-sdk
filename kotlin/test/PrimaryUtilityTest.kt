...
import voxgig.bluefintecsmerchantservicessdk.sdktest.RunnerSupport.getSpec
import voxgig.bluefintecsmerchantservicessdk.sdktest.RunnerSupport.loadTestSpec
import voxgig.bluefintecsmerchantservicessdk.sdktest.RunnerSupport.makeCtxFromMap
import voxgig.bluefintecsmerchantservicessdk.sdktest.RunnerSupport.runset
...
class PrimaryUtilityTest {
  ...
  private fun client(): BluefinTecsMerchantServicesSDK = BluefinTecsMerchantServicesSDK.testSDK()

  private fun makeTestCtx(client: BluefinTecsMerchantServicesSDK, utility: Utility, overrides: MutableMap<String, Any?>?): Context {
  ...
  private fun makeTestFullCtx(client: BluefinTecsMerchantServicesSDK, utility: Utility): Context {
  ...
  fun fetcherLive() {
    ...
    val liveClient = BluefinTecsMerchantServicesSDK(
      fhMap(
        "system",
        fhMap(
          "fetch",
  ...
  fun fetcherBlockedTestMode() {
    val blockedClient = BluefinTecsMerchantServicesSDK(
      fhMap(
        "system",
  ...
  fun makeSpecBasic() {
    ...
    val specClient = BluefinTecsMerchantServicesSDK.testSDK(null, setupOpts)
  ...
  fun prepareAuthBasic() {
    ...
    val authClient = BluefinTecsMerchantServicesSDK.testSDK(null, setupOpts)
