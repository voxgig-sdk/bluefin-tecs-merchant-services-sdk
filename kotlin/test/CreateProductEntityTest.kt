...
class CreateProductEntityTest {
  ...
  fun basic() {
    ...
    createProductRef01Data = Helpers.toMapAny(if (createProductRef01DataResult is SdkEntity) createProductRef01DataResult.data() else createProductRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun createProductBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFIN_TECS_MERCHANT_SERVICES_TEST_CREATE_PRODUCT_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFIN_TECS_MERCHANT_SERVICES_TEST_CREATE_PRODUCT_ENTID"] = idmap
