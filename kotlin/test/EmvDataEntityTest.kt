...
class EmvDataEntityTest {
  ...
  fun basic() {
    ...
    emvDataRef01Data = Helpers.toMapAny(emvDataRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun emvDataBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFINTECSMERCHANTSERVICES_TEST_EMV_DATA_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFINTECSMERCHANTSERVICES_TEST_EMV_DATA_ENTID"] = idmap
      ...
      var idmapResolved = Helpers.toMapAny(env["BLUEFINTECSMERCHANTSERVICES_TEST_EMV_DATA_ENTID"])
