...
class DeactivateTerminalEntityTest {
  ...
  fun basic() {
    ...
    deactivateTerminalRef01Data = Helpers.toMapAny(if (deactivateTerminalRef01DataResult is SdkEntity) deactivateTerminalRef01DataResult.data() else deactivateTerminalRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun deactivateTerminalBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFIN_TECS_MERCHANT_SERVICES_TEST_DEACTIVATE_TERMINAL_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFIN_TECS_MERCHANT_SERVICES_TEST_DEACTIVATE_TERMINAL_ENTID"] = idmap
