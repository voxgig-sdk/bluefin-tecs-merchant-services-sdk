...
object OmniResolver {
  ...
  class Run internal constructor(
    ...
    val client: BluefinTecsMerchantServicesSDK?,
  ) {
   ...
   */
  fun makeRunner(testfile: Any?, client: BluefinTecsMerchantServicesSDK?): NamedRunner {
  ...
  private fun sdkProvider(client: BluefinTecsMerchantServicesSDK?): Provider = Provider(
    ...
    client = { options ->
      ...
      sdkProvider(BluefinTecsMerchantServicesSDK.testSDK(null, opts ?: linkedMapOf()))
    },
   ...
   * per section, by hand.)
   */
  fun omniCtx(arg: Any?, client: BluefinTecsMerchantServicesSDK?, utility: Utility?): Context {
