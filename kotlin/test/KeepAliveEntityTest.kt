...
class KeepAliveEntityTest {
  ...
  fun basic() {
    ...
    keepAliveRef01Data = Helpers.toMapAny(if (keepAliveRef01DataResult is SdkEntity) keepAliveRef01DataResult.data() else keepAliveRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun keepAliveBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFIN_TECS_MERCHANT_SERVICES_TEST_KEEP_ALIVE_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFIN_TECS_MERCHANT_SERVICES_TEST_KEEP_ALIVE_ENTID"] = idmap
