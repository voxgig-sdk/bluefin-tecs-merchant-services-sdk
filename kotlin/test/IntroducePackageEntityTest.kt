...
class IntroducePackageEntityTest {
  ...
  fun basic() {
    ...
    introducePackageRef01Data = Helpers.toMapAny(introducePackageRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun introducePackageBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFINTECSMERCHANTSERVICES_TEST_INTRODUCE_PACKAGE_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFINTECSMERCHANTSERVICES_TEST_INTRODUCE_PACKAGE_ENTID"] = idmap
