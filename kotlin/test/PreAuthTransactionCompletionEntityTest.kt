...
class PreAuthTransactionCompletionEntityTest {
  ...
  fun basic() {
    ...
    preAuthTransactionCompletionRef01Data = Helpers.toMapAny(preAuthTransactionCompletionRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun preAuthTransactionCompletionBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFINTECSMERCHANTSERVICES_TEST_PRE_AUTH_TRANSACTION_COMPLETION_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFINTECSMERCHANTSERVICES_TEST_PRE_AUTH_TRANSACTION_COMPLETION_ENTID"] = idmap
      ...
      var idmapResolved = Helpers.toMapAny(env["BLUEFINTECSMERCHANTSERVICES_TEST_PRE_AUTH_TRANSACTION_COMPLETION_ENTID"])
