...
class DigitalServicesApiEntityTest {
  ...
  fun basic() {
    ...
    digitalServicesApiRef01Data = Helpers.toMapAny(digitalServicesApiRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun digitalServicesApiBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFINTECSMERCHANTSERVICES_TEST_DIGITAL_SERVICES_API_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFINTECSMERCHANTSERVICES_TEST_DIGITAL_SERVICES_API_ENTID"] = idmap
