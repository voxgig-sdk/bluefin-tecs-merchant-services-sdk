...
class UpdateTemplateXmlEntityTest {
  ...
  fun basic() {
    ...
    updateTemplateXmlRef01Data = Helpers.toMapAny(updateTemplateXmlRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun updateTemplateXmlBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFINTECSMERCHANTSERVICES_TEST_UPDATE_TEMPLATE_XML_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFINTECSMERCHANTSERVICES_TEST_UPDATE_TEMPLATE_XML_ENTID"] = idmap
