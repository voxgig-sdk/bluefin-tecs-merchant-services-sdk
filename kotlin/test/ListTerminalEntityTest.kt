...
class ListTerminalEntityTest {
  ...
  fun basic() {
    ...
    listTerminalRef01Data = Helpers.toMapAny(if (listTerminalRef01DataResult is SdkEntity) listTerminalRef01DataResult.data() else listTerminalRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun listTerminalBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFIN_TECS_MERCHANT_SERVICES_TEST_LIST_TERMINAL_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFIN_TECS_MERCHANT_SERVICES_TEST_LIST_TERMINAL_ENTID"] = idmap
