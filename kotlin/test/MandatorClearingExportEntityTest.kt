...
class MandatorClearingExportEntityTest {
  ...
  fun basic() {
    ...
    mandatorClearingExportRef01Data = Helpers.toMapAny(mandatorClearingExportRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun mandatorClearingExportBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFINTECSMERCHANTSERVICES_TEST_MANDATOR_CLEARING_EXPORT_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFINTECSMERCHANTSERVICES_TEST_MANDATOR_CLEARING_EXPORT_ENTID"] = idmap
