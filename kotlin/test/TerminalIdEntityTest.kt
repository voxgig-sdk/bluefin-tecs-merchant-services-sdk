...
class TerminalIdEntityTest {
  ...
  fun basic() {
    ...
    terminalIdRef01Data = Helpers.toMapAny(terminalIdRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun terminalIdBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFINTECSMERCHANTSERVICES_TEST_TERMINAL_ID_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFINTECSMERCHANTSERVICES_TEST_TERMINAL_ID_ENTID"] = idmap
