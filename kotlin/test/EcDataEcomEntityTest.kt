...
class EcDataEcomEntityTest {
  ...
  fun basic() {
    ...
    ecDataEcomRef01Data = Helpers.toMapAny(if (ecDataEcomRef01DataResult is SdkEntity) ecDataEcomRef01DataResult.data() else ecDataEcomRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun ecDataEcomBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFIN_TECS_MERCHANT_SERVICES_TEST_EC_DATA_ECOM_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFIN_TECS_MERCHANT_SERVICES_TEST_EC_DATA_ECOM_ENTID"] = idmap
