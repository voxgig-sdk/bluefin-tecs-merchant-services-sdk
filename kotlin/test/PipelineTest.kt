...
class PipelineTest {
  ...
  private fun plClient(sdkopts: MutableMap<String, Any?>?): BluefinTecsMerchantServicesSDK {
    return BluefinTecsMerchantServicesSDK.testSDK(null, sdkopts)
  }

  private fun plCtx(client: BluefinTecsMerchantServicesSDK, utility: Utility, ctrl: MutableMap<String, Any?>?): Context {
  ...
  private fun names(client: BluefinTecsMerchantServicesSDK): String {
