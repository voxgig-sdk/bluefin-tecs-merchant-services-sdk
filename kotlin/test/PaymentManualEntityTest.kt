...
class PaymentManualEntityTest {
  ...
  fun basic() {
    ...
    paymentManualRef01Data = Helpers.toMapAny(paymentManualRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun paymentManualBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFINTECSMERCHANTSERVICES_TEST_PAYMENT_MANUAL_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFINTECSMERCHANTSERVICES_TEST_PAYMENT_MANUAL_ENTID"] = idmap
