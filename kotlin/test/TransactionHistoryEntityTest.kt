...
class TransactionHistoryEntityTest {
  ...
  fun basic() {
    ...
    transactionHistoryRef01Data = Helpers.toMapAny(transactionHistoryRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun transactionHistoryBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFINTECSMERCHANTSERVICES_TEST_TRANSACTION_HISTORY_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFINTECSMERCHANTSERVICES_TEST_TRANSACTION_HISTORY_ENTID"] = idmap
