...
class EcrDataEntityTest {
  ...
  fun basic() {
    ...
    ecrDataRef01Data = Helpers.toMapAny(if (ecrDataRef01DataResult is SdkEntity) ecrDataRef01DataResult.data() else ecrDataRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun ecrDataBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFIN_TECS_MERCHANT_SERVICES_TEST_ECR_DATA_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFIN_TECS_MERCHANT_SERVICES_TEST_ECR_DATA_ENTID"] = idmap
