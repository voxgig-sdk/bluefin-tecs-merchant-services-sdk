...
class MandatorClearingExportSummaryEntityTest {
  ...
  fun basic() {
    ...
    mandatorClearingExportSummaryRef01Data = Helpers.toMapAny(mandatorClearingExportSummaryRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun mandatorClearingExportSummaryBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFINTECSMERCHANTSERVICES_TEST_MANDATOR_CLEARING_EXPORT_SUMMARY_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFINTECSMERCHANTSERVICES_TEST_MANDATOR_CLEARING_EXPORT_SUMMARY_ENTID"] = idmap
