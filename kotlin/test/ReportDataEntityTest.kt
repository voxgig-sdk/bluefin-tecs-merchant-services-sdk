...
class ReportDataEntityTest {
  ...
  fun basic() {
    ...
    reportDataRef01Data = Helpers.toMapAny(if (reportDataRef01DataResult is SdkEntity) reportDataRef01DataResult.data() else reportDataRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun reportDataBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFIN_TECS_MERCHANT_SERVICES_TEST_REPORT_DATA_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFIN_TECS_MERCHANT_SERVICES_TEST_REPORT_DATA_ENTID"] = idmap
