...
class ReactivateTerminalEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("reactivate_terminal", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return ReactivateTerminalEntity(this.client, opts)
  }
