...
class CheckCardBlackListedEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("check_card_black_listed", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return CheckCardBlackListedEntity(this.client, opts)
  }
