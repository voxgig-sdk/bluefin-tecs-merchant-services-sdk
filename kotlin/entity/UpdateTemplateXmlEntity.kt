...
class UpdateTemplateXmlEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("update_template_xml", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return UpdateTemplateXmlEntity(this.client, opts)
  }
