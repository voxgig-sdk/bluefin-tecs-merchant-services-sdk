...
class MandatorClearingExportEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("mandator_clearing_export", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return MandatorClearingExportEntity(this.client, opts)
  }
