...
class StoreTerminalParameterEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("store_terminal_parameter", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return StoreTerminalParameterEntity(this.client, opts)
  }
