...
class GetTemplateXmlEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("get_template_xml", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return GetTemplateXmlEntity(this.client, opts)
  }
