...
class PreAuthTransactionCompletionEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("pre_auth_transaction_completion", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return PreAuthTransactionCompletionEntity(this.client, opts)
  }
