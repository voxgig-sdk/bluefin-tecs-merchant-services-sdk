...
class MerchantPortalServicesApiEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("merchant_portal_services_api", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return MerchantPortalServicesApiEntity(this.client, opts)
  }
