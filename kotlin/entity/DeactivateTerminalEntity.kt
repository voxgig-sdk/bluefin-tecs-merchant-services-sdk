...
class DeactivateTerminalEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("deactivate_terminal", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return DeactivateTerminalEntity(this.client, opts)
  }
