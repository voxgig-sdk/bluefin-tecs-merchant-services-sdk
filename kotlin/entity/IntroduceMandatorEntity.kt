...
class IntroduceMandatorEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("introduce_mandator", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return IntroduceMandatorEntity(this.client, opts)
  }
