...
class GetMerchantContractNumberEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("get_merchant_contract_number", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return GetMerchantContractNumberEntity(this.client, opts)
  }
