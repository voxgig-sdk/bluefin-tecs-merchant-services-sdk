...
class DigitalServicesApiEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("digital_services_api", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return DigitalServicesApiEntity(this.client, opts)
  }
