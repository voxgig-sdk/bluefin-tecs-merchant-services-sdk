...
class TransactionsTurnoverEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("transactions_turnover", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return TransactionsTurnoverEntity(this.client, opts)
  }
