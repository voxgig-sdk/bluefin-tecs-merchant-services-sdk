...
class TransactionsCountCardBrandEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("transactions_count_card_brand", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return TransactionsCountCardBrandEntity(this.client, opts)
  }
