...
class RegisterTecsCompanyEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("register_tecs_company", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return RegisterTecsCompanyEntity(this.client, opts)
  }
