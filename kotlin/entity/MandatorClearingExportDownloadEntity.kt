...
class MandatorClearingExportDownloadEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("mandator_clearing_export_download", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return MandatorClearingExportDownloadEntity(this.client, opts)
  }
