...
class MandatorClearingExportSummaryEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("mandator_clearing_export_summary", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return MandatorClearingExportSummaryEntity(this.client, opts)
  }
