...
fun resultBasic(ctx: Context): voxgig.bluefintecsmerchantservicessdk.core.Result {
...
fun resultBody(ctx: Context): voxgig.bluefintecsmerchantservicessdk.core.Result {
  val response = ctx.response
  val result = ctx.result
...
fun resultHeaders(ctx: Context): voxgig.bluefintecsmerchantservicessdk.core.Result {
  val response = ctx.response
  val result = ctx.result
