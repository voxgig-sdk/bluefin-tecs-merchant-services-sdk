// ReactivateTerminal entity client (generated — mirrors the go/rust Entity fragment).
...
pub const ReactivateTerminalEntity = struct {
    name: []const u8 = "reactivate_terminal",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *ReactivateTerminalEntity {
        ...
        const e = h.A().create(ReactivateTerminalEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *ReactivateTerminalEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *ReactivateTerminalEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *ReactivateTerminalEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *ReactivateTerminalEntity, ctx: *Context, post_done: *const fn (*ReactivateTerminalEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *ReactivateTerminalEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *ReactivateTerminalEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *ReactivateTerminalEntity, ctx: *Context, post_done: *const fn (*ReactivateTerminalEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *ReactivateTerminalEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *ReactivateTerminalEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return ReactivateTerminalEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *ReactivateTerminalEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *ReactivateTerminalEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *ReactivateTerminalEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *ReactivateTerminalEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *ReactivateTerminalEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *ReactivateTerminalEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *ReactivateTerminalEntity, ctx: *Context) void {
    ...
    pub fn update(self: *ReactivateTerminalEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *ReactivateTerminalEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
