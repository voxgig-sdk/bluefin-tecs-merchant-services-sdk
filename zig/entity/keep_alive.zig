// KeepAlive entity client (generated — mirrors the go/rust Entity fragment).
...
pub const KeepAliveEntity = struct {
    name: []const u8 = "keep_alive",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *KeepAliveEntity {
        ...
        const e = h.A().create(KeepAliveEntity) catch unreachable;
        e.* = .{
            .name = "keep_alive",
            .client = client,
    ...
    fn ent_ctx(self: *KeepAliveEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *KeepAliveEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *KeepAliveEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *KeepAliveEntity, ctx: *Context, post_done: *const fn (*KeepAliveEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *KeepAliveEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *KeepAliveEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *KeepAliveEntity, ctx: *Context, post_done: *const fn (*KeepAliveEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *KeepAliveEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *KeepAliveEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return KeepAliveEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *KeepAliveEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *KeepAliveEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *KeepAliveEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *KeepAliveEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *KeepAliveEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *KeepAliveEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *KeepAliveEntity, ctx: *Context) void {
    ...
    pub fn update(self: *KeepAliveEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *KeepAliveEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
