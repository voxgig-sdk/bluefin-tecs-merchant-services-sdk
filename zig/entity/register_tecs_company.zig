// RegisterTecsCompany entity client (generated — mirrors the go/rust Entity fragment).
...
pub const RegisterTecsCompanyEntity = struct {
    name: []const u8 = "register_tecs_company",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *RegisterTecsCompanyEntity {
        ...
        const e = h.A().create(RegisterTecsCompanyEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *RegisterTecsCompanyEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *RegisterTecsCompanyEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *RegisterTecsCompanyEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *RegisterTecsCompanyEntity, ctx: *Context, post_done: *const fn (*RegisterTecsCompanyEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *RegisterTecsCompanyEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *RegisterTecsCompanyEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *RegisterTecsCompanyEntity, ctx: *Context, post_done: *const fn (*RegisterTecsCompanyEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *RegisterTecsCompanyEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *RegisterTecsCompanyEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return RegisterTecsCompanyEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *RegisterTecsCompanyEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *RegisterTecsCompanyEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *RegisterTecsCompanyEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *RegisterTecsCompanyEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *RegisterTecsCompanyEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *RegisterTecsCompanyEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *RegisterTecsCompanyEntity, ctx: *Context) void {
    ...
    pub fn update(self: *RegisterTecsCompanyEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *RegisterTecsCompanyEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
