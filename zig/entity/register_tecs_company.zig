...
pub const RegisterTecsCompanyEntity = struct {
    ...
    pub fn load(self: *RegisterTecsCompanyEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *RegisterTecsCompanyEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *RegisterTecsCompanyEntity, reqdata: Value, ctrl: Value) OpResult {
    ...
    pub fn update(self: *RegisterTecsCompanyEntity, _reqdata: Value, _ctrl: Value) OpResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *RegisterTecsCompanyEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
