// TransactionHistory entity client (generated — mirrors the go/rust Entity fragment).
...
pub const TransactionHistoryEntity = struct {
    name: []const u8 = "transaction_history",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *TransactionHistoryEntity {
        ...
        const e = h.A().create(TransactionHistoryEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *TransactionHistoryEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *TransactionHistoryEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *TransactionHistoryEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *TransactionHistoryEntity, ctx: *Context, post_done: *const fn (*TransactionHistoryEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *TransactionHistoryEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *TransactionHistoryEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *TransactionHistoryEntity, ctx: *Context, post_done: *const fn (*TransactionHistoryEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *TransactionHistoryEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *TransactionHistoryEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return TransactionHistoryEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *TransactionHistoryEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *TransactionHistoryEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *TransactionHistoryEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *TransactionHistoryEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *TransactionHistoryEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *TransactionHistoryEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *TransactionHistoryEntity, ctx: *Context) void {
    ...
    pub fn update(self: *TransactionHistoryEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *TransactionHistoryEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
