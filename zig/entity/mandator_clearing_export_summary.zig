...
pub const MandatorClearingExportSummaryEntity = struct {
    ...
    pub fn load(self: *MandatorClearingExportSummaryEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *MandatorClearingExportSummaryEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *MandatorClearingExportSummaryEntity, reqdata: Value, ctrl: Value) OpResult {
    ...
    pub fn update(self: *MandatorClearingExportSummaryEntity, _reqdata: Value, _ctrl: Value) OpResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *MandatorClearingExportSummaryEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
