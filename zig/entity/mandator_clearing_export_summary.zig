// MandatorClearingExportSummary entity client (generated — mirrors the go/rust Entity fragment).
...
pub const EntResult = union(enum) {
    ok: *MandatorClearingExportSummaryEntity,
...
pub const MandatorClearingExportSummaryEntity = struct {
    name: []const u8 = "mandator_clearing_export_summary",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *MandatorClearingExportSummaryEntity {
        ...
        const e = h.A().create(MandatorClearingExportSummaryEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *MandatorClearingExportSummaryEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *MandatorClearingExportSummaryEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *MandatorClearingExportSummaryEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *MandatorClearingExportSummaryEntity, ctx: *Context, post_done: *const fn (*MandatorClearingExportSummaryEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *MandatorClearingExportSummaryEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *MandatorClearingExportSummaryEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *MandatorClearingExportSummaryEntity, ctx: *Context, post_done: *const fn (*MandatorClearingExportSummaryEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *MandatorClearingExportSummaryEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *MandatorClearingExportSummaryEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return MandatorClearingExportSummaryEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *MandatorClearingExportSummaryEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *MandatorClearingExportSummaryEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *MandatorClearingExportSummaryEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *MandatorClearingExportSummaryEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *MandatorClearingExportSummaryEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *MandatorClearingExportSummaryEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *MandatorClearingExportSummaryEntity, ctx: *Context) void {
    ...
    pub fn update(self: *MandatorClearingExportSummaryEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *MandatorClearingExportSummaryEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
