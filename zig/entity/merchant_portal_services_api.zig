...
pub const MerchantPortalServicesApiEntity = struct {
    ...
    pub fn load(self: *MerchantPortalServicesApiEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *MerchantPortalServicesApiEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *MerchantPortalServicesApiEntity, reqdata: Value, ctrl: Value) OpResult {
    ...
    pub fn update(self: *MerchantPortalServicesApiEntity, _reqdata: Value, _ctrl: Value) OpResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *MerchantPortalServicesApiEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
