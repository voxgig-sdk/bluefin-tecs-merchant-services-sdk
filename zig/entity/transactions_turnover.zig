// TransactionsTurnover entity client (generated — mirrors the go/rust Entity fragment).
...
pub const TransactionsTurnoverEntity = struct {
    name: []const u8 = "transactions_turnover",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *TransactionsTurnoverEntity {
        ...
        const e = h.A().create(TransactionsTurnoverEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *TransactionsTurnoverEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *TransactionsTurnoverEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *TransactionsTurnoverEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *TransactionsTurnoverEntity, ctx: *Context, post_done: *const fn (*TransactionsTurnoverEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *TransactionsTurnoverEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *TransactionsTurnoverEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *TransactionsTurnoverEntity, ctx: *Context, post_done: *const fn (*TransactionsTurnoverEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *TransactionsTurnoverEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *TransactionsTurnoverEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return TransactionsTurnoverEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *TransactionsTurnoverEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *TransactionsTurnoverEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *TransactionsTurnoverEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *TransactionsTurnoverEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *TransactionsTurnoverEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *TransactionsTurnoverEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *TransactionsTurnoverEntity, ctx: *Context) void {
    ...
    pub fn update(self: *TransactionsTurnoverEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *TransactionsTurnoverEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
