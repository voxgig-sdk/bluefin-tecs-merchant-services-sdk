// RefundTransaction entity client (generated — mirrors the go/rust Entity fragment).
...
pub const RefundTransactionEntity = struct {
    name: []const u8 = "refund_transaction",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *RefundTransactionEntity {
        ...
        const e = h.A().create(RefundTransactionEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *RefundTransactionEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *RefundTransactionEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *RefundTransactionEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *RefundTransactionEntity, ctx: *Context, post_done: *const fn (*RefundTransactionEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *RefundTransactionEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *RefundTransactionEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *RefundTransactionEntity, ctx: *Context, post_done: *const fn (*RefundTransactionEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *RefundTransactionEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *RefundTransactionEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return RefundTransactionEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *RefundTransactionEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *RefundTransactionEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *RefundTransactionEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *RefundTransactionEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *RefundTransactionEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *RefundTransactionEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *RefundTransactionEntity, ctx: *Context) void {
    ...
    pub fn update(self: *RefundTransactionEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *RefundTransactionEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
