// DeactivateTerminal entity client (generated — mirrors the go/rust Entity fragment).
...
pub const DeactivateTerminalEntity = struct {
    name: []const u8 = "deactivate_terminal",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *DeactivateTerminalEntity {
        ...
        const e = h.A().create(DeactivateTerminalEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *DeactivateTerminalEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *DeactivateTerminalEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *DeactivateTerminalEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *DeactivateTerminalEntity, ctx: *Context, post_done: *const fn (*DeactivateTerminalEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *DeactivateTerminalEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *DeactivateTerminalEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *DeactivateTerminalEntity, ctx: *Context, post_done: *const fn (*DeactivateTerminalEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *DeactivateTerminalEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *DeactivateTerminalEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return DeactivateTerminalEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *DeactivateTerminalEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *DeactivateTerminalEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *DeactivateTerminalEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *DeactivateTerminalEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *DeactivateTerminalEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *DeactivateTerminalEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *DeactivateTerminalEntity, ctx: *Context) void {
    ...
    pub fn update(self: *DeactivateTerminalEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *DeactivateTerminalEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
