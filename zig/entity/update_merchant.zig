// UpdateMerchant entity client (generated — mirrors the go/rust Entity fragment).
...
pub const UpdateMerchantEntity = struct {
    name: []const u8 = "update_merchant",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *UpdateMerchantEntity {
        ...
        const e = h.A().create(UpdateMerchantEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *UpdateMerchantEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *UpdateMerchantEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *UpdateMerchantEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *UpdateMerchantEntity, ctx: *Context, post_done: *const fn (*UpdateMerchantEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *UpdateMerchantEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *UpdateMerchantEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *UpdateMerchantEntity, ctx: *Context, post_done: *const fn (*UpdateMerchantEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *UpdateMerchantEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *UpdateMerchantEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return UpdateMerchantEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *UpdateMerchantEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *UpdateMerchantEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *UpdateMerchantEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *UpdateMerchantEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *UpdateMerchantEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *UpdateMerchantEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *UpdateMerchantEntity, ctx: *Context) void {
    ...
    pub fn update(self: *UpdateMerchantEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *UpdateMerchantEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
