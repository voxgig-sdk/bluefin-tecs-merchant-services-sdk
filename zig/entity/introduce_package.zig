// IntroducePackage entity client (generated — mirrors the go/rust Entity fragment).
...
pub const IntroducePackageEntity = struct {
    name: []const u8 = "introduce_package",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *IntroducePackageEntity {
        ...
        const e = h.A().create(IntroducePackageEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *IntroducePackageEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *IntroducePackageEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *IntroducePackageEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *IntroducePackageEntity, ctx: *Context, post_done: *const fn (*IntroducePackageEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *IntroducePackageEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *IntroducePackageEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *IntroducePackageEntity, ctx: *Context, post_done: *const fn (*IntroducePackageEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *IntroducePackageEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *IntroducePackageEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return IntroducePackageEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *IntroducePackageEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *IntroducePackageEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *IntroducePackageEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *IntroducePackageEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *IntroducePackageEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *IntroducePackageEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *IntroducePackageEntity, ctx: *Context) void {
    ...
    pub fn update(self: *IntroducePackageEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *IntroducePackageEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
