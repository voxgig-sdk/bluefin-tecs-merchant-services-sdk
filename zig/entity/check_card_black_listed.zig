// CheckCardBlackListed entity client (generated — mirrors the go/rust Entity fragment).
...
pub const CheckCardBlackListedEntity = struct {
    name: []const u8 = "check_card_black_listed",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *CheckCardBlackListedEntity {
        ...
        const e = h.A().create(CheckCardBlackListedEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *CheckCardBlackListedEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *CheckCardBlackListedEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *CheckCardBlackListedEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *CheckCardBlackListedEntity, ctx: *Context, post_done: *const fn (*CheckCardBlackListedEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *CheckCardBlackListedEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *CheckCardBlackListedEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *CheckCardBlackListedEntity, ctx: *Context, post_done: *const fn (*CheckCardBlackListedEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *CheckCardBlackListedEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *CheckCardBlackListedEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return CheckCardBlackListedEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *CheckCardBlackListedEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *CheckCardBlackListedEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *CheckCardBlackListedEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *CheckCardBlackListedEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *CheckCardBlackListedEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *CheckCardBlackListedEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *CheckCardBlackListedEntity, ctx: *Context) void {
    ...
    pub fn update(self: *CheckCardBlackListedEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *CheckCardBlackListedEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
