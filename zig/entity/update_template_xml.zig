// UpdateTemplateXml entity client (generated — mirrors the go/rust Entity fragment).
...
pub const UpdateTemplateXmlEntity = struct {
    name: []const u8 = "update_template_xml",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *UpdateTemplateXmlEntity {
        ...
        const e = h.A().create(UpdateTemplateXmlEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *UpdateTemplateXmlEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *UpdateTemplateXmlEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *UpdateTemplateXmlEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *UpdateTemplateXmlEntity, ctx: *Context, post_done: *const fn (*UpdateTemplateXmlEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *UpdateTemplateXmlEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *UpdateTemplateXmlEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *UpdateTemplateXmlEntity, ctx: *Context, post_done: *const fn (*UpdateTemplateXmlEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *UpdateTemplateXmlEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *UpdateTemplateXmlEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return UpdateTemplateXmlEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *UpdateTemplateXmlEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *UpdateTemplateXmlEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *UpdateTemplateXmlEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *UpdateTemplateXmlEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *UpdateTemplateXmlEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *UpdateTemplateXmlEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *UpdateTemplateXmlEntity, ctx: *Context) void {
    ...
    pub fn update(self: *UpdateTemplateXmlEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *UpdateTemplateXmlEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
