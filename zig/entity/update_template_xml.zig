...
pub const UpdateTemplateXmlEntity = struct {
    ...
    pub fn load(self: *UpdateTemplateXmlEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *UpdateTemplateXmlEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *UpdateTemplateXmlEntity, reqdata: Value, ctrl: Value) OpResult {
    ...
    pub fn update(self: *UpdateTemplateXmlEntity, _reqdata: Value, _ctrl: Value) OpResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *UpdateTemplateXmlEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
