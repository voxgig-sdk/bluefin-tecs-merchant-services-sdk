// EcrData entity client (generated — mirrors the go/rust Entity fragment).
...
pub const EcrDataEntity = struct {
    name: []const u8 = "ecr_data",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *EcrDataEntity {
        ...
        const e = h.A().create(EcrDataEntity) catch unreachable;
        e.* = .{
            .name = "ecr_data",
            .client = client,
    ...
    fn ent_ctx(self: *EcrDataEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *EcrDataEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *EcrDataEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *EcrDataEntity, ctx: *Context, post_done: *const fn (*EcrDataEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *EcrDataEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *EcrDataEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *EcrDataEntity, ctx: *Context, post_done: *const fn (*EcrDataEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *EcrDataEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *EcrDataEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return EcrDataEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *EcrDataEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *EcrDataEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *EcrDataEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *EcrDataEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *EcrDataEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *EcrDataEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *EcrDataEntity, ctx: *Context) void {
    ...
    pub fn update(self: *EcrDataEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *EcrDataEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
