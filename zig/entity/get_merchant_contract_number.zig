// GetMerchantContractNumber entity client (generated — mirrors the go/rust Entity fragment).
...
pub const EntResult = union(enum) {
    ok: *GetMerchantContractNumberEntity,
...
pub const GetMerchantContractNumberEntity = struct {
    name: []const u8 = "get_merchant_contract_number",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *GetMerchantContractNumberEntity {
        ...
        const e = h.A().create(GetMerchantContractNumberEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *GetMerchantContractNumberEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *GetMerchantContractNumberEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *GetMerchantContractNumberEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *GetMerchantContractNumberEntity, ctx: *Context, post_done: *const fn (*GetMerchantContractNumberEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *GetMerchantContractNumberEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *GetMerchantContractNumberEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *GetMerchantContractNumberEntity, ctx: *Context, post_done: *const fn (*GetMerchantContractNumberEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *GetMerchantContractNumberEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *GetMerchantContractNumberEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return GetMerchantContractNumberEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *GetMerchantContractNumberEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *GetMerchantContractNumberEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *GetMerchantContractNumberEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *GetMerchantContractNumberEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *GetMerchantContractNumberEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *GetMerchantContractNumberEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *GetMerchantContractNumberEntity, ctx: *Context) void {
    ...
    pub fn update(self: *GetMerchantContractNumberEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *GetMerchantContractNumberEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
