...
pub const GetMerchantContractNumberEntity = struct {
    ...
    pub fn load(self: *GetMerchantContractNumberEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *GetMerchantContractNumberEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *GetMerchantContractNumberEntity, reqdata: Value, ctrl: Value) OpResult {
    ...
    pub fn update(self: *GetMerchantContractNumberEntity, _reqdata: Value, _ctrl: Value) OpResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *GetMerchantContractNumberEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
