// CancelTransaction entity client (generated — mirrors the go/rust Entity fragment).
...
pub const CancelTransactionEntity = struct {
    name: []const u8 = "cancel_transaction",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *CancelTransactionEntity {
        ...
        const e = h.A().create(CancelTransactionEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *CancelTransactionEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *CancelTransactionEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *CancelTransactionEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *CancelTransactionEntity, ctx: *Context, post_done: *const fn (*CancelTransactionEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *CancelTransactionEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *CancelTransactionEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *CancelTransactionEntity, ctx: *Context, post_done: *const fn (*CancelTransactionEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *CancelTransactionEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *CancelTransactionEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return CancelTransactionEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *CancelTransactionEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *CancelTransactionEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *CancelTransactionEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *CancelTransactionEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *CancelTransactionEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *CancelTransactionEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *CancelTransactionEntity, ctx: *Context) void {
    ...
    pub fn update(self: *CancelTransactionEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *CancelTransactionEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
