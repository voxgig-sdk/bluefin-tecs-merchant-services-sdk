// CreateProduct entity client (generated — mirrors the go/rust Entity fragment).
...
pub const CreateProductEntity = struct {
    name: []const u8 = "create_product",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *CreateProductEntity {
        ...
        const e = h.A().create(CreateProductEntity) catch unreachable;
        e.* = .{
            .name = "create_product",
            .client = client,
    ...
    fn ent_ctx(self: *CreateProductEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *CreateProductEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *CreateProductEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *CreateProductEntity, ctx: *Context, post_done: *const fn (*CreateProductEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *CreateProductEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *CreateProductEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *CreateProductEntity, ctx: *Context, post_done: *const fn (*CreateProductEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *CreateProductEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *CreateProductEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return CreateProductEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *CreateProductEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *CreateProductEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *CreateProductEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *CreateProductEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *CreateProductEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *CreateProductEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *CreateProductEntity, ctx: *Context) void {
    ...
    pub fn update(self: *CreateProductEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *CreateProductEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
