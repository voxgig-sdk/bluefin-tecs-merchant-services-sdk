// TransactionsCount entity client (generated — mirrors the go/rust Entity fragment).
...
pub const TransactionsCountEntity = struct {
    name: []const u8 = "transactions_count",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *TransactionsCountEntity {
        ...
        const e = h.A().create(TransactionsCountEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *TransactionsCountEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *TransactionsCountEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *TransactionsCountEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *TransactionsCountEntity, ctx: *Context, post_done: *const fn (*TransactionsCountEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *TransactionsCountEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *TransactionsCountEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *TransactionsCountEntity, ctx: *Context, post_done: *const fn (*TransactionsCountEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *TransactionsCountEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *TransactionsCountEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return TransactionsCountEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *TransactionsCountEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *TransactionsCountEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *TransactionsCountEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *TransactionsCountEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *TransactionsCountEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *TransactionsCountEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *TransactionsCountEntity, ctx: *Context) void {
    ...
    pub fn update(self: *TransactionsCountEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *TransactionsCountEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
