// TerminalId entity client (generated — mirrors the go/rust Entity fragment).
...
pub const TerminalIdEntity = struct {
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *TerminalIdEntity {
        ...
        const e = h.A().create(TerminalIdEntity) catch unreachable;
        e.* = .{
            .name = "terminal_id",
            .client = client,
    ...
    fn ent_ctx(self: *TerminalIdEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *TerminalIdEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *TerminalIdEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *TerminalIdEntity, ctx: *Context, post_done: *const fn (*TerminalIdEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *TerminalIdEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *TerminalIdEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *TerminalIdEntity, ctx: *Context, post_done: *const fn (*TerminalIdEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *TerminalIdEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *TerminalIdEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return TerminalIdEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *TerminalIdEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *TerminalIdEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *TerminalIdEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *TerminalIdEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *TerminalIdEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *TerminalIdEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *TerminalIdEntity, ctx: *Context) void {
    ...
    pub fn update(self: *TerminalIdEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *TerminalIdEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
