...
pub const StoreTerminalParameterEntity = struct {
    ...
    pub fn load(self: *StoreTerminalParameterEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *StoreTerminalParameterEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *StoreTerminalParameterEntity, reqdata: Value, ctrl: Value) OpResult {
    ...
    pub fn update(self: *StoreTerminalParameterEntity, _reqdata: Value, _ctrl: Value) OpResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *StoreTerminalParameterEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
