// StoreTerminalParameter entity client (generated — mirrors the go/rust Entity fragment).
...
pub const EntResult = union(enum) {
    ok: *StoreTerminalParameterEntity,
...
pub const StoreTerminalParameterEntity = struct {
    name: []const u8 = "store_terminal_parameter",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *StoreTerminalParameterEntity {
        ...
        const e = h.A().create(StoreTerminalParameterEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *StoreTerminalParameterEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *StoreTerminalParameterEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *StoreTerminalParameterEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *StoreTerminalParameterEntity, ctx: *Context, post_done: *const fn (*StoreTerminalParameterEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *StoreTerminalParameterEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *StoreTerminalParameterEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *StoreTerminalParameterEntity, ctx: *Context, post_done: *const fn (*StoreTerminalParameterEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *StoreTerminalParameterEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *StoreTerminalParameterEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return StoreTerminalParameterEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *StoreTerminalParameterEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *StoreTerminalParameterEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *StoreTerminalParameterEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *StoreTerminalParameterEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *StoreTerminalParameterEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *StoreTerminalParameterEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *StoreTerminalParameterEntity, ctx: *Context) void {
    ...
    pub fn update(self: *StoreTerminalParameterEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *StoreTerminalParameterEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
