// EmvData entity client (generated — mirrors the go/rust Entity fragment).
...
pub const EmvDataEntity = struct {
    name: []const u8 = "emv_data",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *EmvDataEntity {
        ...
        const e = h.A().create(EmvDataEntity) catch unreachable;
        e.* = .{
            .name = "emv_data",
            .client = client,
    ...
    fn ent_ctx(self: *EmvDataEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *EmvDataEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *EmvDataEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *EmvDataEntity, ctx: *Context, post_done: *const fn (*EmvDataEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *EmvDataEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *EmvDataEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *EmvDataEntity, ctx: *Context, post_done: *const fn (*EmvDataEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *EmvDataEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *EmvDataEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return EmvDataEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *EmvDataEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *EmvDataEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *EmvDataEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *EmvDataEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *EmvDataEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *EmvDataEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *EmvDataEntity, ctx: *Context) void {
    ...
    pub fn update(self: *EmvDataEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *EmvDataEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
