// PaymentManual entity client (generated — mirrors the go/rust Entity fragment).
...
pub const PaymentManualEntity = struct {
    name: []const u8 = "payment_manual",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *PaymentManualEntity {
        ...
        const e = h.A().create(PaymentManualEntity) catch unreachable;
        e.* = .{
            .name = "payment_manual",
            .client = client,
    ...
    fn ent_ctx(self: *PaymentManualEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *PaymentManualEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *PaymentManualEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *PaymentManualEntity, ctx: *Context, post_done: *const fn (*PaymentManualEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *PaymentManualEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *PaymentManualEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *PaymentManualEntity, ctx: *Context, post_done: *const fn (*PaymentManualEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *PaymentManualEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *PaymentManualEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return PaymentManualEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *PaymentManualEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *PaymentManualEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *PaymentManualEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *PaymentManualEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *PaymentManualEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *PaymentManualEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *PaymentManualEntity, ctx: *Context) void {
    ...
    pub fn update(self: *PaymentManualEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *PaymentManualEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
