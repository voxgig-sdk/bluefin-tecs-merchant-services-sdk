// PreAuthTransactionCompletion entity client (generated — mirrors the go/rust Entity fragment).
...
pub const EntResult = union(enum) {
    ok: *PreAuthTransactionCompletionEntity,
...
pub const PreAuthTransactionCompletionEntity = struct {
    name: []const u8 = "pre_auth_transaction_completion",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantServicesSDK, entopts_in: Value) *PreAuthTransactionCompletionEntity {
        ...
        const e = h.A().create(PreAuthTransactionCompletionEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *PreAuthTransactionCompletionEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *PreAuthTransactionCompletionEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *PreAuthTransactionCompletionEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *PreAuthTransactionCompletionEntity, ctx: *Context, post_done: *const fn (*PreAuthTransactionCompletionEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *PreAuthTransactionCompletionEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *PreAuthTransactionCompletionEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *PreAuthTransactionCompletionEntity, ctx: *Context, post_done: *const fn (*PreAuthTransactionCompletionEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *PreAuthTransactionCompletionEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *PreAuthTransactionCompletionEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return PreAuthTransactionCompletionEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *PreAuthTransactionCompletionEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *PreAuthTransactionCompletionEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *PreAuthTransactionCompletionEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *PreAuthTransactionCompletionEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *PreAuthTransactionCompletionEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *PreAuthTransactionCompletionEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *PreAuthTransactionCompletionEntity, ctx: *Context) void {
    ...
    pub fn update(self: *PreAuthTransactionCompletionEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *PreAuthTransactionCompletionEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
