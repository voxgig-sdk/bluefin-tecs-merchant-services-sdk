...
pub const PreAuthTransactionCompletionEntity = struct {
    ...
    pub fn load(self: *PreAuthTransactionCompletionEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *PreAuthTransactionCompletionEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *PreAuthTransactionCompletionEntity, reqdata: Value, ctrl: Value) OpResult {
    ...
    pub fn update(self: *PreAuthTransactionCompletionEntity, _reqdata: Value, _ctrl: Value) OpResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *PreAuthTransactionCompletionEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
