# BluefinTecsMerchantServices Lean SDK Reference

Complete API reference for the BluefinTecsMerchantServices Lean SDK.
...
wraps whatever is already installed. This SDK fixes that order in its own
