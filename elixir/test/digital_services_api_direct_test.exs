# DigitalServicesApi direct test (offline, mock system.fetch)

defmodule BluefinTecsMerchantServices.DigitalServicesApiDirectTest do
  use ExUnit.Case
  ...
  test "should direct load digital_services_api" do
    canned = S.jm(["id", "direct01"])
    sdk = mk(canned)
    res = BluefinTecsMerchantServices.direct(sdk, H.deep(%{"path" => "/digital_services_api/direct01", "method" => "GET", "params" => %{}}))
