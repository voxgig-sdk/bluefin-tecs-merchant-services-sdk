# PaymentManual entity test (offline, mock transport)

defmodule BluefinTecsMerchantServices.PaymentManualEntityTest do
  use ExUnit.Case
  ...
  defp fixture do
    Json.parse(File.read!("../.sdk/test/entity/payment_manual/PaymentManualTestData.json"))
  end
  ...
  defp first_id do
    existing = H.or_(S.getpath(fixture(), "existing.payment_manual"), S.jm([]))
