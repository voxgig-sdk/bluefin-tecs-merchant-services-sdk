...
defmodule BluefinTecsMerchantServices.FeatureHarness do
  alias Voxgig.Struct, as: S
  alias BluefinTecsMerchantServices.Helpers, as: H
  alias BluefinTecsMerchantServices.{Control, Spec, Result, Context, Features}

  # True when this SDK was generated with the named feature.
  def has_feature(name) do
    feature = S.getprop(BluefinTecsMerchantServices.Config.make_config(), "feature")
