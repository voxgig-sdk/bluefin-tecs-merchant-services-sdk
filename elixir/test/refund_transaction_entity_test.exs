# RefundTransaction entity test (offline, mock transport)

defmodule BluefinTecsMerchantServices.RefundTransactionEntityTest do
  use ExUnit.Case
  ...
  defp fixture do
    Json.parse(File.read!("../.sdk/test/entity/refund_transaction/RefundTransactionTestData.json"))
  end
  ...
  defp first_id do
    existing = H.or_(S.getpath(fixture(), "existing.refund_transaction"), S.jm([]))
