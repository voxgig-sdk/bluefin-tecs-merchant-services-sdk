# StoreTerminalParameter entity test (offline, mock transport)

defmodule BluefinTecsMerchantServices.StoreTerminalParameterEntityTest do
  use ExUnit.Case
  ...
  defp fixture do
    Json.parse(File.read!("../.sdk/test/entity/store_terminal_parameter/StoreTerminalParameterTestData.json"))
  end
  ...
  defp first_id do
    existing = H.or_(S.getpath(fixture(), "existing.store_terminal_parameter"), S.jm([]))
