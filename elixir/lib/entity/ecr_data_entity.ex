...
defmodule BluefinTecsMerchantServices.Entity.EcrData do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "ecr_data", entopts)
  end
  ...
  # Returns the created ecr_data entity map (BluefinTecsMerchantServices.Types.ecr_data/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.ecr_data_create_data() | nil, map() | nil) :: term()
