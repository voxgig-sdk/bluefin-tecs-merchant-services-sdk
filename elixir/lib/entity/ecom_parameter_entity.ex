...
defmodule BluefinTecsMerchantServices.Entity.EcomParameter do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "ecom_parameter", entopts)
  end
  ...
  # Returns the created ecom_parameter entity map (BluefinTecsMerchantServices.Types.ecom_parameter/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.ecom_parameter_create_data() | nil, map() | nil) :: term()
