...
defmodule BluefinTecsMerchantServices.Entity.EnableAcquiring do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "enable_acquiring", entopts)
  end
  ...
  # Returns the created enable_acquiring entity map (BluefinTecsMerchantServices.Types.enable_acquiring/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.enable_acquiring_create_data() | nil, map() | nil) :: term()
