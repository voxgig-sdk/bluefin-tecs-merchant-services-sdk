...
defmodule BluefinTecsMerchantServices.Entity.IntroduceMandator do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "introduce_mandator", entopts)
  end
  ...
  # Returns the created introduce_mandator entity map (BluefinTecsMerchantServices.Types.introduce_mandator/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.introduce_mandator_create_data() | nil, map() | nil) :: term()
