...
defmodule BluefinTecsMerchantServices.Entity.TransactionsCountCardBrand do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "transactions_count_card_brand", entopts)
  end
  ...
  # Returns the created transactions_count_card_brand entity map (BluefinTecsMerchantServices.Types.transactions_count_card_brand/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.transactions_count_card_brand_create_data() | nil, map() | nil) :: term()
