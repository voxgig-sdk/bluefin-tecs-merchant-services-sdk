...
defmodule BluefinTecsMerchantServices.Entity.Version do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "version", entopts)
  end
  ...
  # Returns the version entity map (BluefinTecsMerchantServices.Types.version/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinTecsMerchantServices.Types.version_load_match() | nil, map() | nil) :: term()
