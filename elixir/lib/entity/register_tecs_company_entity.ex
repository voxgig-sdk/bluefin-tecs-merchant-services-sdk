...
defmodule BluefinTecsMerchantServices.Entity.RegisterTecsCompany do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "register_tecs_company", entopts)
  end
  ...
  # Returns the created register_tecs_company entity map (BluefinTecsMerchantServices.Types.register_tecs_company/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.register_tecs_company_create_data() | nil, map() | nil) :: term()
