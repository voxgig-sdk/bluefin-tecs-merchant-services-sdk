...
defmodule BluefinTecsMerchantServices.Entity.UpdateMerchant do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "update_merchant", entopts)
  end
  ...
  # Returns the created update_merchant entity map (BluefinTecsMerchantServices.Types.update_merchant/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.update_merchant_create_data() | nil, map() | nil) :: term()
