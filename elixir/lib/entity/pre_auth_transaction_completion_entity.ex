...
defmodule BluefinTecsMerchantServices.Entity.PreAuthTransactionCompletion do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "pre_auth_transaction_completion", entopts)
  end
  ...
  # Returns the created pre_auth_transaction_completion entity map (BluefinTecsMerchantServices.Types.pre_auth_transaction_completion/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.pre_auth_transaction_completion_create_data() | nil, map() | nil) :: term()
