...
defmodule BluefinTecsMerchantServices.Entity.GetMerchantContractNumber do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "get_merchant_contract_number", entopts)
  end
  ...
  # Returns the created get_merchant_contract_number entity map (BluefinTecsMerchantServices.Types.get_merchant_contract_number/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.get_merchant_contract_number_create_data() | nil, map() | nil) :: term()
