...
defmodule BluefinTecsMerchantServices.Entity.EcDataEcom do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "ec_data_ecom", entopts)
  end
  ...
  # Returns the created ec_data_ecom entity map (BluefinTecsMerchantServices.Types.ec_data_ecom/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.ec_data_ecom_create_data() | nil, map() | nil) :: term()
