...
defmodule BluefinTecsMerchantServices.Entity.MandatorClearingExportSummary do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "mandator_clearing_export_summary", entopts)
  end
  ...
  # Returns the created mandator_clearing_export_summary entity map (BluefinTecsMerchantServices.Types.mandator_clearing_export_summary/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.mandator_clearing_export_summary_create_data() | nil, map() | nil) :: term()
