...
defmodule BluefinTecsMerchantServices.Entity.PaymentSred do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "payment_sred", entopts)
  end
  ...
  # Returns the created payment_sred entity map (BluefinTecsMerchantServices.Types.payment_sred/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.payment_sred_create_data() | nil, map() | nil) :: term()
