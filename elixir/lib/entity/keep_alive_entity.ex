...
defmodule BluefinTecsMerchantServices.Entity.KeepAlive do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "keep_alive", entopts)
  end
  ...
  # Returns the created keep_alive entity map (BluefinTecsMerchantServices.Types.keep_alive/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.keep_alive_create_data() | nil, map() | nil) :: term()
