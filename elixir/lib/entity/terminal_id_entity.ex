...
defmodule BluefinTecsMerchantServices.Entity.TerminalId do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "terminal_id", entopts)
  end
  ...
  # Returns the created terminal_id entity map (BluefinTecsMerchantServices.Types.terminal_id/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.terminal_id_create_data() | nil, map() | nil) :: term()
