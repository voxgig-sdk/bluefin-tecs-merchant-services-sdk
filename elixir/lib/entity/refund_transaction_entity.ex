...
defmodule BluefinTecsMerchantServices.Entity.RefundTransaction do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "refund_transaction", entopts)
  end
  ...
  # Returns the created refund_transaction entity map (BluefinTecsMerchantServices.Types.refund_transaction/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.refund_transaction_create_data() | nil, map() | nil) :: term()
