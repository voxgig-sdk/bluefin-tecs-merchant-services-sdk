...
defmodule BluefinTecsMerchantServices.Entity.CreateProduct do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "create_product", entopts)
  end
  ...
  # Returns the created create_product entity map (BluefinTecsMerchantServices.Types.create_product/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.create_product_create_data() | nil, map() | nil) :: term()
