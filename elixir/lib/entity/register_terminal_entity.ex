...
defmodule BluefinTecsMerchantServices.Entity.RegisterTerminal do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "register_terminal", entopts)
  end
  ...
  # Returns the created register_terminal entity map (BluefinTecsMerchantServices.Types.register_terminal/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.register_terminal_create_data() | nil, map() | nil) :: term()
