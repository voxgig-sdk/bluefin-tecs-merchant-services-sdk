...
defmodule BluefinTecsMerchantServices.Entity.DigitalServicesApi do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "digital_services_api", entopts)
  end
  ...
  # Returns the digital_services_api entity map (BluefinTecsMerchantServices.Types.digital_services_api/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinTecsMerchantServices.Types.digital_services_api_load_match() | nil, map() | nil) :: term()
  ...
  # Returns the created digital_services_api entity map (BluefinTecsMerchantServices.Types.digital_services_api/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec create(map(), BluefinTecsMerchantServices.Types.digital_services_api_create_data() | nil, map() | nil) :: term()
