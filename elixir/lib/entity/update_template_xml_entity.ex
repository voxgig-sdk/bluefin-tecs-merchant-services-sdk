...
defmodule BluefinTecsMerchantServices.Entity.UpdateTemplateXml do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "update_template_xml", entopts)
  end
  ...
  # Returns the created update_template_xml entity map (BluefinTecsMerchantServices.Types.update_template_xml/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.update_template_xml_create_data() | nil, map() | nil) :: term()
