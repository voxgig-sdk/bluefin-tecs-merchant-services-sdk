...
defmodule BluefinTecsMerchantServices.Entity.StoreTerminalParameter do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "store_terminal_parameter", entopts)
  end
  ...
  # Returns the created store_terminal_parameter entity map (BluefinTecsMerchantServices.Types.store_terminal_parameter/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.store_terminal_parameter_create_data() | nil, map() | nil) :: term()
