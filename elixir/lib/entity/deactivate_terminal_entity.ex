...
defmodule BluefinTecsMerchantServices.Entity.DeactivateTerminal do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "deactivate_terminal", entopts)
  end
  ...
  # Returns the created deactivate_terminal entity map (BluefinTecsMerchantServices.Types.deactivate_terminal/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.deactivate_terminal_create_data() | nil, map() | nil) :: term()
