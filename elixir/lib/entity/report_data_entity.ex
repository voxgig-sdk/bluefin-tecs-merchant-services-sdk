...
defmodule BluefinTecsMerchantServices.Entity.ReportData do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "report_data", entopts)
  end
  ...
  # Returns the created report_data entity map (BluefinTecsMerchantServices.Types.report_data/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.report_data_create_data() | nil, map() | nil) :: term()
