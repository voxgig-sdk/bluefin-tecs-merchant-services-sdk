...
defmodule BluefinTecsMerchantServices.Entity.MerchantPortalServicesApi do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "merchant_portal_services_api", entopts)
  end
  ...
  # Returns the created merchant_portal_services_api entity map (BluefinTecsMerchantServices.Types.merchant_portal_services_api/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.merchant_portal_services_api_create_data() | nil, map() | nil) :: term()
