...
defmodule BluefinTecsMerchantServices.Entity.TransactionsCount do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "transactions_count", entopts)
  end
  ...
  # Returns the created transactions_count entity map (BluefinTecsMerchantServices.Types.transactions_count/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.transactions_count_create_data() | nil, map() | nil) :: term()
