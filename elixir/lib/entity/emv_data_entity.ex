...
defmodule BluefinTecsMerchantServices.Entity.EmvData do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "emv_data", entopts)
  end
  ...
  # Returns the created emv_data entity map (BluefinTecsMerchantServices.Types.emv_data/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.emv_data_create_data() | nil, map() | nil) :: term()
