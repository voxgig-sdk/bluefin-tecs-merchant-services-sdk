...
# and drives it through BluefinTecsMerchantServices.Pipeline.run_op.

defmodule BluefinTecsMerchantServices.Entity.MandatorClearingExportDownload do
  alias Voxgig.Struct, as: S
  alias BluefinTecsMerchantServices.Helpers, as: H
  alias BluefinTecsMerchantServices.{EntityBase, Context, Pipeline}

  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "mandator_clearing_export_download", entopts)
  end
  ...
  # Returns the mandator_clearing_export_download entity map (BluefinTecsMerchantServices.Types.mandator_clearing_export_download/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinTecsMerchantServices.Types.mandator_clearing_export_download_load_match() | nil, map() | nil) :: term()
  ...
  # Returns the created mandator_clearing_export_download entity map (BluefinTecsMerchantServices.Types.mandator_clearing_export_download/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec create(map(), BluefinTecsMerchantServices.Types.mandator_clearing_export_download_create_data() | nil, map() | nil) :: term()
