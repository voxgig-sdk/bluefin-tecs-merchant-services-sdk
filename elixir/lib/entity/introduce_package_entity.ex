...
defmodule BluefinTecsMerchantServices.Entity.IntroducePackage do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "introduce_package", entopts)
  end
  ...
  # Returns the created introduce_package entity map (BluefinTecsMerchantServices.Types.introduce_package/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.introduce_package_create_data() | nil, map() | nil) :: term()
