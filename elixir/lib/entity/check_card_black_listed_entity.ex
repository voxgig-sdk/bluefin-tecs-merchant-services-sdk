...
defmodule BluefinTecsMerchantServices.Entity.CheckCardBlackListed do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "check_card_black_listed", entopts)
  end
  ...
  # Returns the created check_card_black_listed entity map (BluefinTecsMerchantServices.Types.check_card_black_listed/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.check_card_black_listed_create_data() | nil, map() | nil) :: term()
