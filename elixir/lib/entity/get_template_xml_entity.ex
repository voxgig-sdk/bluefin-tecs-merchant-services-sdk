...
defmodule BluefinTecsMerchantServices.Entity.GetTemplateXml do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "get_template_xml", entopts)
  end
  ...
  # Returns the created get_template_xml entity map (BluefinTecsMerchantServices.Types.get_template_xml/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.get_template_xml_create_data() | nil, map() | nil) :: term()
