...
defmodule BluefinTecsMerchantServices.Entity.TransactionsTurnover do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "transactions_turnover", entopts)
  end
  ...
  # Returns the created transactions_turnover entity map (BluefinTecsMerchantServices.Types.transactions_turnover/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.transactions_turnover_create_data() | nil, map() | nil) :: term()
