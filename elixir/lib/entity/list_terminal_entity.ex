...
defmodule BluefinTecsMerchantServices.Entity.ListTerminal do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "list_terminal", entopts)
  end
  ...
  # Returns the created list_terminal entity map (BluefinTecsMerchantServices.Types.list_terminal/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.list_terminal_create_data() | nil, map() | nil) :: term()
