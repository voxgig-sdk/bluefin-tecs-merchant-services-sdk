...
defmodule BluefinTecsMerchantServices.Entity.StatusTransaction do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "status_transaction", entopts)
  end
  ...
  # Returns the created status_transaction entity map (BluefinTecsMerchantServices.Types.status_transaction/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.status_transaction_create_data() | nil, map() | nil) :: term()
