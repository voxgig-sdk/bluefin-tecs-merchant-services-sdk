...
defmodule BluefinTecsMerchantServices.Entity.MoveTid do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "move_tid", entopts)
  end
  ...
  # Returns the created move_tid entity map (BluefinTecsMerchantServices.Types.move_tid/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.move_tid_create_data() | nil, map() | nil) :: term()
