...
defmodule BluefinTecsMerchantServices.Entity.ReactivateTerminal do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "reactivate_terminal", entopts)
  end
  ...
  # Returns the created reactivate_terminal entity map (BluefinTecsMerchantServices.Types.reactivate_terminal/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.reactivate_terminal_create_data() | nil, map() | nil) :: term()
