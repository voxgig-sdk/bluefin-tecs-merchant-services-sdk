...
defmodule BluefinTecsMerchantServices.Entity.CancelTransaction do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "cancel_transaction", entopts)
  end
  ...
  # Returns the created cancel_transaction entity map (BluefinTecsMerchantServices.Types.cancel_transaction/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.cancel_transaction_create_data() | nil, map() | nil) :: term()
