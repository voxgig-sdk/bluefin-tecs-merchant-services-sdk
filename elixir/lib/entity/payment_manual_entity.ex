...
defmodule BluefinTecsMerchantServices.Entity.PaymentManual do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "payment_manual", entopts)
  end
  ...
  # Returns the created payment_manual entity map (BluefinTecsMerchantServices.Types.payment_manual/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.payment_manual_create_data() | nil, map() | nil) :: term()
