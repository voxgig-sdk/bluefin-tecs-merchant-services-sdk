...
defmodule BluefinTecsMerchantServices.Entity.TransactionHistory do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "transaction_history", entopts)
  end
  ...
  # Returns the created transaction_history entity map (BluefinTecsMerchantServices.Types.transaction_history/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.transaction_history_create_data() | nil, map() | nil) :: term()
