...
defmodule BluefinTecsMerchantServices.Entity.MandatorClearingExport do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "mandator_clearing_export", entopts)
  end
  ...
  # Returns the created mandator_clearing_export entity map (BluefinTecsMerchantServices.Types.mandator_clearing_export/0)
  ...
  @spec create(map(), BluefinTecsMerchantServices.Types.mandator_clearing_export_create_data() | nil, map() | nil) :: term()
