// EcDataEcom entity client (generated). Shared entity runtime (data/match
...
class EcDataEcomEntity : public EntityBase {
public:
  EcDataEcomEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("ec_data_ecom", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<EcDataEcomEntity>(this->client, opts);
  }
