// DigitalServicesApi entity client (generated). Shared entity runtime (data/match
...
class DigitalServicesApiEntity : public EntityBase {
public:
  DigitalServicesApiEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("digital_services_api", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<DigitalServicesApiEntity>(this->client, opts);
  }
