// KeepAlive entity client (generated). Shared entity runtime (data/match
...
class KeepAliveEntity : public EntityBase {
public:
  KeepAliveEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("keep_alive", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<KeepAliveEntity>(this->client, opts);
  }
