// ListTerminal entity client (generated). Shared entity runtime (data/match
...
class ListTerminalEntity : public EntityBase {
public:
  ListTerminalEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("list_terminal", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<ListTerminalEntity>(this->client, opts);
  }
