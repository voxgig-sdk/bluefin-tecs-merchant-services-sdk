// IntroduceMandator entity client (generated). Shared entity runtime (data/match
...
class IntroduceMandatorEntity : public EntityBase {
public:
  IntroduceMandatorEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("introduce_mandator", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<IntroduceMandatorEntity>(this->client, opts);
  }
