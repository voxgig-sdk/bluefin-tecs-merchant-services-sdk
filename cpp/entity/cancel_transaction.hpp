// CancelTransaction entity client (generated). Shared entity runtime (data/match
...
class CancelTransactionEntity : public EntityBase {
public:
  CancelTransactionEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("cancel_transaction", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<CancelTransactionEntity>(this->client, opts);
  }
