// RegisterTecsCompany entity client (generated). Shared entity runtime (data/match
...
class RegisterTecsCompanyEntity : public EntityBase {
public:
  RegisterTecsCompanyEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("register_tecs_company", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<RegisterTecsCompanyEntity>(this->client, opts);
  }
