// TerminalId entity client (generated). Shared entity runtime (data/match
...
class TerminalIdEntity : public EntityBase {
public:
  TerminalIdEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("terminal_id", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<TerminalIdEntity>(this->client, opts);
  }
