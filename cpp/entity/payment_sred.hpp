// PaymentSred entity client (generated). Shared entity runtime (data/match
...
class PaymentSredEntity : public EntityBase {
public:
  PaymentSredEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("payment_sred", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<PaymentSredEntity>(this->client, opts);
  }
