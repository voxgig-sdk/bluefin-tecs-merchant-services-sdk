// GetMerchantContractNumber entity client (generated). Shared entity runtime (data/match
...
class GetMerchantContractNumberEntity : public EntityBase {
public:
  GetMerchantContractNumberEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("get_merchant_contract_number", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<GetMerchantContractNumberEntity>(this->client, opts);
  }
