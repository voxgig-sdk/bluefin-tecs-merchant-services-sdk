// EmvData entity client (generated). Shared entity runtime (data/match
...
class EmvDataEntity : public EntityBase {
public:
  EmvDataEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("emv_data", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<EmvDataEntity>(this->client, opts);
  }
