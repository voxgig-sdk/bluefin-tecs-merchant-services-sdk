// UpdateMerchant entity client (generated). Shared entity runtime (data/match
...
class UpdateMerchantEntity : public EntityBase {
public:
  UpdateMerchantEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("update_merchant", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<UpdateMerchantEntity>(this->client, opts);
  }
