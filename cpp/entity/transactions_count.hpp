// TransactionsCount entity client (generated). Shared entity runtime (data/match
...
class TransactionsCountEntity : public EntityBase {
public:
  TransactionsCountEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("transactions_count", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<TransactionsCountEntity>(this->client, opts);
  }
