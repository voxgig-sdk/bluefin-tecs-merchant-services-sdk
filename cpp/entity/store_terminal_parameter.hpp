// StoreTerminalParameter entity client (generated). Shared entity runtime (data/match
...
class StoreTerminalParameterEntity : public EntityBase {
public:
  StoreTerminalParameterEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("store_terminal_parameter", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<StoreTerminalParameterEntity>(this->client, opts);
  }
