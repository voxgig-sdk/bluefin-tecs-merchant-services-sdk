// MandatorClearingExport entity client (generated). Shared entity runtime (data/match
...
class MandatorClearingExportEntity : public EntityBase {
public:
  MandatorClearingExportEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("mandator_clearing_export", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<MandatorClearingExportEntity>(this->client, opts);
  }
