// RefundTransaction entity client (generated). Shared entity runtime (data/match
...
class RefundTransactionEntity : public EntityBase {
public:
  RefundTransactionEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("refund_transaction", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<RefundTransactionEntity>(this->client, opts);
  }
