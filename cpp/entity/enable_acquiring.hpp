// EnableAcquiring entity client (generated). Shared entity runtime (data/match
...
class EnableAcquiringEntity : public EntityBase {
public:
  EnableAcquiringEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("enable_acquiring", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<EnableAcquiringEntity>(this->client, opts);
  }
