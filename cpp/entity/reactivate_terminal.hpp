// ReactivateTerminal entity client (generated). Shared entity runtime (data/match
...
class ReactivateTerminalEntity : public EntityBase {
public:
  ReactivateTerminalEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("reactivate_terminal", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<ReactivateTerminalEntity>(this->client, opts);
  }
