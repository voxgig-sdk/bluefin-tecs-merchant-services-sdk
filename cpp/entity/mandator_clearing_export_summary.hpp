// MandatorClearingExportSummary entity client (generated). Shared entity runtime (data/match
...
class MandatorClearingExportSummaryEntity : public EntityBase {
public:
  MandatorClearingExportSummaryEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("mandator_clearing_export_summary", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<MandatorClearingExportSummaryEntity>(this->client, opts);
  }
