// MerchantPortalServicesApi entity client (generated). Shared entity runtime (data/match
...
class MerchantPortalServicesApiEntity : public EntityBase {
public:
  MerchantPortalServicesApiEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("merchant_portal_services_api", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<MerchantPortalServicesApiEntity>(this->client, opts);
  }
