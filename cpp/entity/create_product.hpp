// CreateProduct entity client (generated). Shared entity runtime (data/match
...
class CreateProductEntity : public EntityBase {
public:
  CreateProductEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("create_product", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<CreateProductEntity>(this->client, opts);
  }
