// IntroducePackage entity client (generated). Shared entity runtime (data/match
...
class IntroducePackageEntity : public EntityBase {
public:
  IntroducePackageEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("introduce_package", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<IntroducePackageEntity>(this->client, opts);
  }
