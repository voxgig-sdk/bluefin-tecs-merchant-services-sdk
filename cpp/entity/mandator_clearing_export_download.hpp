// MandatorClearingExportDownload entity client (generated). Shared entity runtime (data/match
...
class MandatorClearingExportDownloadEntity : public EntityBase {
public:
  MandatorClearingExportDownloadEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("mandator_clearing_export_download", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<MandatorClearingExportDownloadEntity>(this->client, opts);
  }
