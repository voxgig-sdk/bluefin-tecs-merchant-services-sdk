// UpdateTemplateXml entity client (generated). Shared entity runtime (data/match
...
class UpdateTemplateXmlEntity : public EntityBase {
public:
  UpdateTemplateXmlEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("update_template_xml", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<UpdateTemplateXmlEntity>(this->client, opts);
  }
