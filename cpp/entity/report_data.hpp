// ReportData entity client (generated). Shared entity runtime (data/match
...
class ReportDataEntity : public EntityBase {
public:
  ReportDataEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("report_data", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<ReportDataEntity>(this->client, opts);
  }
