// DeactivateTerminal entity client (generated). Shared entity runtime (data/match
...
class DeactivateTerminalEntity : public EntityBase {
public:
  DeactivateTerminalEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("deactivate_terminal", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<DeactivateTerminalEntity>(this->client, opts);
  }
