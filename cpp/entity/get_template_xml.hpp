// GetTemplateXml entity client (generated). Shared entity runtime (data/match
...
class GetTemplateXmlEntity : public EntityBase {
public:
  GetTemplateXmlEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("get_template_xml", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<GetTemplateXmlEntity>(this->client, opts);
  }
