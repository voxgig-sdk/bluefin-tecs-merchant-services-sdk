// RegisterTerminal entity client (generated). Shared entity runtime (data/match
...
class RegisterTerminalEntity : public EntityBase {
public:
  RegisterTerminalEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("register_terminal", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<RegisterTerminalEntity>(this->client, opts);
  }
