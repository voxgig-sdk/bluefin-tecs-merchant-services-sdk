// MoveTid entity client (generated). Shared entity runtime (data/match
...
class MoveTidEntity : public EntityBase {
public:
  MoveTidEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("move_tid", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<MoveTidEntity>(this->client, opts);
  }
