// EcomParameter entity client (generated). Shared entity runtime (data/match
...
class EcomParameterEntity : public EntityBase {
public:
  EcomParameterEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("ecom_parameter", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<EcomParameterEntity>(this->client, opts);
  }
