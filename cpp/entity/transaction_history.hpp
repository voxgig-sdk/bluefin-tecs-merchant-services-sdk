// TransactionHistory entity client (generated). Shared entity runtime (data/match
...
class TransactionHistoryEntity : public EntityBase {
public:
  TransactionHistoryEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("transaction_history", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<TransactionHistoryEntity>(this->client, opts);
  }
