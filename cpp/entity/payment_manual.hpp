// PaymentManual entity client (generated). Shared entity runtime (data/match
...
class PaymentManualEntity : public EntityBase {
public:
  PaymentManualEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("payment_manual", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<PaymentManualEntity>(this->client, opts);
  }
