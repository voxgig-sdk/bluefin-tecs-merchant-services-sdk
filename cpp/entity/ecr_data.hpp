// EcrData entity client (generated). Shared entity runtime (data/match
...
class EcrDataEntity : public EntityBase {
public:
  EcrDataEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("ecr_data", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<EcrDataEntity>(this->client, opts);
  }
