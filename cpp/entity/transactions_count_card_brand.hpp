// TransactionsCountCardBrand entity client (generated). Shared entity runtime (data/match
...
class TransactionsCountCardBrandEntity : public EntityBase {
public:
  TransactionsCountCardBrandEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("transactions_count_card_brand", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<TransactionsCountCardBrandEntity>(this->client, opts);
  }
