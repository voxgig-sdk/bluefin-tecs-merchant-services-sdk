// TransactionsTurnover entity client (generated). Shared entity runtime (data/match
...
class TransactionsTurnoverEntity : public EntityBase {
public:
  TransactionsTurnoverEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("transactions_turnover", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<TransactionsTurnoverEntity>(this->client, opts);
  }
