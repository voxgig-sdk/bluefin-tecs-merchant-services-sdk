// CheckCardBlackListed entity client (generated). Shared entity runtime (data/match
...
class CheckCardBlackListedEntity : public EntityBase {
public:
  CheckCardBlackListedEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("check_card_black_listed", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<CheckCardBlackListedEntity>(this->client, opts);
  }
