// StatusTransaction entity client (generated). Shared entity runtime (data/match
...
class StatusTransactionEntity : public EntityBase {
public:
  StatusTransactionEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("status_transaction", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<StatusTransactionEntity>(this->client, opts);
  }
