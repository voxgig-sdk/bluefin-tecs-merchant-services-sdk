...
static StoreTerminalParameterSetup store_terminal_parameter_basic_setup(const Value& extra) {
  ...
  Value idmap_resolved = Helpers::toMapAny(getp(env, "BLUEFIN_TECS_MERCHANT_SERVICES_TEST_STORE_TERMINAL_PARAMETER_ENTID"));
...
static void store_terminal_parameter_entity_basic() {
  ...
  {
    Value store_terminal_parameter_ref01_data_result = store_terminal_parameter_ref01_ent->create(Struct::clone(store_terminal_parameter_ref01_data), Value::undef())->data();
