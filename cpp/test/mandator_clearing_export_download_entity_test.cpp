...
static MandatorClearingExportDownloadSetup mandator_clearing_export_download_basic_setup(const Value& extra) {
  ...
  Value idmap_resolved = Helpers::toMapAny(getp(env, "BLUEFIN_TECS_MERCHANT_SERVICES_TEST_MANDATOR_CLEARING_EXPORT_DOWNLOAD_ENTID"));
...
static void mandator_clearing_export_download_entity_basic() {
  ...
  {
    Value mandator_clearing_export_download_ref01_data_result = mandator_clearing_export_download_ref01_ent->create(Struct::clone(mandator_clearing_export_download_ref01_data), Value::undef())->data();
