...
static DigitalServicesApiSetup digital_services_api_basic_setup(const Value& extra) {
  ...
  Value idmap_resolved = Helpers::toMapAny(getp(env, "BLUEFIN_TECS_MERCHANT_SERVICES_TEST_DIGITAL_SERVICES_API_ENTID"));
...
static void digital_services_api_entity_basic() {
  ...
  {
    Value digital_services_api_ref01_data_result = digital_services_api_ref01_ent->create(Struct::clone(digital_services_api_ref01_data), Value::undef())->data();
  ...
  Value digital_services_api_ref01_data_dt0_loaded = digital_services_api_ref01_ent->load(digital_services_api_ref01_match_dt0, Value::undef())->data();
