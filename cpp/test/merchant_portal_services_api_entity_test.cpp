...
static MerchantPortalServicesApiSetup merchant_portal_services_api_basic_setup(const Value& extra) {
  ...
  Value idmap_resolved = Helpers::toMapAny(getp(env, "BLUEFIN_TECS_MERCHANT_SERVICES_TEST_MERCHANT_PORTAL_SERVICES_API_ENTID"));
...
static void merchant_portal_services_api_entity_basic() {
  ...
  {
    Value merchant_portal_services_api_ref01_data_result = merchant_portal_services_api_ref01_ent->create(Struct::clone(merchant_portal_services_api_ref01_data), Value::undef())->data();
