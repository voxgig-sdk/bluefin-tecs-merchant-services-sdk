...
public class UpdateMerchantEntity extends EntityBase {

  public UpdateMerchantEntity(SdkClient client, Map<String, Object> entopts) {
    super("update_merchant", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new UpdateMerchantEntity(this.client, opts);
  }
