...
public class CreateProductEntity extends EntityBase {

  public CreateProductEntity(SdkClient client, Map<String, Object> entopts) {
    super("create_product", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new CreateProductEntity(this.client, opts);
  }
