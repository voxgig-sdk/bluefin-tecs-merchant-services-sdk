...
public class TransactionHistoryEntity extends EntityBase {

  public TransactionHistoryEntity(SdkClient client, Map<String, Object> entopts) {
    super("transaction_history", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new TransactionHistoryEntity(this.client, opts);
  }
