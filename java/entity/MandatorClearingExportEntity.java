...
public class MandatorClearingExportEntity extends EntityBase {

  public MandatorClearingExportEntity(SdkClient client, Map<String, Object> entopts) {
    super("mandator_clearing_export", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new MandatorClearingExportEntity(this.client, opts);
  }
