...
public class CheckCardBlackListedEntity extends EntityBase {

  public CheckCardBlackListedEntity(SdkClient client, Map<String, Object> entopts) {
    super("check_card_black_listed", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new CheckCardBlackListedEntity(this.client, opts);
  }
