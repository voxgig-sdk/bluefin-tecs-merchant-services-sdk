...
public class EnableAcquiringEntity extends EntityBase {

  public EnableAcquiringEntity(SdkClient client, Map<String, Object> entopts) {
    super("enable_acquiring", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new EnableAcquiringEntity(this.client, opts);
  }
