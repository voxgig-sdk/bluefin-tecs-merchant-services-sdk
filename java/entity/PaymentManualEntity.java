...
public class PaymentManualEntity extends EntityBase {

  public PaymentManualEntity(SdkClient client, Map<String, Object> entopts) {
    super("payment_manual", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new PaymentManualEntity(this.client, opts);
  }
