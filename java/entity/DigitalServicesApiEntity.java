...
public class DigitalServicesApiEntity extends EntityBase {

  public DigitalServicesApiEntity(SdkClient client, Map<String, Object> entopts) {
    super("digital_services_api", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new DigitalServicesApiEntity(this.client, opts);
  }
