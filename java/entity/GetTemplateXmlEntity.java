...
public class GetTemplateXmlEntity extends EntityBase {

  public GetTemplateXmlEntity(SdkClient client, Map<String, Object> entopts) {
    super("get_template_xml", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new GetTemplateXmlEntity(this.client, opts);
  }
