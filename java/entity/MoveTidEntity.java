...
public class MoveTidEntity extends EntityBase {

  public MoveTidEntity(SdkClient client, Map<String, Object> entopts) {
    super("move_tid", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new MoveTidEntity(this.client, opts);
  }
