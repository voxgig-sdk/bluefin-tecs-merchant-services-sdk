...
public class PreAuthTransactionCompletionEntity extends EntityBase {

  public PreAuthTransactionCompletionEntity(SdkClient client, Map<String, Object> entopts) {
    super("pre_auth_transaction_completion", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new PreAuthTransactionCompletionEntity(this.client, opts);
  }
