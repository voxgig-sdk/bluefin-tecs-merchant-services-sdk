...
public class StatusTransactionEntity extends EntityBase {

  public StatusTransactionEntity(SdkClient client, Map<String, Object> entopts) {
    super("status_transaction", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new StatusTransactionEntity(this.client, opts);
  }
