...
public class IntroduceMandatorEntity extends EntityBase {

  public IntroduceMandatorEntity(SdkClient client, Map<String, Object> entopts) {
    super("introduce_mandator", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new IntroduceMandatorEntity(this.client, opts);
  }
