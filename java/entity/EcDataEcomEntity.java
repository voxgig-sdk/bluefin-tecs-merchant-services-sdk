...
public class EcDataEcomEntity extends EntityBase {

  public EcDataEcomEntity(SdkClient client, Map<String, Object> entopts) {
    super("ec_data_ecom", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new EcDataEcomEntity(this.client, opts);
  }
