...
public class TerminalIdEntity extends EntityBase {

  public TerminalIdEntity(SdkClient client, Map<String, Object> entopts) {
    super("terminal_id", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new TerminalIdEntity(this.client, opts);
  }
