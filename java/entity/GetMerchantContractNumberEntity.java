...
public class GetMerchantContractNumberEntity extends EntityBase {

  public GetMerchantContractNumberEntity(SdkClient client, Map<String, Object> entopts) {
    super("get_merchant_contract_number", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new GetMerchantContractNumberEntity(this.client, opts);
  }
