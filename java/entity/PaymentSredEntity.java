...
public class PaymentSredEntity extends EntityBase {

  public PaymentSredEntity(SdkClient client, Map<String, Object> entopts) {
    super("payment_sred", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new PaymentSredEntity(this.client, opts);
  }
