...
public class TransactionsCountCardBrandEntity extends EntityBase {

  public TransactionsCountCardBrandEntity(SdkClient client, Map<String, Object> entopts) {
    super("transactions_count_card_brand", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new TransactionsCountCardBrandEntity(this.client, opts);
  }
