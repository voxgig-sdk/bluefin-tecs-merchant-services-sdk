...
public class ReactivateTerminalEntity extends EntityBase {

  public ReactivateTerminalEntity(SdkClient client, Map<String, Object> entopts) {
    super("reactivate_terminal", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new ReactivateTerminalEntity(this.client, opts);
  }
