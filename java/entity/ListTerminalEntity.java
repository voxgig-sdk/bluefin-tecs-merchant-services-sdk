...
public class ListTerminalEntity extends EntityBase {

  public ListTerminalEntity(SdkClient client, Map<String, Object> entopts) {
    super("list_terminal", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new ListTerminalEntity(this.client, opts);
  }
