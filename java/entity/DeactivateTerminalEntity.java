...
public class DeactivateTerminalEntity extends EntityBase {

  public DeactivateTerminalEntity(SdkClient client, Map<String, Object> entopts) {
    super("deactivate_terminal", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new DeactivateTerminalEntity(this.client, opts);
  }
