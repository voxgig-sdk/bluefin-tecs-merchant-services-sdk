...
public class UpdateTemplateXmlEntity extends EntityBase {

  public UpdateTemplateXmlEntity(SdkClient client, Map<String, Object> entopts) {
    super("update_template_xml", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new UpdateTemplateXmlEntity(this.client, opts);
  }
