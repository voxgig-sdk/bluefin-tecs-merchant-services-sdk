...
public class RefundTransactionEntity extends EntityBase {

  public RefundTransactionEntity(SdkClient client, Map<String, Object> entopts) {
    super("refund_transaction", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new RefundTransactionEntity(this.client, opts);
  }
