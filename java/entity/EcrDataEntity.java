...
public class EcrDataEntity extends EntityBase {

  public EcrDataEntity(SdkClient client, Map<String, Object> entopts) {
    super("ecr_data", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new EcrDataEntity(this.client, opts);
  }
