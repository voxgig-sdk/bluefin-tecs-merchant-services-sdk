...
public class EcomParameterEntity extends EntityBase {

  public EcomParameterEntity(SdkClient client, Map<String, Object> entopts) {
    super("ecom_parameter", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new EcomParameterEntity(this.client, opts);
  }
