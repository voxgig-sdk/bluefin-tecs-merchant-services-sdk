...
public class StoreTerminalParameterEntity extends EntityBase {

  public StoreTerminalParameterEntity(SdkClient client, Map<String, Object> entopts) {
    super("store_terminal_parameter", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new StoreTerminalParameterEntity(this.client, opts);
  }
