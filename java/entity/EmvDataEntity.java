...
public class EmvDataEntity extends EntityBase {

  public EmvDataEntity(SdkClient client, Map<String, Object> entopts) {
    super("emv_data", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new EmvDataEntity(this.client, opts);
  }
