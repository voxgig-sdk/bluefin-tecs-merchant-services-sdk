...
public class CancelTransactionEntity extends EntityBase {

  public CancelTransactionEntity(SdkClient client, Map<String, Object> entopts) {
    super("cancel_transaction", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new CancelTransactionEntity(this.client, opts);
  }
