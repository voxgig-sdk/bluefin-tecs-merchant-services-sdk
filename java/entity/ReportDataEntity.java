...
public class ReportDataEntity extends EntityBase {

  public ReportDataEntity(SdkClient client, Map<String, Object> entopts) {
    super("report_data", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new ReportDataEntity(this.client, opts);
  }
