...
public class TransactionsTurnoverEntity extends EntityBase {

  public TransactionsTurnoverEntity(SdkClient client, Map<String, Object> entopts) {
    super("transactions_turnover", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new TransactionsTurnoverEntity(this.client, opts);
  }
