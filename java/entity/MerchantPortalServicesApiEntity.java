...
public class MerchantPortalServicesApiEntity extends EntityBase {

  public MerchantPortalServicesApiEntity(SdkClient client, Map<String, Object> entopts) {
    super("merchant_portal_services_api", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new MerchantPortalServicesApiEntity(this.client, opts);
  }
