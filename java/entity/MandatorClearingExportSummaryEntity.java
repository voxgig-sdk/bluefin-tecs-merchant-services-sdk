...
public class MandatorClearingExportSummaryEntity extends EntityBase {

  public MandatorClearingExportSummaryEntity(SdkClient client, Map<String, Object> entopts) {
    super("mandator_clearing_export_summary", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new MandatorClearingExportSummaryEntity(this.client, opts);
  }
