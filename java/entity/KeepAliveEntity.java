...
public class KeepAliveEntity extends EntityBase {

  public KeepAliveEntity(SdkClient client, Map<String, Object> entopts) {
    super("keep_alive", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new KeepAliveEntity(this.client, opts);
  }
