...
public class RegisterTecsCompanyEntity extends EntityBase {

  public RegisterTecsCompanyEntity(SdkClient client, Map<String, Object> entopts) {
    super("register_tecs_company", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new RegisterTecsCompanyEntity(this.client, opts);
  }
