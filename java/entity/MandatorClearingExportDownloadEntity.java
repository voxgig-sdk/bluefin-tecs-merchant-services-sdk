...
public class MandatorClearingExportDownloadEntity extends EntityBase {

  public MandatorClearingExportDownloadEntity(SdkClient client, Map<String, Object> entopts) {
    super("mandator_clearing_export_download", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new MandatorClearingExportDownloadEntity(this.client, opts);
  }
