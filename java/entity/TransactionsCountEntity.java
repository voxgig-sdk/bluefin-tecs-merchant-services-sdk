...
public class TransactionsCountEntity extends EntityBase {

  public TransactionsCountEntity(SdkClient client, Map<String, Object> entopts) {
    super("transactions_count", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new TransactionsCountEntity(this.client, opts);
  }
