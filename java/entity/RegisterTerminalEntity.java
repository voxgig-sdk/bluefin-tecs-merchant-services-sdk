...
public class RegisterTerminalEntity extends EntityBase {

  public RegisterTerminalEntity(SdkClient client, Map<String, Object> entopts) {
    super("register_terminal", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new RegisterTerminalEntity(this.client, opts);
  }
