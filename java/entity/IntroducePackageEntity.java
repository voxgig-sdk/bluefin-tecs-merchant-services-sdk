...
public class IntroducePackageEntity extends EntityBase {

  public IntroducePackageEntity(SdkClient client, Map<String, Object> entopts) {
    super("introduce_package", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new IntroducePackageEntity(this.client, opts);
  }
