...
public final class StatusTransactionEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "status_transaction")
  }

  public override func make() -> Entity {
    return StatusTransactionEntity(client, cloneOpts())
  }
