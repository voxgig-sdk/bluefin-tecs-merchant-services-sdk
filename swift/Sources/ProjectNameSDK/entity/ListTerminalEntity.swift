...
public final class ListTerminalEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "list_terminal")
  }

  public override func make() -> Entity {
    return ListTerminalEntity(client, cloneOpts())
  }
