...
public final class RegisterTerminalEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "register_terminal")
  }

  public override func make() -> Entity {
    return RegisterTerminalEntity(client, cloneOpts())
  }
