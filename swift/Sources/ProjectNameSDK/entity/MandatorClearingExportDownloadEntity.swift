...
public final class MandatorClearingExportDownloadEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "mandator_clearing_export_download")
  }

  public override func make() -> Entity {
    return MandatorClearingExportDownloadEntity(client, cloneOpts())
  }
