...
public final class StoreTerminalParameterEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "store_terminal_parameter")
  }

  public override func make() -> Entity {
    return StoreTerminalParameterEntity(client, cloneOpts())
  }
