...
public final class EcomParameterEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "ecom_parameter")
  }

  public override func make() -> Entity {
    return EcomParameterEntity(client, cloneOpts())
  }
