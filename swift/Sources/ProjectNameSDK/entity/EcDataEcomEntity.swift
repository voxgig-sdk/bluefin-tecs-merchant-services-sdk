...
public final class EcDataEcomEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "ec_data_ecom")
  }

  public override func make() -> Entity {
    return EcDataEcomEntity(client, cloneOpts())
  }
