...
public final class TransactionsCountCardBrandEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "transactions_count_card_brand")
  }

  public override func make() -> Entity {
    return TransactionsCountCardBrandEntity(client, cloneOpts())
  }
