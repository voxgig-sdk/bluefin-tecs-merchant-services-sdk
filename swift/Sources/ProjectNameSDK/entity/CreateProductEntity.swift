...
public final class CreateProductEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "create_product")
  }

  public override func make() -> Entity {
    return CreateProductEntity(client, cloneOpts())
  }
