...
public final class GetMerchantContractNumberEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "get_merchant_contract_number")
  }

  public override func make() -> Entity {
    return GetMerchantContractNumberEntity(client, cloneOpts())
  }
