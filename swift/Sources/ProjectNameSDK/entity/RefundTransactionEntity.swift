...
public final class RefundTransactionEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "refund_transaction")
  }

  public override func make() -> Entity {
    return RefundTransactionEntity(client, cloneOpts())
  }
