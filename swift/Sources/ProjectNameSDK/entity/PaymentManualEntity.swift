...
public final class PaymentManualEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "payment_manual")
  }

  public override func make() -> Entity {
    return PaymentManualEntity(client, cloneOpts())
  }
