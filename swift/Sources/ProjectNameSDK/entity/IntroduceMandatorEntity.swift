...
public final class IntroduceMandatorEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "introduce_mandator")
  }

  public override func make() -> Entity {
    return IntroduceMandatorEntity(client, cloneOpts())
  }
