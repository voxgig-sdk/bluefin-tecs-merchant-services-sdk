...
public final class UpdateTemplateXmlEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "update_template_xml")
  }

  public override func make() -> Entity {
    return UpdateTemplateXmlEntity(client, cloneOpts())
  }
