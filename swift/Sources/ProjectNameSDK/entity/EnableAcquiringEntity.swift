...
public final class EnableAcquiringEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "enable_acquiring")
  }

  public override func make() -> Entity {
    return EnableAcquiringEntity(client, cloneOpts())
  }
