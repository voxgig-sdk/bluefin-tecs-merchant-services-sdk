...
public final class TerminalIdEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "terminal_id")
  }

  public override func make() -> Entity {
    return TerminalIdEntity(client, cloneOpts())
  }
