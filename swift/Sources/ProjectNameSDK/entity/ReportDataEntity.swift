...
public final class ReportDataEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "report_data")
  }

  public override func make() -> Entity {
    return ReportDataEntity(client, cloneOpts())
  }
