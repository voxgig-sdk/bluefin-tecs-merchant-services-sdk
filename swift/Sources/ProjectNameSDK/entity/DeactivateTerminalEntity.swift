...
public final class DeactivateTerminalEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "deactivate_terminal")
  }

  public override func make() -> Entity {
    return DeactivateTerminalEntity(client, cloneOpts())
  }
