// BluefinTecsMerchantServicesEntityBase - shared entity behaviour: construction, data/match
...
open class BluefinTecsMerchantServicesEntityBase: Entity {
  var name: String
  var client: BluefinTecsMerchantServicesSDK
  var utility: Utility
  var entopts: VMap
  var data = VMap()
  var match = VMap()
  ...
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entoptsIn: VMap?, _ name: String) {
  ...
  open func make() -> Entity {
    return BluefinTecsMerchantServicesEntityBase(client, cloneOpts(), name)
  }
