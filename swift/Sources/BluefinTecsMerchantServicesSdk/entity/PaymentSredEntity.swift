...
public final class PaymentSredEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "payment_sred")
  }

  public override func make() -> Entity {
    return PaymentSredEntity(client, cloneOpts())
  }
