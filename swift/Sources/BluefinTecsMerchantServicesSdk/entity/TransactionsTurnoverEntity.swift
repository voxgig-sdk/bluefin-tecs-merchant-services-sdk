...
public final class TransactionsTurnoverEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "transactions_turnover")
  }

  public override func make() -> Entity {
    return TransactionsTurnoverEntity(client, cloneOpts())
  }
