...
public final class MerchantPortalServicesApiEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "merchant_portal_services_api")
  }

  public override func make() -> Entity {
    return MerchantPortalServicesApiEntity(client, cloneOpts())
  }
