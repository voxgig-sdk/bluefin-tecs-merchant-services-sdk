...
public final class CheckCardBlackListedEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "check_card_black_listed")
  }

  public override func make() -> Entity {
    return CheckCardBlackListedEntity(client, cloneOpts())
  }
