...
public final class RegisterTecsCompanyEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "register_tecs_company")
  }

  public override func make() -> Entity {
    return RegisterTecsCompanyEntity(client, cloneOpts())
  }
