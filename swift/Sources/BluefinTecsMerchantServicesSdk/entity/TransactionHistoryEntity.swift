...
public final class TransactionHistoryEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "transaction_history")
  }

  public override func make() -> Entity {
    return TransactionHistoryEntity(client, cloneOpts())
  }
