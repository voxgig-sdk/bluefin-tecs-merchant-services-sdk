...
public final class IntroducePackageEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "introduce_package")
  }

  public override func make() -> Entity {
    return IntroducePackageEntity(client, cloneOpts())
  }
