...
public final class CancelTransactionEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "cancel_transaction")
  }

  public override func make() -> Entity {
    return CancelTransactionEntity(client, cloneOpts())
  }
