...
public final class GetTemplateXmlEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "get_template_xml")
  }

  public override func make() -> Entity {
    return GetTemplateXmlEntity(client, cloneOpts())
  }
