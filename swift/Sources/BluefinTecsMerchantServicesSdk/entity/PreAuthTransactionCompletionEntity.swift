...
public final class PreAuthTransactionCompletionEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "pre_auth_transaction_completion")
  }

  public override func make() -> Entity {
    return PreAuthTransactionCompletionEntity(client, cloneOpts())
  }
