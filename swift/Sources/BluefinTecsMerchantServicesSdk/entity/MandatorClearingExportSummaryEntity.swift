...
public final class MandatorClearingExportSummaryEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "mandator_clearing_export_summary")
  }

  public override func make() -> Entity {
    return MandatorClearingExportSummaryEntity(client, cloneOpts())
  }
