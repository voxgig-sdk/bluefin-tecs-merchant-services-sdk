...
public final class ReactivateTerminalEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "reactivate_terminal")
  }

  public override func make() -> Entity {
    return ReactivateTerminalEntity(client, cloneOpts())
  }
