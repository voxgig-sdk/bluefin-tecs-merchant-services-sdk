...
public final class DigitalServicesApiEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "digital_services_api")
  }

  public override func make() -> Entity {
    return DigitalServicesApiEntity(client, cloneOpts())
  }
