...
public final class MandatorClearingExportEntity: BluefinTecsMerchantServicesEntityBase {
  public init(_ client: BluefinTecsMerchantServicesSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "mandator_clearing_export")
  }

  public override func make() -> Entity {
    return MandatorClearingExportEntity(client, cloneOpts())
  }
