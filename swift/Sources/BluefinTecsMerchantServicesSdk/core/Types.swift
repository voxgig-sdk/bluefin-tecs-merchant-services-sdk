// BluefinTecsMerchantServices SDK - core contracts.
...
// BluefinTecsMerchantServicesEntityBase which implements this.
...
// Throws (typically BluefinTecsMerchantServicesError) on transport-level failure. A returned
