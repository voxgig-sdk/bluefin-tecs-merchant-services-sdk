// BluefinTecsMerchantServices SDK - operation context.
//
...
public final class Context {
  ...
  public var client: BluefinTecsMerchantServicesSDK?
  ...
  public init(_ ctxmap: [String: Any?]?, _ basectx: Context?) {
    ...
    // Client
    if let sdk = ctxProp(ctxmap, "client") as? BluefinTecsMerchantServicesSDK { client = sdk }
  ...
  public func makeError(_ code: String, _ msg: String) -> BluefinTecsMerchantServicesError {
