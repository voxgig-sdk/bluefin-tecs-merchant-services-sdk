// digital_services_api direct API test (generated from the API model).

import XCTest

@testable import BluefinTecsMerchantServicesSdk

final class DigitalServicesApiDirectTest: XCTestCase {
  func testDirectMock() {
    ...
    let args = VMap()
    args.entries["path"] = .string("/digital_services_api")
