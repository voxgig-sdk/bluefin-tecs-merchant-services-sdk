// mandator_clearing_export_download direct API test (generated from the API model).

import XCTest

@testable import BluefinTecsMerchantServicesSdk

final class MandatorClearingExportDownloadDirectTest: XCTestCase {
  func testDirectMock() {
    ...
    let sdk = BluefinTecsMerchantServicesSDK(opts)

    let args = VMap()
    args.entries["path"] = .string("/mandator_clearing_export_download")
