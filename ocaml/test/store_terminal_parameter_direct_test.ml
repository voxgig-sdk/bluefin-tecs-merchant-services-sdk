(* Generated store_terminal_parameter direct-call test. *)
...
let () =
  test "store_terminal_parameter.direct_call" (fun () ->
      let calls = ref [] in
      ...
      let result = Sdk_client.direct client
          (jo [("path", Str "/store_terminal_parameter"); ("method", Str "GET")]) in
