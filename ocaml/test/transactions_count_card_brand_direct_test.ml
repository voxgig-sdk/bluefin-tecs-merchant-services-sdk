(* Generated transactions_count_card_brand direct-call test. *)
...
let () =
  test "transactions_count_card_brand.direct_call" (fun () ->
      let calls = ref [] in
      ...
      let result = Sdk_client.direct client
          (jo [("path", Str "/transactions_count_card_brand"); ("method", Str "GET")]) in
