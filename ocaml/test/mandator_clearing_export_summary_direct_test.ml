(* Generated mandator_clearing_export_summary direct-call test. *)
...
let () =
  test "mandator_clearing_export_summary.direct_call" (fun () ->
      let calls = ref [] in
      ...
      let result = Sdk_client.direct client
          (jo [("path", Str "/mandator_clearing_export_summary"); ("method", Str "GET")]) in
