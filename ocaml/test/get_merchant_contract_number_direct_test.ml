(* Generated get_merchant_contract_number direct-call test. *)
...
let () =
  test "get_merchant_contract_number.direct_call" (fun () ->
      let calls = ref [] in
      ...
      let result = Sdk_client.direct client
          (jo [("path", Str "/get_merchant_contract_number"); ("method", Str "GET")]) in
