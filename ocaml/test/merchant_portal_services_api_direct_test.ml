(* Generated merchant_portal_services_api direct-call test. *)
...
let () =
  test "merchant_portal_services_api.direct_call" (fun () ->
      let calls = ref [] in
      ...
      let result = Sdk_client.direct client
          (jo [("path", Str "/merchant_portal_services_api"); ("method", Str "GET")]) in
