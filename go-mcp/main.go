// Command BluefinTecsMerchantServices-mcp is an MCP server exposing the BluefinTecsMerchantServices
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BluefinTecsMerchantServices_list  — list records of an entity
//	BluefinTecsMerchantServices_load  — load a single record of an entity
//
