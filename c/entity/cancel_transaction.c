// CancelTransaction entity client (generated — mirrors the rust Entity fragment).
...
typedef struct cancel_transaction_entity {
...
static const char* cancel_transaction_get_name(Entity* e);
...
Entity* cancel_transaction_entity_new(BluefinTecsMerchantServicesSDK* client, voxgig_value* entopts) {
  ...
  cancel_transaction_entity* self = (cancel_transaction_entity*)calloc(1, sizeof(cancel_transaction_entity));
  self->base.vt = &cancel_transaction_VT;
  self->name = strdup("cancel_transaction");
  self->client = client;
...
static voxgig_value* cancel_transaction_run_op(cancel_transaction_entity* self, Context* ctx,
                                    cancel_transaction_postdone_fn post_done, PNError** err) {
...
voxgig_value* cancel_transaction_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* cancel_transaction_get_name(Entity* e) {
  return ((cancel_transaction_entity*)e)->name;
}
...
static Entity* cancel_transaction_make(Entity* e) {
  ...
  return cancel_transaction_entity_new(self->client, opts);
}
...
static voxgig_value* cancel_transaction_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(cancel_transaction_ent_ctx(self), "SetData");
  }
  feature_hook_util(cancel_transaction_ent_ctx(self), "GetData");
...
static voxgig_value* cancel_transaction_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(cancel_transaction_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(cancel_transaction_ent_ctx(self), "GetMatch");
...
static void cancel_transaction_create_postdone(cancel_transaction_entity* self, Context* ctx) {
...
static const EntityVT cancel_transaction_VT = {
  ...
  cancel_transaction_update,
  cancel_transaction_remove,
};
