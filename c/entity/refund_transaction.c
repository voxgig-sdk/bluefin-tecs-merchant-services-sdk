// RefundTransaction entity client (generated — mirrors the rust Entity fragment).
...
typedef struct refund_transaction_entity {
  ...
  bool deleted;
} refund_transaction_entity;

typedef void (*refund_transaction_postdone_fn)(refund_transaction_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT refund_transaction_VT;
static const char* refund_transaction_get_name(Entity* e);
static Entity* refund_transaction_make(Entity* e);
static voxgig_value* refund_transaction_data(Entity* e, voxgig_value* args);
static voxgig_value* refund_transaction_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* refund_transaction_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** refund_transaction_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* refund_transaction_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* refund_transaction_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* refund_transaction_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void refund_transaction_mark_deleted(Entity* e);
static bool refund_transaction_deleted(Entity* e);

static Context* refund_transaction_ent_ctx(refund_transaction_entity* self) {
  return self->entctx;
}
...
Entity* refund_transaction_entity_new(BluefinTecsMerchantServicesSDK* client, voxgig_value* entopts) {
  ...
  refund_transaction_entity* self = (refund_transaction_entity*)calloc(1, sizeof(refund_transaction_entity));
  self->base.vt = &refund_transaction_VT;
  self->name = strdup("refund_transaction");
  self->client = client;
...
static voxgig_value* refund_transaction_run_op(refund_transaction_entity* self, Context* ctx,
                                    refund_transaction_postdone_fn post_done, PNError** err) {
...
voxgig_value* refund_transaction_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  refund_transaction_entity* self = (refund_transaction_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, refund_transaction_ent_ctx(self));
...
static const char* refund_transaction_get_name(Entity* e) {
  return ((refund_transaction_entity*)e)->name;
}
...
static Entity* refund_transaction_make(Entity* e) {
  ...
  return refund_transaction_entity_new(self->client, opts);
}
...
static voxgig_value* refund_transaction_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(refund_transaction_ent_ctx(self), "SetData");
  }
  feature_hook_util(refund_transaction_ent_ctx(self), "GetData");
...
static voxgig_value* refund_transaction_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(refund_transaction_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(refund_transaction_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static Entity* refund_transaction_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "refund_transaction");
  return NULL;
}

static Entity** refund_transaction_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "refund_transaction");
  return NULL;
}


static void refund_transaction_create_postdone(refund_transaction_entity* self, Context* ctx) {
...
static Entity* refund_transaction_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, refund_transaction_ent_ctx(self));
  refund_transaction_run_op(self, ctx, refund_transaction_create_postdone, err);
  if (*err) return NULL;
...
static Entity* refund_transaction_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "refund_transaction");
  return NULL;
}

static Entity* refund_transaction_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "refund_transaction");
  return NULL;
}
...
// live record.
static void refund_transaction_mark_deleted(Entity* e) {
  ((refund_transaction_entity*)e)->deleted = true;
}

static bool refund_transaction_deleted(Entity* e) {
  return ((refund_transaction_entity*)e)->deleted;
}

static const EntityVT refund_transaction_VT = {
  refund_transaction_get_name,
  refund_transaction_make,
  refund_transaction_data,
  refund_transaction_matchv,
  refund_transaction_mark_deleted,
  refund_transaction_deleted,
  refund_transaction_load,
  refund_transaction_list,
  refund_transaction_create,
  refund_transaction_update,
  refund_transaction_remove,
};
