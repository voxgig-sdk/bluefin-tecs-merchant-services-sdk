// CreateProduct entity client (generated — mirrors the rust Entity fragment).
...
typedef struct create_product_entity {
...
typedef void (*create_product_postdone_fn)(create_product_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT create_product_VT;
static const char* create_product_get_name(Entity* e);
static Entity* create_product_make(Entity* e);
static voxgig_value* create_product_data(Entity* e, voxgig_value* args);
static voxgig_value* create_product_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* create_product_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** create_product_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* create_product_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* create_product_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* create_product_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void create_product_mark_deleted(Entity* e);
static bool create_product_deleted(Entity* e);

static Context* create_product_ent_ctx(create_product_entity* self) {
  return self->entctx;
}
...
Entity* create_product_entity_new(BluefinTecsMerchantServicesSDK* client, voxgig_value* entopts) {
  ...
  create_product_entity* self = (create_product_entity*)calloc(1, sizeof(create_product_entity));
  self->base.vt = &create_product_VT;
  self->name = strdup("create_product");
  self->client = client;
...
static voxgig_value* create_product_run_op(create_product_entity* self, Context* ctx,
                                    create_product_postdone_fn post_done, PNError** err) {
...
voxgig_value* create_product_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  create_product_entity* self = (create_product_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, create_product_ent_ctx(self));
...
static const char* create_product_get_name(Entity* e) {
  return ((create_product_entity*)e)->name;
}
...
static Entity* create_product_make(Entity* e) {
  ...
  return create_product_entity_new(self->client, opts);
}
...
static voxgig_value* create_product_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(create_product_ent_ctx(self), "SetData");
  }
  feature_hook_util(create_product_ent_ctx(self), "GetData");
...
static voxgig_value* create_product_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(create_product_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(create_product_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static Entity* create_product_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "create_product");
  return NULL;
}

static Entity** create_product_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "create_product");
  return NULL;
}


static void create_product_create_postdone(create_product_entity* self, Context* ctx) {
...
static Entity* create_product_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, create_product_ent_ctx(self));
  create_product_run_op(self, ctx, create_product_create_postdone, err);
  if (*err) return NULL;
...
static Entity* create_product_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "create_product");
  return NULL;
}

static Entity* create_product_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "create_product");
  return NULL;
}
...
// live record.
static void create_product_mark_deleted(Entity* e) {
  ((create_product_entity*)e)->deleted = true;
}

static bool create_product_deleted(Entity* e) {
  return ((create_product_entity*)e)->deleted;
}

static const EntityVT create_product_VT = {
  create_product_get_name,
  create_product_make,
  create_product_data,
  create_product_matchv,
  create_product_mark_deleted,
  create_product_deleted,
  create_product_load,
  create_product_list,
  create_product_create,
  create_product_update,
  create_product_remove,
};
