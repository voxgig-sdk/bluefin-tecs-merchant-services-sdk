// DigitalServicesApi entity client (generated — mirrors the rust Entity fragment).
...
typedef struct digital_services_api_entity {
...
static const char* digital_services_api_get_name(Entity* e);
...
Entity* digital_services_api_entity_new(BluefinTecsMerchantServicesSDK* client, voxgig_value* entopts) {
  ...
  digital_services_api_entity* self = (digital_services_api_entity*)calloc(1, sizeof(digital_services_api_entity));
  self->base.vt = &digital_services_api_VT;
  self->name = strdup("digital_services_api");
  self->client = client;
...
static voxgig_value* digital_services_api_run_op(digital_services_api_entity* self, Context* ctx,
                                    digital_services_api_postdone_fn post_done, PNError** err) {
...
voxgig_value* digital_services_api_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* digital_services_api_get_name(Entity* e) {
  return ((digital_services_api_entity*)e)->name;
}
...
static Entity* digital_services_api_make(Entity* e) {
  ...
  return digital_services_api_entity_new(self->client, opts);
}
...
static voxgig_value* digital_services_api_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(digital_services_api_ent_ctx(self), "SetData");
  }
  feature_hook_util(digital_services_api_ent_ctx(self), "GetData");
...
static voxgig_value* digital_services_api_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(digital_services_api_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(digital_services_api_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}


static void digital_services_api_load_postdone(digital_services_api_entity* self, Context* ctx) {
...
static void digital_services_api_create_postdone(digital_services_api_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resdata = result->resdata;
    if (!v_is_noval(resdata) && !v_is_null(resdata)) {
...
static const EntityVT digital_services_api_VT = {
  ...
  digital_services_api_update,
  digital_services_api_remove,
};
