// KeepAlive entity client (generated — mirrors the rust Entity fragment).
...
typedef struct keep_alive_entity {
...
typedef void (*keep_alive_postdone_fn)(keep_alive_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT keep_alive_VT;
static const char* keep_alive_get_name(Entity* e);
static Entity* keep_alive_make(Entity* e);
static voxgig_value* keep_alive_data(Entity* e, voxgig_value* args);
static voxgig_value* keep_alive_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* keep_alive_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** keep_alive_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* keep_alive_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* keep_alive_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* keep_alive_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void keep_alive_mark_deleted(Entity* e);
static bool keep_alive_deleted(Entity* e);

static Context* keep_alive_ent_ctx(keep_alive_entity* self) {
  return self->entctx;
}
...
Entity* keep_alive_entity_new(BluefinTecsMerchantServicesSDK* client, voxgig_value* entopts) {
  ...
  keep_alive_entity* self = (keep_alive_entity*)calloc(1, sizeof(keep_alive_entity));
  self->base.vt = &keep_alive_VT;
  self->name = strdup("keep_alive");
  self->client = client;
...
static voxgig_value* keep_alive_run_op(keep_alive_entity* self, Context* ctx,
                                    keep_alive_postdone_fn post_done, PNError** err) {
...
voxgig_value* keep_alive_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  keep_alive_entity* self = (keep_alive_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, keep_alive_ent_ctx(self));
...
static const char* keep_alive_get_name(Entity* e) {
  return ((keep_alive_entity*)e)->name;
}
...
static Entity* keep_alive_make(Entity* e) {
  ...
  return keep_alive_entity_new(self->client, opts);
}
...
static voxgig_value* keep_alive_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(keep_alive_ent_ctx(self), "SetData");
  }
  feature_hook_util(keep_alive_ent_ctx(self), "GetData");
...
static voxgig_value* keep_alive_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(keep_alive_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(keep_alive_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static Entity* keep_alive_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "keep_alive");
  return NULL;
}

static Entity** keep_alive_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "keep_alive");
  return NULL;
}


static void keep_alive_create_postdone(keep_alive_entity* self, Context* ctx) {
...
static Entity* keep_alive_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, keep_alive_ent_ctx(self));
  keep_alive_run_op(self, ctx, keep_alive_create_postdone, err);
  if (*err) return NULL;
...
static Entity* keep_alive_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "keep_alive");
  return NULL;
}

static Entity* keep_alive_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "keep_alive");
  return NULL;
}
...
// live record.
static void keep_alive_mark_deleted(Entity* e) {
  ((keep_alive_entity*)e)->deleted = true;
}

static bool keep_alive_deleted(Entity* e) {
  return ((keep_alive_entity*)e)->deleted;
}
