// MerchantPortalServicesApi entity client (generated — mirrors the rust Entity fragment).
...
typedef struct merchant_portal_services_api_entity {
...
static const char* merchant_portal_services_api_get_name(Entity* e);
...
Entity* merchant_portal_services_api_entity_new(BluefinTecsMerchantServicesSDK* client, voxgig_value* entopts) {
  ...
  merchant_portal_services_api_entity* self = (merchant_portal_services_api_entity*)calloc(1, sizeof(merchant_portal_services_api_entity));
  self->base.vt = &merchant_portal_services_api_VT;
  self->name = strdup("merchant_portal_services_api");
  self->client = client;
...
static voxgig_value* merchant_portal_services_api_run_op(merchant_portal_services_api_entity* self, Context* ctx,
                                    merchant_portal_services_api_postdone_fn post_done, PNError** err) {
...
voxgig_value* merchant_portal_services_api_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* merchant_portal_services_api_get_name(Entity* e) {
  return ((merchant_portal_services_api_entity*)e)->name;
}
...
static Entity* merchant_portal_services_api_make(Entity* e) {
  ...
  return merchant_portal_services_api_entity_new(self->client, opts);
}
...
static voxgig_value* merchant_portal_services_api_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(merchant_portal_services_api_ent_ctx(self), "SetData");
  }
  feature_hook_util(merchant_portal_services_api_ent_ctx(self), "GetData");
...
static voxgig_value* merchant_portal_services_api_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(merchant_portal_services_api_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(merchant_portal_services_api_ent_ctx(self), "GetMatch");
...
static void merchant_portal_services_api_create_postdone(merchant_portal_services_api_entity* self, Context* ctx) {
...
static const EntityVT merchant_portal_services_api_VT = {
  merchant_portal_services_api_get_name,
  ...
  merchant_portal_services_api_update,
  merchant_portal_services_api_remove,
};
