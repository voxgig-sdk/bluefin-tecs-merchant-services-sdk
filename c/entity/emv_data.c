// EmvData entity client (generated — mirrors the rust Entity fragment).
...
typedef struct emv_data_entity {
...
static const char* emv_data_get_name(Entity* e);
...
Entity* emv_data_entity_new(BluefinTecsMerchantServicesSDK* client, voxgig_value* entopts) {
  ...
  emv_data_entity* self = (emv_data_entity*)calloc(1, sizeof(emv_data_entity));
  self->base.vt = &emv_data_VT;
  self->name = strdup("emv_data");
  self->client = client;
...
static voxgig_value* emv_data_run_op(emv_data_entity* self, Context* ctx,
                                    emv_data_postdone_fn post_done, PNError** err) {
...
voxgig_value* emv_data_stream(Entity* e, const char* action, voxgig_value* args,
...
static Entity* emv_data_make(Entity* e) {
  ...
  return emv_data_entity_new(self->client, opts);
}
...
static voxgig_value* emv_data_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(emv_data_ent_ctx(self), "SetData");
  }
  feature_hook_util(emv_data_ent_ctx(self), "GetData");
...
static voxgig_value* emv_data_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(emv_data_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(emv_data_ent_ctx(self), "GetMatch");
...
static void emv_data_create_postdone(emv_data_entity* self, Context* ctx) {
