// DeactivateTerminal entity client (generated — mirrors the rust Entity fragment).
...
typedef struct deactivate_terminal_entity {
  ...
  bool deleted;
} deactivate_terminal_entity;

typedef void (*deactivate_terminal_postdone_fn)(deactivate_terminal_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT deactivate_terminal_VT;
static const char* deactivate_terminal_get_name(Entity* e);
static Entity* deactivate_terminal_make(Entity* e);
static voxgig_value* deactivate_terminal_data(Entity* e, voxgig_value* args);
static voxgig_value* deactivate_terminal_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* deactivate_terminal_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** deactivate_terminal_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* deactivate_terminal_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* deactivate_terminal_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* deactivate_terminal_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void deactivate_terminal_mark_deleted(Entity* e);
static bool deactivate_terminal_deleted(Entity* e);

static Context* deactivate_terminal_ent_ctx(deactivate_terminal_entity* self) {
  return self->entctx;
}
...
Entity* deactivate_terminal_entity_new(BluefinTecsMerchantServicesSDK* client, voxgig_value* entopts) {
  ...
  deactivate_terminal_entity* self = (deactivate_terminal_entity*)calloc(1, sizeof(deactivate_terminal_entity));
  self->base.vt = &deactivate_terminal_VT;
  self->name = strdup("deactivate_terminal");
  self->client = client;
...
static voxgig_value* deactivate_terminal_run_op(deactivate_terminal_entity* self, Context* ctx,
                                    deactivate_terminal_postdone_fn post_done, PNError** err) {
...
voxgig_value* deactivate_terminal_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  deactivate_terminal_entity* self = (deactivate_terminal_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, deactivate_terminal_ent_ctx(self));
...
static const char* deactivate_terminal_get_name(Entity* e) {
  return ((deactivate_terminal_entity*)e)->name;
}
...
static Entity* deactivate_terminal_make(Entity* e) {
  ...
  return deactivate_terminal_entity_new(self->client, opts);
}
...
static voxgig_value* deactivate_terminal_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(deactivate_terminal_ent_ctx(self), "SetData");
  }
  feature_hook_util(deactivate_terminal_ent_ctx(self), "GetData");
...
static voxgig_value* deactivate_terminal_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(deactivate_terminal_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(deactivate_terminal_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static Entity* deactivate_terminal_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "deactivate_terminal");
  return NULL;
}

static Entity** deactivate_terminal_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "deactivate_terminal");
  return NULL;
}


static void deactivate_terminal_create_postdone(deactivate_terminal_entity* self, Context* ctx) {
...
static Entity* deactivate_terminal_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, deactivate_terminal_ent_ctx(self));
  deactivate_terminal_run_op(self, ctx, deactivate_terminal_create_postdone, err);
  if (*err) return NULL;
...
static Entity* deactivate_terminal_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "deactivate_terminal");
  return NULL;
}

static Entity* deactivate_terminal_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "deactivate_terminal");
  return NULL;
}
...
// live record.
static void deactivate_terminal_mark_deleted(Entity* e) {
  ((deactivate_terminal_entity*)e)->deleted = true;
}

static bool deactivate_terminal_deleted(Entity* e) {
  return ((deactivate_terminal_entity*)e)->deleted;
}

static const EntityVT deactivate_terminal_VT = {
  deactivate_terminal_get_name,
  deactivate_terminal_make,
  deactivate_terminal_data,
  deactivate_terminal_matchv,
  deactivate_terminal_mark_deleted,
  deactivate_terminal_deleted,
  deactivate_terminal_load,
  deactivate_terminal_list,
  deactivate_terminal_create,
  deactivate_terminal_update,
  deactivate_terminal_remove,
};
