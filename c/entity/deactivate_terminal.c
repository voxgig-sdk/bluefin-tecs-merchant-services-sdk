...
static voxgig_value* deactivate_terminal_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* deactivate_terminal_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* deactivate_terminal_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* deactivate_terminal_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* deactivate_terminal_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
...
static voxgig_value* deactivate_terminal_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "deactivate_terminal");
  return NULL;
}

static voxgig_value* deactivate_terminal_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
...
static voxgig_value* deactivate_terminal_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, deactivate_terminal_ent_ctx(self));
  return deactivate_terminal_run_op(self, ctx, deactivate_terminal_create_postdone, err);
}


static voxgig_value* deactivate_terminal_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "deactivate_terminal");
  return NULL;
}

static voxgig_value* deactivate_terminal_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
