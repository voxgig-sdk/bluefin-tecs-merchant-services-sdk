// UpdateTemplateXml entity client (generated — mirrors the rust Entity fragment).
...
typedef struct update_template_xml_entity {
...
static const char* update_template_xml_get_name(Entity* e);
...
Entity* update_template_xml_entity_new(BluefinTecsMerchantServicesSDK* client, voxgig_value* entopts) {
  ...
  update_template_xml_entity* self = (update_template_xml_entity*)calloc(1, sizeof(update_template_xml_entity));
  self->base.vt = &update_template_xml_VT;
  self->name = strdup("update_template_xml");
  self->client = client;
...
static voxgig_value* update_template_xml_run_op(update_template_xml_entity* self, Context* ctx,
                                    update_template_xml_postdone_fn post_done, PNError** err) {
...
voxgig_value* update_template_xml_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* update_template_xml_get_name(Entity* e) {
  return ((update_template_xml_entity*)e)->name;
}
...
static Entity* update_template_xml_make(Entity* e) {
  ...
  return update_template_xml_entity_new(self->client, opts);
}
...
static voxgig_value* update_template_xml_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(update_template_xml_ent_ctx(self), "SetData");
  }
  feature_hook_util(update_template_xml_ent_ctx(self), "GetData");
...
static voxgig_value* update_template_xml_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(update_template_xml_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(update_template_xml_ent_ctx(self), "GetMatch");
...
static void update_template_xml_create_postdone(update_template_xml_entity* self, Context* ctx) {
...
static const EntityVT update_template_xml_VT = {
  ...
  update_template_xml_update,
  update_template_xml_remove,
};
