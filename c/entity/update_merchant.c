// UpdateMerchant entity client (generated — mirrors the rust Entity fragment).
...
typedef struct update_merchant_entity {
...
static const char* update_merchant_get_name(Entity* e);
...
Entity* update_merchant_entity_new(BluefinTecsMerchantServicesSDK* client, voxgig_value* entopts) {
  ...
  update_merchant_entity* self = (update_merchant_entity*)calloc(1, sizeof(update_merchant_entity));
  self->base.vt = &update_merchant_VT;
  self->name = strdup("update_merchant");
  self->client = client;
...
static voxgig_value* update_merchant_run_op(update_merchant_entity* self, Context* ctx,
                                    update_merchant_postdone_fn post_done, PNError** err) {
...
voxgig_value* update_merchant_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* update_merchant_get_name(Entity* e) {
  return ((update_merchant_entity*)e)->name;
}
...
static Entity* update_merchant_make(Entity* e) {
  ...
  return update_merchant_entity_new(self->client, opts);
}
...
static voxgig_value* update_merchant_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(update_merchant_ent_ctx(self), "SetData");
  }
  feature_hook_util(update_merchant_ent_ctx(self), "GetData");
...
static voxgig_value* update_merchant_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(update_merchant_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(update_merchant_ent_ctx(self), "GetMatch");
...
static void update_merchant_create_postdone(update_merchant_entity* self, Context* ctx) {
...
static const EntityVT update_merchant_VT = {
  ...
  update_merchant_update,
  update_merchant_remove,
};
