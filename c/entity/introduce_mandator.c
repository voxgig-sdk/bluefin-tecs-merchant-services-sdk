// IntroduceMandator entity client (generated — mirrors the rust Entity fragment).
...
typedef struct introduce_mandator_entity {
...
static const char* introduce_mandator_get_name(Entity* e);
...
Entity* introduce_mandator_entity_new(BluefinTecsMerchantServicesSDK* client, voxgig_value* entopts) {
  ...
  introduce_mandator_entity* self = (introduce_mandator_entity*)calloc(1, sizeof(introduce_mandator_entity));
  self->base.vt = &introduce_mandator_VT;
  self->name = strdup("introduce_mandator");
  self->client = client;
...
static voxgig_value* introduce_mandator_run_op(introduce_mandator_entity* self, Context* ctx,
                                    introduce_mandator_postdone_fn post_done, PNError** err) {
...
voxgig_value* introduce_mandator_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* introduce_mandator_get_name(Entity* e) {
  return ((introduce_mandator_entity*)e)->name;
}
...
static Entity* introduce_mandator_make(Entity* e) {
  ...
  return introduce_mandator_entity_new(self->client, opts);
}
...
static voxgig_value* introduce_mandator_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(introduce_mandator_ent_ctx(self), "SetData");
  }
  feature_hook_util(introduce_mandator_ent_ctx(self), "GetData");
...
static voxgig_value* introduce_mandator_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(introduce_mandator_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(introduce_mandator_ent_ctx(self), "GetMatch");
...
static void introduce_mandator_create_postdone(introduce_mandator_entity* self, Context* ctx) {
...
static const EntityVT introduce_mandator_VT = {
  ...
  introduce_mandator_update,
  introduce_mandator_remove,
};
