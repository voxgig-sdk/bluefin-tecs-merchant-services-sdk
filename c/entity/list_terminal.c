// ListTerminal entity client (generated — mirrors the rust Entity fragment).
...
typedef struct list_terminal_entity {
...
static const char* list_terminal_get_name(Entity* e);
...
Entity* list_terminal_entity_new(BluefinTecsMerchantServicesSDK* client, voxgig_value* entopts) {
  ...
  list_terminal_entity* self = (list_terminal_entity*)calloc(1, sizeof(list_terminal_entity));
  self->base.vt = &list_terminal_VT;
  self->name = strdup("list_terminal");
  self->client = client;
...
static voxgig_value* list_terminal_run_op(list_terminal_entity* self, Context* ctx,
                                    list_terminal_postdone_fn post_done, PNError** err) {
...
voxgig_value* list_terminal_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* list_terminal_get_name(Entity* e) {
  return ((list_terminal_entity*)e)->name;
}
...
static Entity* list_terminal_make(Entity* e) {
  ...
  return list_terminal_entity_new(self->client, opts);
}
...
static voxgig_value* list_terminal_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(list_terminal_ent_ctx(self), "SetData");
  }
  feature_hook_util(list_terminal_ent_ctx(self), "GetData");
...
static voxgig_value* list_terminal_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(list_terminal_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(list_terminal_ent_ctx(self), "GetMatch");
...
static void list_terminal_create_postdone(list_terminal_entity* self, Context* ctx) {
...
static const EntityVT list_terminal_VT = {
  ...
  list_terminal_update,
  list_terminal_remove,
};
