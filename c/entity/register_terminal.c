// RegisterTerminal entity client (generated — mirrors the rust Entity fragment).
...
typedef struct register_terminal_entity {
  ...
  bool deleted;
} register_terminal_entity;

typedef void (*register_terminal_postdone_fn)(register_terminal_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT register_terminal_VT;
static const char* register_terminal_get_name(Entity* e);
static Entity* register_terminal_make(Entity* e);
static voxgig_value* register_terminal_data(Entity* e, voxgig_value* args);
static voxgig_value* register_terminal_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* register_terminal_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** register_terminal_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* register_terminal_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* register_terminal_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* register_terminal_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void register_terminal_mark_deleted(Entity* e);
static bool register_terminal_deleted(Entity* e);

static Context* register_terminal_ent_ctx(register_terminal_entity* self) {
  return self->entctx;
}
...
Entity* register_terminal_entity_new(BluefinTecsMerchantServicesSDK* client, voxgig_value* entopts) {
  ...
  register_terminal_entity* self = (register_terminal_entity*)calloc(1, sizeof(register_terminal_entity));
  self->base.vt = &register_terminal_VT;
  self->name = strdup("register_terminal");
  self->client = client;
...
static voxgig_value* register_terminal_run_op(register_terminal_entity* self, Context* ctx,
                                    register_terminal_postdone_fn post_done, PNError** err) {
...
voxgig_value* register_terminal_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  register_terminal_entity* self = (register_terminal_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, register_terminal_ent_ctx(self));
...
static const char* register_terminal_get_name(Entity* e) {
  return ((register_terminal_entity*)e)->name;
}
...
static Entity* register_terminal_make(Entity* e) {
  ...
  return register_terminal_entity_new(self->client, opts);
}
...
static voxgig_value* register_terminal_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(register_terminal_ent_ctx(self), "SetData");
  }
  feature_hook_util(register_terminal_ent_ctx(self), "GetData");
...
static voxgig_value* register_terminal_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(register_terminal_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(register_terminal_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static Entity* register_terminal_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "register_terminal");
  return NULL;
}

static Entity** register_terminal_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "register_terminal");
  return NULL;
}


static void register_terminal_create_postdone(register_terminal_entity* self, Context* ctx) {
...
static Entity* register_terminal_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, register_terminal_ent_ctx(self));
  register_terminal_run_op(self, ctx, register_terminal_create_postdone, err);
  if (*err) return NULL;
...
static Entity* register_terminal_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "register_terminal");
  return NULL;
}

static Entity* register_terminal_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "register_terminal");
  return NULL;
}
...
// live record.
static void register_terminal_mark_deleted(Entity* e) {
  ((register_terminal_entity*)e)->deleted = true;
}

static bool register_terminal_deleted(Entity* e) {
  return ((register_terminal_entity*)e)->deleted;
}

static const EntityVT register_terminal_VT = {
  register_terminal_get_name,
  register_terminal_make,
  register_terminal_data,
  register_terminal_matchv,
  register_terminal_mark_deleted,
  register_terminal_deleted,
  register_terminal_load,
  register_terminal_list,
  register_terminal_create,
  register_terminal_update,
  register_terminal_remove,
};
