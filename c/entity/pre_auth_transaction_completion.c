// PreAuthTransactionCompletion entity client (generated — mirrors the rust Entity fragment).
...
typedef struct pre_auth_transaction_completion_entity {
...
static const char* pre_auth_transaction_completion_get_name(Entity* e);
...
Entity* pre_auth_transaction_completion_entity_new(BluefinTecsMerchantServicesSDK* client, voxgig_value* entopts) {
  ...
  pre_auth_transaction_completion_entity* self = (pre_auth_transaction_completion_entity*)calloc(1, sizeof(pre_auth_transaction_completion_entity));
  self->base.vt = &pre_auth_transaction_completion_VT;
  self->name = strdup("pre_auth_transaction_completion");
  self->client = client;
...
static voxgig_value* pre_auth_transaction_completion_run_op(pre_auth_transaction_completion_entity* self, Context* ctx,
                                    pre_auth_transaction_completion_postdone_fn post_done, PNError** err) {
...
voxgig_value* pre_auth_transaction_completion_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* pre_auth_transaction_completion_get_name(Entity* e) {
  return ((pre_auth_transaction_completion_entity*)e)->name;
}
...
static Entity* pre_auth_transaction_completion_make(Entity* e) {
  ...
  return pre_auth_transaction_completion_entity_new(self->client, opts);
}
...
static voxgig_value* pre_auth_transaction_completion_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(pre_auth_transaction_completion_ent_ctx(self), "SetData");
  }
  feature_hook_util(pre_auth_transaction_completion_ent_ctx(self), "GetData");
...
static voxgig_value* pre_auth_transaction_completion_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(pre_auth_transaction_completion_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(pre_auth_transaction_completion_ent_ctx(self), "GetMatch");
...
static void pre_auth_transaction_completion_create_postdone(pre_auth_transaction_completion_entity* self, Context* ctx) {
...
static const EntityVT pre_auth_transaction_completion_VT = {
  pre_auth_transaction_completion_get_name,
  ...
  pre_auth_transaction_completion_update,
  pre_auth_transaction_completion_remove,
};
