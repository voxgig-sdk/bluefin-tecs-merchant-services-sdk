// TransactionsCount entity client (generated — mirrors the rust Entity fragment).
...
typedef struct transactions_count_entity {
...
static const char* transactions_count_get_name(Entity* e);
...
Entity* transactions_count_entity_new(BluefinTecsMerchantServicesSDK* client, voxgig_value* entopts) {
  ...
  transactions_count_entity* self = (transactions_count_entity*)calloc(1, sizeof(transactions_count_entity));
  self->base.vt = &transactions_count_VT;
  self->name = strdup("transactions_count");
  self->client = client;
...
static voxgig_value* transactions_count_run_op(transactions_count_entity* self, Context* ctx,
                                    transactions_count_postdone_fn post_done, PNError** err) {
...
voxgig_value* transactions_count_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* transactions_count_get_name(Entity* e) {
  return ((transactions_count_entity*)e)->name;
}
...
static Entity* transactions_count_make(Entity* e) {
  ...
  return transactions_count_entity_new(self->client, opts);
}
...
static voxgig_value* transactions_count_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(transactions_count_ent_ctx(self), "SetData");
  }
  feature_hook_util(transactions_count_ent_ctx(self), "GetData");
...
static voxgig_value* transactions_count_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(transactions_count_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(transactions_count_ent_ctx(self), "GetMatch");
...
static void transactions_count_create_postdone(transactions_count_entity* self, Context* ctx) {
...
static const EntityVT transactions_count_VT = {
  ...
  transactions_count_update,
  transactions_count_remove,
};
