// MandatorClearingExport entity client (generated — mirrors the rust Entity fragment).
...
typedef struct mandator_clearing_export_entity {
  ...
  bool deleted;
} mandator_clearing_export_entity;

typedef void (*mandator_clearing_export_postdone_fn)(mandator_clearing_export_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT mandator_clearing_export_VT;
static const char* mandator_clearing_export_get_name(Entity* e);
static Entity* mandator_clearing_export_make(Entity* e);
static voxgig_value* mandator_clearing_export_data(Entity* e, voxgig_value* args);
static voxgig_value* mandator_clearing_export_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* mandator_clearing_export_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** mandator_clearing_export_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* mandator_clearing_export_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* mandator_clearing_export_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* mandator_clearing_export_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void mandator_clearing_export_mark_deleted(Entity* e);
static bool mandator_clearing_export_deleted(Entity* e);

static Context* mandator_clearing_export_ent_ctx(mandator_clearing_export_entity* self) {
  return self->entctx;
}
...
Entity* mandator_clearing_export_entity_new(BluefinTecsMerchantServicesSDK* client, voxgig_value* entopts) {
  ...
  mandator_clearing_export_entity* self = (mandator_clearing_export_entity*)calloc(1, sizeof(mandator_clearing_export_entity));
  self->base.vt = &mandator_clearing_export_VT;
  self->name = strdup("mandator_clearing_export");
  self->client = client;
...
static voxgig_value* mandator_clearing_export_run_op(mandator_clearing_export_entity* self, Context* ctx,
                                    mandator_clearing_export_postdone_fn post_done, PNError** err) {
...
voxgig_value* mandator_clearing_export_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  mandator_clearing_export_entity* self = (mandator_clearing_export_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, mandator_clearing_export_ent_ctx(self));
...
static const char* mandator_clearing_export_get_name(Entity* e) {
  return ((mandator_clearing_export_entity*)e)->name;
}
...
static Entity* mandator_clearing_export_make(Entity* e) {
  ...
  return mandator_clearing_export_entity_new(self->client, opts);
}
...
static voxgig_value* mandator_clearing_export_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(mandator_clearing_export_ent_ctx(self), "SetData");
  }
  feature_hook_util(mandator_clearing_export_ent_ctx(self), "GetData");
...
static voxgig_value* mandator_clearing_export_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(mandator_clearing_export_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(mandator_clearing_export_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static Entity* mandator_clearing_export_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "mandator_clearing_export");
  return NULL;
}

static Entity** mandator_clearing_export_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "mandator_clearing_export");
  return NULL;
}


static void mandator_clearing_export_create_postdone(mandator_clearing_export_entity* self, Context* ctx) {
...
static Entity* mandator_clearing_export_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, mandator_clearing_export_ent_ctx(self));
  mandator_clearing_export_run_op(self, ctx, mandator_clearing_export_create_postdone, err);
  if (*err) return NULL;
...
static Entity* mandator_clearing_export_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "mandator_clearing_export");
  return NULL;
}

static Entity* mandator_clearing_export_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "mandator_clearing_export");
  return NULL;
}
...
// live record.
static void mandator_clearing_export_mark_deleted(Entity* e) {
  ((mandator_clearing_export_entity*)e)->deleted = true;
}

static bool mandator_clearing_export_deleted(Entity* e) {
  return ((mandator_clearing_export_entity*)e)->deleted;
}

static const EntityVT mandator_clearing_export_VT = {
  mandator_clearing_export_get_name,
  mandator_clearing_export_make,
  mandator_clearing_export_data,
  mandator_clearing_export_matchv,
  mandator_clearing_export_mark_deleted,
  mandator_clearing_export_deleted,
  mandator_clearing_export_load,
  mandator_clearing_export_list,
  mandator_clearing_export_create,
  mandator_clearing_export_update,
  mandator_clearing_export_remove,
};
