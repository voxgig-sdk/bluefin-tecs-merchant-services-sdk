// BluefinTecsMerchantServices SDK — umbrella runtime header (template; BluefinTecsMerchantServices tokens
...
#ifndef BLUEFINTECSMERCHANTSERVICES_SDK_H
#define BLUEFINTECSMERCHANTSERVICES_SDK_H
...
typedef struct BluefinTecsMerchantServicesSDK BluefinTecsMerchantServicesSDK;
...
// ===========================================================================
// Error (mirrors core/error.rs BluefinTecsMerchantServicesError)
// ===========================================================================

typedef struct PNError {
  char* sdk;   // "BluefinTecsMerchantServices"
...
// ===========================================================================
// Entity (vtable; mirrors core/types.rs Entity + BluefinTecsMerchantServicesEntity)
// ===========================================================================
...
typedef struct EntityVT {
  ...
  // CRUD ops (BluefinTecsMerchantServicesEntity). On error set *err and return NULL.
...
// ===========================================================================
// SDK client (mirrors Main.fragment BluefinTecsMerchantServicesSDK) — generic fields.
// ===========================================================================

struct BluefinTecsMerchantServicesSDK {
  char* mode;             // "live" | "test"
  voxgig_value* options;
  Utility* utility;
...
void sdk_features_push(BluefinTecsMerchantServicesSDK* sdk, Feature* f);
void sdk_features_insert(BluefinTecsMerchantServicesSDK* sdk, size_t i, Feature* f);
void sdk_features_replace(BluefinTecsMerchantServicesSDK* sdk, size_t i, Feature* f);

voxgig_value* sdk_options_map(BluefinTecsMerchantServicesSDK* sdk); // deep clone of options
Utility* sdk_get_utility(BluefinTecsMerchantServicesSDK* sdk);      // utility_copy
Context* sdk_get_root_ctx(BluefinTecsMerchantServicesSDK* sdk);
...
#endif // BLUEFINTECSMERCHANTSERVICES_SDK_H
