...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_ec_data_ecom(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_ec_data_ecom(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = ec_data_ecom_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_ec_data_ecom(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = ec_data_ecom_stream(pe, "list", NULL, NULL, &perr);
