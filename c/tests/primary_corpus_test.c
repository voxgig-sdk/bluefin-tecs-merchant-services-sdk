...
static Context* corpus_ctx(BluefinTecsMerchantServicesSDK* cl, voxgig_value* ctxmap) {
  CtxSpec cs;
...
static void runset(const char* name, BluefinTecsMerchantServicesSDK* cl,
                        ctxfn cf, argfn af) {
...
static BluefinTecsMerchantServicesSDK* SHARED = NULL;
...
static BluefinTecsMerchantServicesSDK* client_for(const char* section) {
