...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_ecom_parameter(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_ecom_parameter(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = ecom_parameter_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_ecom_parameter(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = ecom_parameter_stream(pe, "list", NULL, NULL, &perr);
