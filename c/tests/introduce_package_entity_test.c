...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_introduce_package(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_introduce_package(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = introduce_package_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_introduce_package(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = introduce_package_stream(pe, "list", NULL, NULL, &perr);
