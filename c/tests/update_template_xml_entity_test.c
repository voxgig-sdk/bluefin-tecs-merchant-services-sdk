...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_update_template_xml(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_update_template_xml(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = update_template_xml_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_update_template_xml(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = update_template_xml_stream(pe, "list", NULL, NULL, &perr);
