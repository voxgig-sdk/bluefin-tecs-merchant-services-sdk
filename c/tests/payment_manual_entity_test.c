...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_payment_manual(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_payment_manual(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = payment_manual_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_payment_manual(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = payment_manual_stream(pe, "list", NULL, NULL, &perr);
