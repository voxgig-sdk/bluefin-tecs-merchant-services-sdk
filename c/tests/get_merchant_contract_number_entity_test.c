...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_get_merchant_contract_number(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    voxgig_value* seed = cmap(1, "entity",
      cmap(1, "get_merchant_contract_number",
        cmap(2,
    ...
    Entity* se = bluefin_tecs_merchant_services_get_merchant_contract_number(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = get_merchant_contract_number_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_get_merchant_contract_number(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = get_merchant_contract_number_stream(pe, "list", NULL, NULL, &perr);
