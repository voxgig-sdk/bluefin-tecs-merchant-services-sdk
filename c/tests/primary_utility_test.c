...
static BluefinTecsMerchantServicesSDK* C;
static Utility* U;
...
static void test_primary_fetcher_live(void) {
  ...
  BluefinTecsMerchantServicesSDK* live = bluefintecsmerchantservices_sdk_new(
...
static void test_primary_fetcher_blocked_test_mode(void) {
  BluefinTecsMerchantServicesSDK* blocked = bluefintecsmerchantservices_sdk_new(
...
static void test_primary_new_sdk_smoke(void) {
  BluefinTecsMerchantServicesSDK* client = bluefintecsmerchantservices_sdk_new(v_undef());
