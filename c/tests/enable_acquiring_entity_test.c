...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_enable_acquiring(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_enable_acquiring(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = enable_acquiring_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_enable_acquiring(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = enable_acquiring_stream(pe, "list", NULL, NULL, &perr);
