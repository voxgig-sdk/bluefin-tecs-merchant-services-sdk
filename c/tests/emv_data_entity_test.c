...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_emv_data(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_emv_data(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = emv_data_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_emv_data(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = emv_data_stream(pe, "list", NULL, NULL, &perr);
