...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_transactions_turnover(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_transactions_turnover(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = transactions_turnover_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_transactions_turnover(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = transactions_turnover_stream(pe, "list", NULL, NULL, &perr);
