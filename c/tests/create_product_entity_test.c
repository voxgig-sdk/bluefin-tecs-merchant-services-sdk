...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_create_product(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_create_product(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = create_product_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_create_product(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = create_product_stream(pe, "list", NULL, NULL, &perr);
