// Generated instance test for the register_tecs_company entity.
...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_register_tecs_company(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "register_tecs_company", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_register_tecs_company(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = register_tecs_company_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_register_tecs_company(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = register_tecs_company_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("register_tecs_company_entity");
}
