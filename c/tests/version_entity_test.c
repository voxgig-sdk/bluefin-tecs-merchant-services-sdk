...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_version(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_version(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = version_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_version(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = version_stream(pe, "list", NULL, NULL, &perr);
