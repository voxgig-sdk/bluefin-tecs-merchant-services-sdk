// Generated instance test for the mandator_clearing_export_summary entity.
...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_mandator_clearing_export_summary(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "mandator_clearing_export_summary", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    voxgig_value* seed = cmap(1, "entity",
      cmap(1, "mandator_clearing_export_summary",
        cmap(2,
    ...
    Entity* se = bluefin_tecs_merchant_services_mandator_clearing_export_summary(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = mandator_clearing_export_summary_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_mandator_clearing_export_summary(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = mandator_clearing_export_summary_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("mandator_clearing_export_summary_entity");
}
