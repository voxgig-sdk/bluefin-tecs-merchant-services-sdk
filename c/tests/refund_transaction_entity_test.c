...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_refund_transaction(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_refund_transaction(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = refund_transaction_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_refund_transaction(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = refund_transaction_stream(pe, "list", NULL, NULL, &perr);
