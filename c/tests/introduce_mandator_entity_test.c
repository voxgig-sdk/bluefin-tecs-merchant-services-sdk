...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_introduce_mandator(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_introduce_mandator(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = introduce_mandator_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_introduce_mandator(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = introduce_mandator_stream(pe, "list", NULL, NULL, &perr);
