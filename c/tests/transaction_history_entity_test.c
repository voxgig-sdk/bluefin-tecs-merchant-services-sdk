...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_transaction_history(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_transaction_history(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = transaction_history_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_transaction_history(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = transaction_history_stream(pe, "list", NULL, NULL, &perr);
