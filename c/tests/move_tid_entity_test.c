...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_move_tid(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_move_tid(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = move_tid_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_move_tid(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = move_tid_stream(pe, "list", NULL, NULL, &perr);
