// Generated instance test for the transactions_count_card_brand entity.
...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_transactions_count_card_brand(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "transactions_count_card_brand", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    voxgig_value* seed = cmap(1, "entity",
      cmap(1, "transactions_count_card_brand",
        cmap(2,
    ...
    Entity* se = bluefin_tecs_merchant_services_transactions_count_card_brand(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = transactions_count_card_brand_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_transactions_count_card_brand(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = transactions_count_card_brand_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("transactions_count_card_brand_entity");
}
