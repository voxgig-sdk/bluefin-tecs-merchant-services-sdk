...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_store_terminal_parameter(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    voxgig_value* seed = cmap(1, "entity",
      cmap(1, "store_terminal_parameter",
        cmap(2,
    ...
    Entity* se = bluefin_tecs_merchant_services_store_terminal_parameter(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = store_terminal_parameter_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_store_terminal_parameter(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = store_terminal_parameter_stream(pe, "list", NULL, NULL, &perr);
