...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_check_card_black_listed(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    voxgig_value* seed = cmap(1, "entity",
      cmap(1, "check_card_black_listed",
        cmap(2,
    ...
    Entity* se = bluefin_tecs_merchant_services_check_card_black_listed(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = check_card_black_listed_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_check_card_black_listed(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = check_card_black_listed_stream(pe, "list", NULL, NULL, &perr);
