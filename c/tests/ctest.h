// Minimal C test harness for the BluefinTecsMerchantServices SDK test binaries. Each test
...
#ifndef BLUEFINTECSMERCHANTSERVICES_CTEST_H
#define BLUEFINTECSMERCHANTSERVICES_CTEST_H
...
#endif // BLUEFINTECSMERCHANTSERVICES_CTEST_H
