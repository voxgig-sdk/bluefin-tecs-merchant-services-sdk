...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_merchant_portal_services_api(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    voxgig_value* seed = cmap(1, "entity",
      cmap(1, "merchant_portal_services_api",
        cmap(2,
    ...
    Entity* se = bluefin_tecs_merchant_services_merchant_portal_services_api(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = merchant_portal_services_api_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_merchant_portal_services_api(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = merchant_portal_services_api_stream(pe, "list", NULL, NULL, &perr);
