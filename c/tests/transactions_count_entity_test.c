...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_transactions_count(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_transactions_count(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = transactions_count_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_transactions_count(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = transactions_count_stream(pe, "list", NULL, NULL, &perr);
