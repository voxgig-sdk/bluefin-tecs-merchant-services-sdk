...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_pre_auth_transaction_completion(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    voxgig_value* seed = cmap(1, "entity",
      cmap(1, "pre_auth_transaction_completion",
        cmap(2,
    ...
    Entity* se = bluefin_tecs_merchant_services_pre_auth_transaction_completion(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = pre_auth_transaction_completion_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_pre_auth_transaction_completion(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = pre_auth_transaction_completion_stream(pe, "list", NULL, NULL, &perr);
