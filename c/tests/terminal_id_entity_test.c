...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_terminal_id(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_terminal_id(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = terminal_id_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_terminal_id(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = terminal_id_stream(pe, "list", NULL, NULL, &perr);
