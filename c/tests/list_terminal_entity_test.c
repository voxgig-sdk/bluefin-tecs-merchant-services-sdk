...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_list_terminal(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_list_terminal(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = list_terminal_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_list_terminal(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = list_terminal_stream(pe, "list", NULL, NULL, &perr);
