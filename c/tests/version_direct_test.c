// Generated direct-call test for the version entity (mirrors the
...
static voxgig_value* version_mock(void* ud, voxgig_value* args) {
  CALLS++;
...
static BluefinTecsMerchantServicesSDK* version_direct_setup(voxgig_value* mockres) {
...
int main(void) {
  ...
  // LOAD
  {
    ...
    BluefinTecsMerchantServicesSDK* sdk = version_direct_setup(mockres);
    voxgig_value* params = v_map();
    PNError* err = NULL;
    voxgig_value* result = sdk_direct(sdk, cmap(3,
      "path", v_str("public/version"),
      "method", v_str("GET"),
      "params", params), &err);
  ...
  TEST_SUMMARY("bluefin_tecs_merchant_services_version_direct");
}
