// Behavioural feature-test harness for the BluefinTecsMerchantServices SDK (C port of the
...
#ifndef BLUEFINTECSMERCHANTSERVICES_FEATURE_HARNESS_H
#define BLUEFINTECSMERCHANTSERVICES_FEATURE_HARNESS_H
...
#endif // BLUEFINTECSMERCHANTSERVICES_FEATURE_HARNESS_H
