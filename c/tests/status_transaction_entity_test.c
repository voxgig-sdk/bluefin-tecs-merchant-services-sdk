...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_status_transaction(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_status_transaction(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = status_transaction_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_status_transaction(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = status_transaction_stream(pe, "list", NULL, NULL, &perr);
