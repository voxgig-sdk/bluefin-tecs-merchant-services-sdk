...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_mandator_clearing_export_download(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    voxgig_value* seed = cmap(1, "entity",
      cmap(1, "mandator_clearing_export_download",
        cmap(2,
    ...
    Entity* se = bluefin_tecs_merchant_services_mandator_clearing_export_download(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = mandator_clearing_export_download_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_mandator_clearing_export_download(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = mandator_clearing_export_download_stream(pe, "list", NULL, NULL, &perr);
