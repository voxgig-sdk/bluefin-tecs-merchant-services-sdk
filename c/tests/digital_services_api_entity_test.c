...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_digital_services_api(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_digital_services_api(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = digital_services_api_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_digital_services_api(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = digital_services_api_stream(pe, "list", NULL, NULL, &perr);
