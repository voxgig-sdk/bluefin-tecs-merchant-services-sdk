...
int main(void) {
  ...
  BluefinTecsMerchantServicesSDK* t = test_sdk(NULL, NULL);
  ...
  BluefinTecsMerchantServicesSDK* sdk = bluefintecsmerchantservices_sdk_new(opts);
  ...
  BluefinTecsMerchantServicesSDK* rsdk = bluefintecsmerchantservices_sdk_new(ropts);
  PNError* rerr = NULL;
