...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_services_keep_alive(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_services_keep_alive(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = keep_alive_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_services_keep_alive(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = keep_alive_stream(pe, "list", NULL, NULL, &perr);
