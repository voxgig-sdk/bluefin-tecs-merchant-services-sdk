// BluefinTecsMerchantServices SDK — documentation dart-examples presence & completeness gate.
...
const String _sdkClass = 'BluefinTecsMerchantServicesSDK';

// The API's capitalised semantic entities, used to spot a client.<Entity>()
// factory call inside a block.
const List<String> _entities = <String>['CancelTransaction', 'CheckCardBlackListed', 'CreateProduct', 'DeactivateTerminal', 'DigitalServicesApi', 'EcDataEcom', 'EcomParameter', 'EcrData', 'EmvData', 'EnableAcquiring', 'GetMerchantContractNumber', 'GetTemplateXml', 'IntroduceMandator', 'IntroducePackage', 'KeepAlive', 'ListTerminal', 'MandatorClearingExport', 'MandatorClearingExportDownload', 'MandatorClearingExportSummary', 'MerchantPortalServicesApi', 'MoveTid', 'PaymentManual', 'PaymentSred', 'PreAuthTransactionCompletion', 'ReactivateTerminal', 'RefundTransaction', 'RegisterTecsCompany', 'RegisterTerminal', 'ReportData', 'StatusTransaction', 'StoreTerminalParameter', 'TerminalId', 'TransactionHistory', 'TransactionsCount', 'TransactionsCountCardBrand', 'TransactionsTurnover', 'UpdateMerchant', 'UpdateTemplateXml', 'Version'];
