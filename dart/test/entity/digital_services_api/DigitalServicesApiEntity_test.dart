...
void tests() {
  describe('DigitalServicesApiEntity', () {
    ...
    test('stream', (t) async {
      ...
      final plainent = plainsdk.DigitalServicesApi();
      final seen2 = [];
    ...
    test('basic', (t) async {
      ...
      for (final op in ['create', 'load']) {
        if (maybeSkipControl(t, 'entityOp', 'digital_services_api.' + op, live)) {
          return;
        }
      }
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  dynamic idmap = transform(
      <dynamic>['digital_services_api01', 'digital_services_api02', 'digital_services_api03', 'mandator_clearing_export_download01', 'mandator_clearing_export_download02', 'mandator_clearing_export_download03'],
      <String, dynamic>{
        '`\$PACK`': <dynamic>[
          '',
          <String, dynamic>{
  ...
  final idmapEnvVal =
      Platform.environment['BLUEFIN_TECS_MERCHANT_SERVICES_TEST_DIGITAL_SERVICES_API_ENTID'];
