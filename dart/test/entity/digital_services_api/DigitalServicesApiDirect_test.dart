...
Map<String, dynamic> directSetup([dynamic mockres]) {
  ...
  final env = envOverride({
    'BLUEFINTECSMERCHANTSERVICES_TEST_DIGITAL_SERVICES_API_ENTID': <String, dynamic>{},
  ...
  if (live) {
    ...
    dynamic idmap = env['BLUEFINTECSMERCHANTSERVICES_TEST_DIGITAL_SERVICES_API_ENTID'];
