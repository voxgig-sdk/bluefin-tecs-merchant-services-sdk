...
void tests() {
  describe('RefundTransactionEntity', () {
    ...
    test('stream', (t) async {
      ...
      final plainent = plainsdk.RefundTransaction();
      final seen2 = [];
    ...
    test('basic', (t) async {
      ...
      for (final op in ['create']) {
        if (maybeSkipControl(t, 'entityOp', 'refund_transaction.' + op, live)) {
          return;
        }
      }
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  dynamic idmap = transform(
      <dynamic>['refund_transaction01', 'refund_transaction02', 'refund_transaction03'],
      <String, dynamic>{
        '`\$PACK`': <dynamic>[
          '',
          <String, dynamic>{
  ...
  final idmapEnvVal =
      Platform.environment['BLUEFIN_TECS_MERCHANT_SERVICES_TEST_REFUND_TRANSACTION_ENTID'];
