...
void tests() {
  describe('IntroduceMandatorEntity', () {
    ...
    test('stream', (t) async {
      ...
      final plainent = plainsdk.IntroduceMandator();
      final seen2 = [];
    ...
    test('basic', (t) async {
      ...
      for (final op in ['create']) {
        if (maybeSkipControl(t, 'entityOp', 'introduce_mandator.' + op, live)) {
          return;
        }
      }
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  dynamic idmap = transform(
      <dynamic>['introduce_mandator01', 'introduce_mandator02', 'introduce_mandator03'],
      <String, dynamic>{
        '`\$PACK`': <dynamic>[
          '',
          <String, dynamic>{
  ...
  final idmapEnvVal =
      Platform.environment['BLUEFIN_TECS_MERCHANT_SERVICES_TEST_INTRODUCE_MANDATOR_ENTID'];
