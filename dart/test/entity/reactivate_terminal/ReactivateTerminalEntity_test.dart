...
void tests() {
  describe('ReactivateTerminalEntity', () {
    ...
    test('stream', (t) async {
      ...
      final plainent = plainsdk.ReactivateTerminal();
      final seen2 = [];
    ...
    test('basic', (t) async {
      ...
      for (final op in ['create']) {
        if (maybeSkipControl(t, 'entityOp', 'reactivate_terminal.' + op, live)) {
          return;
        }
      }
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  dynamic idmap = transform(
      <dynamic>['reactivate_terminal01', 'reactivate_terminal02', 'reactivate_terminal03'],
      <String, dynamic>{
        '`\$PACK`': <dynamic>[
          '',
          <String, dynamic>{
  ...
  final idmapEnvVal =
      Platform.environment['BLUEFIN_TECS_MERCHANT_SERVICES_TEST_REACTIVATE_TERMINAL_ENTID'];
