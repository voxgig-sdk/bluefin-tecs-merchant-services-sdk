...
void tests() {
  describe('ListTerminalEntity', () {
    ...
    test('stream', (t) async {
      ...
      final plainent = plainsdk.ListTerminal();
      final seen2 = [];
    ...
    test('basic', (t) async {
      ...
      for (final op in ['create']) {
        if (maybeSkipControl(t, 'entityOp', 'list_terminal.' + op, live)) {
          return;
        }
      }
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  dynamic idmap = transform(
      <dynamic>['list_terminal01', 'list_terminal02', 'list_terminal03'],
      <String, dynamic>{
        '`\$PACK`': <dynamic>[
          '',
          <String, dynamic>{
  ...
  final idmapEnvVal =
      Platform.environment['BLUEFIN_TECS_MERCHANT_SERVICES_TEST_LIST_TERMINAL_ENTID'];
