...
void tests() {
  describe('DeactivateTerminalEntity', () {
    ...
    test('stream', (t) async {
      ...
      final plainent = plainsdk.DeactivateTerminal();
      final seen2 = [];
    ...
    test('basic', (t) async {
      ...
      for (final op in ['create']) {
        if (maybeSkipControl(t, 'entityOp', 'deactivate_terminal.' + op, live)) {
          return;
        }
      }
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  dynamic idmap = transform(
      <dynamic>['deactivate_terminal01', 'deactivate_terminal02', 'deactivate_terminal03'],
      <String, dynamic>{
        '`\$PACK`': <dynamic>[
          '',
          <String, dynamic>{
  ...
  final idmapEnvVal =
      Platform.environment['BLUEFIN_TECS_MERCHANT_SERVICES_TEST_DEACTIVATE_TERMINAL_ENTID'];
