...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (EmvData and the per-op request/match types).
class EmvDataEntity extends BluefinTecsMerchantServicesEntityBase {
  EmvDataEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'emv_data';
    name_ = 'emv_data';
    Name = 'EmvData';
  }
  ...
  EmvDataEntity make() {
    return EmvDataEntity(client, entopts());
  }




  /// Create a EmvData (see EmvDataCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (EmvData).
