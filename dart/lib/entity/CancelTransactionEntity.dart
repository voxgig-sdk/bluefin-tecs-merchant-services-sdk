...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (CancelTransaction and the per-op request/match types).
class CancelTransactionEntity extends BluefinTecsMerchantServicesEntityBase {
  CancelTransactionEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'cancel_transaction';
    name_ = 'cancel_transaction';
    Name = 'CancelTransaction';
  }

  CancelTransactionEntity make() {
    return CancelTransactionEntity(client, entopts());
  }




  /// Create a CancelTransaction (see CancelTransactionCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (CancelTransaction).
