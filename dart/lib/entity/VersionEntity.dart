...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (Version and the per-op request/match types).
class VersionEntity extends BluefinTecsMerchantServicesEntityBase {
  VersionEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'version';
    name_ = 'version';
    Name = 'Version';
  }
  ...
  VersionEntity make() {
    return VersionEntity(client, entopts());
  }


  /// Load a Version by match (see VersionLoadMatch in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (Version).
