...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (GetTemplateXml and the per-op request/match types).
class GetTemplateXmlEntity extends BluefinTecsMerchantServicesEntityBase {
  GetTemplateXmlEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'get_template_xml';
    name_ = 'get_template_xml';
    Name = 'GetTemplateXml';
  }

  GetTemplateXmlEntity make() {
    return GetTemplateXmlEntity(client, entopts());
  }




  /// Create a GetTemplateXml (see GetTemplateXmlCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (GetTemplateXml).
