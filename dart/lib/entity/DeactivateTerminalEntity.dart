...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (DeactivateTerminal and the per-op request/match types).
class DeactivateTerminalEntity extends BluefinTecsMerchantServicesEntityBase {
  DeactivateTerminalEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'deactivate_terminal';
    name_ = 'deactivate_terminal';
    Name = 'DeactivateTerminal';
  }

  DeactivateTerminalEntity make() {
    return DeactivateTerminalEntity(client, entopts());
  }




  /// Create a DeactivateTerminal (see DeactivateTerminalCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (DeactivateTerminal).
