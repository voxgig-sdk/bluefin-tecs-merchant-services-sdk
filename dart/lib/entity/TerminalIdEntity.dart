...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (TerminalId and the per-op request/match types).
class TerminalIdEntity extends BluefinTecsMerchantServicesEntityBase {
  TerminalIdEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'terminal_id';
    name_ = 'terminal_id';
    Name = 'TerminalId';
  }

  TerminalIdEntity make() {
    return TerminalIdEntity(client, entopts());
  }




  /// Create a TerminalId (see TerminalIdCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (TerminalId).
