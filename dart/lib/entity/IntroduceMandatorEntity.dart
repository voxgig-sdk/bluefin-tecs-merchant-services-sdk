...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (IntroduceMandator and the per-op request/match types).
class IntroduceMandatorEntity extends BluefinTecsMerchantServicesEntityBase {
  IntroduceMandatorEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'introduce_mandator';
    name_ = 'introduce_mandator';
    Name = 'IntroduceMandator';
  }

  IntroduceMandatorEntity make() {
    return IntroduceMandatorEntity(client, entopts());
  }




  /// Create a IntroduceMandator (see IntroduceMandatorCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (IntroduceMandator).
