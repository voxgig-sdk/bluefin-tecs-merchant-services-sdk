...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (EcrData and the per-op request/match types).
class EcrDataEntity extends BluefinTecsMerchantServicesEntityBase {
  EcrDataEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'ecr_data';
    name_ = 'ecr_data';
    Name = 'EcrData';
  }
  ...
  EcrDataEntity make() {
    return EcrDataEntity(client, entopts());
  }




  /// Create a EcrData (see EcrDataCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (EcrData).
