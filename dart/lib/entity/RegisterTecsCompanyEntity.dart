...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (RegisterTecsCompany and the per-op request/match types).
class RegisterTecsCompanyEntity extends BluefinTecsMerchantServicesEntityBase {
  RegisterTecsCompanyEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'register_tecs_company';
    name_ = 'register_tecs_company';
    Name = 'RegisterTecsCompany';
  }

  RegisterTecsCompanyEntity make() {
    return RegisterTecsCompanyEntity(client, entopts());
  }




  /// Create a RegisterTecsCompany (see RegisterTecsCompanyCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (RegisterTecsCompany).
