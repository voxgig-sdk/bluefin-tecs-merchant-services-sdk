...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (PaymentManual and the per-op request/match types).
class PaymentManualEntity extends BluefinTecsMerchantServicesEntityBase {
  PaymentManualEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'payment_manual';
    name_ = 'payment_manual';
    Name = 'PaymentManual';
  }

  PaymentManualEntity make() {
    return PaymentManualEntity(client, entopts());
  }




  /// Create a PaymentManual (see PaymentManualCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (PaymentManual).
