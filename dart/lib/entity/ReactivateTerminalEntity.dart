...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (ReactivateTerminal and the per-op request/match types).
class ReactivateTerminalEntity extends BluefinTecsMerchantServicesEntityBase {
  ReactivateTerminalEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'reactivate_terminal';
    name_ = 'reactivate_terminal';
    Name = 'ReactivateTerminal';
  }

  ReactivateTerminalEntity make() {
    return ReactivateTerminalEntity(client, entopts());
  }




  /// Create a ReactivateTerminal (see ReactivateTerminalCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (ReactivateTerminal).
