...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (EcomParameter and the per-op request/match types).
class EcomParameterEntity extends BluefinTecsMerchantServicesEntityBase {
  EcomParameterEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'ecom_parameter';
    name_ = 'ecom_parameter';
    Name = 'EcomParameter';
  }

  EcomParameterEntity make() {
    return EcomParameterEntity(client, entopts());
  }




  /// Create a EcomParameter (see EcomParameterCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (EcomParameter).
