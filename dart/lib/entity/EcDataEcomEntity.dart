...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (EcDataEcom and the per-op request/match types).
class EcDataEcomEntity extends BluefinTecsMerchantServicesEntityBase {
  EcDataEcomEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'ec_data_ecom';
    name_ = 'ec_data_ecom';
    Name = 'EcDataEcom';
  }

  EcDataEcomEntity make() {
    return EcDataEcomEntity(client, entopts());
  }




  /// Create a EcDataEcom (see EcDataEcomCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (EcDataEcom).
