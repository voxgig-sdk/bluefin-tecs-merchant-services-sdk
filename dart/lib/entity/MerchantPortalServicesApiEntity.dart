...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (MerchantPortalServicesApi and the per-op request/match types).
class MerchantPortalServicesApiEntity extends BluefinTecsMerchantServicesEntityBase {
  MerchantPortalServicesApiEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'merchant_portal_services_api';
    name_ = 'merchant_portal_services_api';
    Name = 'MerchantPortalServicesApi';
  }

  MerchantPortalServicesApiEntity make() {
    return MerchantPortalServicesApiEntity(client, entopts());
  }




  /// Create a MerchantPortalServicesApi (see MerchantPortalServicesApiCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (MerchantPortalServicesApi).
