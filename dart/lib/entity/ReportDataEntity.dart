...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (ReportData and the per-op request/match types).
class ReportDataEntity extends BluefinTecsMerchantServicesEntityBase {
  ReportDataEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'report_data';
    name_ = 'report_data';
    Name = 'ReportData';
  }

  ReportDataEntity make() {
    return ReportDataEntity(client, entopts());
  }




  /// Create a ReportData (see ReportDataCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (ReportData).
