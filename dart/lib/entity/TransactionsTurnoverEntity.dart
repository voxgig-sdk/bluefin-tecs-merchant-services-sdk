...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (TransactionsTurnover and the per-op request/match types).
class TransactionsTurnoverEntity extends BluefinTecsMerchantServicesEntityBase {
  TransactionsTurnoverEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'transactions_turnover';
    name_ = 'transactions_turnover';
    Name = 'TransactionsTurnover';
  }

  TransactionsTurnoverEntity make() {
    return TransactionsTurnoverEntity(client, entopts());
  }




  /// Create a TransactionsTurnover (see TransactionsTurnoverCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (TransactionsTurnover).
