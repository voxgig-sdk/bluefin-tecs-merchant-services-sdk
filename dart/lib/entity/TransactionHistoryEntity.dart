...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (TransactionHistory and the per-op request/match types).
class TransactionHistoryEntity extends BluefinTecsMerchantServicesEntityBase {
  TransactionHistoryEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'transaction_history';
    name_ = 'transaction_history';
    Name = 'TransactionHistory';
  }

  TransactionHistoryEntity make() {
    return TransactionHistoryEntity(client, entopts());
  }




  /// Create a TransactionHistory (see TransactionHistoryCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (TransactionHistory).
