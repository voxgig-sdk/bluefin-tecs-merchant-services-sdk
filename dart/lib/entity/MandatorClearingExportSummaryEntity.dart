...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (MandatorClearingExportSummary and the per-op request/match types).
class MandatorClearingExportSummaryEntity extends BluefinTecsMerchantServicesEntityBase {
  MandatorClearingExportSummaryEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'mandator_clearing_export_summary';
    name_ = 'mandator_clearing_export_summary';
    Name = 'MandatorClearingExportSummary';
  }

  MandatorClearingExportSummaryEntity make() {
    return MandatorClearingExportSummaryEntity(client, entopts());
  }




  /// Create a MandatorClearingExportSummary (see MandatorClearingExportSummaryCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (MandatorClearingExportSummary).
