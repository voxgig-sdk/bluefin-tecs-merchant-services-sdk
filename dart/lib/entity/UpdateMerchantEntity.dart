...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (UpdateMerchant and the per-op request/match types).
class UpdateMerchantEntity extends BluefinTecsMerchantServicesEntityBase {
  UpdateMerchantEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'update_merchant';
    name_ = 'update_merchant';
    Name = 'UpdateMerchant';
  }

  UpdateMerchantEntity make() {
    return UpdateMerchantEntity(client, entopts());
  }




  /// Create a UpdateMerchant (see UpdateMerchantCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (UpdateMerchant).
