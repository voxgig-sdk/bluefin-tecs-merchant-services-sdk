...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (KeepAlive and the per-op request/match types).
class KeepAliveEntity extends BluefinTecsMerchantServicesEntityBase {
  KeepAliveEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'keep_alive';
    name_ = 'keep_alive';
    Name = 'KeepAlive';
  }

  KeepAliveEntity make() {
    return KeepAliveEntity(client, entopts());
  }




  /// Create a KeepAlive (see KeepAliveCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (KeepAlive).
