...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (UpdateTemplateXml and the per-op request/match types).
class UpdateTemplateXmlEntity extends BluefinTecsMerchantServicesEntityBase {
  UpdateTemplateXmlEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'update_template_xml';
    name_ = 'update_template_xml';
    Name = 'UpdateTemplateXml';
  }

  UpdateTemplateXmlEntity make() {
    return UpdateTemplateXmlEntity(client, entopts());
  }




  /// Create a UpdateTemplateXml (see UpdateTemplateXmlCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (UpdateTemplateXml).
