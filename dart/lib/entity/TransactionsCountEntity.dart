...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (TransactionsCount and the per-op request/match types).
class TransactionsCountEntity extends BluefinTecsMerchantServicesEntityBase {
  TransactionsCountEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'transactions_count';
    name_ = 'transactions_count';
    Name = 'TransactionsCount';
  }

  TransactionsCountEntity make() {
    return TransactionsCountEntity(client, entopts());
  }




  /// Create a TransactionsCount (see TransactionsCountCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (TransactionsCount).
