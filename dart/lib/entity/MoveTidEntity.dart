...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (MoveTid and the per-op request/match types).
class MoveTidEntity extends BluefinTecsMerchantServicesEntityBase {
  MoveTidEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'move_tid';
    name_ = 'move_tid';
    Name = 'MoveTid';
  }
  ...
  MoveTidEntity make() {
    return MoveTidEntity(client, entopts());
  }




  /// Create a MoveTid (see MoveTidCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (MoveTid).
