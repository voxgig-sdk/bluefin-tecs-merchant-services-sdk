...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (CreateProduct and the per-op request/match types).
class CreateProductEntity extends BluefinTecsMerchantServicesEntityBase {
  CreateProductEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'create_product';
    name_ = 'create_product';
    Name = 'CreateProduct';
  }

  CreateProductEntity make() {
    return CreateProductEntity(client, entopts());
  }




  /// Create a CreateProduct (see CreateProductCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (CreateProduct).
