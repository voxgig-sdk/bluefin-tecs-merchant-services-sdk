...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (CheckCardBlackListed and the per-op request/match types).
class CheckCardBlackListedEntity extends BluefinTecsMerchantServicesEntityBase {
  CheckCardBlackListedEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'check_card_black_listed';
    name_ = 'check_card_black_listed';
    Name = 'CheckCardBlackListed';
  }

  CheckCardBlackListedEntity make() {
    return CheckCardBlackListedEntity(client, entopts());
  }




  /// Create a CheckCardBlackListed (see CheckCardBlackListedCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (CheckCardBlackListed).
