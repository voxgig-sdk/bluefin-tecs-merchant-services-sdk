...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (MandatorClearingExport and the per-op request/match types).
class MandatorClearingExportEntity extends BluefinTecsMerchantServicesEntityBase {
  MandatorClearingExportEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'mandator_clearing_export';
    name_ = 'mandator_clearing_export';
    Name = 'MandatorClearingExport';
  }

  MandatorClearingExportEntity make() {
    return MandatorClearingExportEntity(client, entopts());
  }




  /// Create a MandatorClearingExport (see MandatorClearingExportCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (MandatorClearingExport).
