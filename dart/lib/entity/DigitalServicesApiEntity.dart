...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (DigitalServicesApi and the per-op request/match types).
class DigitalServicesApiEntity extends BluefinTecsMerchantServicesEntityBase {
  DigitalServicesApiEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'digital_services_api';
    name_ = 'digital_services_api';
    Name = 'DigitalServicesApi';
  }

  DigitalServicesApiEntity make() {
    return DigitalServicesApiEntity(client, entopts());
  }


  /// Load a DigitalServicesApi by match (see DigitalServicesApiLoadMatch in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (DigitalServicesApi).
  ...
  /// Create a DigitalServicesApi (see DigitalServicesApiCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (DigitalServicesApi).
