...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (RefundTransaction and the per-op request/match types).
class RefundTransactionEntity extends BluefinTecsMerchantServicesEntityBase {
  RefundTransactionEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'refund_transaction';
    name_ = 'refund_transaction';
    Name = 'RefundTransaction';
  }

  RefundTransactionEntity make() {
    return RefundTransactionEntity(client, entopts());
  }




  /// Create a RefundTransaction (see RefundTransactionCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (RefundTransaction).
