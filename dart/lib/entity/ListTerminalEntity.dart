...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (ListTerminal and the per-op request/match types).
class ListTerminalEntity extends BluefinTecsMerchantServicesEntityBase {
  ListTerminalEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'list_terminal';
    name_ = 'list_terminal';
    Name = 'ListTerminal';
  }

  ListTerminalEntity make() {
    return ListTerminalEntity(client, entopts());
  }




  /// Create a ListTerminal (see ListTerminalCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (ListTerminal).
