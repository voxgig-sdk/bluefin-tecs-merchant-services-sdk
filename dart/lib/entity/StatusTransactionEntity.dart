...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (StatusTransaction and the per-op request/match types).
class StatusTransactionEntity extends BluefinTecsMerchantServicesEntityBase {
  StatusTransactionEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'status_transaction';
    name_ = 'status_transaction';
    Name = 'StatusTransaction';
  }

  StatusTransactionEntity make() {
    return StatusTransactionEntity(client, entopts());
  }




  /// Create a StatusTransaction (see StatusTransactionCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (StatusTransaction).
