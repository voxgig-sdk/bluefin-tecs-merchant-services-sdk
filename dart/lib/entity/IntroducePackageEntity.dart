...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (IntroducePackage and the per-op request/match types).
class IntroducePackageEntity extends BluefinTecsMerchantServicesEntityBase {
  IntroducePackageEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'introduce_package';
    name_ = 'introduce_package';
    Name = 'IntroducePackage';
  }

  IntroducePackageEntity make() {
    return IntroducePackageEntity(client, entopts());
  }




  /// Create a IntroducePackage (see IntroducePackageCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (IntroducePackage).
