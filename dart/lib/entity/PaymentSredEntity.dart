...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (PaymentSred and the per-op request/match types).
class PaymentSredEntity extends BluefinTecsMerchantServicesEntityBase {
  PaymentSredEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'payment_sred';
    name_ = 'payment_sred';
    Name = 'PaymentSred';
  }

  PaymentSredEntity make() {
    return PaymentSredEntity(client, entopts());
  }




  /// Create a PaymentSred (see PaymentSredCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (PaymentSred).
