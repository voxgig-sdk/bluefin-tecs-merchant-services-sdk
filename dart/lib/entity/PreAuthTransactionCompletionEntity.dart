...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (PreAuthTransactionCompletion and the per-op request/match types).
class PreAuthTransactionCompletionEntity extends BluefinTecsMerchantServicesEntityBase {
  PreAuthTransactionCompletionEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'pre_auth_transaction_completion';
    name_ = 'pre_auth_transaction_completion';
    Name = 'PreAuthTransactionCompletion';
  }

  PreAuthTransactionCompletionEntity make() {
    return PreAuthTransactionCompletionEntity(client, entopts());
  }




  /// Create a PreAuthTransactionCompletion (see PreAuthTransactionCompletionCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (PreAuthTransactionCompletion).
