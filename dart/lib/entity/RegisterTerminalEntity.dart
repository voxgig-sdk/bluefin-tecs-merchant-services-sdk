...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (RegisterTerminal and the per-op request/match types).
class RegisterTerminalEntity extends BluefinTecsMerchantServicesEntityBase {
  RegisterTerminalEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'register_terminal';
    name_ = 'register_terminal';
    Name = 'RegisterTerminal';
  }

  RegisterTerminalEntity make() {
    return RegisterTerminalEntity(client, entopts());
  }




  /// Create a RegisterTerminal (see RegisterTerminalCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (RegisterTerminal).
