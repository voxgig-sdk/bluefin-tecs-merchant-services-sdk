...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (EnableAcquiring and the per-op request/match types).
class EnableAcquiringEntity extends BluefinTecsMerchantServicesEntityBase {
  EnableAcquiringEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'enable_acquiring';
    name_ = 'enable_acquiring';
    Name = 'EnableAcquiring';
  }

  EnableAcquiringEntity make() {
    return EnableAcquiringEntity(client, entopts());
  }




  /// Create a EnableAcquiring (see EnableAcquiringCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (EnableAcquiring).
