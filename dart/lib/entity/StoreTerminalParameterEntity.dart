...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (StoreTerminalParameter and the per-op request/match types).
class StoreTerminalParameterEntity extends BluefinTecsMerchantServicesEntityBase {
  StoreTerminalParameterEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'store_terminal_parameter';
    name_ = 'store_terminal_parameter';
    Name = 'StoreTerminalParameter';
  }

  StoreTerminalParameterEntity make() {
    return StoreTerminalParameterEntity(client, entopts());
  }




  /// Create a StoreTerminalParameter (see StoreTerminalParameterCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (StoreTerminalParameter).
