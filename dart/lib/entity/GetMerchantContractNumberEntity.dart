...
// Typed models: see ../BluefinTecsMerchantServicesTypes.dart (GetMerchantContractNumber and the per-op request/match types).
class GetMerchantContractNumberEntity extends BluefinTecsMerchantServicesEntityBase {
  GetMerchantContractNumberEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'get_merchant_contract_number';
    name_ = 'get_merchant_contract_number';
    Name = 'GetMerchantContractNumber';
  }

  GetMerchantContractNumberEntity make() {
    return GetMerchantContractNumberEntity(client, entopts());
  }




  /// Create a GetMerchantContractNumber (see GetMerchantContractNumberCreateData in
  /// BluefinTecsMerchantServicesTypes.dart). Returns the entity data map (GetMerchantContractNumber).
