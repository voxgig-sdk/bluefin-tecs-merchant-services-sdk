...
pub trait BluefinTecsMerchantServicesEntity: Entity {
    fn load(&self, reqmatch: Value, ctrl: Value) -> Result<Value, BluefinTecsMerchantServicesError>;
    fn list(&self, reqmatch: Value, ctrl: Value) -> Result<Value, BluefinTecsMerchantServicesError>;
    fn create(&self, reqdata: Value, ctrl: Value) -> Result<Value, BluefinTecsMerchantServicesError>;
    fn update(&self, reqdata: Value, ctrl: Value) -> Result<Value, BluefinTecsMerchantServicesError>;
    fn remove(&self, reqmatch: Value, ctrl: Value) -> Result<Value, BluefinTecsMerchantServicesError>;
}
