// BluefinTecsMerchantServices SDK for Rust (generated by @voxgig/sdkgen).
//
...
pub use crate::core::error::BluefinTecsMerchantServicesError;
...
pub use crate::core::sdk::{test_sdk, BluefinTecsMerchantServicesSDK};
pub use crate::core::spec::Spec;
pub use crate::core::types::{
    Entity, Feature, FeatureRef, FetcherFn, OutVal, BluefinTecsMerchantServicesEntity,
};
...
// No-argument convenience constructors: `bluefin_tecs_merchant_services_sdk::new()` /
// `bluefin_tecs_merchant_services_sdk::test()` for the common no-options case.
use std::rc::Rc;

pub fn new() -> Rc<BluefinTecsMerchantServicesSDK> {
    BluefinTecsMerchantServicesSDK::new(Value::Noval)
}

pub fn test() -> Rc<BluefinTecsMerchantServicesSDK> {
