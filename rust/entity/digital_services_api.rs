// DigitalServicesApi entity client (generated — mirrors the go Entity fragment).
...
pub struct DigitalServicesApiEntity {
    name: String,
    #[allow(dead_code)]
...
impl DigitalServicesApiEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<DigitalServicesApiEntity> {
        ...
        let e = Rc::new(DigitalServicesApiEntity {
            name: "digital_services_api".to_string(),
            client: client.clone(),
...
impl Entity for DigitalServicesApiEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        DigitalServicesApiEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for DigitalServicesApiEntity {
