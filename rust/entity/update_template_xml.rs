// UpdateTemplateXml entity client (generated — mirrors the go Entity fragment).
...
pub struct UpdateTemplateXmlEntity {
    name: String,
    #[allow(dead_code)]
...
impl UpdateTemplateXmlEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<UpdateTemplateXmlEntity> {
        ...
        let e = Rc::new(UpdateTemplateXmlEntity {
            name: "update_template_xml".to_string(),
            client: client.clone(),
...
impl Entity for UpdateTemplateXmlEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        UpdateTemplateXmlEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for UpdateTemplateXmlEntity {
