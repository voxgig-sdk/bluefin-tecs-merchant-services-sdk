// DeactivateTerminal entity client (generated — mirrors the go Entity fragment).
...
pub struct DeactivateTerminalEntity {
    name: String,
    #[allow(dead_code)]
...
impl DeactivateTerminalEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<DeactivateTerminalEntity> {
        ...
        let e = Rc::new(DeactivateTerminalEntity {
            name: "deactivate_terminal".to_string(),
            client: client.clone(),
...
impl Entity for DeactivateTerminalEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        DeactivateTerminalEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for DeactivateTerminalEntity {
