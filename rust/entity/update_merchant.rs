// UpdateMerchant entity client (generated — mirrors the go Entity fragment).
...
impl UpdateMerchantEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<UpdateMerchantEntity> {
        ...
        let e = Rc::new(UpdateMerchantEntity {
            name: "update_merchant".to_string(),
            client: client.clone(),
...
impl Entity for UpdateMerchantEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        UpdateMerchantEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for UpdateMerchantEntity {
