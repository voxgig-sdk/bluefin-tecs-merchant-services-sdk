// RegisterTecsCompany entity client (generated — mirrors the go Entity fragment).
...
pub struct RegisterTecsCompanyEntity {
    name: String,
    #[allow(dead_code)]
...
impl RegisterTecsCompanyEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<RegisterTecsCompanyEntity> {
        ...
        let e = Rc::new(RegisterTecsCompanyEntity {
            name: "register_tecs_company".to_string(),
            client: client.clone(),
...
impl Entity for RegisterTecsCompanyEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        RegisterTecsCompanyEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for RegisterTecsCompanyEntity {
