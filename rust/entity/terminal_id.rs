// TerminalId entity client (generated — mirrors the go Entity fragment).
...
impl TerminalIdEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<TerminalIdEntity> {
...
impl Entity for TerminalIdEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        TerminalIdEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for TerminalIdEntity {
