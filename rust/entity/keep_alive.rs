// KeepAlive entity client (generated — mirrors the go Entity fragment).
...
impl KeepAliveEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<KeepAliveEntity> {
...
impl Entity for KeepAliveEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        KeepAliveEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for KeepAliveEntity {
