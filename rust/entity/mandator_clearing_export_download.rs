// MandatorClearingExportDownload entity client (generated — mirrors the go Entity fragment).
...
use crate::core::sdk::BluefinTecsMerchantServicesSDK;
use crate::core::types::{Entity, BluefinTecsMerchantServicesEntity};
use crate::core::utility_type::Utility;
use crate::utility::voxgigstruct as vs;
use crate::utility::voxgigstruct::Value;

pub struct MandatorClearingExportDownloadEntity {
    name: String,
    #[allow(dead_code)]
...
impl MandatorClearingExportDownloadEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<MandatorClearingExportDownloadEntity> {
        ...
        let e = Rc::new(MandatorClearingExportDownloadEntity {
            name: "mandator_clearing_export_download".to_string(),
            client: client.clone(),
    ...
    pub fn stream(
        ...
        args: Value,
        callopts: Value,
    ) -> Result<std::vec::IntoIter<Value>, BluefinTecsMerchantServicesError> {
...
impl Entity for MandatorClearingExportDownloadEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        MandatorClearingExportDownloadEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for MandatorClearingExportDownloadEntity {

    fn load(self: &Rc<Self>, reqmatch: Value, ctrl: Value) -> Result<Rc<Self>, BluefinTecsMerchantServicesError> {
        let ctx = self.utility.make_context(
            CtxSpec {
    ...
    fn list(self: &Rc<Self>, _reqmatch: Value, _ctrl: Value) -> Result<Vec<Rc<Self>>, BluefinTecsMerchantServicesError> {
        Err(crate::core::helpers::unsupported_op("list", &self.name))
    }


    fn create(self: &Rc<Self>, reqdata: Value, ctrl: Value) -> Result<Rc<Self>, BluefinTecsMerchantServicesError> {
        let ctx = self.utility.make_context(
            CtxSpec {
    ...
    fn update(self: &Rc<Self>, _reqdata: Value, _ctrl: Value) -> Result<Rc<Self>, BluefinTecsMerchantServicesError> {
        Err(crate::core::helpers::unsupported_op("update", &self.name))
    }

    fn remove(self: &Rc<Self>, _reqmatch: Value, _ctrl: Value) -> Result<Rc<Self>, BluefinTecsMerchantServicesError> {
