// PreAuthTransactionCompletion entity client (generated — mirrors the go Entity fragment).
...
pub struct PreAuthTransactionCompletionEntity {
    name: String,
    #[allow(dead_code)]
...
impl PreAuthTransactionCompletionEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<PreAuthTransactionCompletionEntity> {
        ...
        let e = Rc::new(PreAuthTransactionCompletionEntity {
            name: "pre_auth_transaction_completion".to_string(),
            client: client.clone(),
...
impl Entity for PreAuthTransactionCompletionEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        PreAuthTransactionCompletionEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for PreAuthTransactionCompletionEntity {
