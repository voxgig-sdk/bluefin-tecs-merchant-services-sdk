// TransactionHistory entity client (generated — mirrors the go Entity fragment).
...
pub struct TransactionHistoryEntity {
    name: String,
    #[allow(dead_code)]
...
impl TransactionHistoryEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<TransactionHistoryEntity> {
        ...
        let e = Rc::new(TransactionHistoryEntity {
...
impl Entity for TransactionHistoryEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        TransactionHistoryEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for TransactionHistoryEntity {
