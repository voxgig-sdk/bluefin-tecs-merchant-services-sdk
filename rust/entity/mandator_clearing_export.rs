// MandatorClearingExport entity client (generated — mirrors the go Entity fragment).
...
pub struct MandatorClearingExportEntity {
    name: String,
    #[allow(dead_code)]
...
impl MandatorClearingExportEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<MandatorClearingExportEntity> {
        ...
        let e = Rc::new(MandatorClearingExportEntity {
            name: "mandator_clearing_export".to_string(),
            client: client.clone(),
...
impl Entity for MandatorClearingExportEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        MandatorClearingExportEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for MandatorClearingExportEntity {
