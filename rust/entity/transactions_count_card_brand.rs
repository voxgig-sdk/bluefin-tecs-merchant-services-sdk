// TransactionsCountCardBrand entity client (generated — mirrors the go Entity fragment).
...
pub struct TransactionsCountCardBrandEntity {
    name: String,
    #[allow(dead_code)]
...
impl TransactionsCountCardBrandEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<TransactionsCountCardBrandEntity> {
        ...
        let e = Rc::new(TransactionsCountCardBrandEntity {
            name: "transactions_count_card_brand".to_string(),
            client: client.clone(),
...
impl Entity for TransactionsCountCardBrandEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        TransactionsCountCardBrandEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for TransactionsCountCardBrandEntity {
