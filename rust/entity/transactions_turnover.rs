// TransactionsTurnover entity client (generated — mirrors the go Entity fragment).
...
pub struct TransactionsTurnoverEntity {
    name: String,
    #[allow(dead_code)]
...
impl TransactionsTurnoverEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<TransactionsTurnoverEntity> {
        ...
        let e = Rc::new(TransactionsTurnoverEntity {
            name: "transactions_turnover".to_string(),
            client: client.clone(),
...
impl Entity for TransactionsTurnoverEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        TransactionsTurnoverEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for TransactionsTurnoverEntity {
