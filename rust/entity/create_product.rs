// CreateProduct entity client (generated — mirrors the go Entity fragment).
...
impl CreateProductEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<CreateProductEntity> {
        ...
        let e = Rc::new(CreateProductEntity {
...
impl Entity for CreateProductEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        CreateProductEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for CreateProductEntity {
