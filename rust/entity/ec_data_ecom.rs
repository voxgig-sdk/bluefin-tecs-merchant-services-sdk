// EcDataEcom entity client (generated — mirrors the go Entity fragment).
...
impl EcDataEcomEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<EcDataEcomEntity> {
        ...
        let e = Rc::new(EcDataEcomEntity {
            name: "ec_data_ecom".to_string(),
            client: client.clone(),
...
impl Entity for EcDataEcomEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        EcDataEcomEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for EcDataEcomEntity {
