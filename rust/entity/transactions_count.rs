// TransactionsCount entity client (generated — mirrors the go Entity fragment).
...
pub struct TransactionsCountEntity {
    name: String,
    #[allow(dead_code)]
...
impl TransactionsCountEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<TransactionsCountEntity> {
        ...
        let e = Rc::new(TransactionsCountEntity {
            name: "transactions_count".to_string(),
            client: client.clone(),
...
impl Entity for TransactionsCountEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        TransactionsCountEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for TransactionsCountEntity {
