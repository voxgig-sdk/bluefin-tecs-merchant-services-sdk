// RefundTransaction entity client (generated — mirrors the go Entity fragment).
...
pub struct RefundTransactionEntity {
    name: String,
    #[allow(dead_code)]
...
impl RefundTransactionEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<RefundTransactionEntity> {
        ...
        let e = Rc::new(RefundTransactionEntity {
            name: "refund_transaction".to_string(),
            client: client.clone(),
...
impl Entity for RefundTransactionEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        RefundTransactionEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for RefundTransactionEntity {
