// StatusTransaction entity client (generated — mirrors the go Entity fragment).
...
pub struct StatusTransactionEntity {
    name: String,
    #[allow(dead_code)]
...
impl StatusTransactionEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<StatusTransactionEntity> {
        ...
        let e = Rc::new(StatusTransactionEntity {
            name: "status_transaction".to_string(),
            client: client.clone(),
...
impl Entity for StatusTransactionEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        StatusTransactionEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for StatusTransactionEntity {
