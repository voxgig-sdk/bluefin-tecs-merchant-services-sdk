// StoreTerminalParameter entity client (generated — mirrors the go Entity fragment).
...
pub struct StoreTerminalParameterEntity {
    name: String,
    #[allow(dead_code)]
...
impl StoreTerminalParameterEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<StoreTerminalParameterEntity> {
        ...
        let e = Rc::new(StoreTerminalParameterEntity {
            name: "store_terminal_parameter".to_string(),
            client: client.clone(),
...
impl Entity for StoreTerminalParameterEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        StoreTerminalParameterEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for StoreTerminalParameterEntity {
