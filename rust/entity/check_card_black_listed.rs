// CheckCardBlackListed entity client (generated — mirrors the go Entity fragment).
...
pub struct CheckCardBlackListedEntity {
    name: String,
    #[allow(dead_code)]
...
impl CheckCardBlackListedEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<CheckCardBlackListedEntity> {
        ...
        let e = Rc::new(CheckCardBlackListedEntity {
            name: "check_card_black_listed".to_string(),
            client: client.clone(),
...
impl Entity for CheckCardBlackListedEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        CheckCardBlackListedEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for CheckCardBlackListedEntity {
