// ReportData entity client (generated — mirrors the go Entity fragment).
...
impl ReportDataEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<ReportDataEntity> {
        ...
        let e = Rc::new(ReportDataEntity {
            name: "report_data".to_string(),
            client: client.clone(),
...
impl Entity for ReportDataEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        ReportDataEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for ReportDataEntity {
