// RegisterTerminal entity client (generated — mirrors the go Entity fragment).
...
pub struct RegisterTerminalEntity {
    name: String,
    #[allow(dead_code)]
...
impl RegisterTerminalEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<RegisterTerminalEntity> {
        ...
        let e = Rc::new(RegisterTerminalEntity {
            name: "register_terminal".to_string(),
            client: client.clone(),
...
impl Entity for RegisterTerminalEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        RegisterTerminalEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for RegisterTerminalEntity {
