// MandatorClearingExportSummary entity client (generated — mirrors the go Entity fragment).
...
pub struct MandatorClearingExportSummaryEntity {
    name: String,
    #[allow(dead_code)]
...
impl MandatorClearingExportSummaryEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<MandatorClearingExportSummaryEntity> {
        ...
        let e = Rc::new(MandatorClearingExportSummaryEntity {
            name: "mandator_clearing_export_summary".to_string(),
            client: client.clone(),
...
impl Entity for MandatorClearingExportSummaryEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        MandatorClearingExportSummaryEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for MandatorClearingExportSummaryEntity {
    fn load(self: &Rc<Self>, _reqmatch: Value, _ctrl: Value) -> Result<Rc<Self>, BluefinTecsMerchantServicesError> {
