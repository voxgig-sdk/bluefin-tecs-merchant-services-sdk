// EnableAcquiring entity client (generated — mirrors the go Entity fragment).
...
pub struct EnableAcquiringEntity {
    name: String,
    #[allow(dead_code)]
...
impl EnableAcquiringEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<EnableAcquiringEntity> {
        ...
        let e = Rc::new(EnableAcquiringEntity {
            name: "enable_acquiring".to_string(),
            client: client.clone(),
...
impl Entity for EnableAcquiringEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        EnableAcquiringEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for EnableAcquiringEntity {
