// IntroduceMandator entity client (generated — mirrors the go Entity fragment).
...
pub struct IntroduceMandatorEntity {
    name: String,
    #[allow(dead_code)]
...
impl IntroduceMandatorEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<IntroduceMandatorEntity> {
        ...
        let e = Rc::new(IntroduceMandatorEntity {
            name: "introduce_mandator".to_string(),
            client: client.clone(),
...
impl Entity for IntroduceMandatorEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        IntroduceMandatorEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for IntroduceMandatorEntity {
