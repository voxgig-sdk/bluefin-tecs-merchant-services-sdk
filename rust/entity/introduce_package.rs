// IntroducePackage entity client (generated — mirrors the go Entity fragment).
...
pub struct IntroducePackageEntity {
    name: String,
    #[allow(dead_code)]
...
impl IntroducePackageEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<IntroducePackageEntity> {
        ...
        let e = Rc::new(IntroducePackageEntity {
            name: "introduce_package".to_string(),
            client: client.clone(),
...
impl Entity for IntroducePackageEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        IntroducePackageEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for IntroducePackageEntity {
