// ListTerminal entity client (generated — mirrors the go Entity fragment).
...
impl ListTerminalEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<ListTerminalEntity> {
        ...
        let e = Rc::new(ListTerminalEntity {
            name: "list_terminal".to_string(),
            client: client.clone(),
...
impl Entity for ListTerminalEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        ListTerminalEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for ListTerminalEntity {
