// Version entity client (generated — mirrors the go Entity fragment).
...
impl VersionEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<VersionEntity> {
...
impl Entity for VersionEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        VersionEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for VersionEntity {
    ...
    fn create(self: &Rc<Self>, _reqdata: Value, _ctrl: Value) -> Result<Rc<Self>, BluefinTecsMerchantServicesError> {
