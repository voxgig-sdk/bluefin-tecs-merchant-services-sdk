// CancelTransaction entity client (generated — mirrors the go Entity fragment).
...
pub struct CancelTransactionEntity {
    name: String,
    #[allow(dead_code)]
...
impl CancelTransactionEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<CancelTransactionEntity> {
        ...
        let e = Rc::new(CancelTransactionEntity {
            name: "cancel_transaction".to_string(),
            client: client.clone(),
...
impl Entity for CancelTransactionEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        CancelTransactionEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for CancelTransactionEntity {
