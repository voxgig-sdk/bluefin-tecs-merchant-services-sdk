// PaymentSred entity client (generated — mirrors the go Entity fragment).
...
impl PaymentSredEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<PaymentSredEntity> {
        ...
        let e = Rc::new(PaymentSredEntity {
            name: "payment_sred".to_string(),
            client: client.clone(),
...
impl Entity for PaymentSredEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        PaymentSredEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for PaymentSredEntity {
