// GetTemplateXml entity client (generated — mirrors the go Entity fragment).
...
pub struct GetTemplateXmlEntity {
    name: String,
    #[allow(dead_code)]
...
impl GetTemplateXmlEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<GetTemplateXmlEntity> {
        ...
        let e = Rc::new(GetTemplateXmlEntity {
            name: "get_template_xml".to_string(),
            client: client.clone(),
...
impl Entity for GetTemplateXmlEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        GetTemplateXmlEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for GetTemplateXmlEntity {
