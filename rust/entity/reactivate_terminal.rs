// ReactivateTerminal entity client (generated — mirrors the go Entity fragment).
...
pub struct ReactivateTerminalEntity {
    name: String,
    #[allow(dead_code)]
...
impl ReactivateTerminalEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<ReactivateTerminalEntity> {
        ...
        let e = Rc::new(ReactivateTerminalEntity {
            name: "reactivate_terminal".to_string(),
            client: client.clone(),
...
impl Entity for ReactivateTerminalEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        ReactivateTerminalEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for ReactivateTerminalEntity {
