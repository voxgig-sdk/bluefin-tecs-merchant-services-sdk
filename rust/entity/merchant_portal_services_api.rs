// MerchantPortalServicesApi entity client (generated — mirrors the go Entity fragment).
...
pub struct MerchantPortalServicesApiEntity {
    name: String,
    #[allow(dead_code)]
...
impl MerchantPortalServicesApiEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<MerchantPortalServicesApiEntity> {
        ...
        let e = Rc::new(MerchantPortalServicesApiEntity {
            name: "merchant_portal_services_api".to_string(),
            client: client.clone(),
...
impl Entity for MerchantPortalServicesApiEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        MerchantPortalServicesApiEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for MerchantPortalServicesApiEntity {
