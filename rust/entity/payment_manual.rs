// PaymentManual entity client (generated — mirrors the go Entity fragment).
...
pub struct PaymentManualEntity {
    name: String,
    #[allow(dead_code)]
...
impl PaymentManualEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<PaymentManualEntity> {
        ...
        let e = Rc::new(PaymentManualEntity {
            name: "payment_manual".to_string(),
            client: client.clone(),
...
impl Entity for PaymentManualEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        PaymentManualEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for PaymentManualEntity {
