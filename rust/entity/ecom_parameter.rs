// EcomParameter entity client (generated — mirrors the go Entity fragment).
...
pub struct EcomParameterEntity {
    name: String,
    #[allow(dead_code)]
...
impl EcomParameterEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<EcomParameterEntity> {
        ...
        let e = Rc::new(EcomParameterEntity {
            name: "ecom_parameter".to_string(),
            client: client.clone(),
...
impl Entity for EcomParameterEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        EcomParameterEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for EcomParameterEntity {
