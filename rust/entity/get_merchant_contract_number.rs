// GetMerchantContractNumber entity client (generated — mirrors the go Entity fragment).
...
pub struct GetMerchantContractNumberEntity {
    name: String,
    #[allow(dead_code)]
...
impl GetMerchantContractNumberEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<GetMerchantContractNumberEntity> {
        ...
        let e = Rc::new(GetMerchantContractNumberEntity {
            name: "get_merchant_contract_number".to_string(),
            client: client.clone(),
...
impl Entity for GetMerchantContractNumberEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        GetMerchantContractNumberEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for GetMerchantContractNumberEntity {
