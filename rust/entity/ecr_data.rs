// EcrData entity client (generated — mirrors the go Entity fragment).
...
impl EcrDataEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<EcrDataEntity> {
        ...
        let e = Rc::new(EcrDataEntity {
            name: "ecr_data".to_string(),
            client: client.clone(),
...
impl Entity for EcrDataEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        EcrDataEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for EcrDataEntity {
