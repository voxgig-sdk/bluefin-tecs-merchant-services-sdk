// EmvData entity client (generated — mirrors the go Entity fragment).
...
impl EmvDataEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<EmvDataEntity> {
        ...
        let e = Rc::new(EmvDataEntity {
            name: "emv_data".to_string(),
            client: client.clone(),
...
impl Entity for EmvDataEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        EmvDataEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for EmvDataEntity {
