// MoveTid entity client (generated — mirrors the go Entity fragment).
...
impl MoveTidEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantServicesSDK>, entopts: Value) -> Rc<MoveTidEntity> {
        ...
        let e = Rc::new(MoveTidEntity {
            name: "move_tid".to_string(),
            client: client.clone(),
...
impl Entity for MoveTidEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        MoveTidEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantServicesEntity for MoveTidEntity {
