...
use bluefin_tecs_merchant_services_sdk::core::helpers::{getp, getpath, ja, jo};
...
use bluefin_tecs_merchant_services_sdk::{
    ...
    BluefinTecsMerchantServicesSDK, Response, SdkResult, Spec, Utility, Value,
};

// plClient builds a client + isolated utility for pipeline utility tests.
fn pl_client(sdkopts: Value) -> (Rc<BluefinTecsMerchantServicesSDK>, Rc<Utility>) {
...
fn util_with(client: &Rc<BluefinTecsMerchantServicesSDK>, fetcher: FetcherFn) -> Rc<Utility> {
...
fn pipeline_feature_add_ordering_before_after_replace() {
    ...
    let names = |client: &Rc<BluefinTecsMerchantServicesSDK>| -> String {
        client
            .features
            .borrow()
            .iter()
...
use bluefin_tecs_merchant_services_sdk::core::helpers::get_str;
