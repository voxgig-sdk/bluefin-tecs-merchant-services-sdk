...
AQL-driven command-line client **and** interactive REPL for the BluefinTecsMerchantServices
...
- `<entity>` is a bareword, auto-quoted as an AQL atom (e.g. `cancel_transaction`).
