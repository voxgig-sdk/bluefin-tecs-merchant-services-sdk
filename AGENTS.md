# BluefinTecsMerchantServices SDK — Agent Guide
...
**Features** (12): `audit`, `clienttrack`, `debug`, `idempotency`, `log`, `metrics`, `paging`, `ratelimit`, `retry`, `telemetry`, `test`, `timeout`.
