...
class Utility private (noregister: Boolean) {
  ...
  val struct: voxgig.bluefintecsmerchantservicessdk.utility.StructUtility.type = voxgig.bluefintecsmerchantservicessdk.utility.StructUtility

  def this() = {
    this(false)
    voxgig.bluefintecsmerchantservicessdk.utility.Register.registerAll(this)
  }
