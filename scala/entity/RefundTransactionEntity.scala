...
class RefundTransactionEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("refund_transaction", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new RefundTransactionEntity(this.client, opts)
  }
