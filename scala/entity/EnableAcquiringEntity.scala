...
class EnableAcquiringEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("enable_acquiring", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new EnableAcquiringEntity(this.client, opts)
  }
