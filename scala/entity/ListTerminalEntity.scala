...
class ListTerminalEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("list_terminal", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new ListTerminalEntity(this.client, opts)
  }
