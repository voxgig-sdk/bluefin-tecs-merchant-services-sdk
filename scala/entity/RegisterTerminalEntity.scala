...
class RegisterTerminalEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("register_terminal", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new RegisterTerminalEntity(this.client, opts)
  }
