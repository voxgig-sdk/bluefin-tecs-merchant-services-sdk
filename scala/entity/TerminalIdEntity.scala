...
class TerminalIdEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("terminal_id", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new TerminalIdEntity(this.client, opts)
  }
