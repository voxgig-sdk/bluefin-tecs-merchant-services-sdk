...
class KeepAliveEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("keep_alive", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new KeepAliveEntity(this.client, opts)
  }
