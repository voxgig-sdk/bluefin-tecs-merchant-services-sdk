...
class MandatorClearingExportSummaryEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("mandator_clearing_export_summary", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new MandatorClearingExportSummaryEntity(this.client, opts)
  }
