...
class MandatorClearingExportEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("mandator_clearing_export", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new MandatorClearingExportEntity(this.client, opts)
  }
