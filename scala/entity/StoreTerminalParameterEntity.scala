...
class StoreTerminalParameterEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("store_terminal_parameter", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new StoreTerminalParameterEntity(this.client, opts)
  }
