...
class CreateProductEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("create_product", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new CreateProductEntity(this.client, opts)
  }
