...
class PaymentSredEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("payment_sred", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new PaymentSredEntity(this.client, opts)
  }
