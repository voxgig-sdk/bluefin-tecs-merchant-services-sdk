...
class UpdateMerchantEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("update_merchant", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new UpdateMerchantEntity(this.client, opts)
  }
