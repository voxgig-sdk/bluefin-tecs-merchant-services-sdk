...
class EcDataEcomEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("ec_data_ecom", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new EcDataEcomEntity(this.client, opts)
  }
