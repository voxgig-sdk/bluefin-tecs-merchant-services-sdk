...
import voxgig.bluefintecsmerchantservicessdk.core.{Context, Helpers, SdkClient, SdkEntity, Utility}
import voxgig.bluefintecsmerchantservicessdk.utility.struct.Struct

// Shared entity runtime for the BluefinTecsMerchantServices SDK: accreting data/match state,
