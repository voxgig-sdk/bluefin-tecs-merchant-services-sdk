...
class StatusTransactionEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("status_transaction", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new StatusTransactionEntity(this.client, opts)
  }
