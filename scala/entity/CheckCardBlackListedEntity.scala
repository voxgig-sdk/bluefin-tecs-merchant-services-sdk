...
class CheckCardBlackListedEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("check_card_black_listed", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new CheckCardBlackListedEntity(this.client, opts)
  }
