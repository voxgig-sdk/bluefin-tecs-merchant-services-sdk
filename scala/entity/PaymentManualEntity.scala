...
class PaymentManualEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("payment_manual", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new PaymentManualEntity(this.client, opts)
  }
