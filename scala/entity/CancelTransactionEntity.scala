...
class CancelTransactionEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("cancel_transaction", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new CancelTransactionEntity(this.client, opts)
  }
