...
class TransactionsTurnoverEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("transactions_turnover", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new TransactionsTurnoverEntity(this.client, opts)
  }
