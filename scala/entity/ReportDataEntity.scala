...
class ReportDataEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("report_data", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new ReportDataEntity(this.client, opts)
  }
