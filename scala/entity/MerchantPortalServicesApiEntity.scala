...
class MerchantPortalServicesApiEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("merchant_portal_services_api", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new MerchantPortalServicesApiEntity(this.client, opts)
  }
