...
class GetMerchantContractNumberEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("get_merchant_contract_number", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new GetMerchantContractNumberEntity(this.client, opts)
  }
