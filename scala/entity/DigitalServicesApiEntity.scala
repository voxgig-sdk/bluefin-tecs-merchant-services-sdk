...
class DigitalServicesApiEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("digital_services_api", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new DigitalServicesApiEntity(this.client, opts)
  }
