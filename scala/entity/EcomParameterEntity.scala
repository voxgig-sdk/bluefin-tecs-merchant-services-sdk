...
class EcomParameterEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("ecom_parameter", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new EcomParameterEntity(this.client, opts)
  }
