...
class PreAuthTransactionCompletionEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("pre_auth_transaction_completion", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new PreAuthTransactionCompletionEntity(this.client, opts)
  }
