...
class UpdateTemplateXmlEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("update_template_xml", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new UpdateTemplateXmlEntity(this.client, opts)
  }
