...
class ReactivateTerminalEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("reactivate_terminal", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new ReactivateTerminalEntity(this.client, opts)
  }
