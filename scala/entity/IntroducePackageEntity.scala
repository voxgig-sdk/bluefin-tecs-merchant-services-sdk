...
class IntroducePackageEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("introduce_package", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new IntroducePackageEntity(this.client, opts)
  }
