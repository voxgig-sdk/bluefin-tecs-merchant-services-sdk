...
local CreateProductEntity = {}
CreateProductEntity.__index = CreateProductEntity


function CreateProductEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CreateProductEntity)
  self._name = "create_product"
  self._client = client
...
function CreateProductEntity:get_name()
  return self._name
end


function CreateProductEntity:make()
  local opts = {}
...
function CreateProductEntity:mark_deleted()
  self._deleted = true
end


function CreateProductEntity:deleted()
  return true == self._deleted
end


function CreateProductEntity:data_set(args)
  if args ~= nil then
...
function CreateProductEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CreateProductEntity:match_set(args)
  if args ~= nil then
...
function CreateProductEntity:match_get()
...
function CreateProductEntity:stream(action, args, callopts)
...
---@param reqdata CreateProductCreateData
---@param ctrl? table
---@return CreateProduct
---@return string? err
function CreateProductEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function CreateProductEntity:_run_op(ctx, post_done)
  local utility = self._utility
