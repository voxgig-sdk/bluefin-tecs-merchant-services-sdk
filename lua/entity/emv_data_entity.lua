...
local EmvDataEntity = {}
EmvDataEntity.__index = EmvDataEntity


function EmvDataEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EmvDataEntity)
  self._name = "emv_data"
  self._client = client
...
function EmvDataEntity:get_name()
  return self._name
end


function EmvDataEntity:make()
  local opts = {}
...
function EmvDataEntity:mark_deleted()
  self._deleted = true
end


function EmvDataEntity:deleted()
  return true == self._deleted
end


function EmvDataEntity:data_set(args)
  if args ~= nil then
...
function EmvDataEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EmvDataEntity:match_set(args)
  if args ~= nil then
...
function EmvDataEntity:match_get()
...
function EmvDataEntity:stream(action, args, callopts)
...
---@param reqdata EmvDataCreateData
---@param ctrl? table
---@return EmvData
---@return string? err
function EmvDataEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function EmvDataEntity:_run_op(ctx, post_done)
  local utility = self._utility
