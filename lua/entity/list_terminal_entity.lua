...
local ListTerminalEntity = {}
ListTerminalEntity.__index = ListTerminalEntity


function ListTerminalEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ListTerminalEntity)
  self._name = "list_terminal"
  self._client = client
...
function ListTerminalEntity:get_name()
  return self._name
end


function ListTerminalEntity:make()
  local opts = {}
...
function ListTerminalEntity:mark_deleted()
  self._deleted = true
end


function ListTerminalEntity:deleted()
  return true == self._deleted
end


function ListTerminalEntity:data_set(args)
  if args ~= nil then
...
function ListTerminalEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ListTerminalEntity:match_set(args)
  if args ~= nil then
...
function ListTerminalEntity:match_get()
...
function ListTerminalEntity:stream(action, args, callopts)
...
---@param reqdata ListTerminalCreateData
---@param ctrl? table
---@return ListTerminal
---@return string? err
function ListTerminalEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ListTerminalEntity:_run_op(ctx, post_done)
  local utility = self._utility
