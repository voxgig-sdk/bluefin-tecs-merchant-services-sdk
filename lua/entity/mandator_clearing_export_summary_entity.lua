...
local MandatorClearingExportSummaryEntity = {}
MandatorClearingExportSummaryEntity.__index = MandatorClearingExportSummaryEntity


function MandatorClearingExportSummaryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MandatorClearingExportSummaryEntity)
  self._name = "mandator_clearing_export_summary"
  self._client = client
...
function MandatorClearingExportSummaryEntity:get_name()
  return self._name
end


function MandatorClearingExportSummaryEntity:make()
  local opts = {}
...
function MandatorClearingExportSummaryEntity:mark_deleted()
  self._deleted = true
end


function MandatorClearingExportSummaryEntity:deleted()
  return true == self._deleted
end


function MandatorClearingExportSummaryEntity:data_set(args)
  if args ~= nil then
...
function MandatorClearingExportSummaryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MandatorClearingExportSummaryEntity:match_set(args)
  if args ~= nil then
...
function MandatorClearingExportSummaryEntity:match_get()
...
function MandatorClearingExportSummaryEntity:stream(action, args, callopts)
...
---@param reqdata MandatorClearingExportSummaryCreateData
---@param ctrl? table
---@return MandatorClearingExportSummary
---@return string? err
function MandatorClearingExportSummaryEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function MandatorClearingExportSummaryEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MandatorClearingExportSummaryEntity
