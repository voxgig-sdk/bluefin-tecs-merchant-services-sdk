...
local MoveTidEntity = {}
MoveTidEntity.__index = MoveTidEntity


function MoveTidEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MoveTidEntity)
  self._name = "move_tid"
  self._client = client
...
function MoveTidEntity:get_name()
  return self._name
end


function MoveTidEntity:make()
  local opts = {}
...
function MoveTidEntity:mark_deleted()
  self._deleted = true
end


function MoveTidEntity:deleted()
  return true == self._deleted
end


function MoveTidEntity:data_set(args)
  if args ~= nil then
...
function MoveTidEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MoveTidEntity:match_set(args)
  if args ~= nil then
...
function MoveTidEntity:match_get()
...
function MoveTidEntity:stream(action, args, callopts)
...
---@param reqdata MoveTidCreateData
---@param ctrl? table
---@return MoveTid
---@return string? err
function MoveTidEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function MoveTidEntity:_run_op(ctx, post_done)
  local utility = self._utility
