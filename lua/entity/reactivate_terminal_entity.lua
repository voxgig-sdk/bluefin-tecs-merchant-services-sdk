...
local ReactivateTerminalEntity = {}
ReactivateTerminalEntity.__index = ReactivateTerminalEntity


function ReactivateTerminalEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ReactivateTerminalEntity)
  self._name = "reactivate_terminal"
  self._client = client
...
function ReactivateTerminalEntity:get_name()
  return self._name
end


function ReactivateTerminalEntity:make()
  local opts = {}
...
function ReactivateTerminalEntity:mark_deleted()
  self._deleted = true
end


function ReactivateTerminalEntity:deleted()
  return true == self._deleted
end


function ReactivateTerminalEntity:data_set(args)
  if args ~= nil then
...
function ReactivateTerminalEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ReactivateTerminalEntity:match_set(args)
  if args ~= nil then
...
function ReactivateTerminalEntity:match_get()
...
function ReactivateTerminalEntity:stream(action, args, callopts)
...
---@param reqdata ReactivateTerminalCreateData
---@param ctrl? table
---@return ReactivateTerminal
---@return string? err
function ReactivateTerminalEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ReactivateTerminalEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ReactivateTerminalEntity
