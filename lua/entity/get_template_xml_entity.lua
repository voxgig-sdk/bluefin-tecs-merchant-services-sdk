...
local GetTemplateXmlEntity = {}
GetTemplateXmlEntity.__index = GetTemplateXmlEntity


function GetTemplateXmlEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetTemplateXmlEntity)
  self._name = "get_template_xml"
  self._client = client
...
function GetTemplateXmlEntity:get_name()
  return self._name
end


function GetTemplateXmlEntity:make()
  local opts = {}
...
function GetTemplateXmlEntity:mark_deleted()
  self._deleted = true
end


function GetTemplateXmlEntity:deleted()
  return true == self._deleted
end


function GetTemplateXmlEntity:data_set(args)
  if args ~= nil then
...
function GetTemplateXmlEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetTemplateXmlEntity:match_set(args)
  if args ~= nil then
...
function GetTemplateXmlEntity:match_get()
...
function GetTemplateXmlEntity:stream(action, args, callopts)
...
---@param reqdata GetTemplateXmlCreateData
---@param ctrl? table
---@return GetTemplateXml
---@return string? err
function GetTemplateXmlEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function GetTemplateXmlEntity:_run_op(ctx, post_done)
  local utility = self._utility
