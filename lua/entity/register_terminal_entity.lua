...
local RegisterTerminalEntity = {}
RegisterTerminalEntity.__index = RegisterTerminalEntity


function RegisterTerminalEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RegisterTerminalEntity)
  self._name = "register_terminal"
  self._client = client
...
function RegisterTerminalEntity:get_name()
  return self._name
end


function RegisterTerminalEntity:make()
  local opts = {}
...
function RegisterTerminalEntity:mark_deleted()
  self._deleted = true
end


function RegisterTerminalEntity:deleted()
  return true == self._deleted
end


function RegisterTerminalEntity:data_set(args)
  if args ~= nil then
...
function RegisterTerminalEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RegisterTerminalEntity:match_set(args)
  if args ~= nil then
...
function RegisterTerminalEntity:match_get()
...
function RegisterTerminalEntity:stream(action, args, callopts)
...
---@param reqdata RegisterTerminalCreateData
---@param ctrl? table
---@return RegisterTerminal
---@return string? err
function RegisterTerminalEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function RegisterTerminalEntity:_run_op(ctx, post_done)
  local utility = self._utility
