...
local EcomParameterEntity = {}
EcomParameterEntity.__index = EcomParameterEntity


function EcomParameterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EcomParameterEntity)
  self._name = "ecom_parameter"
  self._client = client
...
function EcomParameterEntity:get_name()
  return self._name
end


function EcomParameterEntity:make()
  local opts = {}
...
function EcomParameterEntity:mark_deleted()
  self._deleted = true
end


function EcomParameterEntity:deleted()
  return true == self._deleted
end


function EcomParameterEntity:data_set(args)
  if args ~= nil then
...
function EcomParameterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EcomParameterEntity:match_set(args)
  if args ~= nil then
...
function EcomParameterEntity:match_get()
...
function EcomParameterEntity:stream(action, args, callopts)
...
---@param reqdata EcomParameterCreateData
---@param ctrl? table
---@return EcomParameter
---@return string? err
function EcomParameterEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function EcomParameterEntity:_run_op(ctx, post_done)
  local utility = self._utility
