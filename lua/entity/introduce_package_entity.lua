...
local IntroducePackageEntity = {}
IntroducePackageEntity.__index = IntroducePackageEntity


function IntroducePackageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IntroducePackageEntity)
  self._name = "introduce_package"
  self._client = client
...
function IntroducePackageEntity:get_name()
  return self._name
end


function IntroducePackageEntity:make()
  local opts = {}
...
function IntroducePackageEntity:mark_deleted()
  self._deleted = true
end


function IntroducePackageEntity:deleted()
  return true == self._deleted
end


function IntroducePackageEntity:data_set(args)
  if args ~= nil then
...
function IntroducePackageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IntroducePackageEntity:match_set(args)
  if args ~= nil then
...
function IntroducePackageEntity:match_get()
...
function IntroducePackageEntity:stream(action, args, callopts)
...
---@param reqdata IntroducePackageCreateData
---@param ctrl? table
---@return IntroducePackage
---@return string? err
function IntroducePackageEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function IntroducePackageEntity:_run_op(ctx, post_done)
  local utility = self._utility
