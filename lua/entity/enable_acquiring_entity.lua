...
local EnableAcquiringEntity = {}
EnableAcquiringEntity.__index = EnableAcquiringEntity


function EnableAcquiringEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EnableAcquiringEntity)
  self._name = "enable_acquiring"
  self._client = client
...
function EnableAcquiringEntity:get_name()
  return self._name
end


function EnableAcquiringEntity:make()
  local opts = {}
...
function EnableAcquiringEntity:mark_deleted()
  self._deleted = true
end


function EnableAcquiringEntity:deleted()
  return true == self._deleted
end


function EnableAcquiringEntity:data_set(args)
  if args ~= nil then
...
function EnableAcquiringEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EnableAcquiringEntity:match_set(args)
  if args ~= nil then
...
function EnableAcquiringEntity:match_get()
...
function EnableAcquiringEntity:stream(action, args, callopts)
...
---@param reqdata EnableAcquiringCreateData
---@param ctrl? table
---@return EnableAcquiring
---@return string? err
function EnableAcquiringEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function EnableAcquiringEntity:_run_op(ctx, post_done)
  local utility = self._utility
