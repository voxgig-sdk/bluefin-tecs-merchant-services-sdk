...
local EcrDataEntity = {}
EcrDataEntity.__index = EcrDataEntity


function EcrDataEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EcrDataEntity)
  self._name = "ecr_data"
  self._client = client
...
function EcrDataEntity:get_name()
  return self._name
end


function EcrDataEntity:make()
  local opts = {}
...
function EcrDataEntity:mark_deleted()
  self._deleted = true
end


function EcrDataEntity:deleted()
  return true == self._deleted
end


function EcrDataEntity:data_set(args)
  if args ~= nil then
...
function EcrDataEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EcrDataEntity:match_set(args)
  if args ~= nil then
...
function EcrDataEntity:match_get()
...
function EcrDataEntity:stream(action, args, callopts)
...
---@param reqdata EcrDataCreateData
---@param ctrl? table
---@return EcrData
---@return string? err
function EcrDataEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function EcrDataEntity:_run_op(ctx, post_done)
  local utility = self._utility
