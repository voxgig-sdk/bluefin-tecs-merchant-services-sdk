...
local TransactionHistoryEntity = {}
TransactionHistoryEntity.__index = TransactionHistoryEntity


function TransactionHistoryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TransactionHistoryEntity)
  self._name = "transaction_history"
  self._client = client
...
function TransactionHistoryEntity:get_name()
  return self._name
end


function TransactionHistoryEntity:make()
  local opts = {}
...
function TransactionHistoryEntity:mark_deleted()
  self._deleted = true
end


function TransactionHistoryEntity:deleted()
  return true == self._deleted
end


function TransactionHistoryEntity:data_set(args)
  if args ~= nil then
...
function TransactionHistoryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TransactionHistoryEntity:match_set(args)
  if args ~= nil then
...
function TransactionHistoryEntity:match_get()
...
function TransactionHistoryEntity:stream(action, args, callopts)
...
---@param reqdata TransactionHistoryCreateData
---@param ctrl? table
---@return TransactionHistory
---@return string? err
function TransactionHistoryEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function TransactionHistoryEntity:_run_op(ctx, post_done)
  local utility = self._utility
