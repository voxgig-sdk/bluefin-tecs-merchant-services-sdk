...
local TransactionsCountEntity = {}
TransactionsCountEntity.__index = TransactionsCountEntity


function TransactionsCountEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TransactionsCountEntity)
  self._name = "transactions_count"
  self._client = client
...
function TransactionsCountEntity:get_name()
  return self._name
end


function TransactionsCountEntity:make()
  local opts = {}
...
function TransactionsCountEntity:mark_deleted()
  self._deleted = true
end


function TransactionsCountEntity:deleted()
  return true == self._deleted
end


function TransactionsCountEntity:data_set(args)
  if args ~= nil then
...
function TransactionsCountEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TransactionsCountEntity:match_set(args)
  if args ~= nil then
...
function TransactionsCountEntity:match_get()
...
function TransactionsCountEntity:stream(action, args, callopts)
...
---@param reqdata TransactionsCountCreateData
---@param ctrl? table
---@return TransactionsCount
---@return string? err
function TransactionsCountEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function TransactionsCountEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return TransactionsCountEntity
