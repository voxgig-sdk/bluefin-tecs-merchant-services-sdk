...
local MandatorClearingExportDownloadEntity = {}
MandatorClearingExportDownloadEntity.__index = MandatorClearingExportDownloadEntity


function MandatorClearingExportDownloadEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MandatorClearingExportDownloadEntity)
  self._name = "mandator_clearing_export_download"
  self._client = client
...
function MandatorClearingExportDownloadEntity:get_name()
  return self._name
end


function MandatorClearingExportDownloadEntity:make()
  local opts = {}
...
function MandatorClearingExportDownloadEntity:mark_deleted()
  self._deleted = true
end


function MandatorClearingExportDownloadEntity:deleted()
  return true == self._deleted
end


function MandatorClearingExportDownloadEntity:data_set(args)
  if args ~= nil then
...
function MandatorClearingExportDownloadEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MandatorClearingExportDownloadEntity:match_set(args)
  if args ~= nil then
...
function MandatorClearingExportDownloadEntity:match_get()
...
function MandatorClearingExportDownloadEntity:stream(action, args, callopts)
...
---@param reqmatch MandatorClearingExportDownloadLoadMatch
---@param ctrl? table
---@return MandatorClearingExportDownload
---@return string? err
function MandatorClearingExportDownloadEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata MandatorClearingExportDownloadCreateData
---@param ctrl? table
---@return MandatorClearingExportDownload
---@return string? err
function MandatorClearingExportDownloadEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function MandatorClearingExportDownloadEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MandatorClearingExportDownloadEntity
