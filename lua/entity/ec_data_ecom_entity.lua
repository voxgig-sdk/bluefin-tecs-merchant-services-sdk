...
local EcDataEcomEntity = {}
EcDataEcomEntity.__index = EcDataEcomEntity


function EcDataEcomEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EcDataEcomEntity)
  self._name = "ec_data_ecom"
  self._client = client
...
function EcDataEcomEntity:get_name()
  return self._name
end


function EcDataEcomEntity:make()
  local opts = {}
...
function EcDataEcomEntity:mark_deleted()
  self._deleted = true
end


function EcDataEcomEntity:deleted()
  return true == self._deleted
end


function EcDataEcomEntity:data_set(args)
  if args ~= nil then
...
function EcDataEcomEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EcDataEcomEntity:match_set(args)
  if args ~= nil then
...
function EcDataEcomEntity:match_get()
...
function EcDataEcomEntity:stream(action, args, callopts)
...
---@param reqdata EcDataEcomCreateData
---@param ctrl? table
---@return EcDataEcom
---@return string? err
function EcDataEcomEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function EcDataEcomEntity:_run_op(ctx, post_done)
  local utility = self._utility
