...
local StoreTerminalParameterEntity = {}
StoreTerminalParameterEntity.__index = StoreTerminalParameterEntity


function StoreTerminalParameterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, StoreTerminalParameterEntity)
  self._name = "store_terminal_parameter"
  self._client = client
...
function StoreTerminalParameterEntity:get_name()
  return self._name
end


function StoreTerminalParameterEntity:make()
  local opts = {}
...
function StoreTerminalParameterEntity:mark_deleted()
  self._deleted = true
end


function StoreTerminalParameterEntity:deleted()
  return true == self._deleted
end


function StoreTerminalParameterEntity:data_set(args)
  if args ~= nil then
...
function StoreTerminalParameterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function StoreTerminalParameterEntity:match_set(args)
  if args ~= nil then
...
function StoreTerminalParameterEntity:match_get()
...
function StoreTerminalParameterEntity:stream(action, args, callopts)
...
---@param reqdata StoreTerminalParameterCreateData
---@param ctrl? table
---@return StoreTerminalParameter
---@return string? err
function StoreTerminalParameterEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function StoreTerminalParameterEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return StoreTerminalParameterEntity
