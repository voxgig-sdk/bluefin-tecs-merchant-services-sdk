...
local TransactionsTurnoverEntity = {}
TransactionsTurnoverEntity.__index = TransactionsTurnoverEntity


function TransactionsTurnoverEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TransactionsTurnoverEntity)
  self._name = "transactions_turnover"
  self._client = client
...
function TransactionsTurnoverEntity:get_name()
  return self._name
end


function TransactionsTurnoverEntity:make()
  local opts = {}
...
function TransactionsTurnoverEntity:mark_deleted()
  self._deleted = true
end


function TransactionsTurnoverEntity:deleted()
  return true == self._deleted
end


function TransactionsTurnoverEntity:data_set(args)
  if args ~= nil then
...
function TransactionsTurnoverEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TransactionsTurnoverEntity:match_set(args)
  if args ~= nil then
...
function TransactionsTurnoverEntity:match_get()
...
function TransactionsTurnoverEntity:stream(action, args, callopts)
...
---@param reqdata TransactionsTurnoverCreateData
---@param ctrl? table
---@return TransactionsTurnover
---@return string? err
function TransactionsTurnoverEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function TransactionsTurnoverEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return TransactionsTurnoverEntity
