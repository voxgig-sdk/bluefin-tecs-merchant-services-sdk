...
local PreAuthTransactionCompletionEntity = {}
PreAuthTransactionCompletionEntity.__index = PreAuthTransactionCompletionEntity


function PreAuthTransactionCompletionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PreAuthTransactionCompletionEntity)
  self._name = "pre_auth_transaction_completion"
  self._client = client
...
function PreAuthTransactionCompletionEntity:get_name()
  return self._name
end


function PreAuthTransactionCompletionEntity:make()
  local opts = {}
...
function PreAuthTransactionCompletionEntity:mark_deleted()
  self._deleted = true
end


function PreAuthTransactionCompletionEntity:deleted()
  return true == self._deleted
end


function PreAuthTransactionCompletionEntity:data_set(args)
  if args ~= nil then
...
function PreAuthTransactionCompletionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PreAuthTransactionCompletionEntity:match_set(args)
  if args ~= nil then
...
function PreAuthTransactionCompletionEntity:match_get()
...
function PreAuthTransactionCompletionEntity:stream(action, args, callopts)
...
---@param reqdata PreAuthTransactionCompletionCreateData
---@param ctrl? table
---@return PreAuthTransactionCompletion
---@return string? err
function PreAuthTransactionCompletionEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function PreAuthTransactionCompletionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PreAuthTransactionCompletionEntity
