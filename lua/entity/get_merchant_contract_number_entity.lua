...
local GetMerchantContractNumberEntity = {}
GetMerchantContractNumberEntity.__index = GetMerchantContractNumberEntity


function GetMerchantContractNumberEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetMerchantContractNumberEntity)
  self._name = "get_merchant_contract_number"
  self._client = client
...
function GetMerchantContractNumberEntity:get_name()
  return self._name
end


function GetMerchantContractNumberEntity:make()
  local opts = {}
...
function GetMerchantContractNumberEntity:mark_deleted()
  self._deleted = true
end


function GetMerchantContractNumberEntity:deleted()
  return true == self._deleted
end


function GetMerchantContractNumberEntity:data_set(args)
  if args ~= nil then
...
function GetMerchantContractNumberEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetMerchantContractNumberEntity:match_set(args)
  if args ~= nil then
...
function GetMerchantContractNumberEntity:match_get()
...
function GetMerchantContractNumberEntity:stream(action, args, callopts)
...
---@param reqdata GetMerchantContractNumberCreateData
---@param ctrl? table
---@return GetMerchantContractNumber
---@return string? err
function GetMerchantContractNumberEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function GetMerchantContractNumberEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetMerchantContractNumberEntity
