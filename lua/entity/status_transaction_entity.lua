...
local StatusTransactionEntity = {}
StatusTransactionEntity.__index = StatusTransactionEntity


function StatusTransactionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, StatusTransactionEntity)
  self._name = "status_transaction"
  self._client = client
...
function StatusTransactionEntity:get_name()
  return self._name
end


function StatusTransactionEntity:make()
  local opts = {}
...
function StatusTransactionEntity:mark_deleted()
  self._deleted = true
end


function StatusTransactionEntity:deleted()
  return true == self._deleted
end


function StatusTransactionEntity:data_set(args)
  if args ~= nil then
...
function StatusTransactionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function StatusTransactionEntity:match_set(args)
  if args ~= nil then
...
function StatusTransactionEntity:match_get()
...
function StatusTransactionEntity:stream(action, args, callopts)
...
---@param reqdata StatusTransactionCreateData
---@param ctrl? table
---@return StatusTransaction
---@return string? err
function StatusTransactionEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function StatusTransactionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return StatusTransactionEntity
