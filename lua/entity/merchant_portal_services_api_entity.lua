...
local MerchantPortalServicesApiEntity = {}
MerchantPortalServicesApiEntity.__index = MerchantPortalServicesApiEntity


function MerchantPortalServicesApiEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MerchantPortalServicesApiEntity)
  self._name = "merchant_portal_services_api"
  self._client = client
...
function MerchantPortalServicesApiEntity:get_name()
  return self._name
end


function MerchantPortalServicesApiEntity:make()
  local opts = {}
...
function MerchantPortalServicesApiEntity:mark_deleted()
  self._deleted = true
end


function MerchantPortalServicesApiEntity:deleted()
  return true == self._deleted
end


function MerchantPortalServicesApiEntity:data_set(args)
  if args ~= nil then
...
function MerchantPortalServicesApiEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MerchantPortalServicesApiEntity:match_set(args)
  if args ~= nil then
...
function MerchantPortalServicesApiEntity:match_get()
...
function MerchantPortalServicesApiEntity:stream(action, args, callopts)
...
---@param reqdata MerchantPortalServicesApiCreateData
---@param ctrl? table
---@return MerchantPortalServicesApi
---@return string? err
function MerchantPortalServicesApiEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function MerchantPortalServicesApiEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MerchantPortalServicesApiEntity
