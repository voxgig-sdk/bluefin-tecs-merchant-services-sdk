...
local TransactionsCountCardBrandEntity = {}
TransactionsCountCardBrandEntity.__index = TransactionsCountCardBrandEntity


function TransactionsCountCardBrandEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TransactionsCountCardBrandEntity)
  self._name = "transactions_count_card_brand"
  self._client = client
...
function TransactionsCountCardBrandEntity:get_name()
  return self._name
end


function TransactionsCountCardBrandEntity:make()
  local opts = {}
...
function TransactionsCountCardBrandEntity:mark_deleted()
  self._deleted = true
end


function TransactionsCountCardBrandEntity:deleted()
  return true == self._deleted
end


function TransactionsCountCardBrandEntity:data_set(args)
  if args ~= nil then
...
function TransactionsCountCardBrandEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TransactionsCountCardBrandEntity:match_set(args)
  if args ~= nil then
...
function TransactionsCountCardBrandEntity:match_get()
...
function TransactionsCountCardBrandEntity:stream(action, args, callopts)
...
---@param reqdata TransactionsCountCardBrandCreateData
---@param ctrl? table
---@return TransactionsCountCardBrand
---@return string? err
function TransactionsCountCardBrandEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function TransactionsCountCardBrandEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return TransactionsCountCardBrandEntity
