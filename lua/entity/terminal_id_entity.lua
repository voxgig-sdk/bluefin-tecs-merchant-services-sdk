...
TerminalIdEntity.__index = TerminalIdEntity


function TerminalIdEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TerminalIdEntity)
  self._name = "terminal_id"
  self._client = client
...
function TerminalIdEntity:get_name()
  return self._name
end


function TerminalIdEntity:make()
  local opts = {}
...
function TerminalIdEntity:mark_deleted()
  self._deleted = true
end


function TerminalIdEntity:deleted()
  return true == self._deleted
end


function TerminalIdEntity:data_set(args)
  if args ~= nil then
...
function TerminalIdEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TerminalIdEntity:match_set(args)
  if args ~= nil then
...
function TerminalIdEntity:match_get()
...
function TerminalIdEntity:stream(action, args, callopts)
...
---@param reqdata TerminalIdCreateData
---@param ctrl? table
---@return TerminalId
---@return string? err
function TerminalIdEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function TerminalIdEntity:_run_op(ctx, post_done)
  local utility = self._utility
