...
local CancelTransactionEntity = {}
CancelTransactionEntity.__index = CancelTransactionEntity


function CancelTransactionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CancelTransactionEntity)
  self._name = "cancel_transaction"
  self._client = client
...
function CancelTransactionEntity:get_name()
  return self._name
end


function CancelTransactionEntity:make()
  local opts = {}
...
function CancelTransactionEntity:mark_deleted()
  self._deleted = true
end


function CancelTransactionEntity:deleted()
  return true == self._deleted
end


function CancelTransactionEntity:data_set(args)
  if args ~= nil then
...
function CancelTransactionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CancelTransactionEntity:match_set(args)
  if args ~= nil then
...
function CancelTransactionEntity:match_get()
...
function CancelTransactionEntity:stream(action, args, callopts)
...
---@param reqdata CancelTransactionCreateData
---@param ctrl? table
---@return CancelTransaction
---@return string? err
function CancelTransactionEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function CancelTransactionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CancelTransactionEntity
