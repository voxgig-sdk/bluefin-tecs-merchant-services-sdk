...
local UpdateTemplateXmlEntity = {}
UpdateTemplateXmlEntity.__index = UpdateTemplateXmlEntity


function UpdateTemplateXmlEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UpdateTemplateXmlEntity)
  self._name = "update_template_xml"
  self._client = client
...
function UpdateTemplateXmlEntity:get_name()
  return self._name
end


function UpdateTemplateXmlEntity:make()
  local opts = {}
...
function UpdateTemplateXmlEntity:mark_deleted()
  self._deleted = true
end


function UpdateTemplateXmlEntity:deleted()
  return true == self._deleted
end


function UpdateTemplateXmlEntity:data_set(args)
  if args ~= nil then
...
function UpdateTemplateXmlEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UpdateTemplateXmlEntity:match_set(args)
  if args ~= nil then
...
function UpdateTemplateXmlEntity:match_get()
...
function UpdateTemplateXmlEntity:stream(action, args, callopts)
...
---@param reqdata UpdateTemplateXmlCreateData
---@param ctrl? table
---@return UpdateTemplateXml
---@return string? err
function UpdateTemplateXmlEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function UpdateTemplateXmlEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return UpdateTemplateXmlEntity
