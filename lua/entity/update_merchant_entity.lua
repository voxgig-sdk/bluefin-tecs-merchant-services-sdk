...
local UpdateMerchantEntity = {}
UpdateMerchantEntity.__index = UpdateMerchantEntity


function UpdateMerchantEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UpdateMerchantEntity)
  self._name = "update_merchant"
  self._client = client
...
function UpdateMerchantEntity:get_name()
  return self._name
end


function UpdateMerchantEntity:make()
  local opts = {}
...
function UpdateMerchantEntity:mark_deleted()
  self._deleted = true
end


function UpdateMerchantEntity:deleted()
  return true == self._deleted
end


function UpdateMerchantEntity:data_set(args)
  if args ~= nil then
...
function UpdateMerchantEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UpdateMerchantEntity:match_set(args)
  if args ~= nil then
...
function UpdateMerchantEntity:match_get()
...
function UpdateMerchantEntity:stream(action, args, callopts)
...
---@param reqdata UpdateMerchantCreateData
---@param ctrl? table
---@return UpdateMerchant
---@return string? err
function UpdateMerchantEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function UpdateMerchantEntity:_run_op(ctx, post_done)
  local utility = self._utility
