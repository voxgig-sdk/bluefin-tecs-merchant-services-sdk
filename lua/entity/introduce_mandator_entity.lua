...
local IntroduceMandatorEntity = {}
IntroduceMandatorEntity.__index = IntroduceMandatorEntity


function IntroduceMandatorEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IntroduceMandatorEntity)
  self._name = "introduce_mandator"
  self._client = client
...
function IntroduceMandatorEntity:get_name()
  return self._name
end


function IntroduceMandatorEntity:make()
  local opts = {}
...
function IntroduceMandatorEntity:mark_deleted()
  self._deleted = true
end


function IntroduceMandatorEntity:deleted()
  return true == self._deleted
end


function IntroduceMandatorEntity:data_set(args)
  if args ~= nil then
...
function IntroduceMandatorEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IntroduceMandatorEntity:match_set(args)
  if args ~= nil then
...
function IntroduceMandatorEntity:match_get()
...
function IntroduceMandatorEntity:stream(action, args, callopts)
...
---@param reqdata IntroduceMandatorCreateData
---@param ctrl? table
---@return IntroduceMandator
---@return string? err
function IntroduceMandatorEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function IntroduceMandatorEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return IntroduceMandatorEntity
