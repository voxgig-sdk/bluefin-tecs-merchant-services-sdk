...
local KeepAliveEntity = {}
KeepAliveEntity.__index = KeepAliveEntity


function KeepAliveEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, KeepAliveEntity)
  self._name = "keep_alive"
  self._client = client
...
function KeepAliveEntity:get_name()
  return self._name
end


function KeepAliveEntity:make()
  local opts = {}
...
function KeepAliveEntity:mark_deleted()
  self._deleted = true
end


function KeepAliveEntity:deleted()
  return true == self._deleted
end


function KeepAliveEntity:data_set(args)
  if args ~= nil then
...
function KeepAliveEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function KeepAliveEntity:match_set(args)
  if args ~= nil then
...
function KeepAliveEntity:match_get()
...
function KeepAliveEntity:stream(action, args, callopts)
...
---@param reqdata KeepAliveCreateData
---@param ctrl? table
---@return KeepAlive
---@return string? err
function KeepAliveEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function KeepAliveEntity:_run_op(ctx, post_done)
  local utility = self._utility
