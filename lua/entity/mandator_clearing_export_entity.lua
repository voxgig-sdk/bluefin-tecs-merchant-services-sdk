...
local MandatorClearingExportEntity = {}
MandatorClearingExportEntity.__index = MandatorClearingExportEntity


function MandatorClearingExportEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MandatorClearingExportEntity)
  self._name = "mandator_clearing_export"
  self._client = client
...
function MandatorClearingExportEntity:get_name()
  return self._name
end


function MandatorClearingExportEntity:make()
  local opts = {}
...
function MandatorClearingExportEntity:mark_deleted()
  self._deleted = true
end


function MandatorClearingExportEntity:deleted()
  return true == self._deleted
end


function MandatorClearingExportEntity:data_set(args)
  if args ~= nil then
...
function MandatorClearingExportEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MandatorClearingExportEntity:match_set(args)
  if args ~= nil then
...
function MandatorClearingExportEntity:match_get()
...
function MandatorClearingExportEntity:stream(action, args, callopts)
...
---@param reqdata MandatorClearingExportCreateData
---@param ctrl? table
---@return MandatorClearingExport
---@return string? err
function MandatorClearingExportEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function MandatorClearingExportEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MandatorClearingExportEntity
