...
local ReportDataEntity = {}
ReportDataEntity.__index = ReportDataEntity


function ReportDataEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ReportDataEntity)
  self._name = "report_data"
  self._client = client
...
function ReportDataEntity:get_name()
  return self._name
end


function ReportDataEntity:make()
  local opts = {}
...
function ReportDataEntity:mark_deleted()
  self._deleted = true
end


function ReportDataEntity:deleted()
  return true == self._deleted
end


function ReportDataEntity:data_set(args)
  if args ~= nil then
...
function ReportDataEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ReportDataEntity:match_set(args)
  if args ~= nil then
...
function ReportDataEntity:match_get()
...
function ReportDataEntity:stream(action, args, callopts)
...
---@param reqdata ReportDataCreateData
---@param ctrl? table
---@return ReportData
---@return string? err
function ReportDataEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ReportDataEntity:_run_op(ctx, post_done)
  local utility = self._utility
