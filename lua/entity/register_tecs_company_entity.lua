...
local RegisterTecsCompanyEntity = {}
RegisterTecsCompanyEntity.__index = RegisterTecsCompanyEntity


function RegisterTecsCompanyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RegisterTecsCompanyEntity)
  self._name = "register_tecs_company"
  self._client = client
...
function RegisterTecsCompanyEntity:get_name()
  return self._name
end


function RegisterTecsCompanyEntity:make()
  local opts = {}
...
function RegisterTecsCompanyEntity:mark_deleted()
  self._deleted = true
end


function RegisterTecsCompanyEntity:deleted()
  return true == self._deleted
end


function RegisterTecsCompanyEntity:data_set(args)
  if args ~= nil then
...
function RegisterTecsCompanyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RegisterTecsCompanyEntity:match_set(args)
  if args ~= nil then
...
function RegisterTecsCompanyEntity:match_get()
...
function RegisterTecsCompanyEntity:stream(action, args, callopts)
...
---@param reqdata RegisterTecsCompanyCreateData
---@param ctrl? table
---@return RegisterTecsCompany
---@return string? err
function RegisterTecsCompanyEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function RegisterTecsCompanyEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RegisterTecsCompanyEntity
