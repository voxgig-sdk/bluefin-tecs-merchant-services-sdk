...
local DigitalServicesApiEntity = {}
DigitalServicesApiEntity.__index = DigitalServicesApiEntity


function DigitalServicesApiEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DigitalServicesApiEntity)
  self._name = "digital_services_api"
  self._client = client
...
function DigitalServicesApiEntity:get_name()
  return self._name
end


function DigitalServicesApiEntity:make()
  local opts = {}
...
function DigitalServicesApiEntity:mark_deleted()
  self._deleted = true
end


function DigitalServicesApiEntity:deleted()
  return true == self._deleted
end


function DigitalServicesApiEntity:data_set(args)
  if args ~= nil then
...
function DigitalServicesApiEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DigitalServicesApiEntity:match_set(args)
  if args ~= nil then
...
function DigitalServicesApiEntity:match_get()
...
function DigitalServicesApiEntity:stream(action, args, callopts)
...
---@param reqmatch DigitalServicesApiLoadMatch
---@param ctrl? table
---@return DigitalServicesApi
---@return string? err
function DigitalServicesApiEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata DigitalServicesApiCreateData
---@param ctrl? table
---@return DigitalServicesApi
---@return string? err
function DigitalServicesApiEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function DigitalServicesApiEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DigitalServicesApiEntity
