...
local DeactivateTerminalEntity = {}
DeactivateTerminalEntity.__index = DeactivateTerminalEntity


function DeactivateTerminalEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeactivateTerminalEntity)
  self._name = "deactivate_terminal"
  self._client = client
...
function DeactivateTerminalEntity:get_name()
  return self._name
end


function DeactivateTerminalEntity:make()
  local opts = {}
...
function DeactivateTerminalEntity:mark_deleted()
  self._deleted = true
end


function DeactivateTerminalEntity:deleted()
  return true == self._deleted
end


function DeactivateTerminalEntity:data_set(args)
  if args ~= nil then
...
function DeactivateTerminalEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeactivateTerminalEntity:match_set(args)
  if args ~= nil then
...
function DeactivateTerminalEntity:match_get()
...
function DeactivateTerminalEntity:stream(action, args, callopts)
...
---@param reqdata DeactivateTerminalCreateData
---@param ctrl? table
---@return DeactivateTerminal
---@return string? err
function DeactivateTerminalEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function DeactivateTerminalEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DeactivateTerminalEntity
