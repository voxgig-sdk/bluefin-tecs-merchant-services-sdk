...
local PaymentManualEntity = {}
PaymentManualEntity.__index = PaymentManualEntity


function PaymentManualEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PaymentManualEntity)
  self._name = "payment_manual"
  self._client = client
...
function PaymentManualEntity:get_name()
  return self._name
end


function PaymentManualEntity:make()
  local opts = {}
...
function PaymentManualEntity:mark_deleted()
  self._deleted = true
end


function PaymentManualEntity:deleted()
  return true == self._deleted
end


function PaymentManualEntity:data_set(args)
  if args ~= nil then
...
function PaymentManualEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PaymentManualEntity:match_set(args)
  if args ~= nil then
...
function PaymentManualEntity:match_get()
...
function PaymentManualEntity:stream(action, args, callopts)
...
---@param reqdata PaymentManualCreateData
---@param ctrl? table
---@return PaymentManual
---@return string? err
function PaymentManualEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function PaymentManualEntity:_run_op(ctx, post_done)
  local utility = self._utility
