...
local RefundTransactionEntity = {}
RefundTransactionEntity.__index = RefundTransactionEntity


function RefundTransactionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RefundTransactionEntity)
  self._name = "refund_transaction"
  self._client = client
...
function RefundTransactionEntity:get_name()
  return self._name
end


function RefundTransactionEntity:make()
  local opts = {}
...
function RefundTransactionEntity:mark_deleted()
  self._deleted = true
end


function RefundTransactionEntity:deleted()
  return true == self._deleted
end


function RefundTransactionEntity:data_set(args)
  if args ~= nil then
...
function RefundTransactionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RefundTransactionEntity:match_set(args)
  if args ~= nil then
...
function RefundTransactionEntity:match_get()
...
function RefundTransactionEntity:stream(action, args, callopts)
...
---@param reqdata RefundTransactionCreateData
---@param ctrl? table
---@return RefundTransaction
---@return string? err
function RefundTransactionEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function RefundTransactionEntity:_run_op(ctx, post_done)
  local utility = self._utility
