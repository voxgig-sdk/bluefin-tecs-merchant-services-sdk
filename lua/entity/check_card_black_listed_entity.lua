...
local CheckCardBlackListedEntity = {}
CheckCardBlackListedEntity.__index = CheckCardBlackListedEntity


function CheckCardBlackListedEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CheckCardBlackListedEntity)
  self._name = "check_card_black_listed"
  self._client = client
...
function CheckCardBlackListedEntity:get_name()
  return self._name
end


function CheckCardBlackListedEntity:make()
  local opts = {}
...
function CheckCardBlackListedEntity:mark_deleted()
  self._deleted = true
end


function CheckCardBlackListedEntity:deleted()
  return true == self._deleted
end


function CheckCardBlackListedEntity:data_set(args)
  if args ~= nil then
...
function CheckCardBlackListedEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CheckCardBlackListedEntity:match_set(args)
  if args ~= nil then
...
function CheckCardBlackListedEntity:match_get()
...
function CheckCardBlackListedEntity:stream(action, args, callopts)
...
---@param reqdata CheckCardBlackListedCreateData
---@param ctrl? table
---@return CheckCardBlackListed
---@return string? err
function CheckCardBlackListedEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function CheckCardBlackListedEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CheckCardBlackListedEntity
