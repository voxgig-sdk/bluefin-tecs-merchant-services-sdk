...
describe("VersionDirect", function()
  it("should direct-load-version", function()
    local setup = version_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-version", setup.live and "live" or "unit")
