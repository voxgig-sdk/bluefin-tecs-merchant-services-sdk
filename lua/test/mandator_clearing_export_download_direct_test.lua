...
describe("MandatorClearingExportDownloadDirect", function()
  it("should direct-load-mandator_clearing_export_download", function()
    local setup = mandator_clearing_export_download_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-mandator_clearing_export_download", setup.live and "live" or "unit")
...
function mandator_clearing_export_download_direct_setup(mockres)
