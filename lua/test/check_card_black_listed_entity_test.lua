...
describe("CheckCardBlackListedEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set BLUEFINTECSMERCHANTSERVICES_TEST_CHECK_CARD_BLACK_LISTED_ENTID JSON to run live")
      return
    end
...
function check_card_black_listed_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("BLUEFINTECSMERCHANTSERVICES_TEST_CHECK_CARD_BLACK_LISTED_ENTID")
