...
describe("DeactivateTerminalEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set BLUEFINTECSMERCHANTSERVICES_TEST_DEACTIVATE_TERMINAL_ENTID JSON to run live")
      return
    end
...
function deactivate_terminal_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("BLUEFINTECSMERCHANTSERVICES_TEST_DEACTIVATE_TERMINAL_ENTID")
