...
describe("DigitalServicesApiDirect", function()
  it("should direct-load-digital_services_api", function()
    local setup = digital_services_api_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-digital_services_api", setup.live and "live" or "unit")
...
function digital_services_api_direct_setup(mockres)
