# BluefinTecsMerchantServices SDK proxy feature
#
...
package BluefinTecsMerchantServicesProxyFeature;
...
sub init {
  ...
  if (BluefinTecsMerchantServicesHelpers::is_true($self->{options}{fromEnv})) {
    $self->{url} = $self->{url}
