# BluefinTecsMerchantServices SDK clienttrack feature
#
...
package BluefinTecsMerchantServicesClienttrackFeature;
...
sub _client_name {
  ...
  my $name = defined $self->{options}{clientName}
    ? $self->{options}{clientName} : 'BluefinTecsMerchantServices-SDK';
