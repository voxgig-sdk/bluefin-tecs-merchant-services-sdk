# BluefinTecsMerchantServices SDK utility: make_spec
...
$REGISTRY{make_spec} = sub {
  ...
  my $base = BluefinTecsMerchantServicesHelpers::gp($options, 'base');
  $base = '' unless defined $base;
  my $prefix = BluefinTecsMerchantServicesHelpers::gp($options, 'prefix');
  $prefix = '' unless defined $prefix;
  my $suffix = BluefinTecsMerchantServicesHelpers::gp($options, 'suffix');
  $suffix = '' unless defined $suffix;

  my $parts = [];
  $parts = BluefinTecsMerchantServicesHelpers::gp($point, 'parts') if $point;
  ...
  my $allow_method = BluefinTecsMerchantServicesHelpers::gpath($options, 'allow.method');
  ...
  my $pkind = BluefinTecsMerchantServicesHelpers::gp($ctx->{point}, 'kind');
  if (defined $pkind && 'graphql' eq $pkind) {
    ...
    $ctx->{spec}{headers}{'content-type'} =
      $BluefinTecsMerchantServicesUtilities::GRAPHQL_CONTENT_TYPE;
  }
  else {
