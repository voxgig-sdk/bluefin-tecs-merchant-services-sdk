...
internal static class Fh
{
    ...
    {
        return err is BluefinTecsMerchantServicesError se ? se.Code : "";
    }
}
...
public class FeaturePagingTest
{
    ...
    public void StampsPageLimitAndReadsHeaders()
    {
        ...
        Assert.Equal(2, BluefinTecsMerchantServicesSdk.Helpers.ToInt(paging["nextPage"]));
        Assert.Equal(5, BluefinTecsMerchantServicesSdk.Helpers.ToInt(paging["totalCount"]));
