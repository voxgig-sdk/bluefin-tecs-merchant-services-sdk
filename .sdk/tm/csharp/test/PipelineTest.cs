...
public class PipelineTest
{
    ...
    private static (BluefinTecsMerchantServicesSDK, Utility) PlClient(Dictionary<string, object?>? sdkopts)
    {
        var client = BluefinTecsMerchantServicesSDK.TestSDK(null, sdkopts);
        return (client, client.GetUtility());
    }

    private static Context PlCtx(BluefinTecsMerchantServicesSDK client, Utility utility,
    ...
    private static string ErrCode(Action act)
    {
        ...
        catch (BluefinTecsMerchantServicesError err)
        {
            return err.Code;
        }
        catch (Exception)
    ...
    private class PlEntity : IEntity
    {
        ...
        // BluefinTecsMerchantServicesEntityBase: `remove` marks the instance, which keeps the
    ...
    private static Utility UtilWith(BluefinTecsMerchantServicesSDK client, FetcherFunc fetcher)
    {
    ...
    public void MakeRequestTransportErrorCarriedOnResponse()
    {
        ...
        Assert.True(resp.Err is BluefinTecsMerchantServicesError pe && pe.Code == "boom",
