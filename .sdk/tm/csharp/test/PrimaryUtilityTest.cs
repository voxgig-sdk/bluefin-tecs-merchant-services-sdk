...
public class PrimaryUtilityTest
{
    ...
    private readonly BluefinTecsMerchantServicesSDK _client;
    ...
    public PrimaryUtilityTest()
    {
        ...
        _client = BluefinTecsMerchantServicesSDK.TestSDK(null, null);
        _utility = _client.GetUtility();
    }

    // Helper: create basic test context.
    private Context MakeTestCtx(BluefinTecsMerchantServicesSDK client, Utility utility,
    ...
    private Context MakeTestFullCtx(BluefinTecsMerchantServicesSDK client, Utility utility)
    {
