...
// BluefinTecsMerchantServices SDK pipeline test
//
...
{
    private static function utility(): BluefinTecsMerchantServicesUtility
    {
        return new BluefinTecsMerchantServicesUtility();
    }
    ...
    private static function ctx(array $over = []): BluefinTecsMerchantServicesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new BluefinTecsMerchantServicesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new BluefinTecsMerchantServicesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof BluefinTecsMerchantServicesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new BluefinTecsMerchantServicesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = BluefinTecsMerchantServicesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new BluefinTecsMerchantServicesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = BluefinTecsMerchantServicesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new BluefinTecsMerchantServicesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = BluefinTecsMerchantServicesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BluefinTecsMerchantServicesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = BluefinTecsMerchantServicesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new BluefinTecsMerchantServicesResponse([]),
            'result' => new BluefinTecsMerchantServicesResult([]),
        ]);
        [, $err] = BluefinTecsMerchantServicesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new BluefinTecsMerchantServicesSpec([]),
            'response' => null,
            'result' => new BluefinTecsMerchantServicesResult([]),
        ]);
        [, $err] = BluefinTecsMerchantServicesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new BluefinTecsMerchantServicesSpec(['step' => 's']),
            'response' => new BluefinTecsMerchantServicesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new BluefinTecsMerchantServicesResult([]),
        ]);
        [, $err] = BluefinTecsMerchantServicesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new BluefinTecsMerchantServicesSpec(['step' => 's']),
            'response' => new BluefinTecsMerchantServicesResponse(self::resp(200, ['v' => 1])),
            'result' => new BluefinTecsMerchantServicesResult([]),
        ]);
        [, $err] = BluefinTecsMerchantServicesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new BluefinTecsMerchantServicesSpec(['step' => 's']),
            'response' => new BluefinTecsMerchantServicesResponse(self::resp(200, ['v' => 2])),
            'result' => new BluefinTecsMerchantServicesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        BluefinTecsMerchantServicesMakeResponse::call($ctx);
    ...
    {
        $preset = new BluefinTecsMerchantServicesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new BluefinTecsMerchantServicesSpec([]),
            'response' => new BluefinTecsMerchantServicesResponse([]),
            'result' => new BluefinTecsMerchantServicesResult([]),
        ...
        [$got, $err] = BluefinTecsMerchantServicesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new BluefinTecsMerchantServicesResult([])]);
        [, $err] = BluefinTecsMerchantServicesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new BluefinTecsMerchantServicesSpec([]), 'result' => null]);
        [, $err] = BluefinTecsMerchantServicesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BluefinTecsMerchantServicesSpec(['step' => 's']),
            'result' => new BluefinTecsMerchantServicesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new BluefinTecsMerchantServicesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BluefinTecsMerchantServicesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BluefinTecsMerchantServicesSpec(['step' => 's']),
            'result' => new BluefinTecsMerchantServicesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new BluefinTecsMerchantServicesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BluefinTecsMerchantServicesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BluefinTecsMerchantServicesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new BluefinTecsMerchantServicesSpec([]),
            'result' => new BluefinTecsMerchantServicesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = BluefinTecsMerchantServicesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BluefinTecsMerchantServicesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new BluefinTecsMerchantServicesError('boom', 'boom');
        $utility->fetcher = function (BluefinTecsMerchantServicesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BluefinTecsMerchantServicesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = BluefinTecsMerchantServicesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (BluefinTecsMerchantServicesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = BluefinTecsMerchantServicesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(BluefinTecsMerchantServicesResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        BluefinTecsMerchantServicesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (BluefinTecsMerchantServicesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BluefinTecsMerchantServicesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = BluefinTecsMerchantServicesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new BluefinTecsMerchantServicesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new BluefinTecsMerchantServicesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = BluefinTecsMerchantServicesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = BluefinTecsMerchantServicesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = BluefinTecsMerchantServicesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new BluefinTecsMerchantServicesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, BluefinTecsMerchantServicesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new BluefinTecsMerchantServicesResult(['ok' => false])]);
        $this->expectException(BluefinTecsMerchantServicesError::class);
        BluefinTecsMerchantServicesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new BluefinTecsMerchantServicesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', BluefinTecsMerchantServicesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        BluefinTecsMerchantServicesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new BluefinTecsMerchantServicesBaseFeature();
        $b = new BluefinTecsMerchantServicesBaseFeature();
        BluefinTecsMerchantServicesFeatureAdd::call($ctx, $a);
        BluefinTecsMerchantServicesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): BluefinTecsMerchantServicesBaseFeature
    {
        $f = new BluefinTecsMerchantServicesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        BluefinTecsMerchantServicesFeatureAdd::call($ctx, self::named_feature('a'));
        BluefinTecsMerchantServicesFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        BluefinTecsMerchantServicesFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        BluefinTecsMerchantServicesFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        BluefinTecsMerchantServicesFeatureAdd::call($ctx, $replace);
        ...
        BluefinTecsMerchantServicesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): BluefinTecsMerchantServicesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new BluefinTecsMerchantServicesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BluefinTecsMerchantServicesPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        BluefinTecsMerchantServicesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new BluefinTecsMerchantServicesResponse(['headers' => null]),
            'result' => new BluefinTecsMerchantServicesResult([]),
        ]);
        BluefinTecsMerchantServicesResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        BluefinTecsMerchantServicesResultBody::call($ctx);
