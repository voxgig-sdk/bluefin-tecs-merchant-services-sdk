...
// BluefinTecsMerchantServices SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BluefinTecsMerchantServicesOmni::makeStructRunner(
    ...
    {
        return BluefinTecsMerchantServicesOmni::objmodel(BluefinTecsMerchantServicesOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return BluefinTecsMerchantServicesOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return BluefinTecsMerchantServicesOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BluefinTecsMerchantServicesOmni::structfix($now, Struct::undef()))
                        !== json_encode(BluefinTecsMerchantServicesOmni::structfix($val, Struct::undef()))) {
