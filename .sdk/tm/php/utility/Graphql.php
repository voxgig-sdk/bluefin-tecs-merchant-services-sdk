...
class BluefinTecsMerchantServicesGraphql
{
    ...
    // equivalent.
    public static function body(BluefinTecsMerchantServicesContext $ctx): mixed
    {
    ...
    public static function errors(BluefinTecsMerchantServicesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
