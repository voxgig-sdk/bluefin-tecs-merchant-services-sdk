...
// BluefinTecsMerchantServices SDK timeout feature
...
class BluefinTecsMerchantServicesTimeoutFeature extends BluefinTecsMerchantServicesBaseFeature
{
    ...
    private function _with_timeout(BluefinTecsMerchantServicesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BluefinTecsMerchantServicesContext $_ctx, float $ms): void
    {
        $client = $this->client;
