...
class BluefinTecsMerchantServicesTelemetryFeature extends BluefinTecsMerchantServicesBaseFeature
{
    ...
    private function _close(BluefinTecsMerchantServicesContext $ctx, bool $ok): void
    {
