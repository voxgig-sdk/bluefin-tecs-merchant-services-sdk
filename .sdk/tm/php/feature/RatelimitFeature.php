...
// BluefinTecsMerchantServices SDK ratelimit feature
...
class BluefinTecsMerchantServicesRatelimitFeature extends BluefinTecsMerchantServicesBaseFeature
{
    ...
    private function _acquire(BluefinTecsMerchantServicesContext $ctx): void
    {
    ...
    private function _track(BluefinTecsMerchantServicesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
