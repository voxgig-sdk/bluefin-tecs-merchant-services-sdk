...
class BluefinTecsMerchantServicesAuditFeature extends BluefinTecsMerchantServicesBaseFeature
{
    ...
    private function _emit(BluefinTecsMerchantServicesContext $ctx, string $outcome): void
    {
