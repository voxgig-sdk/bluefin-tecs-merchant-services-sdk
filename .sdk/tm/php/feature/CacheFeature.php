...
// BluefinTecsMerchantServices SDK cache feature
...
class BluefinTecsMerchantServicesCacheFeature extends BluefinTecsMerchantServicesBaseFeature
{
    ...
    private function _through(BluefinTecsMerchantServicesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
