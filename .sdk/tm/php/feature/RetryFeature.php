...
// BluefinTecsMerchantServices SDK retry feature
...
class BluefinTecsMerchantServicesRetryFeature extends BluefinTecsMerchantServicesBaseFeature
{
    ...
    public function init(BluefinTecsMerchantServicesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BluefinTecsMerchantServicesContext $ctx2, string $url, array $fetchdef) use ($inner): array {
            return $this->_with_retry($ctx2, $url, $fetchdef, $inner);
        };
    }

    private function _with_retry(BluefinTecsMerchantServicesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
    ...
    private function _track(BluefinTecsMerchantServicesContext $_ctx, int $attempt, mixed $res, mixed $err, float $wait): void
    {
        $client = $this->client;
