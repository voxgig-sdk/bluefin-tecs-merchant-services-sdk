...
class BluefinTecsMerchantServicesClienttrackFeature extends BluefinTecsMerchantServicesBaseFeature
{
    ...
    public function PostConstruct(BluefinTecsMerchantServicesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BluefinTecsMerchantServices-SDK';
