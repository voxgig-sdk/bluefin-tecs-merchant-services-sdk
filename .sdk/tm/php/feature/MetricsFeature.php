...
class BluefinTecsMerchantServicesMetricsFeature extends BluefinTecsMerchantServicesBaseFeature
{
    ...
    private function _record(BluefinTecsMerchantServicesContext $ctx, bool $ok): void
    {
