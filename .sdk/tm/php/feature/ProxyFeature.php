...
class BluefinTecsMerchantServicesProxyFeature extends BluefinTecsMerchantServicesBaseFeature
{
    ...
    public function init(BluefinTecsMerchantServicesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BluefinTecsMerchantServicesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
