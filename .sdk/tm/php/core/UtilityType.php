...
// BluefinTecsMerchantServices SDK utility type

class BluefinTecsMerchantServicesUtility
{
    ...
    public static function copy(BluefinTecsMerchantServicesUtility $src): BluefinTecsMerchantServicesUtility
    {
        $u = new BluefinTecsMerchantServicesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
