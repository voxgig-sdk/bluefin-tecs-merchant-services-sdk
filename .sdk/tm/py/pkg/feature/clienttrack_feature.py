...
# are never clobbered.
class BluefinTecsMerchantServicesClienttrackFeature(BluefinTecsMerchantServicesBaseFeature):
    def __init__(self):
        super().__init__()
        self.version = "0.0.1"
    ...
    def _name(self):
        name = self.options.get("clientName") or "BluefinTecsMerchantServices-SDK"
