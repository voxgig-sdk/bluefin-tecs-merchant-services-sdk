...
// Shared client runtime for the BluefinTecsMerchantServices SDK. The generated
// BluefinTecsMerchantServicesSDK class extends this with the API-specific entity accessors.
      ...
      Struct.getpath(res, java.util.List.of("data", "errors")) match {
        case errors: JList[_] if !errors.isEmpty =>
          ...
          res.put("err", new SdkError("graphql_error",
            "BluefinTecsMerchantServicesSDK: graphql: " + msg, null))
