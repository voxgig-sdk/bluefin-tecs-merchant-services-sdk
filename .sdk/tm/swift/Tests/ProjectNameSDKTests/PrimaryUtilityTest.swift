...
final class PrimaryUtilityTest: XCTestCase {
  ...
  private static func primaryRun() throws -> OmniResolver.Run {
    ...
    let run = try OmniResolver.makeRunner(
      SdkRunner.testJsonPath(), BluefinTecsMerchantServicesSDK.testSDK(nil, nil))("primary")
    RUN = run
    return run
  }

  // XCTestCase has no custom init; set these up per test.
  private var client: BluefinTecsMerchantServicesSDK!
  private var utility: Utility!

  override func setUp() {
    super.setUp()
    client = BluefinTecsMerchantServicesSDK.testSDK(nil, nil)
  ...
  private func makeTestCtx(_ client: BluefinTecsMerchantServicesSDK, _ utility: Utility,
  ...
  private func makeTestFullCtx(_ client: BluefinTecsMerchantServicesSDK, _ utility: Utility) -> Context {
  ...
  func testFeatureHookBasic() {
    let hookClient = BluefinTecsMerchantServicesSDK.testSDK(nil, nil)
  ...
  func testFeatureInitBasic() {
    let initClient = BluefinTecsMerchantServicesSDK.testSDK(nil, nil)
  ...
  func testExtendOptionInstallsAndInitialisesTheFeature() {
    ...
    let client = BluefinTecsMerchantServicesSDK.testSDK(nil, opts)
  ...
  func testFetcherLive() throws {
    ...
    let liveClient = BluefinTecsMerchantServicesSDK(opts)
  ...
  func testFetcherBlockedTestMode() {
    ...
    let opts = VMap()
    opts.entries["system"] = .map(vm(("fetch", .nat(fetch))))
    let blockedClient = BluefinTecsMerchantServicesSDK(opts)
  ...
  func testMakeSpecBasic() throws {
    ...
    let specClient = BluefinTecsMerchantServicesSDK.testSDK(nil, setupOpts)
  ...
  func testPrepareAuthBasic() throws {
    ...
    let authClient = BluefinTecsMerchantServicesSDK.testSDK(nil, setupOpts)
