...
// ---- SDK client-base generic helpers (Main.fragment BluefinTecsMerchantServicesSDK) -------
...
voxgig_value* sdk_options_map(BluefinTecsMerchantServicesSDK* sdk) { return voxgig_clone(sdk->options); }

Utility* sdk_get_utility(BluefinTecsMerchantServicesSDK* sdk) { return utility_copy(sdk->utility); }

Context* sdk_get_root_ctx(BluefinTecsMerchantServicesSDK* sdk) { return sdk->rootctx; }
