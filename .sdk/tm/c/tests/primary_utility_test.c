...
static void test_primary_fetcher_live(void) {
  ...
  BluefinTecsMerchantServicesSDK* live = projectname_sdk_new(
...
static void test_primary_fetcher_blocked_test_mode(void) {
  BluefinTecsMerchantServicesSDK* blocked = projectname_sdk_new(
...
static void test_primary_new_sdk_smoke(void) {
  BluefinTecsMerchantServicesSDK* client = projectname_sdk_new(v_undef());
