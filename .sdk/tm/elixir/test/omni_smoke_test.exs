# BluefinTecsMerchantServices SDK omni runner smoke test
#
...
defmodule BluefinTecsMerchantServices.OmniSmokeTest do
  use ExUnit.Case
  ...
  defp pack do
    runner = O.make_runner(@spec_smoke, BluefinTecsMerchantServices.test())
    runner.("smoke")
  end
