# BluefinTecsMerchantServices SDK struct corpus test
#
...
defmodule BluefinTecsMerchantServices.StructCorpusTest do
  use ExUnit.Case
  ...
  setup_all do
    ...
    runner = O.make_runner(testfile, BluefinTecsMerchantServices.test())
