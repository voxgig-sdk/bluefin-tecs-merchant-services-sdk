# BluefinTecsMerchantServices SDK corpus test runner: the vendored @voxgig/omni engine driven
...
# and tm/swift/Tests/BluefinTecsMerchantServicesSDKTests/OmniResolver.swift.
#
...
defmodule BluefinTecsMerchantServices.Omni do
  ...
  defp sdkprovider(client) do
    utility = BluefinTecsMerchantServices.get_utility(client)
    ...
    %{
      ...
      client: fn options -> sdkprovider(BluefinTecsMerchantServices.test(nil, tostruct(options))) end,
  ...
  def errify(%BluefinTecsMerchantServices.Error{} = err) do
