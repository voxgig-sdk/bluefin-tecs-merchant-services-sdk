...
defmodule BluefinTecsMerchantServices.Feature.Clienttrack do
  alias Voxgig.Struct, as: S
  alias BluefinTecsMerchantServices.Feature
  ...
  defp name(f) do
    opts = Feature.opts(f)
    n = por(S.getprop(opts, "clientName"), "BluefinTecsMerchantServices-SDK")
