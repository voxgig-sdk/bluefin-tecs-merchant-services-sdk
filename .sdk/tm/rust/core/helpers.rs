// Shared Value helpers for the BluefinTecsMerchantServices SDK pipeline. The SDK data model
...
// underlying API spec doesn't define. The static BluefinTecsMerchantServicesEntity trait
...
pub fn unsupported_op(opname: &str, entityname: &str) -> BluefinTecsMerchantServicesError {
    BluefinTecsMerchantServicesError::new(
        "unsupported_op",
        &format!(
