...
pub struct CtxSpec {
    ...
    pub client: Option<Rc<BluefinTecsMerchantServicesSDK>>,
...
pub struct Context {
    ...
    pub client: RefCell<Option<Rc<BluefinTecsMerchantServicesSDK>>>,
...
impl Context {
    ...
    pub fn make_error(&self, code: &str, msg: &str) -> BluefinTecsMerchantServicesError {
