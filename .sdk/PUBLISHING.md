...
|---|---|---|
| `js/` | @voxgig-sdk/bluefin-tecs-merchant-services-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/bluefin-tecs-merchant-services | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/bluefin-tecs-merchant-services-js \
      --repository voxgig-sdk/bluefin-tecs-merchant-services-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/bluefin-tecs-merchant-services-js` shows it, and
`npm trust revoke @voxgig-sdk/bluefin-tecs-merchant-services-js --id=<id>` removes it.
