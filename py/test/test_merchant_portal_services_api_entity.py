    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set BLUEFINTECSMERCHANTSERVICES_TEST_MERCHANT_PORTAL_SERVICES_API_ENTID JSON to run live")
        client = setup["client"]
        ...
        merchant_portal_services_api_ref01_data = helpers.to_map(merchant_portal_services_api_ref01_ent.create(merchant_portal_services_api_ref01_data, None))
...
def _merchant_portal_services_api_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("BLUEFINTECSMERCHANTSERVICES_TEST_MERCHANT_PORTAL_SERVICES_API_ENTID"))
