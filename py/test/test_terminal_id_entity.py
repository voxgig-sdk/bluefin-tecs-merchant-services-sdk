    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set BLUEFINTECSMERCHANTSERVICES_TEST_TERMINAL_ID_ENTID JSON to run live")
        client = setup["client"]
        ...
        terminal_id_ref01_data = helpers.to_map(terminal_id_ref01_ent.create(terminal_id_ref01_data, None))
...
def _terminal_id_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("BLUEFINTECSMERCHANTSERVICES_TEST_TERMINAL_ID_ENTID"))
