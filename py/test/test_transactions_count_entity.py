    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set BLUEFINTECSMERCHANTSERVICES_TEST_TRANSACTIONS_COUNT_ENTID JSON to run live")
        client = setup["client"]
        ...
        transactions_count_ref01_data = helpers.to_map(transactions_count_ref01_ent.create(transactions_count_ref01_data, None))
...
def _transactions_count_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("BLUEFINTECSMERCHANTSERVICES_TEST_TRANSACTIONS_COUNT_ENTID"))
