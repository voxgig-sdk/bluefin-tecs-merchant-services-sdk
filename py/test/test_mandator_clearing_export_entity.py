    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set BLUEFINTECSMERCHANTSERVICES_TEST_MANDATOR_CLEARING_EXPORT_ENTID JSON to run live")
        client = setup["client"]
        ...
        mandator_clearing_export_ref01_data = helpers.to_map(mandator_clearing_export_ref01_ent.create(mandator_clearing_export_ref01_data, None))
...
def _mandator_clearing_export_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("BLUEFINTECSMERCHANTSERVICES_TEST_MANDATOR_CLEARING_EXPORT_ENTID"))
