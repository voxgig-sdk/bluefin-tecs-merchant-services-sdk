    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set BLUEFINTECSMERCHANTSERVICES_TEST_MOVE_TID_ENTID JSON to run live")
        client = setup["client"]
        ...
        move_tid_ref01_data = helpers.to_map(move_tid_ref01_ent.create(move_tid_ref01_data, None))
...
def _move_tid_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("BLUEFINTECSMERCHANTSERVICES_TEST_MOVE_TID_ENTID"))
