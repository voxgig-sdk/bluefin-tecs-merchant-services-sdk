    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set BLUEFINTECSMERCHANTSERVICES_TEST_DIGITAL_SERVICES_API_ENTID JSON to run live")
        client = setup["client"]
        ...
        digital_services_api_ref01_data = helpers.to_map(digital_services_api_ref01_ent.create(digital_services_api_ref01_data, None))
...
def _digital_services_api_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("BLUEFINTECSMERCHANTSERVICES_TEST_DIGITAL_SERVICES_API_ENTID"))
