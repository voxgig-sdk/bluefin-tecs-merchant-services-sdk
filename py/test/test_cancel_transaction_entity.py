    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set BLUEFINTECSMERCHANTSERVICES_TEST_CANCEL_TRANSACTION_ENTID JSON to run live")
        client = setup["client"]
        ...
        cancel_transaction_ref01_data = helpers.to_map(cancel_transaction_ref01_ent.create(cancel_transaction_ref01_data, None))
...
def _cancel_transaction_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("BLUEFINTECSMERCHANTSERVICES_TEST_CANCEL_TRANSACTION_ENTID"))
