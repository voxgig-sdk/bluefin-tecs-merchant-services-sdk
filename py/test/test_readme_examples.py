# BluefinTecsMerchantServices SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BluefinTecsMerchantServicesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BluefinTecsMerchantServicesSDK(...) and BluefinTecsMerchantServicesSDK.test(...) become
#      BluefinTecsMerchantServicesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "bluefintecsmerchantservices_sdk"
_SDK_CLASS = "BluefinTecsMerchantServicesSDK"
...
_ENTITIES = {
    ...
    "EcDataEcom": "ec_data_ecom",
    "EcomParameter": "ecom_parameter",
    "EcrData": "ecr_data",
    "EmvData": "emv_data",
    "EnableAcquiring": "enable_acquiring",
    "GetMerchantContractNumber": "get_merchant_contract_number",
    "GetTemplateXml": "get_template_xml",
    "IntroduceMandator": "introduce_mandator",
    "IntroducePackage": "introduce_package",
    "KeepAlive": "keep_alive",
    "ListTerminal": "list_terminal",
    "MandatorClearingExport": "mandator_clearing_export",
    "MandatorClearingExportDownload": "mandator_clearing_export_download",
    "MandatorClearingExportSummary": "mandator_clearing_export_summary",
    "MerchantPortalServicesApi": "merchant_portal_services_api",
    "MoveTid": "move_tid",
    "PaymentManual": "payment_manual",
    "PaymentSred": "payment_sred",
    "PreAuthTransactionCompletion": "pre_auth_transaction_completion",
    "ReactivateTerminal": "reactivate_terminal",
    "RefundTransaction": "refund_transaction",
    "RegisterTecsCompany": "register_tecs_company",
    ...
    "UpdateTemplateXml": "update_template_xml",
    "Version": "version",
}
