    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set BLUEFIN_TECS_MERCHANT_SERVICES_TEST_PRE_AUTH_TRANSACTION_COMPLETION_ENTID JSON to run live")
        client = setup["client"]
        ...
        pre_auth_transaction_completion_ref01_data = helpers.to_map(runner.entity_data(pre_auth_transaction_completion_ref01_ent.create(pre_auth_transaction_completion_ref01_data, None)))
...
def _pre_auth_transaction_completion_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("BLUEFIN_TECS_MERCHANT_SERVICES_TEST_PRE_AUTH_TRANSACTION_COMPLETION_ENTID"))
