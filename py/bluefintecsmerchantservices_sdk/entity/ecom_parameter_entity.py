...
class EcomParameterEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EcomParameterEntity(self._client, opts)
    ...
    def data_get(self) -> EcomParameter:
    ...
    def match_get(self) -> EcomParameter:
    ...
    def create(self, reqdata: EcomParameterCreateData, ctrl=None) -> EcomParameter:
        utility = self._utility
