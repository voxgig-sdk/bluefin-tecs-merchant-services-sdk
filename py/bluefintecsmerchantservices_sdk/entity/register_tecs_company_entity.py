...
class RegisterTecsCompanyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RegisterTecsCompanyEntity(self._client, opts)
    ...
    def data_get(self) -> RegisterTecsCompany:
    ...
    def match_get(self) -> RegisterTecsCompany:
    ...
    def create(self, reqdata: RegisterTecsCompanyCreateData, ctrl=None) -> RegisterTecsCompany:
        utility = self._utility
