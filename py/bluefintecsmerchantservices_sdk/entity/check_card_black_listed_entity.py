...
class CheckCardBlackListedEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CheckCardBlackListedEntity(self._client, opts)
    ...
    def data_get(self) -> CheckCardBlackListed:
    ...
    def match_get(self) -> CheckCardBlackListed:
    ...
    def create(self, reqdata: CheckCardBlackListedCreateData, ctrl=None) -> CheckCardBlackListed:
        utility = self._utility
