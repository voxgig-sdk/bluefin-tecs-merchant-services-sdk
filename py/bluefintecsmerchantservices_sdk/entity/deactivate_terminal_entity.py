...
class DeactivateTerminalEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DeactivateTerminalEntity(self._client, opts)
    ...
    def data_get(self) -> DeactivateTerminal:
    ...
    def match_get(self) -> DeactivateTerminal:
    ...
    def create(self, reqdata: DeactivateTerminalCreateData, ctrl=None) -> DeactivateTerminal:
        utility = self._utility
