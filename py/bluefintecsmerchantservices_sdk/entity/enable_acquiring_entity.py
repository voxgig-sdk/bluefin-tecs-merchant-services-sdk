...
class EnableAcquiringEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EnableAcquiringEntity(self._client, opts)
    ...
    def data_get(self) -> EnableAcquiring:
    ...
    def match_get(self) -> EnableAcquiring:
    ...
    def create(self, reqdata: EnableAcquiringCreateData, ctrl=None) -> EnableAcquiring:
        utility = self._utility
