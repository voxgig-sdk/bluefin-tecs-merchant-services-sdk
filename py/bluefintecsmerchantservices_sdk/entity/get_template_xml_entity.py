...
class GetTemplateXmlEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetTemplateXmlEntity(self._client, opts)
    ...
    def data_get(self) -> GetTemplateXml:
    ...
    def match_get(self) -> GetTemplateXml:
    ...
    def create(self, reqdata: GetTemplateXmlCreateData, ctrl=None) -> GetTemplateXml:
        utility = self._utility
