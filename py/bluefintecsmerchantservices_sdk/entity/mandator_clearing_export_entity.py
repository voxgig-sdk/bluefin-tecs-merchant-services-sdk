...
class MandatorClearingExportEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MandatorClearingExportEntity(self._client, opts)
    ...
    def data_get(self) -> MandatorClearingExport:
    ...
    def match_get(self) -> MandatorClearingExport:
    ...
    def create(self, reqdata: MandatorClearingExportCreateData, ctrl=None) -> MandatorClearingExport:
        utility = self._utility
