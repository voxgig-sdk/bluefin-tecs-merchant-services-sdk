...
class TransactionsTurnoverEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TransactionsTurnoverEntity(self._client, opts)
    ...
    def data_get(self) -> TransactionsTurnover:
    ...
    def match_get(self) -> TransactionsTurnover:
    ...
    def create(self, reqdata: TransactionsTurnoverCreateData, ctrl=None) -> TransactionsTurnover:
        utility = self._utility
