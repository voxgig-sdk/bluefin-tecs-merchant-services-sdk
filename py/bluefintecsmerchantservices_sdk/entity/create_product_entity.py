...
class CreateProductEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CreateProductEntity(self._client, opts)
    ...
    def data_get(self) -> CreateProduct:
    ...
    def match_get(self) -> CreateProduct:
    ...
    def create(self, reqdata: CreateProductCreateData, ctrl=None) -> CreateProduct:
        utility = self._utility
