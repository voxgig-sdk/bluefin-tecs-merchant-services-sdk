...
class IntroduceMandatorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return IntroduceMandatorEntity(self._client, opts)
    ...
    def data_get(self) -> IntroduceMandator:
    ...
    def match_get(self) -> IntroduceMandator:
    ...
    def create(self, reqdata: IntroduceMandatorCreateData, ctrl=None) -> IntroduceMandator:
        utility = self._utility
