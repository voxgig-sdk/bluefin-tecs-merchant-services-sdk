...
class RegisterTerminalEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RegisterTerminalEntity(self._client, opts)
    ...
    def data_get(self) -> RegisterTerminal:
    ...
    def match_get(self) -> RegisterTerminal:
    ...
    def create(self, reqdata: RegisterTerminalCreateData, ctrl=None) -> RegisterTerminal:
        utility = self._utility
