...
class EcDataEcomEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EcDataEcomEntity(self._client, opts)
    ...
    def create(self, reqdata: EcDataEcomCreateData, ctrl=None) -> EcDataEcom:
        utility = self._utility
