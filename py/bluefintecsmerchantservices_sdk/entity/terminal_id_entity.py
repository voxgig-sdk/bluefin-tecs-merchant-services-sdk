...
class TerminalIdEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TerminalIdEntity(self._client, opts)
    ...
    def create(self, reqdata: TerminalIdCreateData, ctrl=None) -> TerminalId:
        utility = self._utility
