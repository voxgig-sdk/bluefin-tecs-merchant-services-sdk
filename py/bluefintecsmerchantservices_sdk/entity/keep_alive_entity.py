...
class KeepAliveEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return KeepAliveEntity(self._client, opts)
    ...
    def create(self, reqdata: KeepAliveCreateData, ctrl=None) -> KeepAlive:
        utility = self._utility
