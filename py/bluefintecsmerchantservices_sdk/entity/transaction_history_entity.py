...
class TransactionHistoryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TransactionHistoryEntity(self._client, opts)
    ...
    def data_get(self) -> TransactionHistory:
    ...
    def match_get(self) -> TransactionHistory:
    ...
    def create(self, reqdata: TransactionHistoryCreateData, ctrl=None) -> TransactionHistory:
        utility = self._utility
