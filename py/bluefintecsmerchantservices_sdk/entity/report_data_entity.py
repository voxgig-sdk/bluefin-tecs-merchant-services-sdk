...
class ReportDataEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ReportDataEntity(self._client, opts)
    ...
    def create(self, reqdata: ReportDataCreateData, ctrl=None) -> ReportData:
        utility = self._utility
