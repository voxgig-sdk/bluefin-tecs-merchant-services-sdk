...
class MerchantPortalServicesApiEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MerchantPortalServicesApiEntity(self._client, opts)
    ...
    def data_get(self) -> MerchantPortalServicesApi:
    ...
    def match_get(self) -> MerchantPortalServicesApi:
    ...
    def create(self, reqdata: MerchantPortalServicesApiCreateData, ctrl=None) -> MerchantPortalServicesApi:
        utility = self._utility
