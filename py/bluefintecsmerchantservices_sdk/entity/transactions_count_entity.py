...
class TransactionsCountEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TransactionsCountEntity(self._client, opts)
    ...
    def data_get(self) -> TransactionsCount:
    ...
    def match_get(self) -> TransactionsCount:
    ...
    def create(self, reqdata: TransactionsCountCreateData, ctrl=None) -> TransactionsCount:
        utility = self._utility
