...
class UpdateMerchantEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UpdateMerchantEntity(self._client, opts)
    ...
    def data_get(self) -> UpdateMerchant:
    ...
    def match_get(self) -> UpdateMerchant:
    ...
    def create(self, reqdata: UpdateMerchantCreateData, ctrl=None) -> UpdateMerchant:
        utility = self._utility
