...
class PaymentSredEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PaymentSredEntity(self._client, opts)
    ...
    def match_get(self) -> PaymentSred:
    ...
    def create(self, reqdata: PaymentSredCreateData, ctrl=None) -> PaymentSred:
        utility = self._utility
