...
class MandatorClearingExportSummaryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MandatorClearingExportSummaryEntity(self._client, opts)
    ...
    def data_get(self) -> MandatorClearingExportSummary:
    ...
    def match_get(self) -> MandatorClearingExportSummary:
    ...
    def create(self, reqdata: MandatorClearingExportSummaryCreateData, ctrl=None) -> MandatorClearingExportSummary:
        utility = self._utility
