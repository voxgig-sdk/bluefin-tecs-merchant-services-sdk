...
class PreAuthTransactionCompletionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PreAuthTransactionCompletionEntity(self._client, opts)
    ...
    def data_get(self) -> PreAuthTransactionCompletion:
    ...
    def match_get(self) -> PreAuthTransactionCompletion:
    ...
    def create(self, reqdata: PreAuthTransactionCompletionCreateData, ctrl=None) -> PreAuthTransactionCompletion:
        utility = self._utility
