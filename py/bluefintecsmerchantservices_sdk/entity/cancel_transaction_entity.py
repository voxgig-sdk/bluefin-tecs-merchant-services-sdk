...
class CancelTransactionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CancelTransactionEntity(self._client, opts)
    ...
    def data_get(self) -> CancelTransaction:
    ...
    def match_get(self) -> CancelTransaction:
    ...
    def create(self, reqdata: CancelTransactionCreateData, ctrl=None) -> CancelTransaction:
        utility = self._utility
