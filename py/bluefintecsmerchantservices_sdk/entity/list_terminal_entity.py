...
class ListTerminalEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ListTerminalEntity(self._client, opts)
    ...
    def data_get(self) -> ListTerminal:
    ...
    def match_get(self) -> ListTerminal:
    ...
    def create(self, reqdata: ListTerminalCreateData, ctrl=None) -> ListTerminal:
        utility = self._utility
