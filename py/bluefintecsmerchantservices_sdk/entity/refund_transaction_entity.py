...
class RefundTransactionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RefundTransactionEntity(self._client, opts)
    ...
    def data_get(self) -> RefundTransaction:
    ...
    def match_get(self) -> RefundTransaction:
    ...
    def create(self, reqdata: RefundTransactionCreateData, ctrl=None) -> RefundTransaction:
        utility = self._utility
