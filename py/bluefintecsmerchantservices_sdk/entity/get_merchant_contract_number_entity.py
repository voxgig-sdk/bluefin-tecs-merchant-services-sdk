...
class GetMerchantContractNumberEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetMerchantContractNumberEntity(self._client, opts)
    ...
    def data_get(self) -> GetMerchantContractNumber:
    ...
    def match_get(self) -> GetMerchantContractNumber:
    ...
    def create(self, reqdata: GetMerchantContractNumberCreateData, ctrl=None) -> GetMerchantContractNumber:
        utility = self._utility
