...
class ReactivateTerminalEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ReactivateTerminalEntity(self._client, opts)
    ...
    def data_get(self) -> ReactivateTerminal:
    ...
    def match_get(self) -> ReactivateTerminal:
    ...
    def create(self, reqdata: ReactivateTerminalCreateData, ctrl=None) -> ReactivateTerminal:
        utility = self._utility
