...
class PaymentManualEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PaymentManualEntity(self._client, opts)
    ...
    def data_get(self) -> PaymentManual:
    ...
    def match_get(self) -> PaymentManual:
    ...
    def create(self, reqdata: PaymentManualCreateData, ctrl=None) -> PaymentManual:
        utility = self._utility
