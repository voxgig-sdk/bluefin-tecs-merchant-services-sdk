...
class TransactionsCountCardBrandEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TransactionsCountCardBrandEntity(self._client, opts)
    ...
    def data_get(self) -> TransactionsCountCardBrand:
    ...
    def match_get(self) -> TransactionsCountCardBrand:
    ...
    def create(self, reqdata: TransactionsCountCardBrandCreateData, ctrl=None) -> TransactionsCountCardBrand:
        utility = self._utility
