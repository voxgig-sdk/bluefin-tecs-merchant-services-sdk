...
class StoreTerminalParameterEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return StoreTerminalParameterEntity(self._client, opts)
    ...
    def data_get(self) -> StoreTerminalParameter:
    ...
    def match_get(self) -> StoreTerminalParameter:
    ...
    def create(self, reqdata: StoreTerminalParameterCreateData, ctrl=None) -> StoreTerminalParameter:
        utility = self._utility
