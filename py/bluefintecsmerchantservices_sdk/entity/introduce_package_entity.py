...
class IntroducePackageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return IntroducePackageEntity(self._client, opts)
    ...
    def data_get(self) -> IntroducePackage:
    ...
    def match_get(self) -> IntroducePackage:
    ...
    def create(self, reqdata: IntroducePackageCreateData, ctrl=None) -> IntroducePackage:
        utility = self._utility
