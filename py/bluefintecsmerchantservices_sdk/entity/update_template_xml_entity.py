...
class UpdateTemplateXmlEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UpdateTemplateXmlEntity(self._client, opts)
    ...
    def data_get(self) -> UpdateTemplateXml:
    ...
    def match_get(self) -> UpdateTemplateXml:
    ...
    def create(self, reqdata: UpdateTemplateXmlCreateData, ctrl=None) -> UpdateTemplateXml:
        utility = self._utility
