...
class StatusTransactionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return StatusTransactionEntity(self._client, opts)
    ...
    def data_get(self) -> StatusTransaction:
    ...
    def match_get(self) -> StatusTransaction:
    ...
    def create(self, reqdata: StatusTransactionCreateData, ctrl=None) -> StatusTransaction:
        utility = self._utility
