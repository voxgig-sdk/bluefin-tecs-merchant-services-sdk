...
from bluefintecsmerchantservices_sdk.core.control import BluefinTecsMerchantServicesControl
...
from bluefintecsmerchantservices_sdk.core.helpers import get_ctx_prop, to_map
...
class BluefinTecsMerchantServicesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = BluefinTecsMerchantServicesControl()
        ...
        if isinstance(sp, BluefinTecsMerchantServicesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BluefinTecsMerchantServicesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BluefinTecsMerchantServicesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return BluefinTecsMerchantServicesOperation({})
        ...
        op = BluefinTecsMerchantServicesOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return BluefinTecsMerchantServicesError(code, msg, self)
