...
from bluefintecsmerchantservices_sdk.feature.debug_feature import BluefinTecsMerchantServicesDebugFeature
...
_FEATURES = {
    ...
    "debug": lambda: BluefinTecsMerchantServicesDebugFeature(),
