...
#      (BluefinTecsMerchantServicesSDK->test) against the real SDK. Captured output is scanned for
...
my $SDK_CLASS = 'BluefinTecsMerchantServicesSDK';
...
# becomes BluefinTecsMerchantServicesSDK->test(<fixtures>); a block that only uses $client gets
