# BluefinTecsMerchantServices SDK DigitalServicesApi entity
...
package DigitalServicesApiEntity;
...
sub make {
  ...
  return DigitalServicesApiEntity->new($self->{_client}, $opts);
}
...
# Returns the current DigitalServicesApi data (hashref).
sub data_get {
  my ($self) = @_;
...
# Returns the current match filter (any subset of DigitalServicesApi fields).
sub match_get {
  my ($self) = @_;
...
# Load a single DigitalServicesApi.
#
# reqmatch: match criteria hashref (id/query fields; DigitalServicesApiLoadMatch
...
# Returns the loaded DigitalServicesApi data (hashref); dies with BluefinTecsMerchantServicesError
# on failure.
sub load {
...
# Create a new DigitalServicesApi.
#
# reqdata: body data hashref (DigitalServicesApiCreateData shape). ctrl: optional
# per-call control. Returns the created DigitalServicesApi data (hashref); dies
