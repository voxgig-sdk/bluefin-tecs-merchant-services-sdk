# BluefinTecsMerchantServices SDK MandatorClearingExportSummary entity
...
package MandatorClearingExportSummaryEntity;
...
sub new {
  ...
  my $self = bless {
    _name => 'mandator_clearing_export_summary',
    _client => $client,
...
sub make {
  ...
  return MandatorClearingExportSummaryEntity->new($self->{_client}, $opts);
}
...
# Returns the current MandatorClearingExportSummary data (hashref).
sub data_get {
  my ($self) = @_;
...
# Returns the current match filter (any subset of MandatorClearingExportSummary fields).
sub match_get {
  my ($self) = @_;
...
# Create a new MandatorClearingExportSummary.
#
# reqdata: body data hashref (MandatorClearingExportSummaryCreateData shape). ctrl: optional
# per-call control. Returns the created MandatorClearingExportSummary data (hashref); dies
