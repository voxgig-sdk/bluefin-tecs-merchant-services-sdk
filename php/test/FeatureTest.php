...
// BluefinTecsMerchantServices SDK feature test
//
...
class FtCtrl extends BluefinTecsMerchantServicesControl
{
...
class FtClient
{
    ...
    private BluefinTecsMerchantServicesUtility $utility;

    public function __construct(BluefinTecsMerchantServicesUtility $utility, array $options)
    {
    ...
    public function get_utility(): BluefinTecsMerchantServicesUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (BluefinTecsMerchantServicesContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public BluefinTecsMerchantServicesContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (BluefinTecsMerchantServicesContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = BluefinTecsMerchantServicesConfig::make_feature($name);
    ...
    private static function buildUrl(BluefinTecsMerchantServicesSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof BluefinTecsMerchantServicesError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new BluefinTecsMerchantServicesResponse($fetched);
        }
    ...
    private function fail(BluefinTecsMerchantServicesContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (BluefinTecsMerchantServicesContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
