...
class MandatorClearingExportDownloadDirectTest extends TestCase
{
    public function test_direct_load_mandator_clearing_export_download(): void
    {
        $setup = mandator_clearing_export_download_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-mandator_clearing_export_download", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
