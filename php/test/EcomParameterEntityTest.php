...
class EcomParameterEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set BLUEFINTECSMERCHANTSERVICES_TEST_ECOM_PARAMETER_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function ecom_parameter_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("BLUEFINTECSMERCHANTSERVICES_TEST_ECOM_PARAMETER_ENTID");
