...
class MoveTidEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set BLUEFINTECSMERCHANTSERVICES_TEST_MOVE_TID_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function move_tid_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("BLUEFINTECSMERCHANTSERVICES_TEST_MOVE_TID_ENTID");
