...
class BluefinTecsMerchantServicesMakeRequest
{
    public static function call(BluefinTecsMerchantServicesContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BluefinTecsMerchantServicesResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BluefinTecsMerchantServicesResponse($fetched);
        } else {
