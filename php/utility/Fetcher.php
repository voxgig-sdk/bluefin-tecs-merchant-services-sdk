...
class BluefinTecsMerchantServicesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BluefinTecsMerchantServicesSDK/1.0)';
    ...
    public static function call(BluefinTecsMerchantServicesContext $ctx, string $fullurl, array $fetchdef): array
    {
