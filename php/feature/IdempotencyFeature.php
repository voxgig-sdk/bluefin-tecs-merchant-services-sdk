...
class BluefinTecsMerchantServicesIdempotencyFeature extends BluefinTecsMerchantServicesBaseFeature
{
    ...
    private function _mutating(BluefinTecsMerchantServicesContext $ctx): bool
    {
