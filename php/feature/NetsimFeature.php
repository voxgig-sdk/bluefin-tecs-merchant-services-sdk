...
// BluefinTecsMerchantServices SDK netsim feature
...
class BluefinTecsMerchantServicesNetsimFeature extends BluefinTecsMerchantServicesBaseFeature
{
    ...
    private function _simulate(BluefinTecsMerchantServicesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BluefinTecsMerchantServicesContext $ctx, array $applied): void
    {
        $client = $this->client;
