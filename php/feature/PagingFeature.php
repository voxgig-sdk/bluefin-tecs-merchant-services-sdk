...
class BluefinTecsMerchantServicesPagingFeature extends BluefinTecsMerchantServicesBaseFeature
{
    ...
    private function _graphql_pre_request(BluefinTecsMerchantServicesContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(BluefinTecsMerchantServicesContext $ctx): bool
    {
