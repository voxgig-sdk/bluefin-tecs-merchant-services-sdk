...
// BluefinTecsMerchantServices SDK rbac feature
...
class BluefinTecsMerchantServicesRbacFeature extends BluefinTecsMerchantServicesBaseFeature
{
    ...
    private function _required(BluefinTecsMerchantServicesContext $ctx): ?string
    {
    ...
    private function _reject(BluefinTecsMerchantServicesContext $ctx, string $required): void
    {
    ...
    private function _track(BluefinTecsMerchantServicesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
