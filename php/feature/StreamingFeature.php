...
class BluefinTecsMerchantServicesStreamingFeature extends BluefinTecsMerchantServicesBaseFeature
{
    ...
    private function _iterate(BluefinTecsMerchantServicesResult $result): \Generator
    {
    ...
    private function _streamable(BluefinTecsMerchantServicesContext $ctx): bool
    {
