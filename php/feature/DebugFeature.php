...
class BluefinTecsMerchantServicesDebugFeature extends BluefinTecsMerchantServicesBaseFeature
{
    ...
    private function _finish(BluefinTecsMerchantServicesContext $ctx, bool $ok): void
    {
