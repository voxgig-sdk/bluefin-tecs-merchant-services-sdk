...
class ReportDataEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ReportDataEntity($this->_client, $opts);
    }

    /**
     * @param ReportData|array $args ReportData data (assoc-array) to store.
     */
    ...
    /**
     * @return ReportData|array The current ReportData data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ReportData fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ReportData fields).
     */
     ...
     *
     * @param ReportDataCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ReportDataCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReportData|array The created ReportData as an assoc-array at the
