...
class TransactionsCountCardBrandEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "transactions_count_card_brand";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new TransactionsCountCardBrandEntity($this->_client, $opts);
    }

    /**
     * @param TransactionsCountCardBrand|array $args TransactionsCountCardBrand data (assoc-array) to store.
     */
    ...
    /**
     * @return TransactionsCountCardBrand|array The current TransactionsCountCardBrand data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TransactionsCountCardBrand fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TransactionsCountCardBrand fields).
     */
     ...
     *
     * @param TransactionsCountCardBrandCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TransactionsCountCardBrandCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TransactionsCountCardBrand|array The created TransactionsCountCardBrand as an assoc-array at the
