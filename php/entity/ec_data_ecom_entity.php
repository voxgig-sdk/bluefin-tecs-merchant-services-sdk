...
class EcDataEcomEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EcDataEcomEntity($this->_client, $opts);
    }

    /**
     * @param EcDataEcom|array $args EcDataEcom data (assoc-array) to store.
     */
    ...
    /**
     * @return EcDataEcom|array The current EcDataEcom data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EcDataEcom fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EcDataEcom fields).
     */
     ...
     *
     * @param EcDataEcomCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EcDataEcomCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EcDataEcom|array The created EcDataEcom as an assoc-array at the
