...
class CheckCardBlackListedEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "check_card_black_listed";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CheckCardBlackListedEntity($this->_client, $opts);
    }

    /**
     * @param CheckCardBlackListed|array $args CheckCardBlackListed data (assoc-array) to store.
     */
    ...
    /**
     * @return CheckCardBlackListed|array The current CheckCardBlackListed data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CheckCardBlackListed fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CheckCardBlackListed fields).
     */
     ...
     *
     * @param CheckCardBlackListedCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CheckCardBlackListedCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CheckCardBlackListed|array The created CheckCardBlackListed as an assoc-array at the
