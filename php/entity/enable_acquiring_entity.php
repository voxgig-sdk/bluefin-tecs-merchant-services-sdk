...
class EnableAcquiringEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EnableAcquiringEntity($this->_client, $opts);
    }

    /**
     * @param EnableAcquiring|array $args EnableAcquiring data (assoc-array) to store.
     */
    ...
    /**
     * @return EnableAcquiring|array The current EnableAcquiring data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EnableAcquiring fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EnableAcquiring fields).
     */
     ...
     *
     * @param EnableAcquiringCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EnableAcquiringCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EnableAcquiring|array The created EnableAcquiring as an assoc-array at the
