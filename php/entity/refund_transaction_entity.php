...
class RefundTransactionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RefundTransactionEntity($this->_client, $opts);
    }

    /**
     * @param RefundTransaction|array $args RefundTransaction data (assoc-array) to store.
     */
    ...
    /**
     * @return RefundTransaction|array The current RefundTransaction data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RefundTransaction fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RefundTransaction fields).
     */
     ...
     *
     * @param RefundTransactionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RefundTransactionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RefundTransaction|array The created RefundTransaction as an assoc-array at the
