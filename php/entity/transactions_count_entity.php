...
class TransactionsCountEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TransactionsCountEntity($this->_client, $opts);
    }

    /**
     * @param TransactionsCount|array $args TransactionsCount data (assoc-array) to store.
     */
    ...
    /**
     * @return TransactionsCount|array The current TransactionsCount data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TransactionsCount fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TransactionsCount fields).
     */
     ...
     *
     * @param TransactionsCountCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TransactionsCountCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TransactionsCount|array The created TransactionsCount as an assoc-array at the
