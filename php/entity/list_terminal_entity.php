...
class ListTerminalEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ListTerminalEntity($this->_client, $opts);
    }

    /**
     * @param ListTerminal|array $args ListTerminal data (assoc-array) to store.
     */
    ...
    /**
     * @return ListTerminal|array The current ListTerminal data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ListTerminal fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ListTerminal fields).
     */
     ...
     *
     * @param ListTerminalCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ListTerminalCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ListTerminal|array The created ListTerminal as an assoc-array at the
