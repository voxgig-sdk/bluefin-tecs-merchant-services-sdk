...
class EmvDataEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EmvDataEntity($this->_client, $opts);
    }

    /**
     * @param EmvData|array $args EmvData data (assoc-array) to store.
     */
    ...
    /**
     * @return EmvData|array The current EmvData data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmvData fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmvData fields).
     */
     ...
     *
     * @param EmvDataCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EmvDataCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmvData|array The created EmvData as an assoc-array at the
