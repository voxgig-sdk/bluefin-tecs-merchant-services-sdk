...
class MerchantPortalServicesApiEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "merchant_portal_services_api";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MerchantPortalServicesApiEntity($this->_client, $opts);
    }

    /**
     * @param MerchantPortalServicesApi|array $args MerchantPortalServicesApi data (assoc-array) to store.
     */
    ...
    /**
     * @return MerchantPortalServicesApi|array The current MerchantPortalServicesApi data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MerchantPortalServicesApi fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MerchantPortalServicesApi fields).
     */
     ...
     *
     * @param MerchantPortalServicesApiCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MerchantPortalServicesApiCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MerchantPortalServicesApi|array The created MerchantPortalServicesApi as an assoc-array at the
