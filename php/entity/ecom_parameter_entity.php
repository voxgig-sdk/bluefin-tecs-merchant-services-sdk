...
class EcomParameterEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EcomParameterEntity($this->_client, $opts);
    }

    /**
     * @param EcomParameter|array $args EcomParameter data (assoc-array) to store.
     */
    ...
    /**
     * @return EcomParameter|array The current EcomParameter data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EcomParameter fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EcomParameter fields).
     */
     ...
     *
     * @param EcomParameterCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EcomParameterCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EcomParameter|array The created EcomParameter as an assoc-array at the
