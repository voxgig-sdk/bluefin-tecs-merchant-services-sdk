...
class DeactivateTerminalEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "deactivate_terminal";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DeactivateTerminalEntity($this->_client, $opts);
    }

    /**
     * @param DeactivateTerminal|array $args DeactivateTerminal data (assoc-array) to store.
     */
    ...
    /**
     * @return DeactivateTerminal|array The current DeactivateTerminal data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeactivateTerminal fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeactivateTerminal fields).
     */
     ...
     *
     * @param DeactivateTerminalCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DeactivateTerminalCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeactivateTerminal|array The created DeactivateTerminal as an assoc-array at the
