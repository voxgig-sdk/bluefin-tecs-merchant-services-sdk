...
class GetTemplateXmlEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GetTemplateXmlEntity($this->_client, $opts);
    }

    /**
     * @param GetTemplateXml|array $args GetTemplateXml data (assoc-array) to store.
     */
    ...
    /**
     * @return GetTemplateXml|array The current GetTemplateXml data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GetTemplateXml fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GetTemplateXml fields).
     */
     ...
     *
     * @param GetTemplateXmlCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GetTemplateXmlCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GetTemplateXml|array The created GetTemplateXml as an assoc-array at the
