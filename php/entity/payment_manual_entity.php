...
class PaymentManualEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PaymentManualEntity($this->_client, $opts);
    }

    /**
     * @param PaymentManual|array $args PaymentManual data (assoc-array) to store.
     */
    ...
    /**
     * @return PaymentManual|array The current PaymentManual data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PaymentManual fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PaymentManual fields).
     */
     ...
     *
     * @param PaymentManualCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PaymentManualCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PaymentManual|array The created PaymentManual as an assoc-array at the
