...
class StatusTransactionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StatusTransactionEntity($this->_client, $opts);
    }

    /**
     * @param StatusTransaction|array $args StatusTransaction data (assoc-array) to store.
     */
    ...
    /**
     * @return StatusTransaction|array The current StatusTransaction data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of StatusTransaction fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of StatusTransaction fields).
     */
     ...
     *
     * @param StatusTransactionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed StatusTransactionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StatusTransaction|array The created StatusTransaction as an assoc-array at the
