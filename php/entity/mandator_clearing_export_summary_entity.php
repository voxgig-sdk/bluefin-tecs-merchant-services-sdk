...
class MandatorClearingExportSummaryEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "mandator_clearing_export_summary";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MandatorClearingExportSummaryEntity($this->_client, $opts);
    }

    /**
     * @param MandatorClearingExportSummary|array $args MandatorClearingExportSummary data (assoc-array) to store.
     */
    ...
    /**
     * @return MandatorClearingExportSummary|array The current MandatorClearingExportSummary data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MandatorClearingExportSummary fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MandatorClearingExportSummary fields).
     */
     ...
     *
     * @param MandatorClearingExportSummaryCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MandatorClearingExportSummaryCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MandatorClearingExportSummary|array The created MandatorClearingExportSummary as an assoc-array at the
