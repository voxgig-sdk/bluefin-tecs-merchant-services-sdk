...
class IntroducePackageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IntroducePackageEntity($this->_client, $opts);
    }

    /**
     * @param IntroducePackage|array $args IntroducePackage data (assoc-array) to store.
     */
    ...
    /**
     * @return IntroducePackage|array The current IntroducePackage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IntroducePackage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IntroducePackage fields).
     */
     ...
     *
     * @param IntroducePackageCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed IntroducePackageCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IntroducePackage|array The created IntroducePackage as an assoc-array at the
