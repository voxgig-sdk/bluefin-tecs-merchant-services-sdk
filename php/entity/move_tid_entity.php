...
class MoveTidEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MoveTidEntity($this->_client, $opts);
    }

    /**
     * @param MoveTid|array $args MoveTid data (assoc-array) to store.
     */
    ...
    /**
     * @return MoveTid|array The current MoveTid data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MoveTid fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MoveTid fields).
     */
     ...
     *
     * @param MoveTidCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MoveTidCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MoveTid|array The created MoveTid as an assoc-array at the
