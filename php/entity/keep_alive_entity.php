...
class KeepAliveEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new KeepAliveEntity($this->_client, $opts);
    }

    /**
     * @param KeepAlive|array $args KeepAlive data (assoc-array) to store.
     */
    ...
    /**
     * @return KeepAlive|array The current KeepAlive data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of KeepAlive fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of KeepAlive fields).
     */
     ...
     *
     * @param KeepAliveCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed KeepAliveCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return KeepAlive|array The created KeepAlive as an assoc-array at the
