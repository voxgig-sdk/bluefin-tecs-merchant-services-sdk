...
class UpdateTemplateXmlEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "update_template_xml";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new UpdateTemplateXmlEntity($this->_client, $opts);
    }

    /**
     * @param UpdateTemplateXml|array $args UpdateTemplateXml data (assoc-array) to store.
     */
    ...
    /**
     * @return UpdateTemplateXml|array The current UpdateTemplateXml data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UpdateTemplateXml fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UpdateTemplateXml fields).
     */
     ...
     *
     * @param UpdateTemplateXmlCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UpdateTemplateXmlCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UpdateTemplateXml|array The created UpdateTemplateXml as an assoc-array at the
