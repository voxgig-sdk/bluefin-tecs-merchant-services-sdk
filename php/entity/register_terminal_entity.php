...
class RegisterTerminalEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RegisterTerminalEntity($this->_client, $opts);
    }

    /**
     * @param RegisterTerminal|array $args RegisterTerminal data (assoc-array) to store.
     */
    ...
    /**
     * @return RegisterTerminal|array The current RegisterTerminal data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RegisterTerminal fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RegisterTerminal fields).
     */
     ...
     *
     * @param RegisterTerminalCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RegisterTerminalCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RegisterTerminal|array The created RegisterTerminal as an assoc-array at the
