...
class DigitalServicesApiEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "digital_services_api";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DigitalServicesApiEntity($this->_client, $opts);
    }

    /**
     * @param DigitalServicesApi|array $args DigitalServicesApi data (assoc-array) to store.
     */
    ...
    /**
     * @return DigitalServicesApi|array The current DigitalServicesApi data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DigitalServicesApi fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DigitalServicesApi fields).
     */
     ...
     *
     * @param DigitalServicesApiLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DigitalServicesApiLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DigitalServicesApi|array The loaded DigitalServicesApi as an assoc-array at the
     ...
     *
     * @param DigitalServicesApiCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DigitalServicesApiCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DigitalServicesApi|array The created DigitalServicesApi as an assoc-array at the
     *   SDK boundary; throws BluefinTecsMerchantServicesError on failure (item-5 convention).
     */
