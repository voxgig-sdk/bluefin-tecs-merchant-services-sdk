...
class TransactionHistoryEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "transaction_history";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new TransactionHistoryEntity($this->_client, $opts);
    }

    /**
     * @param TransactionHistory|array $args TransactionHistory data (assoc-array) to store.
     */
    ...
    /**
     * @return TransactionHistory|array The current TransactionHistory data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TransactionHistory fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TransactionHistory fields).
     */
     ...
     *
     * @param TransactionHistoryCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TransactionHistoryCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TransactionHistory|array The created TransactionHistory as an assoc-array at the
