...
class UpdateMerchantEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UpdateMerchantEntity($this->_client, $opts);
    }

    /**
     * @param UpdateMerchant|array $args UpdateMerchant data (assoc-array) to store.
     */
    ...
    /**
     * @return UpdateMerchant|array The current UpdateMerchant data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UpdateMerchant fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UpdateMerchant fields).
     */
     ...
     *
     * @param UpdateMerchantCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UpdateMerchantCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UpdateMerchant|array The created UpdateMerchant as an assoc-array at the
