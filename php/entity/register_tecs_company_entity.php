...
class RegisterTecsCompanyEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "register_tecs_company";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new RegisterTecsCompanyEntity($this->_client, $opts);
    }

    /**
     * @param RegisterTecsCompany|array $args RegisterTecsCompany data (assoc-array) to store.
     */
    ...
    /**
     * @return RegisterTecsCompany|array The current RegisterTecsCompany data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RegisterTecsCompany fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RegisterTecsCompany fields).
     */
     ...
     *
     * @param RegisterTecsCompanyCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RegisterTecsCompanyCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RegisterTecsCompany|array The created RegisterTecsCompany as an assoc-array at the
