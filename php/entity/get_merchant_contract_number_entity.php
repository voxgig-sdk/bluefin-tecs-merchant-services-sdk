...
class GetMerchantContractNumberEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "get_merchant_contract_number";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new GetMerchantContractNumberEntity($this->_client, $opts);
    }

    /**
     * @param GetMerchantContractNumber|array $args GetMerchantContractNumber data (assoc-array) to store.
     */
    ...
    /**
     * @return GetMerchantContractNumber|array The current GetMerchantContractNumber data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GetMerchantContractNumber fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GetMerchantContractNumber fields).
     */
     ...
     *
     * @param GetMerchantContractNumberCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GetMerchantContractNumberCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GetMerchantContractNumber|array The created GetMerchantContractNumber as an assoc-array at the
