...
class CreateProductEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CreateProductEntity($this->_client, $opts);
    }

    /**
     * @param CreateProduct|array $args CreateProduct data (assoc-array) to store.
     */
    ...
    /**
     * @return CreateProduct|array The current CreateProduct data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CreateProduct fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CreateProduct fields).
     */
     ...
     *
     * @param CreateProductCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CreateProductCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CreateProduct|array The created CreateProduct as an assoc-array at the
