...
class MandatorClearingExportEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "mandator_clearing_export";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MandatorClearingExportEntity($this->_client, $opts);
    }

    /**
     * @param MandatorClearingExport|array $args MandatorClearingExport data (assoc-array) to store.
     */
    ...
    /**
     * @return MandatorClearingExport|array The current MandatorClearingExport data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MandatorClearingExport fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MandatorClearingExport fields).
     */
     ...
     *
     * @param MandatorClearingExportCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MandatorClearingExportCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MandatorClearingExport|array The created MandatorClearingExport as an assoc-array at the
