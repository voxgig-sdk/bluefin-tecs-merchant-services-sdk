...
class EcrDataEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EcrDataEntity($this->_client, $opts);
    }

    /**
     * @param EcrData|array $args EcrData data (assoc-array) to store.
     */
    ...
    /**
     * @return EcrData|array The current EcrData data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EcrData fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EcrData fields).
     */
     ...
     *
     * @param EcrDataCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EcrDataCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EcrData|array The created EcrData as an assoc-array at the
