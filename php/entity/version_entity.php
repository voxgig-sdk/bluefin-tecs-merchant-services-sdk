...
class VersionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new VersionEntity($this->_client, $opts);
    }

    /**
     * @param Version|array $args Version data (assoc-array) to store.
     */
    ...
    /**
     * @return Version|array The current Version data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Version fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Version fields).
     */
     ...
     *
     * @param VersionLoadMatch|array|null $reqmatch Match criteria (id/query
