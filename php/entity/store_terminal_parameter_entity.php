...
class StoreTerminalParameterEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "store_terminal_parameter";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new StoreTerminalParameterEntity($this->_client, $opts);
    }

    /**
     * @param StoreTerminalParameter|array $args StoreTerminalParameter data (assoc-array) to store.
     */
    ...
    /**
     * @return StoreTerminalParameter|array The current StoreTerminalParameter data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of StoreTerminalParameter fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of StoreTerminalParameter fields).
     */
     ...
     *
     * @param StoreTerminalParameterCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed StoreTerminalParameterCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StoreTerminalParameter|array The created StoreTerminalParameter as an assoc-array at the
