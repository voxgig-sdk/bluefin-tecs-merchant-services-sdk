...
class IntroduceMandatorEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IntroduceMandatorEntity($this->_client, $opts);
    }

    /**
     * @param IntroduceMandator|array $args IntroduceMandator data (assoc-array) to store.
     */
    ...
    /**
     * @return IntroduceMandator|array The current IntroduceMandator data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IntroduceMandator fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IntroduceMandator fields).
     */
     ...
     *
     * @param IntroduceMandatorCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed IntroduceMandatorCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IntroduceMandator|array The created IntroduceMandator as an assoc-array at the
