...
class ReactivateTerminalEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "reactivate_terminal";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ReactivateTerminalEntity($this->_client, $opts);
    }

    /**
     * @param ReactivateTerminal|array $args ReactivateTerminal data (assoc-array) to store.
     */
    ...
    /**
     * @return ReactivateTerminal|array The current ReactivateTerminal data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ReactivateTerminal fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ReactivateTerminal fields).
     */
     ...
     *
     * @param ReactivateTerminalCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ReactivateTerminalCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReactivateTerminal|array The created ReactivateTerminal as an assoc-array at the
