...
class TransactionsTurnoverEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "transactions_turnover";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new TransactionsTurnoverEntity($this->_client, $opts);
    }

    /**
     * @param TransactionsTurnover|array $args TransactionsTurnover data (assoc-array) to store.
     */
    ...
    /**
     * @return TransactionsTurnover|array The current TransactionsTurnover data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TransactionsTurnover fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TransactionsTurnover fields).
     */
     ...
     *
     * @param TransactionsTurnoverCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TransactionsTurnoverCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TransactionsTurnover|array The created TransactionsTurnover as an assoc-array at the
