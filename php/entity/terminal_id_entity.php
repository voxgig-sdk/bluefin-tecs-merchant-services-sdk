...
class TerminalIdEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TerminalIdEntity($this->_client, $opts);
    }

    /**
     * @param TerminalId|array $args TerminalId data (assoc-array) to store.
     */
    ...
    /**
     * @return TerminalId|array The current TerminalId data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TerminalId fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TerminalId fields).
     */
     ...
     *
     * @param TerminalIdCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TerminalIdCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TerminalId|array The created TerminalId as an assoc-array at the
