...
class CancelTransactionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CancelTransactionEntity($this->_client, $opts);
    }

    /**
     * @param CancelTransaction|array $args CancelTransaction data (assoc-array) to store.
     */
    ...
    /**
     * @return CancelTransaction|array The current CancelTransaction data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CancelTransaction fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CancelTransaction fields).
     */
     ...
     *
     * @param CancelTransactionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CancelTransactionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CancelTransaction|array The created CancelTransaction as an assoc-array at the
