...
class PreAuthTransactionCompletionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "pre_auth_transaction_completion";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PreAuthTransactionCompletionEntity($this->_client, $opts);
    }

    /**
     * @param PreAuthTransactionCompletion|array $args PreAuthTransactionCompletion data (assoc-array) to store.
     */
    ...
    /**
     * @return PreAuthTransactionCompletion|array The current PreAuthTransactionCompletion data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PreAuthTransactionCompletion fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PreAuthTransactionCompletion fields).
     */
     ...
     *
     * @param PreAuthTransactionCompletionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PreAuthTransactionCompletionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PreAuthTransactionCompletion|array The created PreAuthTransactionCompletion as an assoc-array at the
