...
class PaymentSredEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PaymentSredEntity($this->_client, $opts);
    }

    /**
     * @param PaymentSred|array $args PaymentSred data (assoc-array) to store.
     */
    ...
    /**
     * @return PaymentSred|array The current PaymentSred data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PaymentSred fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PaymentSred fields).
     */
     ...
     *
     * @param PaymentSredCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PaymentSredCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PaymentSred|array The created PaymentSred as an assoc-array at the
