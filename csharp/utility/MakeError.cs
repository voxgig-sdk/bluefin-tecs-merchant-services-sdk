// BluefinTecsMerchantServices SDK utility: makeError - the single error surface of the
// pipeline. Throws the wrapped BluefinTecsMerchantServicesError unless the per-call ctrl
// disables throwing (ctrl.throw == false), in which case it returns the
// (possibly nil) result data instead.

namespace BluefinTecsMerchantServicesSdk.Util;
...
public static partial class SdkUtility
{
    internal static object? MakeErrorUtil(Context ctx, Exception? err)
    {
        ...
        var msg = "BluefinTecsMerchantServicesSDK: " + opname + ": " + errmsg;
        ...
        var sdkErr = new BluefinTecsMerchantServicesError(
            err is BluefinTecsMerchantServicesError se ? se.Code : "", msg, ctx)
        {
