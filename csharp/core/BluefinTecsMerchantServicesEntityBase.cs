...
public abstract class BluefinTecsMerchantServicesEntityBase : IEntity
{
    protected string name;
    protected BluefinTecsMerchantServicesSDK client;
    ...
    protected BluefinTecsMerchantServicesEntityBase(BluefinTecsMerchantServicesSDK client,
