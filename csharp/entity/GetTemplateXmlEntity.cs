// GetTemplateXml entity client for the BluefinTecsMerchantServices SDK.

using Voxgig.Struct;

namespace BluefinTecsMerchantServicesSdk.Entity;

public class GetTemplateXmlEntity : BluefinTecsMerchantServicesEntityBase
{
    public GetTemplateXmlEntity(BluefinTecsMerchantServicesSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "get_template_xml")
    {
    }

    public override IEntity Make()
    {
        return new GetTemplateXmlEntity(client, CloneOpts());
    }
