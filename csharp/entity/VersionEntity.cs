// Version entity client for the BluefinTecsMerchantServices SDK.

using Voxgig.Struct;

namespace BluefinTecsMerchantServicesSdk.Entity;

public class VersionEntity : BluefinTecsMerchantServicesEntityBase
{
    public VersionEntity(BluefinTecsMerchantServicesSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "version")
    {
    }

    public override IEntity Make()
    {
        return new VersionEntity(client, CloneOpts());
    }
