// KeepAlive entity client for the BluefinTecsMerchantServices SDK.

using Voxgig.Struct;

namespace BluefinTecsMerchantServicesSdk.Entity;

public class KeepAliveEntity : BluefinTecsMerchantServicesEntityBase
{
    public KeepAliveEntity(BluefinTecsMerchantServicesSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "keep_alive")
    {
    }

    public override IEntity Make()
    {
        return new KeepAliveEntity(client, CloneOpts());
    }
