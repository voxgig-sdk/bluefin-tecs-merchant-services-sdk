// ListTerminal entity client for the BluefinTecsMerchantServices SDK.

using Voxgig.Struct;

namespace BluefinTecsMerchantServicesSdk.Entity;

public class ListTerminalEntity : BluefinTecsMerchantServicesEntityBase
{
    public ListTerminalEntity(BluefinTecsMerchantServicesSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "list_terminal")
    {
    }

    public override IEntity Make()
    {
        return new ListTerminalEntity(client, CloneOpts());
    }
