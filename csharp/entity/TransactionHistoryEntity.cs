...
public class TransactionHistoryEntity : BluefinTecsMerchantServicesEntityBase
{
    public TransactionHistoryEntity(BluefinTecsMerchantServicesSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "transaction_history")
    {
    }

    public override IEntity Make()
    {
        return new TransactionHistoryEntity(client, CloneOpts());
    }
