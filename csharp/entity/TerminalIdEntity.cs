// TerminalId entity client for the BluefinTecsMerchantServices SDK.

using Voxgig.Struct;

namespace BluefinTecsMerchantServicesSdk.Entity;

public class TerminalIdEntity : BluefinTecsMerchantServicesEntityBase
{
    public TerminalIdEntity(BluefinTecsMerchantServicesSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "terminal_id")
    {
    }

    public override IEntity Make()
    {
        return new TerminalIdEntity(client, CloneOpts());
    }
