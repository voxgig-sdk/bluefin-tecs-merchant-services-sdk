// EcomParameter entity client for the BluefinTecsMerchantServices SDK.

using Voxgig.Struct;

namespace BluefinTecsMerchantServicesSdk.Entity;

public class EcomParameterEntity : BluefinTecsMerchantServicesEntityBase
{
    public EcomParameterEntity(BluefinTecsMerchantServicesSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "ecom_parameter")
    {
    }

    public override IEntity Make()
    {
        return new EcomParameterEntity(client, CloneOpts());
    }
