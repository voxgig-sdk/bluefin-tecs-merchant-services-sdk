...
public class RegisterTecsCompanyEntity : BluefinTecsMerchantServicesEntityBase
{
    public RegisterTecsCompanyEntity(BluefinTecsMerchantServicesSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "register_tecs_company")
    {
    }

    public override IEntity Make()
    {
        return new RegisterTecsCompanyEntity(client, CloneOpts());
    }
