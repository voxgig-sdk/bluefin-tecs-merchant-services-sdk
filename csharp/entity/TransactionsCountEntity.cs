...
public class TransactionsCountEntity : BluefinTecsMerchantServicesEntityBase
{
    public TransactionsCountEntity(BluefinTecsMerchantServicesSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "transactions_count")
    {
    }

    public override IEntity Make()
    {
        return new TransactionsCountEntity(client, CloneOpts());
    }
