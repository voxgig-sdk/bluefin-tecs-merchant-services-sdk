// ReportData entity client for the BluefinTecsMerchantServices SDK.

using Voxgig.Struct;

namespace BluefinTecsMerchantServicesSdk.Entity;

public class ReportDataEntity : BluefinTecsMerchantServicesEntityBase
{
    public ReportDataEntity(BluefinTecsMerchantServicesSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "report_data")
    {
    }

    public override IEntity Make()
    {
        return new ReportDataEntity(client, CloneOpts());
    }
