// EcDataEcom entity client for the BluefinTecsMerchantServices SDK.

using Voxgig.Struct;

namespace BluefinTecsMerchantServicesSdk.Entity;

public class EcDataEcomEntity : BluefinTecsMerchantServicesEntityBase
{
    public EcDataEcomEntity(BluefinTecsMerchantServicesSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "ec_data_ecom")
    {
    }

    public override IEntity Make()
    {
        return new EcDataEcomEntity(client, CloneOpts());
    }
