// EmvData entity client for the BluefinTecsMerchantServices SDK.

using Voxgig.Struct;

namespace BluefinTecsMerchantServicesSdk.Entity;

public class EmvDataEntity : BluefinTecsMerchantServicesEntityBase
{
    public EmvDataEntity(BluefinTecsMerchantServicesSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "emv_data")
    {
    }

    public override IEntity Make()
    {
        return new EmvDataEntity(client, CloneOpts());
    }
