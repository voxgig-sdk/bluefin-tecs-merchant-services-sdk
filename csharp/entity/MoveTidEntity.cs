// MoveTid entity client for the BluefinTecsMerchantServices SDK.

using Voxgig.Struct;

namespace BluefinTecsMerchantServicesSdk.Entity;

public class MoveTidEntity : BluefinTecsMerchantServicesEntityBase
{
    public MoveTidEntity(BluefinTecsMerchantServicesSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "move_tid")
    {
    }

    public override IEntity Make()
    {
        return new MoveTidEntity(client, CloneOpts());
    }
