// PaymentManual entity client for the BluefinTecsMerchantServices SDK.

using Voxgig.Struct;

namespace BluefinTecsMerchantServicesSdk.Entity;

public class PaymentManualEntity : BluefinTecsMerchantServicesEntityBase
{
    public PaymentManualEntity(BluefinTecsMerchantServicesSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "payment_manual")
    {
    }

    public override IEntity Make()
    {
        return new PaymentManualEntity(client, CloneOpts());
    }
