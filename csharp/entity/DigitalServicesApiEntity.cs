// DigitalServicesApi entity client for the BluefinTecsMerchantServices SDK.

using Voxgig.Struct;

namespace BluefinTecsMerchantServicesSdk.Entity;

public class DigitalServicesApiEntity : BluefinTecsMerchantServicesEntityBase
{
    public DigitalServicesApiEntity(BluefinTecsMerchantServicesSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "digital_services_api")
    {
    }

    public override IEntity Make()
    {
        return new DigitalServicesApiEntity(client, CloneOpts());
    }
