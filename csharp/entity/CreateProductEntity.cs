// CreateProduct entity client for the BluefinTecsMerchantServices SDK.

using Voxgig.Struct;

namespace BluefinTecsMerchantServicesSdk.Entity;

public class CreateProductEntity : BluefinTecsMerchantServicesEntityBase
{
    public CreateProductEntity(BluefinTecsMerchantServicesSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "create_product")
    {
    }

    public override IEntity Make()
    {
        return new CreateProductEntity(client, CloneOpts());
    }
