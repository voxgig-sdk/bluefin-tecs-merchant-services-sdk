...
public class TerminalIdEntityTest
{
    ...
    public void Basic()
    {
        ...
        // and 4xx; set BLUEFIN_TECS_MERCHANT_SERVICES_TEST_TERMINAL_ID_ENTID JSON to run live.
        ...
        terminalIdRef01Data = Helpers.ToMapAny(terminalIdRef01DataResult is IEntity ce ? ce.Data() : terminalIdRef01DataResult);
