...
public class UpdateTemplateXmlEntityTest
{
    ...
    public void Basic()
    {
        ...
        // and 4xx; set BLUEFIN_TECS_MERCHANT_SERVICES_TEST_UPDATE_TEMPLATE_XML_ENTID JSON to run live.
        ...
        updateTemplateXmlRef01Data = Helpers.ToMapAny(updateTemplateXmlRef01DataResult is IEntity ce ? ce.Data() : updateTemplateXmlRef01DataResult);
