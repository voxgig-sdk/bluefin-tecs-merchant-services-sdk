...
public class CancelTransactionEntityTest
{
    ...
    public void Basic()
    {
        ...
        // and 4xx; set BLUEFIN_TECS_MERCHANT_SERVICES_TEST_CANCEL_TRANSACTION_ENTID JSON to run live.
        ...
        cancelTransactionRef01Data = Helpers.ToMapAny(cancelTransactionRef01DataResult is IEntity ce ? ce.Data() : cancelTransactionRef01DataResult);
