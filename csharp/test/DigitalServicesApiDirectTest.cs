...
public class DigitalServicesApiDirectTest
{
    ...
    private static DigitalServicesApiDirectSetupResult DigitalServicesApiDirectSetup(object? mockres)
    {
        ...
        {
            ["BLUEFINTECSMERCHANTSERVICES_TEST_DIGITAL_SERVICES_API_ENTID"] = new Dictionary<string, object?>(),
        ...
        if (live)
        {
            ...
            var entidRaw = env["BLUEFINTECSMERCHANTSERVICES_TEST_DIGITAL_SERVICES_API_ENTID"];
