...
public class DigitalServicesApiEntityTest
{
    ...
    public void Basic()
    {
        ...
        // and 4xx; set BLUEFIN_TECS_MERCHANT_SERVICES_TEST_DIGITAL_SERVICES_API_ENTID JSON to run live.
        ...
        digitalServicesApiRef01Data = Helpers.ToMapAny(digitalServicesApiRef01DataResult is IEntity ce ? ce.Data() : digitalServicesApiRef01DataResult);
