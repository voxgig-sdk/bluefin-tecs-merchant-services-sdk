...
public class PrimaryUtilityTest
{
    ...
    private static OmniResolver.Run Run()
    {
        lock (RunLock)
        {
            if (RUN == null)
            {
                CLIENT = BluefinTecsMerchantServicesSDK.TestSDK(null, null);
    ...
    private static BluefinTecsMerchantServicesSDK GetClient()
    {
        Run();
        return CLIENT!;
    }
    ...
    private static Context MakeTestCtx(BluefinTecsMerchantServicesSDK client, Utility utility,
    ...
    private static Context MakeTestFullCtx(BluefinTecsMerchantServicesSDK client, Utility utility)
    {
    ...
    {
        var hookClient = BluefinTecsMerchantServicesSDK.TestSDK(null, null);
    ...
    {
        var initClient = BluefinTecsMerchantServicesSDK.TestSDK(null, null);
    ...
    public void FetcherBlockedTestMode()
    {
        ...
        var blockedClient = new BluefinTecsMerchantServicesSDK(new Dictionary<string, object?>
        {
            ["base"] = "http://localhost:8080",
            ["system"] = new Dictionary<string, object?>
            {
    ...
    public void MakeSpecBasic()
    {
        ...
        var specClient = BluefinTecsMerchantServicesSDK.TestSDK(null, setupOpts);
    ...
    // BluefinTecsMerchantServicesError. The corpus says `match: out: code` for both, so
    ...
    public void MakePointBasic()
    {
        runsection("makePoint", args =>
        {
            ...
            catch (BluefinTecsMerchantServicesError e)
            {
    ...
    public void PrepareAuthBasic()
    {
        ...
        var authClient = BluefinTecsMerchantServicesSDK.TestSDK(null, setupOpts);
