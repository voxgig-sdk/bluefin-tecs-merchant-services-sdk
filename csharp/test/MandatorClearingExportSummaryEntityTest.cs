...
public class MandatorClearingExportSummaryEntityTest
{
    ...
    public void Basic()
    {
        ...
        // and 4xx; set BLUEFIN_TECS_MERCHANT_SERVICES_TEST_MANDATOR_CLEARING_EXPORT_SUMMARY_ENTID JSON to run live.
        ...
        mandatorClearingExportSummaryRef01Data = Helpers.ToMapAny(mandatorClearingExportSummaryRef01DataResult is IEntity ce ? ce.Data() : mandatorClearingExportSummaryRef01DataResult);
