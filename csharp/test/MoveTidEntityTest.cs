...
public class MoveTidEntityTest
{
    ...
    public void Basic()
    {
        ...
        // and 4xx; set BLUEFIN_TECS_MERCHANT_SERVICES_TEST_MOVE_TID_ENTID JSON to run live.
        ...
        moveTidRef01Data = Helpers.ToMapAny(moveTidRef01DataResult is IEntity ce ? ce.Data() : moveTidRef01DataResult);
