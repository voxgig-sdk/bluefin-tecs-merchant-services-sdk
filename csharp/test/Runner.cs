// BluefinTecsMerchantServices SDK test-runner SUPPORT (vendor-tag rollout): env overrides,
...
public static class TestRunner
{
    ...
    {
        if (Environment.GetEnvironmentVariable("BLUEFIN_TECS_MERCHANT_SERVICES_TEST_LIVE") == "TRUE" ||
            Environment.GetEnvironmentVariable("BLUEFIN_TECS_MERCHANT_SERVICES_TEST_OVERRIDE") == "TRUE")
        {
        ...
        var explain = Environment.GetEnvironmentVariable("BLUEFIN_TECS_MERCHANT_SERVICES_TEST_EXPLAIN");
    ...
    public static int LiveDelayMs()
    {
        ...
        {
            var n = BluefinTecsMerchantServicesSdk.Helpers.ToInt(v);
            if (n >= 0)
            {
                return n;
            }
    ...
    public static Context MakeCtxFromMap(Dictionary<string, object?>? ctxmap,
        BluefinTecsMerchantServicesSDK? client, Utility? utility)
    {
            ...
            resRaw is Dictionary<string, object?> resMap)
        {
            ...
            {
                ctx.Result.Err = new BluefinTecsMerchantServicesError("", msg, null);
            }
        }
    ...
    public static void FixCtx(Context ctx, BluefinTecsMerchantServicesSDK client)
    {
    ...
    public static Exception? ErrFromMap(Dictionary<string, object?>? m)
    {
        ...
        return new BluefinTecsMerchantServicesError(code, msg, null);
    }
