...
public static class TestRunner
{
    ...
    {
        if (Environment.GetEnvironmentVariable("BLUEFINTECSMERCHANTSERVICES_TEST_LIVE") == "TRUE" ||
            Environment.GetEnvironmentVariable("BLUEFINTECSMERCHANTSERVICES_TEST_OVERRIDE") == "TRUE")
        {
        ...
        var explain = Environment.GetEnvironmentVariable("BLUEFINTECSMERCHANTSERVICES_TEST_EXPLAIN");
