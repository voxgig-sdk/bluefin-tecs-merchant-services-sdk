;; BluefinTecsMerchantServices SDK MoveTid entity (generated by @voxgig/sdkgen).
(ns sdk.entity.move_tid
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "move_tid" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "move_tid")
...
;; Canonical facade: (MoveTid client data) accessor delegates here.
...
;; Create a new MoveTid (reqdata: body data).
