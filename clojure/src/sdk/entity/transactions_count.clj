;; BluefinTecsMerchantServices SDK TransactionsCount entity (generated by @voxgig/sdkgen).
(ns sdk.entity.transactions_count
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "transactions_count" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "transactions_count")
...
;; Canonical facade: (TransactionsCount client data) accessor delegates here.
...
;; Create a new TransactionsCount (reqdata: body data).
