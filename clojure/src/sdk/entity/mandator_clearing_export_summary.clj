...
(ns sdk.entity.mandator_clearing_export_summary
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "mandator_clearing_export_summary" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "mandator_clearing_export_summary")
...
;; Canonical facade: (MandatorClearingExportSummary client data) accessor delegates here.
...
;; Create a new MandatorClearingExportSummary (reqdata: body data).
