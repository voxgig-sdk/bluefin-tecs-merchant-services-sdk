;; BluefinTecsMerchantServices SDK ReportData entity (generated by @voxgig/sdkgen).
(ns sdk.entity.report_data
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "report_data" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "report_data")
...
;; Canonical facade: (ReportData client data) accessor delegates here.
...
;; Create a new ReportData (reqdata: body data).
