;; BluefinTecsMerchantServices SDK EmvData entity (generated by @voxgig/sdkgen).
(ns sdk.entity.emv_data
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "emv_data" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "emv_data")
...
;; Canonical facade: (EmvData client data) accessor delegates here.
...
;; Create a new EmvData (reqdata: body data).
