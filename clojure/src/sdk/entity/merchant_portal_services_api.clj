...
(ns sdk.entity.merchant_portal_services_api
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "merchant_portal_services_api" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "merchant_portal_services_api")
...
;; Canonical facade: (MerchantPortalServicesApi client data) accessor delegates here.
...
;; Create a new MerchantPortalServicesApi (reqdata: body data).
