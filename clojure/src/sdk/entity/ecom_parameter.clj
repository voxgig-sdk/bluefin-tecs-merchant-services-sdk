;; BluefinTecsMerchantServices SDK EcomParameter entity (generated by @voxgig/sdkgen).
(ns sdk.entity.ecom_parameter
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "ecom_parameter" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "ecom_parameter")
...
;; Canonical facade: (EcomParameter client data) accessor delegates here.
...
;; Create a new EcomParameter (reqdata: body data).
