;; BluefinTecsMerchantServices SDK ReactivateTerminal entity (generated by @voxgig/sdkgen).
(ns sdk.entity.reactivate_terminal
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "reactivate_terminal" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "reactivate_terminal")
...
;; Canonical facade: (ReactivateTerminal client data) accessor delegates here.
...
;; Create a new ReactivateTerminal (reqdata: body data).
