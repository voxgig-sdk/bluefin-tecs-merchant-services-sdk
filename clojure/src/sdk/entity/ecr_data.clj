;; BluefinTecsMerchantServices SDK EcrData entity (generated by @voxgig/sdkgen).
(ns sdk.entity.ecr_data
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "ecr_data" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "ecr_data")
...
;; Canonical facade: (EcrData client data) accessor delegates here.
...
;; Create a new EcrData (reqdata: body data).
