;; BluefinTecsMerchantServices SDK RefundTransaction entity (generated by @voxgig/sdkgen).
(ns sdk.entity.refund_transaction
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "refund_transaction" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "refund_transaction")
...
;; Canonical facade: (RefundTransaction client data) accessor delegates here.
...
;; Create a new RefundTransaction (reqdata: body data).
