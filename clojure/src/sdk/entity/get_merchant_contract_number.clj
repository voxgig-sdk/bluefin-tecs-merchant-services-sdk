...
(ns sdk.entity.get_merchant_contract_number
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "get_merchant_contract_number" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "get_merchant_contract_number")
...
;; Canonical facade: (GetMerchantContractNumber client data) accessor delegates here.
...
;; Create a new GetMerchantContractNumber (reqdata: body data).
