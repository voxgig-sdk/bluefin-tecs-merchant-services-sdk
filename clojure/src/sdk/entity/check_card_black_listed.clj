...
(ns sdk.entity.check_card_black_listed
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "check_card_black_listed" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "check_card_black_listed")
...
;; Canonical facade: (CheckCardBlackListed client data) accessor delegates here.
...
;; Create a new CheckCardBlackListed (reqdata: body data).
