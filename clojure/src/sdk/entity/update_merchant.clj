...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "update_merchant" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "update_merchant")
...
;; Canonical facade: (UpdateMerchant client data) accessor delegates here.
...
;; Create a new UpdateMerchant (reqdata: body data).
