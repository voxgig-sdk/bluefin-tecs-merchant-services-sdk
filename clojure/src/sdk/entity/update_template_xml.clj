...
(ns sdk.entity.update_template_xml
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "update_template_xml" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "update_template_xml")
...
;; Canonical facade: (UpdateTemplateXml client data) accessor delegates here.
...
;; Create a new UpdateTemplateXml (reqdata: body data).
