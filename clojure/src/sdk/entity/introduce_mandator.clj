;; BluefinTecsMerchantServices SDK IntroduceMandator entity (generated by @voxgig/sdkgen).
(ns sdk.entity.introduce_mandator
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "introduce_mandator" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "introduce_mandator")
...
;; Canonical facade: (IntroduceMandator client data) accessor delegates here.
...
;; Create a new IntroduceMandator (reqdata: body data).
