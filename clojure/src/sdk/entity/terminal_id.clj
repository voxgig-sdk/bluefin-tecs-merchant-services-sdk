;; BluefinTecsMerchantServices SDK TerminalId entity (generated by @voxgig/sdkgen).
(ns sdk.entity.terminal_id
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "terminal_id" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "terminal_id")
...
;; Canonical facade: (TerminalId client data) accessor delegates here.
...
;; Create a new TerminalId (reqdata: body data).
