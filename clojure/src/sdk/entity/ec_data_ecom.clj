;; BluefinTecsMerchantServices SDK EcDataEcom entity (generated by @voxgig/sdkgen).
(ns sdk.entity.ec_data_ecom
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "ec_data_ecom" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "ec_data_ecom")
...
;; Canonical facade: (EcDataEcom client data) accessor delegates here.
...
;; Create a new EcDataEcom (reqdata: body data).
