...
(ns sdk.entity.mandator_clearing_export
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "mandator_clearing_export" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "mandator_clearing_export")
...
;; Canonical facade: (MandatorClearingExport client data) accessor delegates here.
...
;; Create a new MandatorClearingExport (reqdata: body data).
