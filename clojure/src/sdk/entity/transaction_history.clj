;; BluefinTecsMerchantServices SDK TransactionHistory entity (generated by @voxgig/sdkgen).
(ns sdk.entity.transaction_history
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "transaction_history" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "transaction_history")
...
;; Canonical facade: (TransactionHistory client data) accessor delegates here.
...
;; Create a new TransactionHistory (reqdata: body data).
