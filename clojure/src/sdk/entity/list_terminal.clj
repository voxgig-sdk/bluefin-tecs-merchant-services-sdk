;; BluefinTecsMerchantServices SDK ListTerminal entity (generated by @voxgig/sdkgen).
(ns sdk.entity.list_terminal
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "list_terminal" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "list_terminal")
...
;; Canonical facade: (ListTerminal client data) accessor delegates here.
...
;; Create a new ListTerminal (reqdata: body data).
