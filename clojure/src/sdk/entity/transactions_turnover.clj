...
(ns sdk.entity.transactions_turnover
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "transactions_turnover" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "transactions_turnover")
...
;; Canonical facade: (TransactionsTurnover client data) accessor delegates here.
...
;; Create a new TransactionsTurnover (reqdata: body data).
