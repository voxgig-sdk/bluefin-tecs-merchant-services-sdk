...
(ns sdk.entity.deactivate_terminal
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "deactivate_terminal" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "deactivate_terminal")
...
;; Canonical facade: (DeactivateTerminal client data) accessor delegates here.
...
;; Create a new DeactivateTerminal (reqdata: body data).
