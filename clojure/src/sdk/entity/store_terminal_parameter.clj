...
(ns sdk.entity.store_terminal_parameter
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "store_terminal_parameter" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "store_terminal_parameter")
...
;; Canonical facade: (StoreTerminalParameter client data) accessor delegates here.
...
;; Create a new StoreTerminalParameter (reqdata: body data).
