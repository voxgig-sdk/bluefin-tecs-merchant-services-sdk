;; BluefinTecsMerchantServices SDK DigitalServicesApi entity (generated by @voxgig/sdkgen).
(ns sdk.entity.digital_services_api
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "digital_services_api" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "digital_services_api")
...
;; Canonical facade: (DigitalServicesApi client data) accessor delegates here.
...
;; Load a single DigitalServicesApi (reqmatch: id/query fields; nil = empty match).
...
;; Create a new DigitalServicesApi (reqdata: body data).
