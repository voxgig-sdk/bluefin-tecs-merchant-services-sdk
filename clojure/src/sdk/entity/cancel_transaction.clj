;; BluefinTecsMerchantServices SDK CancelTransaction entity (generated by @voxgig/sdkgen).
(ns sdk.entity.cancel_transaction
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "cancel_transaction" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "cancel_transaction")
...
;; Canonical facade: (CancelTransaction client data) accessor delegates here.
...
;; Create a new CancelTransaction (reqdata: body data).
