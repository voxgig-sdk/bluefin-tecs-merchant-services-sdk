...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "payment_manual" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "payment_manual")
...
;; Canonical facade: (PaymentManual client data) accessor delegates here.
...
;; Create a new PaymentManual (reqdata: body data).
