;; BluefinTecsMerchantServices SDK EnableAcquiring entity (generated by @voxgig/sdkgen).
(ns sdk.entity.enable_acquiring
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "enable_acquiring" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "enable_acquiring")
...
;; Canonical facade: (EnableAcquiring client data) accessor delegates here.
...
;; Create a new EnableAcquiring (reqdata: body data).
