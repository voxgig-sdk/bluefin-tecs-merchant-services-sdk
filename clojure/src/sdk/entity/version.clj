...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "version" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (Version client data) accessor delegates here.
...
;; Load a single Version (reqmatch: id/query fields; nil = empty match).
