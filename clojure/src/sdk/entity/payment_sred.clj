;; BluefinTecsMerchantServices SDK PaymentSred entity (generated by @voxgig/sdkgen).
(ns sdk.entity.payment_sred
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "payment_sred" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "payment_sred")
...
;; Canonical facade: (PaymentSred client data) accessor delegates here.
...
;; Create a new PaymentSred (reqdata: body data).
