;; BluefinTecsMerchantServices SDK MandatorClearingExportDownload entity (generated by @voxgig/sdkgen).
(ns sdk.entity.mandator_clearing_export_download
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "mandator_clearing_export_download" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "mandator_clearing_export_download")
...
;; Canonical facade: (MandatorClearingExportDownload client data) accessor delegates here.
...
;; Load a single MandatorClearingExportDownload (reqmatch: id/query fields; nil = empty match).
...
;; Create a new MandatorClearingExportDownload (reqdata: body data).
