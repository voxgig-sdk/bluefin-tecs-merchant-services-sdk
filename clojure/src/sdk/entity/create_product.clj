...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "create_product" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "create_product")
...
;; Canonical facade: (CreateProduct client data) accessor delegates here.
...
;; Create a new CreateProduct (reqdata: body data).
