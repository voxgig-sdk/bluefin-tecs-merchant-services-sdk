;; BluefinTecsMerchantServices SDK IntroducePackage entity (generated by @voxgig/sdkgen).
(ns sdk.entity.introduce_package
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "introduce_package" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "introduce_package")
...
;; Canonical facade: (IntroducePackage client data) accessor delegates here.
...
;; Create a new IntroducePackage (reqdata: body data).
