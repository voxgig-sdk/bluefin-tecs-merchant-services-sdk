...
(ns sdk.entity.register_tecs_company
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "register_tecs_company" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "register_tecs_company")
...
;; Canonical facade: (RegisterTecsCompany client data) accessor delegates here.
...
;; Create a new RegisterTecsCompany (reqdata: body data).
