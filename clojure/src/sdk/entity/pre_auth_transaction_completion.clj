...
(ns sdk.entity.pre_auth_transaction_completion
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "pre_auth_transaction_completion" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "pre_auth_transaction_completion")
...
;; Canonical facade: (PreAuthTransactionCompletion client data) accessor delegates here.
...
;; Create a new PreAuthTransactionCompletion (reqdata: body data).
