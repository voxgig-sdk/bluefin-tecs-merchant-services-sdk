;; BluefinTecsMerchantServices SDK KeepAlive entity (generated by @voxgig/sdkgen).
(ns sdk.entity.keep_alive
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "keep_alive" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "keep_alive")
...
;; Canonical facade: (KeepAlive client data) accessor delegates here.
...
;; Create a new KeepAlive (reqdata: body data).
