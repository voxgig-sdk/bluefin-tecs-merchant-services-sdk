...
(ns sdk.entity.transactions_count_card_brand
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "transactions_count_card_brand" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "transactions_count_card_brand")
...
;; Canonical facade: (TransactionsCountCardBrand client data) accessor delegates here.
...
;; Create a new TransactionsCountCardBrand (reqdata: body data).
