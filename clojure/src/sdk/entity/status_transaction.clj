;; BluefinTecsMerchantServices SDK StatusTransaction entity (generated by @voxgig/sdkgen).
(ns sdk.entity.status_transaction
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "status_transaction" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "status_transaction")
...
;; Canonical facade: (StatusTransaction client data) accessor delegates here.
...
;; Create a new StatusTransaction (reqdata: body data).
