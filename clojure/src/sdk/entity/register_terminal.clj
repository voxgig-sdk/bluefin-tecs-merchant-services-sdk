...
(ns sdk.entity.register_terminal
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "register_terminal" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "register_terminal")
...
;; Canonical facade: (RegisterTerminal client data) accessor delegates here.
...
;; Create a new RegisterTerminal (reqdata: body data).
