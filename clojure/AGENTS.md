# BluefinTecsMerchantServices Clojure — Agent Guide

The Clojure client for the BluefinTecsMerchantServices API. This directory is **generated** — do not edit it by hand; change the model/template/component in `.sdk/` and regenerate. See the [project guide](../AGENTS.md) for the full workflow and the aontu model language.
...
npm run generate     # refreshes this clojure/ directory
```

Then build and test the generated output:

```bash
# in this target directory (clojure/):
make build
make test
```
