...
const testSeed = `map[string]any{"entity": map[string]any{"cancel_transaction": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "check_card_black_listed": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "create_product": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "deactivate_terminal": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "digital_services_api": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ec_data_ecom": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ecom_parameter": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ecr_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "emv_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "enable_acquiring": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_merchant_contract_number": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_template_xml": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "introduce_mandator": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "introduce_package": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "keep_alive": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "list_terminal": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "mandator_clearing_export": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "mandator_clearing_export_download": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "mandator_clearing_export_summary": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "merchant_portal_services_api": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "move_tid": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payment_manual": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payment_sred": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pre_auth_transaction_completion": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "reactivate_terminal": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "refund_transaction": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "register_tecs_company": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "register_terminal": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "report_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "status_transaction": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "store_terminal_parameter": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "terminal_id": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "transaction_history": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "transactions_count": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "transactions_count_card_brand": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "transactions_turnover": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "update_merchant": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "update_template_xml": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "version": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
