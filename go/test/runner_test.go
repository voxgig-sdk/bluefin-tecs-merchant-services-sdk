...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("BLUEFINTECSMERCHANTSERVICES_TEST_LIVE") == "TRUE" ||
		os.Getenv("BLUEFINTECSMERCHANTSERVICES_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("BLUEFINTECSMERCHANTSERVICES_TEST_EXPLAIN"); explain != "" {
