# BluefinTecsMerchantServices Golang — Agent Guide

The Golang client for the BluefinTecsMerchantServices API. This directory is **generated** — do not edit it by hand; change the model/template/component in `.sdk/` and regenerate. See the [project guide](../AGENTS.md) for the full workflow and the aontu model language.
...
| **paging** — Pagination signals for list operations | `feature/paging_feature.go` | `PreRequest`, `PreResult` |
...
| **telemetry** — Distributed tracing spans with W3C trace-context propagation | `feature/telemetry_feature.go` | `PreDone`, `PrePoint`, `PreRequest`, `PreUnexpected` |
