...
type CancelTransactionEntity struct {
	name    string
...
func NewCancelTransactionEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *CancelTransactionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CancelTransactionEntity) GetName() string { return e.name }
...
func (e *CancelTransactionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CancelTransactionEntity) Deleted() bool {
	return e.deleted
}


func (e *CancelTransactionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCancelTransactionEntity(e.client, opts)
}

func (e *CancelTransactionEntity) Data(args ...any) any {
...
func (e *CancelTransactionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CancelTransaction; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CancelTransactionEntity) DataTyped(data ...CancelTransaction) CancelTransaction {
	if len(data) > 0 {
		return typedFrom[CancelTransaction](e.Data(asMap(data[0])))
	}
	return typedFrom[CancelTransaction](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CancelTransaction (all fields
// optional at the wire level).
func (e *CancelTransactionEntity) MatchTyped(match ...CancelTransaction) CancelTransaction {
	if len(match) > 0 {
		return typedFrom[CancelTransaction](e.Match(asMap(match[0])))
	}
	return typedFrom[CancelTransaction](e.Match())
}
...
func (e *CancelTransactionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CancelTransactionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CancelTransactionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CancelTransactionEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CancelTransactionCreateData and returns an CancelTransaction. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CancelTransactionEntity) CreateTyped(reqdata CancelTransactionCreateData, ctrl map[string]any) (CancelTransaction, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return CancelTransaction{}, err
	}
	return typedFrom[CancelTransaction](res), nil
}



func (e *CancelTransactionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CancelTransactionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CancelTransactionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
