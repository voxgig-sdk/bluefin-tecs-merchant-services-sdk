...
type ListTerminalEntity struct {
	name    string
...
func NewListTerminalEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *ListTerminalEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ListTerminalEntity) GetName() string { return e.name }
...
func (e *ListTerminalEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ListTerminalEntity) Deleted() bool {
	return e.deleted
}


func (e *ListTerminalEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewListTerminalEntity(e.client, opts)
}

func (e *ListTerminalEntity) Data(args ...any) any {
...
func (e *ListTerminalEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ListTerminal; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ListTerminalEntity) DataTyped(data ...ListTerminal) ListTerminal {
	if len(data) > 0 {
		return typedFrom[ListTerminal](e.Data(asMap(data[0])))
	}
	return typedFrom[ListTerminal](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ListTerminal (all fields
// optional at the wire level).
func (e *ListTerminalEntity) MatchTyped(match ...ListTerminal) ListTerminal {
	if len(match) > 0 {
		return typedFrom[ListTerminal](e.Match(asMap(match[0])))
	}
	return typedFrom[ListTerminal](e.Match())
}
...
func (e *ListTerminalEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ListTerminalEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ListTerminalEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ListTerminalEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ListTerminalCreateData and returns an ListTerminal. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ListTerminalEntity) CreateTyped(reqdata ListTerminalCreateData, ctrl map[string]any) (ListTerminal, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return ListTerminal{}, err
	}
	return typedFrom[ListTerminal](res), nil
}



func (e *ListTerminalEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ListTerminalEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ListTerminalEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
