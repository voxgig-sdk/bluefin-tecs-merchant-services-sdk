...
type GetTemplateXmlEntity struct {
	name    string
...
func NewGetTemplateXmlEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *GetTemplateXmlEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetTemplateXmlEntity) GetName() string { return e.name }
...
func (e *GetTemplateXmlEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetTemplateXmlEntity) Deleted() bool {
	return e.deleted
}


func (e *GetTemplateXmlEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetTemplateXmlEntity(e.client, opts)
}

func (e *GetTemplateXmlEntity) Data(args ...any) any {
...
func (e *GetTemplateXmlEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetTemplateXml; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetTemplateXmlEntity) DataTyped(data ...GetTemplateXml) GetTemplateXml {
	if len(data) > 0 {
		return typedFrom[GetTemplateXml](e.Data(asMap(data[0])))
	}
	return typedFrom[GetTemplateXml](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetTemplateXml (all fields
// optional at the wire level).
func (e *GetTemplateXmlEntity) MatchTyped(match ...GetTemplateXml) GetTemplateXml {
	if len(match) > 0 {
		return typedFrom[GetTemplateXml](e.Match(asMap(match[0])))
	}
	return typedFrom[GetTemplateXml](e.Match())
}
...
func (e *GetTemplateXmlEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetTemplateXmlEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *GetTemplateXmlEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *GetTemplateXmlEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetTemplateXmlCreateData and returns an GetTemplateXml. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GetTemplateXmlEntity) CreateTyped(reqdata GetTemplateXmlCreateData, ctrl map[string]any) (GetTemplateXml, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return GetTemplateXml{}, err
	}
	return typedFrom[GetTemplateXml](res), nil
}



func (e *GetTemplateXmlEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetTemplateXmlEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetTemplateXmlEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
