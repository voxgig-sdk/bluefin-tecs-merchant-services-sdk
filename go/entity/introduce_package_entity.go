...
type IntroducePackageEntity struct {
	name    string
...
func NewIntroducePackageEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *IntroducePackageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IntroducePackageEntity) GetName() string { return e.name }
...
func (e *IntroducePackageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IntroducePackageEntity) Deleted() bool {
	return e.deleted
}


func (e *IntroducePackageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIntroducePackageEntity(e.client, opts)
}

func (e *IntroducePackageEntity) Data(args ...any) any {
...
func (e *IntroducePackageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IntroducePackage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IntroducePackageEntity) DataTyped(data ...IntroducePackage) IntroducePackage {
	if len(data) > 0 {
		return typedFrom[IntroducePackage](e.Data(asMap(data[0])))
	}
	return typedFrom[IntroducePackage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IntroducePackage (all fields
// optional at the wire level).
func (e *IntroducePackageEntity) MatchTyped(match ...IntroducePackage) IntroducePackage {
	if len(match) > 0 {
		return typedFrom[IntroducePackage](e.Match(asMap(match[0])))
	}
	return typedFrom[IntroducePackage](e.Match())
}
...
func (e *IntroducePackageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IntroducePackageEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *IntroducePackageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *IntroducePackageEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IntroducePackageCreateData and returns an IntroducePackage. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *IntroducePackageEntity) CreateTyped(reqdata IntroducePackageCreateData, ctrl map[string]any) (IntroducePackage, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return IntroducePackage{}, err
	}
	return typedFrom[IntroducePackage](res), nil
}



func (e *IntroducePackageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IntroducePackageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IntroducePackageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
