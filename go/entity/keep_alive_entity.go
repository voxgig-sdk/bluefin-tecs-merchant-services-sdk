...
func NewKeepAliveEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *KeepAliveEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *KeepAliveEntity) GetName() string { return e.name }
...
func (e *KeepAliveEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *KeepAliveEntity) Deleted() bool {
	return e.deleted
}


func (e *KeepAliveEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewKeepAliveEntity(e.client, opts)
}

func (e *KeepAliveEntity) Data(args ...any) any {
...
func (e *KeepAliveEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an KeepAlive; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *KeepAliveEntity) DataTyped(data ...KeepAlive) KeepAlive {
	if len(data) > 0 {
		return typedFrom[KeepAlive](e.Data(asMap(data[0])))
	}
	return typedFrom[KeepAlive](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through KeepAlive (all fields
// optional at the wire level).
func (e *KeepAliveEntity) MatchTyped(match ...KeepAlive) KeepAlive {
	if len(match) > 0 {
		return typedFrom[KeepAlive](e.Match(asMap(match[0])))
	}
	return typedFrom[KeepAlive](e.Match())
}
...
func (e *KeepAliveEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *KeepAliveEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *KeepAliveEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *KeepAliveEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// KeepAliveCreateData and returns an KeepAlive. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *KeepAliveEntity) CreateTyped(reqdata KeepAliveCreateData, ctrl map[string]any) (KeepAlive, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return KeepAlive{}, err
	}
	return typedFrom[KeepAlive](res), nil
}



func (e *KeepAliveEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *KeepAliveEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *KeepAliveEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
