...
type EcomParameterEntity struct {
	name    string
...
func NewEcomParameterEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *EcomParameterEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EcomParameterEntity) GetName() string { return e.name }
...
func (e *EcomParameterEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EcomParameterEntity) Deleted() bool {
	return e.deleted
}


func (e *EcomParameterEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEcomParameterEntity(e.client, opts)
}

func (e *EcomParameterEntity) Data(args ...any) any {
...
func (e *EcomParameterEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EcomParameter; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EcomParameterEntity) DataTyped(data ...EcomParameter) EcomParameter {
	if len(data) > 0 {
		return typedFrom[EcomParameter](e.Data(asMap(data[0])))
	}
	return typedFrom[EcomParameter](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EcomParameter (all fields
// optional at the wire level).
func (e *EcomParameterEntity) MatchTyped(match ...EcomParameter) EcomParameter {
	if len(match) > 0 {
		return typedFrom[EcomParameter](e.Match(asMap(match[0])))
	}
	return typedFrom[EcomParameter](e.Match())
}
...
func (e *EcomParameterEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EcomParameterEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EcomParameterEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EcomParameterEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EcomParameterCreateData and returns an EcomParameter. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EcomParameterEntity) CreateTyped(reqdata EcomParameterCreateData, ctrl map[string]any) (EcomParameter, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return EcomParameter{}, err
	}
	return typedFrom[EcomParameter](res), nil
}



func (e *EcomParameterEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EcomParameterEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EcomParameterEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
