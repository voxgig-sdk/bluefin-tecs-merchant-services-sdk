...
type RegisterTerminalEntity struct {
	name    string
...
func NewRegisterTerminalEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *RegisterTerminalEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RegisterTerminalEntity) GetName() string { return e.name }
...
func (e *RegisterTerminalEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RegisterTerminalEntity) Deleted() bool {
	return e.deleted
}


func (e *RegisterTerminalEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRegisterTerminalEntity(e.client, opts)
}

func (e *RegisterTerminalEntity) Data(args ...any) any {
...
func (e *RegisterTerminalEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RegisterTerminal; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RegisterTerminalEntity) DataTyped(data ...RegisterTerminal) RegisterTerminal {
	if len(data) > 0 {
		return typedFrom[RegisterTerminal](e.Data(asMap(data[0])))
	}
	return typedFrom[RegisterTerminal](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RegisterTerminal (all fields
// optional at the wire level).
func (e *RegisterTerminalEntity) MatchTyped(match ...RegisterTerminal) RegisterTerminal {
	if len(match) > 0 {
		return typedFrom[RegisterTerminal](e.Match(asMap(match[0])))
	}
	return typedFrom[RegisterTerminal](e.Match())
}
...
func (e *RegisterTerminalEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RegisterTerminalEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *RegisterTerminalEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *RegisterTerminalEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RegisterTerminalCreateData and returns an RegisterTerminal. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *RegisterTerminalEntity) CreateTyped(reqdata RegisterTerminalCreateData, ctrl map[string]any) (RegisterTerminal, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return RegisterTerminal{}, err
	}
	return typedFrom[RegisterTerminal](res), nil
}



func (e *RegisterTerminalEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RegisterTerminalEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RegisterTerminalEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
