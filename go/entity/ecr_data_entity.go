...
func NewEcrDataEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *EcrDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EcrDataEntity) GetName() string { return e.name }
...
func (e *EcrDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EcrDataEntity) Deleted() bool {
	return e.deleted
}


func (e *EcrDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEcrDataEntity(e.client, opts)
}

func (e *EcrDataEntity) Data(args ...any) any {
...
func (e *EcrDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EcrData; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EcrDataEntity) DataTyped(data ...EcrData) EcrData {
	if len(data) > 0 {
		return typedFrom[EcrData](e.Data(asMap(data[0])))
	}
	return typedFrom[EcrData](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EcrData (all fields
// optional at the wire level).
func (e *EcrDataEntity) MatchTyped(match ...EcrData) EcrData {
	if len(match) > 0 {
		return typedFrom[EcrData](e.Match(asMap(match[0])))
	}
	return typedFrom[EcrData](e.Match())
}
...
func (e *EcrDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EcrDataEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EcrDataEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EcrDataEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EcrDataCreateData and returns an EcrData. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EcrDataEntity) CreateTyped(reqdata EcrDataCreateData, ctrl map[string]any) (EcrData, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return EcrData{}, err
	}
	return typedFrom[EcrData](res), nil
}



func (e *EcrDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EcrDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EcrDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
