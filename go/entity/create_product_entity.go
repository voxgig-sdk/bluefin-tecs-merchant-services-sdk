...
func NewCreateProductEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *CreateProductEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CreateProductEntity) GetName() string { return e.name }
...
func (e *CreateProductEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CreateProductEntity) Deleted() bool {
	return e.deleted
}


func (e *CreateProductEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCreateProductEntity(e.client, opts)
}

func (e *CreateProductEntity) Data(args ...any) any {
...
func (e *CreateProductEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CreateProduct; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CreateProductEntity) DataTyped(data ...CreateProduct) CreateProduct {
	if len(data) > 0 {
		return typedFrom[CreateProduct](e.Data(asMap(data[0])))
	}
	return typedFrom[CreateProduct](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CreateProduct (all fields
// optional at the wire level).
func (e *CreateProductEntity) MatchTyped(match ...CreateProduct) CreateProduct {
	if len(match) > 0 {
		return typedFrom[CreateProduct](e.Match(asMap(match[0])))
	}
	return typedFrom[CreateProduct](e.Match())
}
...
func (e *CreateProductEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CreateProductEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CreateProductEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CreateProductEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CreateProductCreateData and returns an CreateProduct. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CreateProductEntity) CreateTyped(reqdata CreateProductCreateData, ctrl map[string]any) (CreateProduct, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return CreateProduct{}, err
	}
	return typedFrom[CreateProduct](res), nil
}



func (e *CreateProductEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CreateProductEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CreateProductEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
