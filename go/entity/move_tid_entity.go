...
func NewMoveTidEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *MoveTidEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MoveTidEntity) GetName() string { return e.name }
...
func (e *MoveTidEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MoveTidEntity) Deleted() bool {
	return e.deleted
}


func (e *MoveTidEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMoveTidEntity(e.client, opts)
}

func (e *MoveTidEntity) Data(args ...any) any {
...
func (e *MoveTidEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an MoveTid; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MoveTidEntity) DataTyped(data ...MoveTid) MoveTid {
	if len(data) > 0 {
		return typedFrom[MoveTid](e.Data(asMap(data[0])))
	}
	return typedFrom[MoveTid](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through MoveTid (all fields
// optional at the wire level).
func (e *MoveTidEntity) MatchTyped(match ...MoveTid) MoveTid {
	if len(match) > 0 {
		return typedFrom[MoveTid](e.Match(asMap(match[0])))
	}
	return typedFrom[MoveTid](e.Match())
}
...
func (e *MoveTidEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MoveTidEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *MoveTidEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *MoveTidEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MoveTidCreateData and returns an MoveTid. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *MoveTidEntity) CreateTyped(reqdata MoveTidCreateData, ctrl map[string]any) (MoveTid, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return MoveTid{}, err
	}
	return typedFrom[MoveTid](res), nil
}



func (e *MoveTidEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MoveTidEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MoveTidEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
