...
type UpdateMerchantEntity struct {
	name    string
...
func NewUpdateMerchantEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *UpdateMerchantEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UpdateMerchantEntity) GetName() string { return e.name }
...
func (e *UpdateMerchantEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UpdateMerchantEntity) Deleted() bool {
	return e.deleted
}


func (e *UpdateMerchantEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUpdateMerchantEntity(e.client, opts)
}

func (e *UpdateMerchantEntity) Data(args ...any) any {
...
func (e *UpdateMerchantEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UpdateMerchant; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UpdateMerchantEntity) DataTyped(data ...UpdateMerchant) UpdateMerchant {
	if len(data) > 0 {
		return typedFrom[UpdateMerchant](e.Data(asMap(data[0])))
	}
	return typedFrom[UpdateMerchant](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UpdateMerchant (all fields
// optional at the wire level).
func (e *UpdateMerchantEntity) MatchTyped(match ...UpdateMerchant) UpdateMerchant {
	if len(match) > 0 {
		return typedFrom[UpdateMerchant](e.Match(asMap(match[0])))
	}
	return typedFrom[UpdateMerchant](e.Match())
}
...
func (e *UpdateMerchantEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UpdateMerchantEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *UpdateMerchantEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *UpdateMerchantEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UpdateMerchantCreateData and returns an UpdateMerchant. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *UpdateMerchantEntity) CreateTyped(reqdata UpdateMerchantCreateData, ctrl map[string]any) (UpdateMerchant, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return UpdateMerchant{}, err
	}
	return typedFrom[UpdateMerchant](res), nil
}



func (e *UpdateMerchantEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UpdateMerchantEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UpdateMerchantEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
