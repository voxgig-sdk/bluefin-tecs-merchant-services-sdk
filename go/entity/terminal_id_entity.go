...
func NewTerminalIdEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *TerminalIdEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TerminalIdEntity) GetName() string { return e.name }
...
func (e *TerminalIdEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TerminalIdEntity) Deleted() bool {
	return e.deleted
}


func (e *TerminalIdEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTerminalIdEntity(e.client, opts)
}

func (e *TerminalIdEntity) Data(args ...any) any {
...
func (e *TerminalIdEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TerminalId; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TerminalIdEntity) DataTyped(data ...TerminalId) TerminalId {
	if len(data) > 0 {
		return typedFrom[TerminalId](e.Data(asMap(data[0])))
	}
	return typedFrom[TerminalId](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TerminalId (all fields
// optional at the wire level).
func (e *TerminalIdEntity) MatchTyped(match ...TerminalId) TerminalId {
	if len(match) > 0 {
		return typedFrom[TerminalId](e.Match(asMap(match[0])))
	}
	return typedFrom[TerminalId](e.Match())
}
...
func (e *TerminalIdEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TerminalIdEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *TerminalIdEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *TerminalIdEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TerminalIdCreateData and returns an TerminalId. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *TerminalIdEntity) CreateTyped(reqdata TerminalIdCreateData, ctrl map[string]any) (TerminalId, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return TerminalId{}, err
	}
	return typedFrom[TerminalId](res), nil
}



func (e *TerminalIdEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TerminalIdEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TerminalIdEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
