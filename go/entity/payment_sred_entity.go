...
func NewPaymentSredEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *PaymentSredEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PaymentSredEntity) GetName() string { return e.name }
...
func (e *PaymentSredEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PaymentSredEntity) Deleted() bool {
	return e.deleted
}


func (e *PaymentSredEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPaymentSredEntity(e.client, opts)
}

func (e *PaymentSredEntity) Data(args ...any) any {
...
func (e *PaymentSredEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PaymentSred; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PaymentSredEntity) DataTyped(data ...PaymentSred) PaymentSred {
	if len(data) > 0 {
		return typedFrom[PaymentSred](e.Data(asMap(data[0])))
	}
	return typedFrom[PaymentSred](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PaymentSred (all fields
// optional at the wire level).
func (e *PaymentSredEntity) MatchTyped(match ...PaymentSred) PaymentSred {
	if len(match) > 0 {
		return typedFrom[PaymentSred](e.Match(asMap(match[0])))
	}
	return typedFrom[PaymentSred](e.Match())
}
...
func (e *PaymentSredEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PaymentSredEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PaymentSredEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PaymentSredEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PaymentSredCreateData and returns an PaymentSred. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PaymentSredEntity) CreateTyped(reqdata PaymentSredCreateData, ctrl map[string]any) (PaymentSred, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return PaymentSred{}, err
	}
	return typedFrom[PaymentSred](res), nil
}



func (e *PaymentSredEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PaymentSredEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PaymentSredEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
