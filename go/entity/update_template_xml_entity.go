...
type UpdateTemplateXmlEntity struct {
	name    string
...
func NewUpdateTemplateXmlEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *UpdateTemplateXmlEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UpdateTemplateXmlEntity) GetName() string { return e.name }
...
func (e *UpdateTemplateXmlEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UpdateTemplateXmlEntity) Deleted() bool {
	return e.deleted
}


func (e *UpdateTemplateXmlEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUpdateTemplateXmlEntity(e.client, opts)
}

func (e *UpdateTemplateXmlEntity) Data(args ...any) any {
...
func (e *UpdateTemplateXmlEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UpdateTemplateXml; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UpdateTemplateXmlEntity) DataTyped(data ...UpdateTemplateXml) UpdateTemplateXml {
	if len(data) > 0 {
		return typedFrom[UpdateTemplateXml](e.Data(asMap(data[0])))
	}
	return typedFrom[UpdateTemplateXml](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UpdateTemplateXml (all fields
// optional at the wire level).
func (e *UpdateTemplateXmlEntity) MatchTyped(match ...UpdateTemplateXml) UpdateTemplateXml {
	if len(match) > 0 {
		return typedFrom[UpdateTemplateXml](e.Match(asMap(match[0])))
	}
	return typedFrom[UpdateTemplateXml](e.Match())
}
...
func (e *UpdateTemplateXmlEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UpdateTemplateXmlEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *UpdateTemplateXmlEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *UpdateTemplateXmlEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UpdateTemplateXmlCreateData and returns an UpdateTemplateXml. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *UpdateTemplateXmlEntity) CreateTyped(reqdata UpdateTemplateXmlCreateData, ctrl map[string]any) (UpdateTemplateXml, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return UpdateTemplateXml{}, err
	}
	return typedFrom[UpdateTemplateXml](res), nil
}



func (e *UpdateTemplateXmlEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UpdateTemplateXmlEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UpdateTemplateXmlEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
