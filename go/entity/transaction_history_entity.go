...
type TransactionHistoryEntity struct {
	name    string
...
func NewTransactionHistoryEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *TransactionHistoryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TransactionHistoryEntity) GetName() string { return e.name }
...
func (e *TransactionHistoryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TransactionHistoryEntity) Deleted() bool {
	return e.deleted
}


func (e *TransactionHistoryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTransactionHistoryEntity(e.client, opts)
}

func (e *TransactionHistoryEntity) Data(args ...any) any {
...
func (e *TransactionHistoryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TransactionHistory; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TransactionHistoryEntity) DataTyped(data ...TransactionHistory) TransactionHistory {
	if len(data) > 0 {
		return typedFrom[TransactionHistory](e.Data(asMap(data[0])))
	}
	return typedFrom[TransactionHistory](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TransactionHistory (all fields
// optional at the wire level).
func (e *TransactionHistoryEntity) MatchTyped(match ...TransactionHistory) TransactionHistory {
	if len(match) > 0 {
		return typedFrom[TransactionHistory](e.Match(asMap(match[0])))
	}
	return typedFrom[TransactionHistory](e.Match())
}
...
func (e *TransactionHistoryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TransactionHistoryEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *TransactionHistoryEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *TransactionHistoryEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TransactionHistoryCreateData and returns an TransactionHistory. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *TransactionHistoryEntity) CreateTyped(reqdata TransactionHistoryCreateData, ctrl map[string]any) (TransactionHistory, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return TransactionHistory{}, err
	}
	return typedFrom[TransactionHistory](res), nil
}



func (e *TransactionHistoryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TransactionHistoryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TransactionHistoryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
