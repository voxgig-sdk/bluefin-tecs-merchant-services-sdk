...
func NewReportDataEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *ReportDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReportDataEntity) GetName() string { return e.name }
...
func (e *ReportDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReportDataEntity) Deleted() bool {
	return e.deleted
}


func (e *ReportDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReportDataEntity(e.client, opts)
}

func (e *ReportDataEntity) Data(args ...any) any {
...
func (e *ReportDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ReportData; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReportDataEntity) DataTyped(data ...ReportData) ReportData {
	if len(data) > 0 {
		return typedFrom[ReportData](e.Data(asMap(data[0])))
	}
	return typedFrom[ReportData](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ReportData (all fields
// optional at the wire level).
func (e *ReportDataEntity) MatchTyped(match ...ReportData) ReportData {
	if len(match) > 0 {
		return typedFrom[ReportData](e.Match(asMap(match[0])))
	}
	return typedFrom[ReportData](e.Match())
}
...
func (e *ReportDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReportDataEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ReportDataEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ReportDataEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReportDataCreateData and returns an ReportData. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ReportDataEntity) CreateTyped(reqdata ReportDataCreateData, ctrl map[string]any) (ReportData, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return ReportData{}, err
	}
	return typedFrom[ReportData](res), nil
}



func (e *ReportDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReportDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReportDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
