...
type PaymentManualEntity struct {
	name    string
...
func NewPaymentManualEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *PaymentManualEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PaymentManualEntity) GetName() string { return e.name }
...
func (e *PaymentManualEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PaymentManualEntity) Deleted() bool {
	return e.deleted
}


func (e *PaymentManualEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPaymentManualEntity(e.client, opts)
}

func (e *PaymentManualEntity) Data(args ...any) any {
...
func (e *PaymentManualEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PaymentManual; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PaymentManualEntity) DataTyped(data ...PaymentManual) PaymentManual {
	if len(data) > 0 {
		return typedFrom[PaymentManual](e.Data(asMap(data[0])))
	}
	return typedFrom[PaymentManual](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PaymentManual (all fields
// optional at the wire level).
func (e *PaymentManualEntity) MatchTyped(match ...PaymentManual) PaymentManual {
	if len(match) > 0 {
		return typedFrom[PaymentManual](e.Match(asMap(match[0])))
	}
	return typedFrom[PaymentManual](e.Match())
}
...
func (e *PaymentManualEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PaymentManualEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PaymentManualEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PaymentManualEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PaymentManualCreateData and returns an PaymentManual. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PaymentManualEntity) CreateTyped(reqdata PaymentManualCreateData, ctrl map[string]any) (PaymentManual, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return PaymentManual{}, err
	}
	return typedFrom[PaymentManual](res), nil
}



func (e *PaymentManualEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PaymentManualEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PaymentManualEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
