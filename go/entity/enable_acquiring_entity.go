...
type EnableAcquiringEntity struct {
	name    string
...
func NewEnableAcquiringEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *EnableAcquiringEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EnableAcquiringEntity) GetName() string { return e.name }
...
func (e *EnableAcquiringEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EnableAcquiringEntity) Deleted() bool {
	return e.deleted
}


func (e *EnableAcquiringEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEnableAcquiringEntity(e.client, opts)
}

func (e *EnableAcquiringEntity) Data(args ...any) any {
...
func (e *EnableAcquiringEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EnableAcquiring; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EnableAcquiringEntity) DataTyped(data ...EnableAcquiring) EnableAcquiring {
	if len(data) > 0 {
		return typedFrom[EnableAcquiring](e.Data(asMap(data[0])))
	}
	return typedFrom[EnableAcquiring](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EnableAcquiring (all fields
// optional at the wire level).
func (e *EnableAcquiringEntity) MatchTyped(match ...EnableAcquiring) EnableAcquiring {
	if len(match) > 0 {
		return typedFrom[EnableAcquiring](e.Match(asMap(match[0])))
	}
	return typedFrom[EnableAcquiring](e.Match())
}
...
func (e *EnableAcquiringEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EnableAcquiringEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EnableAcquiringEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EnableAcquiringEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EnableAcquiringCreateData and returns an EnableAcquiring. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EnableAcquiringEntity) CreateTyped(reqdata EnableAcquiringCreateData, ctrl map[string]any) (EnableAcquiring, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return EnableAcquiring{}, err
	}
	return typedFrom[EnableAcquiring](res), nil
}



func (e *EnableAcquiringEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EnableAcquiringEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EnableAcquiringEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
