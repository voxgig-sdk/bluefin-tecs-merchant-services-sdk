...
func NewVersionEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *VersionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *VersionEntity) GetName() string { return e.name }
...
func (e *VersionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *VersionEntity) Deleted() bool {
	return e.deleted
}


func (e *VersionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVersionEntity(e.client, opts)
}

func (e *VersionEntity) Data(args ...any) any {
...
func (e *VersionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Version; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *VersionEntity) DataTyped(data ...Version) Version {
	if len(data) > 0 {
		return typedFrom[Version](e.Data(asMap(data[0])))
	}
	return typedFrom[Version](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Version (all fields
// optional at the wire level).
func (e *VersionEntity) MatchTyped(match ...Version) Version {
	if len(match) > 0 {
		return typedFrom[Version](e.Match(asMap(match[0])))
	}
	return typedFrom[Version](e.Match())
}
...
func (e *VersionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *VersionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// VersionLoadMatch and returns an Version. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *VersionEntity) LoadTyped(reqmatch VersionLoadMatch, ctrl map[string]any) (Version, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Version{}, err
	}
	return typedFrom[Version](res), nil
}



func (e *VersionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *VersionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *VersionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *VersionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *VersionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
