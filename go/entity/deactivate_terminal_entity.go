...
type DeactivateTerminalEntity struct {
	name    string
...
func NewDeactivateTerminalEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *DeactivateTerminalEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeactivateTerminalEntity) GetName() string { return e.name }
...
func (e *DeactivateTerminalEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeactivateTerminalEntity) Deleted() bool {
	return e.deleted
}


func (e *DeactivateTerminalEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeactivateTerminalEntity(e.client, opts)
}

func (e *DeactivateTerminalEntity) Data(args ...any) any {
...
func (e *DeactivateTerminalEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DeactivateTerminal; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DeactivateTerminalEntity) DataTyped(data ...DeactivateTerminal) DeactivateTerminal {
	if len(data) > 0 {
		return typedFrom[DeactivateTerminal](e.Data(asMap(data[0])))
	}
	return typedFrom[DeactivateTerminal](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DeactivateTerminal (all fields
// optional at the wire level).
func (e *DeactivateTerminalEntity) MatchTyped(match ...DeactivateTerminal) DeactivateTerminal {
	if len(match) > 0 {
		return typedFrom[DeactivateTerminal](e.Match(asMap(match[0])))
	}
	return typedFrom[DeactivateTerminal](e.Match())
}
...
func (e *DeactivateTerminalEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeactivateTerminalEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DeactivateTerminalEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DeactivateTerminalEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DeactivateTerminalCreateData and returns an DeactivateTerminal. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DeactivateTerminalEntity) CreateTyped(reqdata DeactivateTerminalCreateData, ctrl map[string]any) (DeactivateTerminal, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return DeactivateTerminal{}, err
	}
	return typedFrom[DeactivateTerminal](res), nil
}



func (e *DeactivateTerminalEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DeactivateTerminalEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DeactivateTerminalEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
