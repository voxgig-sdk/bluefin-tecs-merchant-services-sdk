...
type StatusTransactionEntity struct {
	name    string
...
func NewStatusTransactionEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *StatusTransactionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StatusTransactionEntity) GetName() string { return e.name }
...
func (e *StatusTransactionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StatusTransactionEntity) Deleted() bool {
	return e.deleted
}


func (e *StatusTransactionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStatusTransactionEntity(e.client, opts)
}

func (e *StatusTransactionEntity) Data(args ...any) any {
...
func (e *StatusTransactionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an StatusTransaction; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StatusTransactionEntity) DataTyped(data ...StatusTransaction) StatusTransaction {
	if len(data) > 0 {
		return typedFrom[StatusTransaction](e.Data(asMap(data[0])))
	}
	return typedFrom[StatusTransaction](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through StatusTransaction (all fields
// optional at the wire level).
func (e *StatusTransactionEntity) MatchTyped(match ...StatusTransaction) StatusTransaction {
	if len(match) > 0 {
		return typedFrom[StatusTransaction](e.Match(asMap(match[0])))
	}
	return typedFrom[StatusTransaction](e.Match())
}
...
func (e *StatusTransactionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StatusTransactionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *StatusTransactionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *StatusTransactionEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StatusTransactionCreateData and returns an StatusTransaction. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *StatusTransactionEntity) CreateTyped(reqdata StatusTransactionCreateData, ctrl map[string]any) (StatusTransaction, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return StatusTransaction{}, err
	}
	return typedFrom[StatusTransaction](res), nil
}



func (e *StatusTransactionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StatusTransactionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StatusTransactionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
