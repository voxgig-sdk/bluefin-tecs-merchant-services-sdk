...
type RefundTransactionEntity struct {
	name    string
...
func NewRefundTransactionEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *RefundTransactionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RefundTransactionEntity) GetName() string { return e.name }
...
func (e *RefundTransactionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RefundTransactionEntity) Deleted() bool {
	return e.deleted
}


func (e *RefundTransactionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRefundTransactionEntity(e.client, opts)
}

func (e *RefundTransactionEntity) Data(args ...any) any {
...
func (e *RefundTransactionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RefundTransaction; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RefundTransactionEntity) DataTyped(data ...RefundTransaction) RefundTransaction {
	if len(data) > 0 {
		return typedFrom[RefundTransaction](e.Data(asMap(data[0])))
	}
	return typedFrom[RefundTransaction](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RefundTransaction (all fields
// optional at the wire level).
func (e *RefundTransactionEntity) MatchTyped(match ...RefundTransaction) RefundTransaction {
	if len(match) > 0 {
		return typedFrom[RefundTransaction](e.Match(asMap(match[0])))
	}
	return typedFrom[RefundTransaction](e.Match())
}
...
func (e *RefundTransactionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RefundTransactionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *RefundTransactionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *RefundTransactionEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RefundTransactionCreateData and returns an RefundTransaction. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *RefundTransactionEntity) CreateTyped(reqdata RefundTransactionCreateData, ctrl map[string]any) (RefundTransaction, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return RefundTransaction{}, err
	}
	return typedFrom[RefundTransaction](res), nil
}



func (e *RefundTransactionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RefundTransactionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RefundTransactionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
