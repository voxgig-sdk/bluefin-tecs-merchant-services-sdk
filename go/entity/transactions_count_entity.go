...
type TransactionsCountEntity struct {
	name    string
...
func NewTransactionsCountEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *TransactionsCountEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TransactionsCountEntity) GetName() string { return e.name }
...
func (e *TransactionsCountEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TransactionsCountEntity) Deleted() bool {
	return e.deleted
}


func (e *TransactionsCountEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTransactionsCountEntity(e.client, opts)
}

func (e *TransactionsCountEntity) Data(args ...any) any {
...
func (e *TransactionsCountEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TransactionsCount; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TransactionsCountEntity) DataTyped(data ...TransactionsCount) TransactionsCount {
	if len(data) > 0 {
		return typedFrom[TransactionsCount](e.Data(asMap(data[0])))
	}
	return typedFrom[TransactionsCount](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TransactionsCount (all fields
// optional at the wire level).
func (e *TransactionsCountEntity) MatchTyped(match ...TransactionsCount) TransactionsCount {
	if len(match) > 0 {
		return typedFrom[TransactionsCount](e.Match(asMap(match[0])))
	}
	return typedFrom[TransactionsCount](e.Match())
}
...
func (e *TransactionsCountEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TransactionsCountEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *TransactionsCountEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *TransactionsCountEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TransactionsCountCreateData and returns an TransactionsCount. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *TransactionsCountEntity) CreateTyped(reqdata TransactionsCountCreateData, ctrl map[string]any) (TransactionsCount, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return TransactionsCount{}, err
	}
	return typedFrom[TransactionsCount](res), nil
}



func (e *TransactionsCountEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TransactionsCountEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TransactionsCountEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
