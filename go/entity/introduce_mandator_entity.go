...
type IntroduceMandatorEntity struct {
	name    string
...
func NewIntroduceMandatorEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *IntroduceMandatorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IntroduceMandatorEntity) GetName() string { return e.name }
...
func (e *IntroduceMandatorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IntroduceMandatorEntity) Deleted() bool {
	return e.deleted
}


func (e *IntroduceMandatorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIntroduceMandatorEntity(e.client, opts)
}

func (e *IntroduceMandatorEntity) Data(args ...any) any {
...
func (e *IntroduceMandatorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IntroduceMandator; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IntroduceMandatorEntity) DataTyped(data ...IntroduceMandator) IntroduceMandator {
	if len(data) > 0 {
		return typedFrom[IntroduceMandator](e.Data(asMap(data[0])))
	}
	return typedFrom[IntroduceMandator](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IntroduceMandator (all fields
// optional at the wire level).
func (e *IntroduceMandatorEntity) MatchTyped(match ...IntroduceMandator) IntroduceMandator {
	if len(match) > 0 {
		return typedFrom[IntroduceMandator](e.Match(asMap(match[0])))
	}
	return typedFrom[IntroduceMandator](e.Match())
}
...
func (e *IntroduceMandatorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IntroduceMandatorEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *IntroduceMandatorEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *IntroduceMandatorEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IntroduceMandatorCreateData and returns an IntroduceMandator. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *IntroduceMandatorEntity) CreateTyped(reqdata IntroduceMandatorCreateData, ctrl map[string]any) (IntroduceMandator, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return IntroduceMandator{}, err
	}
	return typedFrom[IntroduceMandator](res), nil
}



func (e *IntroduceMandatorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IntroduceMandatorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IntroduceMandatorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
