...
type ReactivateTerminalEntity struct {
	name    string
...
func NewReactivateTerminalEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *ReactivateTerminalEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReactivateTerminalEntity) GetName() string { return e.name }
...
func (e *ReactivateTerminalEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReactivateTerminalEntity) Deleted() bool {
	return e.deleted
}


func (e *ReactivateTerminalEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReactivateTerminalEntity(e.client, opts)
}

func (e *ReactivateTerminalEntity) Data(args ...any) any {
...
func (e *ReactivateTerminalEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ReactivateTerminal; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReactivateTerminalEntity) DataTyped(data ...ReactivateTerminal) ReactivateTerminal {
	if len(data) > 0 {
		return typedFrom[ReactivateTerminal](e.Data(asMap(data[0])))
	}
	return typedFrom[ReactivateTerminal](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ReactivateTerminal (all fields
// optional at the wire level).
func (e *ReactivateTerminalEntity) MatchTyped(match ...ReactivateTerminal) ReactivateTerminal {
	if len(match) > 0 {
		return typedFrom[ReactivateTerminal](e.Match(asMap(match[0])))
	}
	return typedFrom[ReactivateTerminal](e.Match())
}
...
func (e *ReactivateTerminalEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReactivateTerminalEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ReactivateTerminalEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ReactivateTerminalEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReactivateTerminalCreateData and returns an ReactivateTerminal. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ReactivateTerminalEntity) CreateTyped(reqdata ReactivateTerminalCreateData, ctrl map[string]any) (ReactivateTerminal, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return ReactivateTerminal{}, err
	}
	return typedFrom[ReactivateTerminal](res), nil
}



func (e *ReactivateTerminalEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReactivateTerminalEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReactivateTerminalEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
