...
func NewEmvDataEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *EmvDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EmvDataEntity) GetName() string { return e.name }
...
func (e *EmvDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EmvDataEntity) Deleted() bool {
	return e.deleted
}


func (e *EmvDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEmvDataEntity(e.client, opts)
}

func (e *EmvDataEntity) Data(args ...any) any {
...
func (e *EmvDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EmvData; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EmvDataEntity) DataTyped(data ...EmvData) EmvData {
	if len(data) > 0 {
		return typedFrom[EmvData](e.Data(asMap(data[0])))
	}
	return typedFrom[EmvData](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EmvData (all fields
// optional at the wire level).
func (e *EmvDataEntity) MatchTyped(match ...EmvData) EmvData {
	if len(match) > 0 {
		return typedFrom[EmvData](e.Match(asMap(match[0])))
	}
	return typedFrom[EmvData](e.Match())
}
...
func (e *EmvDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EmvDataEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EmvDataEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EmvDataEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EmvDataCreateData and returns an EmvData. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EmvDataEntity) CreateTyped(reqdata EmvDataCreateData, ctrl map[string]any) (EmvData, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return EmvData{}, err
	}
	return typedFrom[EmvData](res), nil
}



func (e *EmvDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EmvDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EmvDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
