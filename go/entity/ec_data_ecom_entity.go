...
func NewEcDataEcomEntity(client *core.BluefinTecsMerchantServicesSDK, entopts map[string]any) *EcDataEcomEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EcDataEcomEntity) GetName() string { return e.name }
...
func (e *EcDataEcomEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EcDataEcomEntity) Deleted() bool {
	return e.deleted
}


func (e *EcDataEcomEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEcDataEcomEntity(e.client, opts)
}

func (e *EcDataEcomEntity) Data(args ...any) any {
...
func (e *EcDataEcomEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EcDataEcom; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EcDataEcomEntity) DataTyped(data ...EcDataEcom) EcDataEcom {
	if len(data) > 0 {
		return typedFrom[EcDataEcom](e.Data(asMap(data[0])))
	}
	return typedFrom[EcDataEcom](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EcDataEcom (all fields
// optional at the wire level).
func (e *EcDataEcomEntity) MatchTyped(match ...EcDataEcom) EcDataEcom {
	if len(match) > 0 {
		return typedFrom[EcDataEcom](e.Match(asMap(match[0])))
	}
	return typedFrom[EcDataEcom](e.Match())
}
...
func (e *EcDataEcomEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EcDataEcomEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EcDataEcomEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EcDataEcomEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EcDataEcomCreateData and returns an EcDataEcom. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EcDataEcomEntity) CreateTyped(reqdata EcDataEcomCreateData, ctrl map[string]any) (EcDataEcom, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return EcDataEcom{}, err
	}
	return typedFrom[EcDataEcom](res), nil
}



func (e *EcDataEcomEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EcDataEcomEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EcDataEcomEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
