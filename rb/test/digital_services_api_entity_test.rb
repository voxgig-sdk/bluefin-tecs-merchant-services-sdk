...
class DigitalServicesApiEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set BLUEFINTECSMERCHANTSERVICES_TEST_DIGITAL_SERVICES_API_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def digital_services_api_basic_setup(extra)
  ...
  entid_env_raw = ENV["BLUEFINTECSMERCHANTSERVICES_TEST_DIGITAL_SERVICES_API_ENTID"]
