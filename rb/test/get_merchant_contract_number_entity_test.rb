...
class GetMerchantContractNumberEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set BLUEFINTECSMERCHANTSERVICES_TEST_GET_MERCHANT_CONTRACT_NUMBER_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def get_merchant_contract_number_basic_setup(extra)
  ...
  entid_env_raw = ENV["BLUEFINTECSMERCHANTSERVICES_TEST_GET_MERCHANT_CONTRACT_NUMBER_ENTID"]
