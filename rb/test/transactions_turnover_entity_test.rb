...
class TransactionsTurnoverEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set BLUEFINTECSMERCHANTSERVICES_TEST_TRANSACTIONS_TURNOVER_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def transactions_turnover_basic_setup(extra)
  ...
  entid_env_raw = ENV["BLUEFINTECSMERCHANTSERVICES_TEST_TRANSACTIONS_TURNOVER_ENTID"]
