...
class TerminalIdEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set BLUEFINTECSMERCHANTSERVICES_TEST_TERMINAL_ID_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def terminal_id_basic_setup(extra)
  ...
  entid_env_raw = ENV["BLUEFINTECSMERCHANTSERVICES_TEST_TERMINAL_ID_ENTID"]
