...
#      offline in seeded test mode (BluefinTecsMerchantServicesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "BluefinTecsMerchantServices_sdk.rb")
  SDK_CLASS = "BluefinTecsMerchantServicesSDK"
  ...
  SDK_BASE = "BluefinTecsMerchantServices_sdk"
