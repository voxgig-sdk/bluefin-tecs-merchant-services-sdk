...
class TransactionsTurnoverEntity
  ...
  def make
    opts = @_entopts.dup
    TransactionsTurnoverEntity.new(@_client, opts)
  end
  ...
  # @return [TransactionsTurnover, Hash] the current TransactionsTurnover data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of TransactionsTurnover fields)
  def match_get
  ...
  #
  # @param reqdata [TransactionsTurnoverCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [TransactionsTurnover, Hash] the created TransactionsTurnover; raises BluefinTecsMerchantServicesError on failure
