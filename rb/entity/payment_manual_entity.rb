...
class PaymentManualEntity
  ...
  def make
    opts = @_entopts.dup
    PaymentManualEntity.new(@_client, opts)
  end
  ...
  # @return [PaymentManual, Hash] the current PaymentManual data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PaymentManual fields)
  def match_get
  ...
  #
  # @param reqdata [PaymentManualCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [PaymentManual, Hash] the created PaymentManual; raises BluefinTecsMerchantServicesError on failure
