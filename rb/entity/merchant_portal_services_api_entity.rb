...
class MerchantPortalServicesApiEntity
  ...
  def make
    opts = @_entopts.dup
    MerchantPortalServicesApiEntity.new(@_client, opts)
  end
  ...
  # @return [MerchantPortalServicesApi, Hash] the current MerchantPortalServicesApi data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MerchantPortalServicesApi fields)
  def match_get
  ...
  #
  # @param reqdata [MerchantPortalServicesApiCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [MerchantPortalServicesApi, Hash] the created MerchantPortalServicesApi; raises BluefinTecsMerchantServicesError on failure
