...
class IntroducePackageEntity
  ...
  def make
    opts = @_entopts.dup
    IntroducePackageEntity.new(@_client, opts)
  end
  ...
  # @return [IntroducePackage, Hash] the current IntroducePackage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of IntroducePackage fields)
  def match_get
  ...
  #
  # @param reqdata [IntroducePackageCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [IntroducePackage, Hash] the created IntroducePackage; raises BluefinTecsMerchantServicesError on failure
