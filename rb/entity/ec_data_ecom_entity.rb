...
class EcDataEcomEntity
  ...
  def make
    opts = @_entopts.dup
    EcDataEcomEntity.new(@_client, opts)
  end
  ...
  # @return [EcDataEcom, Hash] the current EcDataEcom data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EcDataEcom fields)
  def match_get
  ...
  #
  # @param reqdata [EcDataEcomCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [EcDataEcom, Hash] the created EcDataEcom; raises BluefinTecsMerchantServicesError on failure
