...
class IntroduceMandatorEntity
  ...
  def make
    opts = @_entopts.dup
    IntroduceMandatorEntity.new(@_client, opts)
  end
  ...
  # @return [IntroduceMandator, Hash] the current IntroduceMandator data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of IntroduceMandator fields)
  def match_get
  ...
  #
  # @param reqdata [IntroduceMandatorCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [IntroduceMandator, Hash] the created IntroduceMandator; raises BluefinTecsMerchantServicesError on failure
