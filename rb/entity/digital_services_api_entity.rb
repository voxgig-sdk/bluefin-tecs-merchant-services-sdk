...
class DigitalServicesApiEntity
  ...
  def make
    opts = @_entopts.dup
    DigitalServicesApiEntity.new(@_client, opts)
  end
  ...
  # @return [DigitalServicesApi, Hash] the current DigitalServicesApi data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DigitalServicesApi fields)
  def match_get
  ...
  #
  # @param reqmatch [DigitalServicesApiLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.DigitalServicesApi.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [DigitalServicesApi, Hash] the loaded DigitalServicesApi; raises BluefinTecsMerchantServicesError on failure
  ...
  #
  # @param reqdata [DigitalServicesApiCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [DigitalServicesApi, Hash] the created DigitalServicesApi; raises BluefinTecsMerchantServicesError on failure
