...
class MandatorClearingExportEntity
  ...
  def make
    opts = @_entopts.dup
    MandatorClearingExportEntity.new(@_client, opts)
  end
  ...
  # @return [MandatorClearingExport, Hash] the current MandatorClearingExport data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MandatorClearingExport fields)
  def match_get
  ...
  #
  # @param reqdata [MandatorClearingExportCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [MandatorClearingExport, Hash] the created MandatorClearingExport; raises BluefinTecsMerchantServicesError on failure
