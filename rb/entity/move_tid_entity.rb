...
class MoveTidEntity
  ...
  def make
    opts = @_entopts.dup
    MoveTidEntity.new(@_client, opts)
  end
  ...
  # @return [MoveTid, Hash] the current MoveTid data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MoveTid fields)
  def match_get
  ...
  #
  # @param reqdata [MoveTidCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [MoveTid, Hash] the created MoveTid; raises BluefinTecsMerchantServicesError on failure
