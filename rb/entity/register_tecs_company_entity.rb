...
class RegisterTecsCompanyEntity
  ...
  def make
    opts = @_entopts.dup
    RegisterTecsCompanyEntity.new(@_client, opts)
  end
  ...
  # @return [RegisterTecsCompany, Hash] the current RegisterTecsCompany data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RegisterTecsCompany fields)
  def match_get
  ...
  #
  # @param reqdata [RegisterTecsCompanyCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [RegisterTecsCompany, Hash] the created RegisterTecsCompany; raises BluefinTecsMerchantServicesError on failure
