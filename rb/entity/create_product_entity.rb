...
class CreateProductEntity
  ...
  def make
    opts = @_entopts.dup
    CreateProductEntity.new(@_client, opts)
  end
  ...
  # @return [CreateProduct, Hash] the current CreateProduct data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CreateProduct fields)
  def match_get
  ...
  #
  # @param reqdata [CreateProductCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [CreateProduct, Hash] the created CreateProduct; raises BluefinTecsMerchantServicesError on failure
