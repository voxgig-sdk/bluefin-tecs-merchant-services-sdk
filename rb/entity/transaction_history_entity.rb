...
class TransactionHistoryEntity
  ...
  def make
    opts = @_entopts.dup
    TransactionHistoryEntity.new(@_client, opts)
  end
  ...
  # @return [TransactionHistory, Hash] the current TransactionHistory data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of TransactionHistory fields)
  def match_get
  ...
  #
  # @param reqdata [TransactionHistoryCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [TransactionHistory, Hash] the created TransactionHistory; raises BluefinTecsMerchantServicesError on failure
