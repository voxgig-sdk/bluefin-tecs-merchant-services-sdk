...
class RefundTransactionEntity
  ...
  def make
    opts = @_entopts.dup
    RefundTransactionEntity.new(@_client, opts)
  end
  ...
  # @return [RefundTransaction, Hash] the current RefundTransaction data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RefundTransaction fields)
  def match_get
  ...
  #
  # @param reqdata [RefundTransactionCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [RefundTransaction, Hash] the created RefundTransaction; raises BluefinTecsMerchantServicesError on failure
