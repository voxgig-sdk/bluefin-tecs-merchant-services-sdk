...
class ReportDataEntity
  ...
  def make
    opts = @_entopts.dup
    ReportDataEntity.new(@_client, opts)
  end
  ...
  # @return [ReportData, Hash] the current ReportData data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ReportData fields)
  def match_get
  ...
  #
  # @param reqdata [ReportDataCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ReportData, Hash] the created ReportData; raises BluefinTecsMerchantServicesError on failure
