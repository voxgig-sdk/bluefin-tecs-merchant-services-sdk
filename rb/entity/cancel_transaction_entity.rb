...
class CancelTransactionEntity
  ...
  def make
    opts = @_entopts.dup
    CancelTransactionEntity.new(@_client, opts)
  end
  ...
  # @return [CancelTransaction, Hash] the current CancelTransaction data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CancelTransaction fields)
  def match_get
  ...
  #
  # @param reqdata [CancelTransactionCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [CancelTransaction, Hash] the created CancelTransaction; raises BluefinTecsMerchantServicesError on failure
