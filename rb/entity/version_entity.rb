...
class VersionEntity
  ...
  def make
    opts = @_entopts.dup
    VersionEntity.new(@_client, opts)
  end
  ...
  # @return [Version, Hash] the current Version data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Version fields)
  def match_get
  ...
  #
  # @param reqmatch [VersionLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Version.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Version, Hash] the loaded Version; raises BluefinTecsMerchantServicesError on failure
