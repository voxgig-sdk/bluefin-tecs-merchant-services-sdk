...
class EmvDataEntity
  ...
  def make
    opts = @_entopts.dup
    EmvDataEntity.new(@_client, opts)
  end
  ...
  # @return [EmvData, Hash] the current EmvData data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EmvData fields)
  def match_get
  ...
  #
  # @param reqdata [EmvDataCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [EmvData, Hash] the created EmvData; raises BluefinTecsMerchantServicesError on failure
