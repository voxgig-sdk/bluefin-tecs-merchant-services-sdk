...
class EcomParameterEntity
  ...
  def make
    opts = @_entopts.dup
    EcomParameterEntity.new(@_client, opts)
  end
  ...
  # @return [EcomParameter, Hash] the current EcomParameter data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EcomParameter fields)
  def match_get
  ...
  #
  # @param reqdata [EcomParameterCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [EcomParameter, Hash] the created EcomParameter; raises BluefinTecsMerchantServicesError on failure
