...
class UpdateMerchantEntity
  ...
  def make
    opts = @_entopts.dup
    UpdateMerchantEntity.new(@_client, opts)
  end
  ...
  # @return [UpdateMerchant, Hash] the current UpdateMerchant data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of UpdateMerchant fields)
  def match_get
  ...
  #
  # @param reqdata [UpdateMerchantCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [UpdateMerchant, Hash] the created UpdateMerchant; raises BluefinTecsMerchantServicesError on failure
