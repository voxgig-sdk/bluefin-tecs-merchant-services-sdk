...
class RegisterTerminalEntity
  ...
  def make
    opts = @_entopts.dup
    RegisterTerminalEntity.new(@_client, opts)
  end
  ...
  # @return [RegisterTerminal, Hash] the current RegisterTerminal data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RegisterTerminal fields)
  def match_get
  ...
  #
  # @param reqdata [RegisterTerminalCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [RegisterTerminal, Hash] the created RegisterTerminal; raises BluefinTecsMerchantServicesError on failure
