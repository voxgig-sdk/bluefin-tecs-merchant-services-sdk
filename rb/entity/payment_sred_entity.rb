...
class PaymentSredEntity
  ...
  def make
    opts = @_entopts.dup
    PaymentSredEntity.new(@_client, opts)
  end
  ...
  # @return [PaymentSred, Hash] the current PaymentSred data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PaymentSred fields)
  def match_get
  ...
  #
  # @param reqdata [PaymentSredCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [PaymentSred, Hash] the created PaymentSred; raises BluefinTecsMerchantServicesError on failure
