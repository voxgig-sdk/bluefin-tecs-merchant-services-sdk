...
class KeepAliveEntity
  ...
  def make
    opts = @_entopts.dup
    KeepAliveEntity.new(@_client, opts)
  end
  ...
  # @return [KeepAlive, Hash] the current KeepAlive data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of KeepAlive fields)
  def match_get
  ...
  #
  # @param reqdata [KeepAliveCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [KeepAlive, Hash] the created KeepAlive; raises BluefinTecsMerchantServicesError on failure
