...
class EcrDataEntity
  ...
  def make
    opts = @_entopts.dup
    EcrDataEntity.new(@_client, opts)
  end
  ...
  # @return [EcrData, Hash] the current EcrData data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EcrData fields)
  def match_get
  ...
  #
  # @param reqdata [EcrDataCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [EcrData, Hash] the created EcrData; raises BluefinTecsMerchantServicesError on failure
