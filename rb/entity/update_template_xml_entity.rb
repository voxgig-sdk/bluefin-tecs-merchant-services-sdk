...
class UpdateTemplateXmlEntity
  ...
  def make
    opts = @_entopts.dup
    UpdateTemplateXmlEntity.new(@_client, opts)
  end
  ...
  # @return [UpdateTemplateXml, Hash] the current UpdateTemplateXml data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of UpdateTemplateXml fields)
  def match_get
  ...
  #
  # @param reqdata [UpdateTemplateXmlCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [UpdateTemplateXml, Hash] the created UpdateTemplateXml; raises BluefinTecsMerchantServicesError on failure
