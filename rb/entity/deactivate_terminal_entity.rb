...
class DeactivateTerminalEntity
  ...
  def make
    opts = @_entopts.dup
    DeactivateTerminalEntity.new(@_client, opts)
  end
  ...
  # @return [DeactivateTerminal, Hash] the current DeactivateTerminal data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DeactivateTerminal fields)
  def match_get
  ...
  #
  # @param reqdata [DeactivateTerminalCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [DeactivateTerminal, Hash] the created DeactivateTerminal; raises BluefinTecsMerchantServicesError on failure
