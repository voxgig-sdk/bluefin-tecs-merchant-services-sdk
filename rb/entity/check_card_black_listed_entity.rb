...
class CheckCardBlackListedEntity
  ...
  def make
    opts = @_entopts.dup
    CheckCardBlackListedEntity.new(@_client, opts)
  end
  ...
  # @return [CheckCardBlackListed, Hash] the current CheckCardBlackListed data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CheckCardBlackListed fields)
  def match_get
  ...
  #
  # @param reqdata [CheckCardBlackListedCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [CheckCardBlackListed, Hash] the created CheckCardBlackListed; raises BluefinTecsMerchantServicesError on failure
