...
class StatusTransactionEntity
  ...
  def make
    opts = @_entopts.dup
    StatusTransactionEntity.new(@_client, opts)
  end
  ...
  # @return [StatusTransaction, Hash] the current StatusTransaction data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of StatusTransaction fields)
  def match_get
  ...
  #
  # @param reqdata [StatusTransactionCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [StatusTransaction, Hash] the created StatusTransaction; raises BluefinTecsMerchantServicesError on failure
