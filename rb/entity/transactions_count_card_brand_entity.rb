...
class TransactionsCountCardBrandEntity
  ...
  def make
    opts = @_entopts.dup
    TransactionsCountCardBrandEntity.new(@_client, opts)
  end
  ...
  # @return [TransactionsCountCardBrand, Hash] the current TransactionsCountCardBrand data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of TransactionsCountCardBrand fields)
  def match_get
  ...
  #
  # @param reqdata [TransactionsCountCardBrandCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [TransactionsCountCardBrand, Hash] the created TransactionsCountCardBrand; raises BluefinTecsMerchantServicesError on failure
