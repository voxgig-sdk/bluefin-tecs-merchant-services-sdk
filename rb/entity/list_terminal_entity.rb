...
class ListTerminalEntity
  ...
  def make
    opts = @_entopts.dup
    ListTerminalEntity.new(@_client, opts)
  end
  ...
  # @return [ListTerminal, Hash] the current ListTerminal data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ListTerminal fields)
  def match_get
  ...
  #
  # @param reqdata [ListTerminalCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ListTerminal, Hash] the created ListTerminal; raises BluefinTecsMerchantServicesError on failure
