...
class TransactionsCountEntity
  ...
  def make
    opts = @_entopts.dup
    TransactionsCountEntity.new(@_client, opts)
  end
  ...
  # @return [TransactionsCount, Hash] the current TransactionsCount data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of TransactionsCount fields)
  def match_get
  ...
  #
  # @param reqdata [TransactionsCountCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [TransactionsCount, Hash] the created TransactionsCount; raises BluefinTecsMerchantServicesError on failure
