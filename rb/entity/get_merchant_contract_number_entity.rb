...
class GetMerchantContractNumberEntity
  ...
  def make
    opts = @_entopts.dup
    GetMerchantContractNumberEntity.new(@_client, opts)
  end
  ...
  # @return [GetMerchantContractNumber, Hash] the current GetMerchantContractNumber data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GetMerchantContractNumber fields)
  def match_get
  ...
  #
  # @param reqdata [GetMerchantContractNumberCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [GetMerchantContractNumber, Hash] the created GetMerchantContractNumber; raises BluefinTecsMerchantServicesError on failure
