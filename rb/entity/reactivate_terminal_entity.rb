...
class ReactivateTerminalEntity
  ...
  def make
    opts = @_entopts.dup
    ReactivateTerminalEntity.new(@_client, opts)
  end
  ...
  # @return [ReactivateTerminal, Hash] the current ReactivateTerminal data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ReactivateTerminal fields)
  def match_get
  ...
  #
  # @param reqdata [ReactivateTerminalCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ReactivateTerminal, Hash] the created ReactivateTerminal; raises BluefinTecsMerchantServicesError on failure
