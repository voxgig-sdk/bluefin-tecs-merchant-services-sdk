...
class TerminalIdEntity
  ...
  def make
    opts = @_entopts.dup
    TerminalIdEntity.new(@_client, opts)
  end
  ...
  # @return [TerminalId, Hash] the current TerminalId data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of TerminalId fields)
  def match_get
  ...
  #
  # @param reqdata [TerminalIdCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [TerminalId, Hash] the created TerminalId; raises BluefinTecsMerchantServicesError on failure
