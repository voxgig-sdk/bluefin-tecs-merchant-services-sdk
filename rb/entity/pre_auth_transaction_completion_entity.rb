...
class PreAuthTransactionCompletionEntity
  ...
  def make
    opts = @_entopts.dup
    PreAuthTransactionCompletionEntity.new(@_client, opts)
  end
  ...
  # @return [PreAuthTransactionCompletion, Hash] the current PreAuthTransactionCompletion data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PreAuthTransactionCompletion fields)
  def match_get
  ...
  #
  # @param reqdata [PreAuthTransactionCompletionCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [PreAuthTransactionCompletion, Hash] the created PreAuthTransactionCompletion; raises BluefinTecsMerchantServicesError on failure
