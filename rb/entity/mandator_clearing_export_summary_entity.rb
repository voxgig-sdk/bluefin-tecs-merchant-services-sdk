...
class MandatorClearingExportSummaryEntity
  ...
  def make
    opts = @_entopts.dup
    MandatorClearingExportSummaryEntity.new(@_client, opts)
  end
  ...
  # @return [MandatorClearingExportSummary, Hash] the current MandatorClearingExportSummary data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MandatorClearingExportSummary fields)
  def match_get
  ...
  #
  # @param reqdata [MandatorClearingExportSummaryCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [MandatorClearingExportSummary, Hash] the created MandatorClearingExportSummary; raises BluefinTecsMerchantServicesError on failure
