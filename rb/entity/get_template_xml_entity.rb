...
class GetTemplateXmlEntity
  ...
  def make
    opts = @_entopts.dup
    GetTemplateXmlEntity.new(@_client, opts)
  end
  ...
  # @return [GetTemplateXml, Hash] the current GetTemplateXml data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GetTemplateXml fields)
  def match_get
  ...
  #
  # @param reqdata [GetTemplateXmlCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [GetTemplateXml, Hash] the created GetTemplateXml; raises BluefinTecsMerchantServicesError on failure
