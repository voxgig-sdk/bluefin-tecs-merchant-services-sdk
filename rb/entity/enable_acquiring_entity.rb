...
class EnableAcquiringEntity
  ...
  def make
    opts = @_entopts.dup
    EnableAcquiringEntity.new(@_client, opts)
  end
  ...
  # @return [EnableAcquiring, Hash] the current EnableAcquiring data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EnableAcquiring fields)
  def match_get
  ...
  #
  # @param reqdata [EnableAcquiringCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [EnableAcquiring, Hash] the created EnableAcquiring; raises BluefinTecsMerchantServicesError on failure
