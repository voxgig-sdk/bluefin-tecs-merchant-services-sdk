...
class StoreTerminalParameterEntity
  ...
  def make
    opts = @_entopts.dup
    StoreTerminalParameterEntity.new(@_client, opts)
  end
  ...
  # @return [StoreTerminalParameter, Hash] the current StoreTerminalParameter data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of StoreTerminalParameter fields)
  def match_get
  ...
  #
  # @param reqdata [StoreTerminalParameterCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [StoreTerminalParameter, Hash] the created StoreTerminalParameter; raises BluefinTecsMerchantServicesError on failure
