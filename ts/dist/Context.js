...
const BluefinTecsMerchantServicesError_1 = require("./BluefinTecsMerchantServicesError");
...
class Context {
    ...
    error(code, msg) {
        return new BluefinTecsMerchantServicesError_1.BluefinTecsMerchantServicesError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
