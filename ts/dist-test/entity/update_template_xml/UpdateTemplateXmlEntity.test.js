...
(0, node_test_1.describe)('UpdateTemplateXmlEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != update_template_xml_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/update_template_xml/UpdateTemplateXmlTestData.json');
    ...
    let idmap = transform(['update_template_xml01', 'update_template_xml02', 'update_template_xml03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=UpdateTemplateXmlEntity.test.js.map