...
(0, node_test_1.describe)('PreAuthTransactionCompletionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'pre_auth_transaction_completion.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != pre_auth_transaction_completion_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/pre_auth_transaction_completion/PreAuthTransactionCompletionTestData.json');
    ...
    let idmap = transform(['pre_auth_transaction_completion01', 'pre_auth_transaction_completion02', 'pre_auth_transaction_completion03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['BLUEFIN_TECS_MERCHANT_SERVICES_TEST_PRE_AUTH_TRANSACTION_COMPLETION_ENTID'];
...
//# sourceMappingURL=PreAuthTransactionCompletionEntity.test.js.map