...
(0, node_test_1.describe)('IntroducePackageEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != introduce_package_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/introduce_package/IntroducePackageTestData.json');
    ...
    let idmap = transform(['introduce_package01', 'introduce_package02', 'introduce_package03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=IntroducePackageEntity.test.js.map