...
(0, node_test_1.describe)('IntroducePackageEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'introduce_package.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['BLUEFIN_TECS_MERCHANT_SERVICES_TEST_INTRODUCE_PACKAGE_ENTID'];
