...
(0, node_test_1.describe)('EcDataEcomEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != ec_data_ecom_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/ec_data_ecom/EcDataEcomTestData.json');
    ...
    let idmap = transform(['ec_data_ecom01', 'ec_data_ecom02', 'ec_data_ecom03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=EcDataEcomEntity.test.js.map