...
(0, node_test_1.describe)('CancelTransactionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != cancel_transaction_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/cancel_transaction/CancelTransactionTestData.json');
    ...
    let idmap = transform(['cancel_transaction01', 'cancel_transaction02', 'cancel_transaction03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CancelTransactionEntity.test.js.map