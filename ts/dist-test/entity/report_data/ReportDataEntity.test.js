...
(0, node_test_1.describe)('ReportDataEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'report_data.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != report_data_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/report_data/ReportDataTestData.json');
    ...
    let idmap = transform(['report_data01', 'report_data02', 'report_data03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['BLUEFIN_TECS_MERCHANT_SERVICES_TEST_REPORT_DATA_ENTID'];
...
//# sourceMappingURL=ReportDataEntity.test.js.map