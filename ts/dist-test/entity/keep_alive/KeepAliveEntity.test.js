...
(0, node_test_1.describe)('KeepAliveEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != keep_alive_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/keep_alive/KeepAliveTestData.json');
    ...
    let idmap = transform(['keep_alive01', 'keep_alive02', 'keep_alive03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=KeepAliveEntity.test.js.map