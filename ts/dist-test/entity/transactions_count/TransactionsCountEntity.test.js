...
(0, node_test_1.describe)('TransactionsCountEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != transactions_count_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/transactions_count/TransactionsCountTestData.json');
    ...
    let idmap = transform(['transactions_count01', 'transactions_count02', 'transactions_count03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    if (live) {
        const rawIds = process.env['BLUEFIN_TECS_MERCHANT_SERVICES_TEST_TRANSACTIONS_COUNT_ENTID'];
...
//# sourceMappingURL=TransactionsCountEntity.test.js.map