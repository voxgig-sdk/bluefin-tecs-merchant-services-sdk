...
(0, node_test_1.describe)('VersionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-version', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-version', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['BLUEFIN_TECS_MERCHANT_SERVICES_TEST_VERSION_ENTID'];
...
//# sourceMappingURL=VersionDirect.test.js.map