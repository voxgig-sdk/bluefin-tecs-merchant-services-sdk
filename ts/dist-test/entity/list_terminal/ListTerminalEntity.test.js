...
(0, node_test_1.describe)('ListTerminalEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'list_terminal.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != list_terminal_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/list_terminal/ListTerminalTestData.json');
    ...
    let idmap = transform(['list_terminal01', 'list_terminal02', 'list_terminal03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['BLUEFIN_TECS_MERCHANT_SERVICES_TEST_LIST_TERMINAL_ENTID'];
...
//# sourceMappingURL=ListTerminalEntity.test.js.map