...
(0, node_test_1.describe)('UpdateMerchantEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'update_merchant.' + op, live))
                return;
        }
        const setup = basicSetup();
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [{ "active": true, "name": "city", "req": false, "type": "`$STRING`", "index$": 0 }, { "active": true, "name": "corporateUuid", "req": true, "type": "`$STRING`", "index$": 1 }, { "active": true, "name": "country", "req": false, "type": "`$STRING`", "index$": 2 }, { "active": true, "name": "merchantCategoryCode", "req": false, "type": "`$STRING`", "index$": 3 }, { "active": true, "name": "name", "req": false, "type": "`$STRING`", "index$": 4 }, { "active": true, "format": "int32", "name": "responseCode", "req": false, "type": "`$INTEGER`", "index$": 5 }, { "active": true, "name": "responseMessage", "req": false, "type": "`$STRING`", "index$": 6 }, { "active": true, "name": "state", "req": false, "type": "`$STRING`", "index$": 7 }, { "active": true, "name": "street", "req": false, "type": "`$STRING`", "index$": 8 }, { "active": true, "name": "vuNummer", "req": false, "type": "`$STRING`", "index$": 9 }, { "active": true, "name": "zipcode", "req": false, "type": "`$STRING`", "index$": 10 }], "name": "update_merchant", "op": { "create": { "input": "data", "name": "create", "points": [{ "active": true, "args": {}, "contract": { "id": "POST /public/updateMerchant", "json": "{\"operationId\":\"updateMerchant\",\"parameters\":[],\"protocol\":\"http\",\"requestBody\":{\"content\":{\"application/json\":{\"schema\":{\"properties\":{\"city\":{\"type\":\"string\"},\"corporateUuid\":{\"minLength\":1,\"type\":\"string\"},\"country\":{\"type\":\"string\"},\"merchantCategoryCode\":{\"maxLength\":100,\"minLength\":0,\"type\":\"string\"},\"name\":{\"type\":\"string\"},\"state\":{\"type\":\"string\"},\"street\":{\"type\":\"string\"},\"vuNummer\":{\"maxLength\":15,\"minLength\":0,\"type\":\"string\"},\"zipcode\":{\"type\":\"string\"}},\"required\":[\"corporateUuid\"],\"type\":\"object\"}}},\"required\":true},\"responses\":{\"200\":{\"content\":{\"application/json\":{\"schema\":{\"properties\":{\"responseCode\":{\"format\":\"int32\",\"type\":\"integer\"},\"responseMessage\":{\"type\":\"string\"}},\"type\":\"object\"}}},\"description\":\"Successful operation\"},\"400\":{\"content\":{\"application/json\":{\"schema\":{\"properties\":{\"responseCode\":{\"format\":\"int32\",\"type\":\"integer\"},\"responseMessage\":{\"type\":\"string\"}},\"type\":\"object\"}}},\"description\":\"Bad request\"},\"401\":{\"content\":{\"application/json\":{\"schema\":{\"properties\":{\"responseCode\":{\"format\":\"int32\",\"type\":\"integer\"},\"responseMessage\":{\"type\":\"string\"}},\"type\":\"object\"}}},\"description\":\"Unauthenticated - Authentication failed\"},\"403\":{\"content\":{\"application/json\":{\"schema\":{\"properties\":{\"responseCode\":{\"format\":\"int32\",\"type\":\"integer\"},\"responseMessage\":{\"type\":\"string\"}},\"type\":\"object\"}}},\"description\":\"Unauthorized - Missing role BO_USERMANAGEMENT_UPDATE_CORPORATE\"},\"500\":{\"content\":{\"application/json\":{\"schema\":{\"properties\":{\"responseCode\":{\"format\":\"int32\",\"type\":\"integer\"},\"responseMessage\":{\"type\":\"string\"}},\"type\":\"object\"}}},\"description\":\"Internal server error\"}},\"security\":[{\"bearer-key\":[]},{\"basic-key\":[]}],\"securitySchemes\":{\"basic-key\":{\"scheme\":\"basic\",\"type\":\"http\"},\"bearer-key\":{\"bearerFormat\":\"JWT\",\"scheme\":\"bearer\",\"type\":\"http\"},\"tecsweb-key\":{\"description\":\"TecsWeb token\",\"in\":\"header\",\"name\":\"TecsWebToken\",\"type\":\"apiKey\"}},\"securitySource\":\"operation\"}", "source": "openapi3", "version": 1 }, "kind": "http", "method": "POST", "orig": "/public/updateMerchant", "segments": [{ "lit": "public" }, { "lit": "updateMerchant" }], "select": {}, "transform": { "req": "`reqdata`", "res": "`body`" }, "index$": 0 }], "key$": "create" } }, "relations": { "ancestors": [] }, "key$": "update_merchant", "name__orig": "update_merchant", "Name": "UpdateMerchant", "name_": "update_merchant", "name-": "update-merchant", "NAME": "UPDATE_MERCHANT", "index$": 36 }, { "active": true, "entity": "update_merchant", "key$": "BasicUpdateMerchantFlow", "kind": "basic", "name": "BasicUpdateMerchantFlow", "param": {}, "step": [{ "active": true, "data": {}, "input": { "ref": "update_merchant_ref01" }, "match": {}, "op": "create", "spec": [], "valid": [], "index$": 0 }] }, 'UpdateMerchant');
        }
        ...
        (0, node_assert_1.default)(null != update_merchant_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/update_merchant/UpdateMerchantTestData.json');
    ...
    let idmap = transform(['update_merchant01', 'update_merchant02', 'update_merchant03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=UpdateMerchantEntity.test.js.map