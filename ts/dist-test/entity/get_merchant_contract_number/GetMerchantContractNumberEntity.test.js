...
(0, node_test_1.describe)('GetMerchantContractNumberEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != get_merchant_contract_number_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/get_merchant_contract_number/GetMerchantContractNumberTestData.json');
    ...
    let idmap = transform(['get_merchant_contract_number01', 'get_merchant_contract_number02', 'get_merchant_contract_number03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=GetMerchantContractNumberEntity.test.js.map