...
(0, node_test_1.describe)('TerminalIdEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != terminal_id_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/terminal_id/TerminalIdTestData.json');
    ...
    let idmap = transform(['terminal_id01', 'terminal_id02', 'terminal_id03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=TerminalIdEntity.test.js.map