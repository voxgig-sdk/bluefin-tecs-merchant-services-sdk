...
(0, node_test_1.describe)('DigitalServicesApiEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'digital_services_api.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != digital_services_api_ref01_data);
        // LOAD
        ...
        (0, node_assert_1.default)(null != digital_services_api_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/digital_services_api/DigitalServicesApiTestData.json');
    ...
    let idmap = transform(['digital_services_api01', 'digital_services_api02', 'digital_services_api03', 'mandator_clearing_export_download01', 'mandator_clearing_export_download02', 'mandator_clearing_export_download03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=DigitalServicesApiEntity.test.js.map