...
(0, node_test_1.describe)('DigitalServicesApiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-digital_services_api', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-digital_services_api', setup.live))
            return;
...
//# sourceMappingURL=DigitalServicesApiDirect.test.js.map