...
(0, node_test_1.describe)('EcomParameterEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'ecom_parameter.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != ecom_parameter_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/ecom_parameter/EcomParameterTestData.json');
    ...
    let idmap = transform(['ecom_parameter01', 'ecom_parameter02', 'ecom_parameter03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['BLUEFIN_TECS_MERCHANT_SERVICES_TEST_ECOM_PARAMETER_ENTID'];
...
//# sourceMappingURL=EcomParameterEntity.test.js.map