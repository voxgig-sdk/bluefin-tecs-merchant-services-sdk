...
(0, node_test_1.describe)('TransactionsTurnoverEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'transactions_turnover.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != transactions_turnover_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/transactions_turnover/TransactionsTurnoverTestData.json');
    ...
    let idmap = transform(['transactions_turnover01', 'transactions_turnover02', 'transactions_turnover03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=TransactionsTurnoverEntity.test.js.map