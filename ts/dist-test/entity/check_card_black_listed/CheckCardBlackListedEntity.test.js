...
(0, node_test_1.describe)('CheckCardBlackListedEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != check_card_black_listed_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/check_card_black_listed/CheckCardBlackListedTestData.json');
    ...
    let idmap = transform(['check_card_black_listed01', 'check_card_black_listed02', 'check_card_black_listed03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CheckCardBlackListedEntity.test.js.map