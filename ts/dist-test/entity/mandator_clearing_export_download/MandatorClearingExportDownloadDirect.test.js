...
(0, node_test_1.describe)('MandatorClearingExportDownloadDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.BluefinTecsMerchantServicesSDK({
    ...
    (0, node_test_1.test)('direct-load-mandator_clearing_export_download', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-mandator_clearing_export_download', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.BLUEFIN_TECS_MERCHANT_SERVICES_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.BluefinTecsMerchantServicesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.BLUEFIN_TECS_MERCHANT_SERVICES_APIKEY,
        }));
        let idmap = env['BLUEFIN_TECS_MERCHANT_SERVICES_TEST_MANDATOR_CLEARING_EXPORT_DOWNLOAD_ENTID'];
    ...
    const client = new __1.BluefinTecsMerchantServicesSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=MandatorClearingExportDownloadDirect.test.js.map