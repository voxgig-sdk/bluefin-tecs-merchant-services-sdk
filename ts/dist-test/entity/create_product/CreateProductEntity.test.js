...
(0, node_test_1.describe)('CreateProductEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != create_product_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/create_product/CreateProductTestData.json');
    ...
    let idmap = transform(['create_product01', 'create_product02', 'create_product03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CreateProductEntity.test.js.map