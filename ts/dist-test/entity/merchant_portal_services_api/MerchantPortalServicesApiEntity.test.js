...
(0, node_test_1.describe)('MerchantPortalServicesApiEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'merchant_portal_services_api.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != merchant_portal_services_api_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/merchant_portal_services_api/MerchantPortalServicesApiTestData.json');
    ...
    let idmap = transform(['merchant_portal_services_api01', 'merchant_portal_services_api02', 'merchant_portal_services_api03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['BLUEFIN_TECS_MERCHANT_SERVICES_TEST_MERCHANT_PORTAL_SERVICES_API_ENTID'];
...
//# sourceMappingURL=MerchantPortalServicesApiEntity.test.js.map