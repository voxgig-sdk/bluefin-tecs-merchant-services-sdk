...
const __1 = require("..");
const SDK_NAME = 'BluefinTecsMerchantServicesSDK';
...
const TEST_SEED = { "entity": { "cancel_transaction": { "test01": { "id": "test01" } }, "check_card_black_listed": { "test01": { "id": "test01" } }, "create_product": { "test01": { "id": "test01" } }, "deactivate_terminal": { "test01": { "id": "test01" } }, "digital_services_api": { "test01": { "id": "test01" } }, "ec_data_ecom": { "test01": { "id": "test01" } }, "ecom_parameter": { "test01": { "id": "test01" } }, "ecr_data": { "test01": { "id": "test01" } }, "emv_data": { "test01": { "id": "test01" } }, "enable_acquiring": { "test01": { "id": "test01" } }, "get_merchant_contract_number": { "test01": { "id": "test01" } }, "get_template_xml": { "test01": { "id": "test01" } }, "introduce_mandator": { "test01": { "id": "test01" } }, "introduce_package": { "test01": { "id": "test01" } }, "keep_alive": { "test01": { "id": "test01" } }, "list_terminal": { "test01": { "id": "test01" } }, "mandator_clearing_export": { "test01": { "id": "test01" } }, "mandator_clearing_export_download": { "test01": { "id": "test01" } }, "mandator_clearing_export_summary": { "test01": { "id": "test01" } }, "merchant_portal_services_api": { "test01": { "id": "test01" } }, "move_tid": { "test01": { "id": "test01" } }, "payment_manual": { "test01": { "id": "test01" } }, "payment_sred": { "test01": { "id": "test01" } }, "pre_auth_transaction_completion": { "test01": { "id": "test01" } }, "reactivate_terminal": { "test01": { "id": "test01" } }, "refund_transaction": { "test01": { "id": "test01" } }, "register_tecs_company": { "test01": { "id": "test01" } }, "register_terminal": { "test01": { "id": "test01" } }, "report_data": { "test01": { "id": "test01" } }, "status_transaction": { "test01": { "id": "test01" } }, "store_terminal_parameter": { "test01": { "id": "test01" } }, "terminal_id": { "test01": { "id": "test01" } }, "transaction_history": { "test01": { "id": "test01" } }, "transactions_count": { "test01": { "id": "test01" } }, "transactions_count_card_brand": { "test01": { "id": "test01" } }, "transactions_turnover": { "test01": { "id": "test01" } }, "update_merchant": { "test01": { "id": "test01" } }, "update_template_xml": { "test01": { "id": "test01" } }, "version": { "test01": { "id": "test01" } } } };
...
function isRunnable(code) {
    return (/new\s+BluefinTecsMerchantServicesSDK\b/.test(code) ||
        /\bBluefinTecsMerchantServicesSDK\.test\b/.test(code) ||
        /\bclient\s*\./.test(code));
}
...
function rewriteForRun(code) {
    ...
    out = out.replace(/new\s+BluefinTecsMerchantServicesSDK\s*\([^)]*\)/g, () => SEEDED_CTOR);
    out = out.replace(/BluefinTecsMerchantServicesSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR);
