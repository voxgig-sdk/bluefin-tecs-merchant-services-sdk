...
class VersionEntity extends BluefinTecsMerchantServicesEntityBase<Version> {
  ...
  async load(this: any, reqmatch?: VersionLoadMatch, ctrl?: Control): Promise<VersionEntity> {
